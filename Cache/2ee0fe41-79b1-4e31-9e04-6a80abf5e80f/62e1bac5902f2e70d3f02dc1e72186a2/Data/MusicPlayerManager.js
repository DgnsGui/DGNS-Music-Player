...
function setupAudioComponent() {
    ...
    if (!script.getSceneObject().getComponent("AudioComponent")) {
        audioComponent = script.getSceneObject().createComponent("AudioComponent");
        logDebug("Created new AudioComponent");
    } else {
        audioComponent = script.getSceneObject().getComponent("AudioComponent");
