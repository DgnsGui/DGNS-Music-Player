...
function setupButtonListeners() {
    ...
    // Cette méthode gère correctement l'accès aux événements des boutons
    
    // Configuration du bouton play/pause
    if (script.playPauseButton) {
        var onPinchEvent = script.createEvent("TapEvent");
        onPinchEvent.bind(function() {
            togglePlayPause();
        });
    ...
    if (script.nextTrackButton) {
        var onNextEvent = script.createEvent("TapEvent");
        onNextEvent.bind(function() {
            nextTrack();
        });
    ...
    if (script.backTrackButton) {
        var onBackEvent = script.createEvent("TapEvent");
        onBackEvent.bind(function() {
            previousTrack();
        });
    ...
    if (script.shuffleButton) {
        var onShuffleEvent = script.createEvent("TapEvent");
        onShuffleEvent.bind(function() {
            toggleShuffle();
        });
    ...
    if (script.repeatButton) {
        var onRepeatEvent = script.createEvent("TapEvent");
        onRepeatEvent.bind(function() {
            toggleRepeat();
        });
    ...
    if (script.stopButton) {
        var onStopEvent = script.createEvent("TapEvent");
        onStopEvent.bind(function() {
            stopTrack();
        });
