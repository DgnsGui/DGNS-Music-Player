...
vec3 l9_83=ssSRGB_to_Linear(l9_80);
...
#endif
vec3 l9_87=vec3(Port_Metallic_N006);
vec3 l9_88=mix(vec3(0.039999999),l9_83*Port_Metallic_N006,l9_87);
vec3 l9_89=mix(l9_83*(1.0-Port_Metallic_N006),vec3(0.0),l9_87);
SurfaceProperties l9_90=SurfaceProperties(l9_89,l9_79,l9_84,varPos,l9_0,Port_Metallic_N006,l9_82,l9_85,l9_86,Port_SpecularAO_N006,vec3(1.0),l9_88);
vec4 l9_91=vec4(1.0);
vec3 l9_92;
vec3 l9_93;
vec3 l9_94;
...
l9_81=vec4(l9_215.x,l9_215.y,l9_215.z,l9_212.w);
}
#endif
vec4 l9_216=max(l9_81,vec4(0.0));
vec4 l9_217;
#if (sc_ProjectiveShadowsCaster)
{
float l9_218;
