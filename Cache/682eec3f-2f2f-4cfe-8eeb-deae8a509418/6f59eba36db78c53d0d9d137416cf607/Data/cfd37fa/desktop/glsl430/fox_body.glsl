...
#else
{
l9_158=ngsCalculateLighting(l9_157,l9_156,l9_155,l9_4,l9_5,Port_Emissive_N006,Port_Metallic_N006,clamp(l9_108.y,0.0,1.0),clamp(vec3(l9_108.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
