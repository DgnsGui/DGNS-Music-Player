...
#else
{
l9_15=ngsCalculateLighting(l9_14,Port_Opacity_N006,l9_13,l9_7,l9_8,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
