...
vec3 l9_13=normalize(l9_7);
vec3 l9_14=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_15;
#if (sc_SSAOEnabled)
{
l9_15=evaluateSSAO(varPos);
}
#else
{
l9_15=Port_AO_N006;
...
SurfaceProperties l9_19=SurfaceProperties(l9_18,Port_Opacity_N006,l9_13,varPos,l9_3,l9_10,l9_11,l9_14,l9_15,Port_SpecularAO_N006,vec3(1.0),l9_17);
vec4 l9_20=vec4(1.0);
vec3 l9_21;
vec3 l9_22;
vec3 l9_23;
...
{
LightingComponents l9_40=accumulateLight(LightingComponents(l9_28,l9_29,l9_34,l9_33,l9_31,l9_30),LightProperties(sc_DirectionalLights[l9_39].direction,sc_DirectionalLights[l9_39].color.xyz,sc_DirectionalLights[l9_39].color.w*l9_20[(l9_32<3) ? l9_32 : 3]),l9_19,l9_3);
...
{
vec3 l9_59=sc_PointLights[l9_57].position-varPos;
...
l9_50=l9_58+1;
LightingComponents l9_65=accumulateLight(LightingComponents(l9_44,l9_45,l9_49,l9_48,l9_47,l9_46),LightProperties(l9_60,sc_PointLights[l9_57].color.xyz,l9_64),l9_19,l9_3);
...
vec2 l9_108=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_13,reflect(-l9_3,l9_13),l9_11),sc_EnvmapRotation.y);
vec4 l9_109;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_106=vec3(0.0)+((((l9_109.xyz*(1.0/l9_109.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_19,abs(dot(l9_13,l9_3))));
}
#else
{
l9_106=vec3(0.0);
...
vec3 l9_117=reflect(-l9_3,l9_13);
float l9_118=dot(l9_13,l9_3);
...
l9_127=vec3(0.0);
l9_126=vec3(0.0);
l9_125=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_18,vec3(Port_Opacity_N006));
l9_124=1.0;
}
#else
{
...
vec3 l9_132=l9_112*Port_SpecularAO_N006;
...
{
vec4 l9_140=l9_138;
l9_140.x=l9_137+((l9_15.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_139=l9_140;
}
#else
{
...
#endif
vec3 l9_147=(((l9_5/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(exp(density),0.0)))+vec3(Port_Value1_N011,Port_Value2_N011,l9_1*(l9_146-0.001)))*noiseFrequency;
vec2 l9_148=l9_147.yz;
float l9_149;
Node54_Noise_Simplex(l9_148,Port_Scale_N054,l9_149,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_148,varPackedTex.xy));
float l9_150=l9_149;
vec2 l9_151=l9_147.zx;
float l9_152;
Node54_Noise_Simplex(l9_151,Port_Scale_N054,l9_152,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_151,varPackedTex.xy));
float l9_153=l9_152;
vec2 l9_154=l9_147.xy;
float l9_155;
Node54_Noise_Simplex(l9_154,Port_Scale_N054,l9_155,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_154,varPackedTex.xy));
float l9_156=l9_155;
vec3 l9_157=pow(abs(l9_6),vec3(1.0/(1.0-((clamp(Port_Import_N081+0.001,Port_Input1_N082+0.001,Port_Input2_N082+0.001)-0.001)*0.99000001))));
float l9_158=l9_157.x;
float l9_159=l9_157.y;
float l9_160=l9_157.z;
float l9_161;
#if (animate)
{
float l9_162=((Port_TimeA_N028+Port_TimeTransition_N028)+Port_TimeB_N028)+9.9999997e-05;
l9_161=mix(Port_ValueA_N028,Port_ValueB_N028,smoothstep(Port_TimeA_N028/l9_162,1.0-(Port_TimeB_N028/l9_162),abs((mod((l9_1/l9_162)+Port_TimeBias_N028,1.0)*2.0)-1.0)));
}
#else
{
l9_161=disintegrate;
...
#endif
float l9_163=l9_161-Port_RangeMinA_N017;
float l9_164=clamp((((((l9_150*l9_158)+(l9_153*l9_159))+(l9_156*l9_160))/((l9_158+l9_159)+l9_160))+(((l9_163/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001;
float l9_165=(((l9_164-Port_RangeMinA_N064)/(Port_RangeMaxA_N064-Port_RangeMinA_N064))*(Port_RangeMaxB_N064-Port_RangeMinB_N064))+Port_RangeMinB_N064;
float l9_166;
if (Port_RangeMaxB_N064>Port_RangeMinB_N064)
{
l9_166=clamp(l9_165,Port_RangeMinB_N064,Port_RangeMaxB_N064);
}
else
{
l9_166=clamp(l9_165,Port_RangeMaxB_N064,Port_RangeMinB_N064);
}
vec4 l9_167=vec4(l9_166);
vec4 l9_168=mix(l9_145,edgeColor,l9_167);
if ((floor(l9_164+0.5)*1.0)!=0.0)
{
discard;
}
vec4 l9_169;
...
{
l9_170=1-sc_GetStereoViewIndex();
}
#else
{
l9_170=sc_GetStereoViewIndex();
}
#endif
float l9_171=varPackedTex.x;
sc_SoftwareWrapEarly(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_172=l9_171;
float l9_173=varPackedTex.y;
sc_SoftwareWrapEarly(l9_173,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_174=l9_173;
vec2 l9_175;
float l9_176;
...
{
l9_177=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_177=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_178=l9_172;
float l9_179=1.0;
sc_ClampUV(l9_178,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_177,l9_179);
float l9_180=l9_178;
float l9_181=l9_179;
bool l9_182;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_182=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
...
float l9_183=l9_174;
float l9_184=l9_181;
sc_ClampUV(l9_183,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_182,l9_184);
l9_176=l9_184;
...
#endif
vec2 l9_185=sc_TransformUV(l9_175,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_186=l9_185.x;
float l9_187=l9_176;
sc_SoftwareWrapLate(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_187);
float l9_188=l9_185.y;
float l9_189=l9_187;
sc_SoftwareWrapLate(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_189);
float l9_190=l9_189;
vec3 l9_191=sc_SamplingCoordsViewToGlobal(vec2(l9_186,l9_188),opacityTextureLayout,l9_170);
vec4 l9_192=texture2D(opacityTexture,l9_191.xy,0.0);
vec4 l9_193;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_193=mix(opacityTextureBorderColor,l9_192,vec4(l9_190));
}
#else
{
l9_193=l9_192;
...
#else
{
l9_169=vec4(Port_Input2_N044);
}
#endif
float l9_194=clamp((l9_168.w*l9_169.x)+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_195=vec4(l9_168.x,l9_168.y,l9_168.z,vec4(0.0).w);
l9_195.w=l9_194;
vec4 l9_196;
#if (sc_ProjectiveShadowsCaster)
{
