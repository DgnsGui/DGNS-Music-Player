...
vec2 l9_7=(((l9_4-(l9_5.xy*0.5))/vec2(l9_6.y))*5.0)-vec2(0.5);
float l9_8=sin(l9_0);
float l9_9=l9_0*0.222;
float l9_10=length(l9_7+(vec2(l9_8,sin(l9_9+99.0))*1.5));
float l9_11=length(l9_7)+l9_0;
float l9_12=l9_11+(l9_7.x*0.15000001);
float l9_13;
vec2 l9_14;
vec2 l9_15;
l9_15=l9_7;
...
if (l9_16<4.0)
{
float l9_17=cos(l9_12);
vec2 l9_18=l9_14*(mat2(vec2(cos(l9_12-sin(l9_0/4.0)),sin(l9_12)),vec2(-sin(l9_17-l9_0),l9_17))*(-0.15000001));
float l9_19=l9_10-(l9_0/(l9_16+1.5));
vec2 l9_20=l9_15-(l9_18+vec2(cos((l9_19-l9_15.x)-l9_10)+sin(l9_19+l9_15.y),(sin(l9_19-l9_15.y)+cos(l9_19+l9_15.x))+l9_10));
l9_15=l9_20;
l9_14=l9_18;
l9_13+=(1.0/length(vec2(sin(l9_20.x+l9_19)/0.15000001,cos(l9_20.y+l9_19)/0.15000001)));
l9_16+=1.0;
continue;
}
else
...
float l9_21=l9_13/4.0;
vec4 l9_22=vec4((vec3(l9_21)*vec3(4.3000002,3.4000001,0.1))-vec3(0.34999999),0.1);
#if (sc_BlendMode_AlphaTest)
{
if (0.1<alphaTestThreshold)
{
discard;
}
}
...
{
if (0.1<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_28=clamp(dot(l9_22.xyz,vec3(0.1)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*0.1;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*0.1;
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*0.1;
}
#else
{
float l9_33;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*0.1;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_22.xyz,vec3(0.33333001))*0.1;
}
#else
{
float l9_36;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_22.xyz).xyz,vec3(0.1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_22.xyz,vec3(0.1)),0.1);
}
#else
{
vec4 l9_52;
