...
#endif
float l9_4=varPackedTex.z;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_5=l9_4;
float l9_6=varPackedTex.w;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),Tweak_N0Layout,l9_3);
vec4 l9_25=texture2D(Tweak_N0,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_26=mix(Tweak_N0BorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
vec4 l9_27=vec4(l9_2,l9_2,l9_2,l9_26.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_26.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_26.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_30=clamp(l9_26.x*2.0,0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_27.xyz,vec3(l9_26.x)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*l9_26.x;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*l9_26.x;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_26.x;
}
#else
{
float l9_36;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_26.x;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_27.xyz,vec3(0.33333001))*l9_26.x;
}
#else
{
float l9_39;
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_27.xyz).xyz,vec3(l9_26.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_26.x)),l9_26.x);
}
#else
{
vec4 l9_54;
