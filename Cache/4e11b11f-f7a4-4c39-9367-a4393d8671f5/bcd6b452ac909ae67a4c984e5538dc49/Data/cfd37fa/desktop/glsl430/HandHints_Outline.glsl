...
mat3 l9_11=mat3(l9_4,l9_2,l9_3);
vec3 l9_12=-l9_1;
float l9_13=max(pow(1.0-abs(dot(l9_12,l9_11*Port_Normal_N041)),Tweak_N44),0.0)*fadeLevel;
vec4 l9_14;
#if (Tweak_N0Layout==2)
{
float l9_15=l9_0.x;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_16=l9_15;
float l9_17=l9_0.y;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_18=l9_17;
vec2 l9_19;
float l9_20;
...
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_22=l9_16;
float l9_23=1.0;
sc_ClampUV(l9_22,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_21,l9_23);
float l9_24=l9_22;
float l9_25=l9_23;
bool l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_27=l9_18;
float l9_28=l9_25;
sc_ClampUV(l9_27,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_26,l9_28);
l9_20=l9_28;
...
#endif
vec2 l9_29=sc_TransformUV(l9_19,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_30=l9_29.x;
float l9_31=l9_20;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_31);
float l9_32=l9_29.y;
float l9_33=l9_31;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_33);
float l9_34=l9_33;
vec3 l9_35=sc_SamplingCoordsViewToGlobal(vec2(l9_30,l9_32),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_36=texture(Tweak_N0ArrSC,l9_35,0.0);
vec4 l9_37;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_37=mix(Tweak_N0BorderColor,l9_36,vec4(l9_34));
}
#else
{
l9_37=l9_36;
...
{
float l9_38=l9_0.x;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_39=l9_38;
float l9_40=l9_0.y;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_41=l9_40;
vec2 l9_42;
float l9_43;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_45=l9_39;
float l9_46=1.0;
sc_ClampUV(l9_45,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_44,l9_46);
float l9_47=l9_45;
float l9_48=l9_46;
bool l9_49;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_50=l9_41;
float l9_51=l9_48;
sc_ClampUV(l9_50,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_49,l9_51);
l9_43=l9_51;
...
#endif
vec2 l9_52=sc_TransformUV(l9_42,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_56);
float l9_57=l9_56;
vec3 l9_58=sc_SamplingCoordsViewToGlobal(vec2(l9_53,l9_55),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_59=texture(Tweak_N0,l9_58.xy,0.0);
vec4 l9_60;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_60=mix(Tweak_N0BorderColor,l9_59,vec4(l9_57));
}
#else
{
l9_60=l9_59;
...
#endif
vec4 l9_61=vec4(l9_13,l9_13,l9_13,l9_14.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_14.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_14.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_62,vec4(0.0)));
return;
}
vec4 l9_64;
...
{
l9_66=clamp(l9_14.x*2.0,0.0,1.0);
}
#else
{
float l9_67;
...
{
l9_67=clamp(dot(l9_61.xyz,vec3(l9_14.x)),0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_69=(1.0-dot(l9_61.xyz,vec3(0.33333001)))*l9_14.x;
}
#else
{
float l9_70;
...
{
l9_70=(1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0))*l9_14.x;
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_14.x;
}
#else
{
float l9_72;
#if (sc_BlendMode_Add)
{
l9_72=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_73=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0)*l9_14.x;
}
#else
{
float l9_74;
...
{
l9_74=dot(l9_61.xyz,vec3(0.33333001))*l9_14.x;
}
#else
{
float l9_75;
#if (sc_BlendMode_Min)
{
l9_75=1.0-clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_76;
#if (sc_BlendMode_Max)
{
l9_76=clamp(dot(l9_61.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_76=1.0;
...
#endif
l9_64=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_61.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_65);
}
#else
{
vec4 l9_77;
...
{
l9_85=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_83,sc_ScreenTextureLayout,l9_84),0.0);
}
#else
{
l9_85=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_83,sc_ScreenTextureLayout,l9_84).xy,0.0);
}
#endif
l9_79=l9_85;
}
...
#endif
vec3 l9_88=mix(l9_86.xyz,definedBlend(l9_86.xyz,l9_61.xyz).xyz,vec3(l9_14.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_90=vec4(mix(vec3(1.0),l9_61.xyz,vec3(l9_14.x)),l9_14.x);
}
#else
{
vec4 l9_91;
...
#endif
l9_91=vec4(l9_61.xyz*l9_92,l9_92);
}
#else
{
l9_91=l9_61;
