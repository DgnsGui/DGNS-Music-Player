...
vec2 l9_4=((((varPackedTex.xy*l9_1.xy)-(l9_2.xy*0.5))/vec2(l9_3.y))*5.0)-vec2(0.5);
float l9_5=sin(l9_0);
float l9_6=l9_0*0.222;
float l9_7=length(l9_4+(vec2(l9_5,sin(l9_6+99.0))*1.5));
float l9_8=length(l9_4)+l9_0;
float l9_9=l9_8+(l9_4.x*0.15000001);
float l9_10;
vec2 l9_11;
vec2 l9_12;
l9_12=l9_4;
...
if (l9_13<4.0)
{
float l9_14=cos(l9_9);
vec2 l9_15=l9_11*(mat2(vec2(cos(l9_9-sin(l9_0/4.0)),sin(l9_9)),vec2(-sin(l9_14-l9_0),l9_14))*(-0.15000001));
float l9_16=l9_7-(l9_0/(l9_13+1.5));
vec2 l9_17=l9_12-(l9_15+vec2(cos((l9_16-l9_12.x)-l9_7)+sin(l9_16+l9_12.y),(sin(l9_16-l9_12.y)+cos(l9_16+l9_12.x))+l9_7));
l9_12=l9_17;
l9_11=l9_15;
l9_10+=(1.0/length(vec2(sin(l9_17.x+l9_16)/0.15000001,cos(l9_17.y+l9_16)/0.15000001)));
l9_13+=1.0;
continue;
}
else
...
float l9_18=l9_10/4.0;
vec4 l9_19=vec4((vec3(l9_18)*vec3(4.3000002,3.4000001,0.1))-vec3(0.34999999),0.1);
...
{
l9_23=clamp(dot(l9_19.xyz,vec3(0.1)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*0.1;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*0.1;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*0.1;
}
#else
{
float l9_28;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*0.1;
}
#else
{
float l9_30;
...
{
l9_30=dot(l9_19.xyz,vec3(0.33333001))*0.1;
}
#else
{
float l9_31;
...
#endif
vec3 l9_43=mix(l9_41.xyz,definedBlend(l9_41.xyz,l9_19.xyz).xyz,vec3(0.1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_45=vec4(mix(vec3(1.0),l9_19.xyz,vec3(0.1)),0.1);
}
#else
{
vec4 l9_46;
