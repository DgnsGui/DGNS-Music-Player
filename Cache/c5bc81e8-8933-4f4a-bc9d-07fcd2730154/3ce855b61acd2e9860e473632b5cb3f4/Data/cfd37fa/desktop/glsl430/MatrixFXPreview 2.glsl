...
uniform float Port_Index_N001;
uniform vec4 Port_Item0_N001;
uniform vec4 Port_Item1_N001;
uniform vec4 Port_Item2_N001;
uniform vec4 Port_Item3_N001;
...
vec4 l9_2[4];
l9_2[0]=Port_Item0_N001;
l9_2[1]=Port_Item1_N001;
l9_2[2]=Port_Item2_N001;
l9_2[3]=Port_Item3_N001;
float l9_3=l9_0*0.5;
vec2 l9_4=mod(l9_2[int(clamp(Port_Index_N001+9.9999997e-05,0.0,3.0))].xy*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_5;
vec2 l9_6;
l9_6=l9_4;
l9_5=1.0;
...
{
int l9_8=l9_7+1;
float l9_9=(l9_3+23.0)*(1.0-(3.5/float(l9_8)));
...
{
l9_18=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_12.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_22;
...
#if (sc_BlendMode_Add)
{
l9_23=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_24=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_25;
...
{
l9_25=dot(l9_12.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_26;
#if (sc_BlendMode_Min)
{
l9_26=1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
#if (sc_BlendMode_Max)
{
l9_27=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_27=1.0;
...
#endif
l9_15=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_12.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_16);
}
#else
{
vec4 l9_28;
...
{
l9_36=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_34,sc_ScreenTextureLayout,l9_35),0.0);
}
#else
{
l9_36=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_34,sc_ScreenTextureLayout,l9_35).xy,0.0);
}
#endif
l9_30=l9_36;
}
...
#endif
vec3 l9_39=definedBlend(l9_37.xyz,l9_12.xyz);
