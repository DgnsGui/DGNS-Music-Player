...
vec4 l9_1=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_1.w=Port_Value2_N001;
...
#endif
sc_writeFragData0(max(l9_2,vec4(0.0)));
return;
}
vec4 l9_4;
...
{
l9_7=clamp(dot(l9_1.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_8;
...
{
l9_9=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_10;
...
{
l9_10=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_11;
...
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_12;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_13=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_14;
...
{
l9_14=dot(l9_1.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_15;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_1.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_1.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_31;
...
{
l9_32=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_32=Port_Value2_N001;
}
#endif
