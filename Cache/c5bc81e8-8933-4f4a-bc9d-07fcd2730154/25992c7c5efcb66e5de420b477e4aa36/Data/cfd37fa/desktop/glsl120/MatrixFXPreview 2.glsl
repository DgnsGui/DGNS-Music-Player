...
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),Tweak_N1Layout,l9_1);
vec4 l9_23=texture2D(Tweak_N1,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_24=mix(Tweak_N1BorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
float l9_25=l9_0*0.5;
vec2 l9_26=mod(l9_24.xy*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_27;
vec2 l9_28;
l9_28=l9_26;
l9_27=1.0;
...
{
int l9_30=l9_29+1;
float l9_31=(l9_25+23.0)*(1.0-(3.5/float(l9_30)));
vec2 l9_32=l9_26+vec2(cos(l9_31-l9_28.x)+sin(l9_31+l9_28.y),sin(l9_31-l9_28.y)+cos(l9_31+l9_28.x));
l9_28=l9_32;
l9_27+=(1.0/length(vec2(l9_26.x/(sin(l9_32.x+l9_31)/0.0049999999),l9_26.y/(cos(l9_32.y+l9_31)/0.0049999999))));
l9_29=l9_30;
continue;
}
else
...
float l9_33=ssPow(abs(1.17-ssPow(l9_27/5.0,1.4)),8.0);
vec4 l9_34=vec4(clamp(vec3(l9_33)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_38=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_40=(1.0-dot(l9_34.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_43;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(l9_34.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_45;
...
{
l9_45=dot(l9_34.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_46;
...
#endif
vec3 l9_58=definedBlend(l9_56.xyz,l9_34.xyz);
