...
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_22);
float l9_23=l9_22;
...
{
float l9_27=l9_1.x;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_28=l9_27;
float l9_29=l9_1.y;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
...
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_48=texture(Tweak_N1,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_49=mix(Tweak_N1BorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
float l9_50=l9_0*0.5;
vec2 l9_51=mod(l9_3.xy*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_52;
vec2 l9_53;
l9_53=l9_51;
l9_52=1.0;
...
{
int l9_55=l9_54+1;
float l9_56=(l9_50+23.0)*(1.0-(3.5/float(l9_55)));
vec2 l9_57=l9_51+vec2(cos(l9_56-l9_53.x)+sin(l9_56+l9_53.y),sin(l9_56-l9_53.y)+cos(l9_56+l9_53.x));
l9_53=l9_57;
l9_52+=(1.0/length(vec2(l9_51.x/(sin(l9_57.x+l9_56)/0.0049999999),l9_51.y/(cos(l9_57.y+l9_56)/0.0049999999))));
l9_54=l9_55;
continue;
}
else
...
float l9_58=ssPow(abs(1.17-ssPow(l9_52/5.0,1.4)),8.0);
vec4 l9_59=vec4(clamp(vec3(l9_58)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
#endif
sc_writeFragData0(max(l9_60,vec4(0.0)));
return;
}
vec4 l9_62;
...
{
l9_65=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_66;
...
{
l9_67=(1.0-dot(l9_59.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_68;
...
{
l9_68=(1.0-clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_69;
...
{
l9_69=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_70;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_71=clamp(dot(l9_59.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_72;
...
{
l9_72=dot(l9_59.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_73;
...
{
l9_83=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_81,sc_ScreenTextureLayout,l9_82),0.0);
}
#else
{
l9_83=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_81,sc_ScreenTextureLayout,l9_82).xy,0.0);
}
#endif
l9_77=l9_83;
}
...
#endif
vec3 l9_86=definedBlend(l9_84.xyz,l9_59.xyz);
