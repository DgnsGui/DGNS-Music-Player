...
float l9_3=l9_0*0.5;
vec2 l9_4=mod(l9_2*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_5;
vec2 l9_6;
l9_6=l9_4;
l9_5=1.0;
...
#else
{
vec2 l9_32=sc_ScreenCoordsGlobalToView(l9_1);
int l9_33;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_47=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_60=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
