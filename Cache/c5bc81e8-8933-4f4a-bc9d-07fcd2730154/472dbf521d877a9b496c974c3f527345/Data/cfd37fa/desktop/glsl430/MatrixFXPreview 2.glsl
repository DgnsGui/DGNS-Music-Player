...
float l9_4=l9_0*0.5;
vec2 l9_5=l9_1*6.2831855;
vec2 l9_6=mod(l9_5,vec2(6.2831855))-vec2(250.0);
float l9_7;
vec2 l9_8;
l9_8=l9_6;
l9_7=1.0;
...
{
int l9_10=l9_9+1;
float l9_11=(l9_4+23.0)*(1.0-(3.5/float(l9_10)));
vec2 l9_12=l9_6+vec2(cos(l9_11-l9_8.x)+sin(l9_11+l9_8.y),sin(l9_11-l9_8.y)+cos(l9_11+l9_8.x));
l9_8=l9_12;
l9_7+=(1.0/length(vec2(l9_6.x/(sin(l9_12.x+l9_11)/0.0049999999),l9_6.y/(cos(l9_12.y+l9_11)/0.0049999999))));
l9_9=l9_10;
continue;
}
else
...
float l9_13=ssPow(abs(1.17-ssPow(l9_7/5.0,1.4)),8.0);
vec4 l9_14=vec4(clamp(vec3(l9_13)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
#endif
sc_writeFragData0(max(l9_15,vec4(0.0)));
return;
}
vec4 l9_17;
...
{
l9_20=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_22=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_23;
...
{
l9_23=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_25;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_26=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_27;
...
{
l9_27=dot(l9_14.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_28;
...
#endif
vec3 l9_41=definedBlend(l9_39.xyz,l9_14.xyz);
