...
vec2 l9_3=l9_1*Port_Input1_N003;
float l9_4=l9_0*0.5;
vec2 l9_5=mod(l9_3*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_6;
vec2 l9_7;
l9_7=l9_5;
l9_6=1.0;
...
{
int l9_9=l9_8+1;
float l9_10=(l9_4+23.0)*(1.0-(3.5/float(l9_9)));
vec2 l9_11=l9_5+vec2(cos(l9_10-l9_7.x)+sin(l9_10+l9_7.y),sin(l9_10-l9_7.y)+cos(l9_10+l9_7.x));
l9_7=l9_11;
l9_6+=(1.0/length(vec2(l9_5.x/(sin(l9_11.x+l9_10)/0.0049999999),l9_5.y/(cos(l9_11.y+l9_10)/0.0049999999))));
l9_8=l9_9;
continue;
}
else
...
float l9_12=ssPow(abs(1.17-ssPow(l9_6/5.0,1.4)),8.0);
vec4 l9_13=vec4(clamp(vec3(l9_12)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_19=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_13.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_24;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_13.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_13.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_27;
...
#endif
vec3 l9_40=definedBlend(l9_38.xyz,l9_13.xyz);
