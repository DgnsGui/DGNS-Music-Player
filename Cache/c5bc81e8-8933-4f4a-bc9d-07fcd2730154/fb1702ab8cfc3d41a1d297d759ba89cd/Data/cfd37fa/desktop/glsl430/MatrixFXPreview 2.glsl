...
float l9_2=l9_0*0.5;
vec2 l9_3=mod(vec2(Tweak_N1[int(clamp(Port_Index_N001+9.9999997e-05,0.0,7.0))])*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_4;
vec2 l9_5;
l9_5=l9_3;
l9_4=1.0;
...
{
int l9_7=l9_6+1;
float l9_8=(l9_2+23.0)*(1.0-(3.5/float(l9_7)));
vec2 l9_9=l9_3+vec2(cos(l9_8-l9_5.x)+sin(l9_8+l9_5.y),sin(l9_8-l9_5.y)+cos(l9_8+l9_5.x));
l9_5=l9_9;
l9_4+=(1.0/length(vec2(l9_3.x/(sin(l9_9.x+l9_8)/0.0049999999),l9_3.y/(cos(l9_9.y+l9_8)/0.0049999999))));
l9_6=l9_7;
continue;
}
else
...
float l9_10=ssPow(abs(1.17-ssPow(l9_4/5.0,1.4)),8.0);
vec4 l9_11=vec4(clamp(vec3(l9_10)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_17=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_19=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_20;
...
{
l9_20=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_21;
...
{
l9_21=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_22;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_23=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_24;
...
{
l9_24=dot(l9_11.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_25;
...
{
l9_35=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_33,sc_ScreenTextureLayout,l9_34),0.0);
}
#else
{
l9_35=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_33,sc_ScreenTextureLayout,l9_34).xy,0.0);
}
#endif
l9_29=l9_35;
}
...
#endif
vec3 l9_38=definedBlend(l9_36.xyz,l9_11.xyz);
