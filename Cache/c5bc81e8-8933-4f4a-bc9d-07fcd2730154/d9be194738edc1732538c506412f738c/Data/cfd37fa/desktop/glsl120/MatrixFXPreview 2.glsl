...
vec4 l9_1[4];
l9_1[0]=Port_Item0_N001;
l9_1[1]=Port_Item1_N001;
l9_1[2]=Port_Item2_N001;
l9_1[3]=Port_Item3_N001;
float l9_2=l9_0*0.5;
vec2 l9_3=mod(l9_1[int(clamp(Port_Index_N001+9.9999997e-05,0.0,3.0))].xy*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_4;
vec2 l9_5;
l9_5=l9_3;
l9_4=1.0;
...
{
l9_15=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_20;
...
{
l9_22=dot(l9_11.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_23;
...
#endif
vec3 l9_35=definedBlend(l9_33.xyz,l9_11.xyz);
