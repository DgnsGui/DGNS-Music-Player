...
{
vec2 l9_69;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_69,l9_8);
float l9_70;
Node67_Bool_Parameter(l9_70,l9_8);
l9_68=mix(l9_5,l9_69,vec2(l9_70));
}
#else
{
vec2 l9_71;
...
{
vec2 l9_72;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_72,l9_8);
float l9_73;
Node11_Bool_Parameter(l9_73,l9_8);
l9_71=mix(l9_5,l9_72,vec2(l9_73));
}
#else
{
l9_71=l9_5;
...
float l9_109=l9_98;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_109);
float l9_110=l9_107.y;
float l9_111=l9_109;
sc_SoftwareWrapLate(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_111);
}
#endif
}
#else
...
#endif
vec4 l9_112=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_112.w=alpha;
...
#endif
sc_writeFragData0(max(l9_113,vec4(0.0)));
return;
}
vec4 l9_115;
...
{
l9_117=clamp(alpha*2.0,0.0,1.0);
}
#else
{
float l9_118;
...
{
l9_118=clamp(dot(l9_112.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_119;
...
{
l9_120=(1.0-dot(l9_112.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_121;
...
{
l9_121=(1.0-clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_122;
...
{
l9_122=clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_123;
#if (sc_BlendMode_Add)
{
l9_123=clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_124;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_124=clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_125;
...
{
l9_125=dot(l9_112.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_126;
#if (sc_BlendMode_Min)
{
l9_126=1.0-clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_127;
#if (sc_BlendMode_Max)
{
l9_127=clamp(dot(l9_112.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_127=1.0;
...
#endif
l9_115=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_112.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_116);
}
#else
{
vec4 l9_128;
...
#if (sc_FramebufferFetch)
{
vec4 l9_131=sc_readFragData0_Platform();
vec4 l9_132;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_133=l9_131;
l9_133.x=l9_131.x+_sc_framebufferFetchMarker;
l9_132=l9_133;
}
#else
{
...
{
l9_135=1-sc_GetStereoViewIndex();
}
#else
{
l9_135=sc_GetStereoViewIndex();
}
#endif
vec4 l9_136;
#if (sc_ScreenTextureLayout==2)
{
l9_136=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_134,sc_ScreenTextureLayout,l9_135),0.0);
}
#else
{
l9_136=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_134,sc_ScreenTextureLayout,l9_135).xy,0.0);
}
#endif
l9_130=l9_136;
}
...
{
vec4 l9_138=l9_130;
l9_138.x=l9_130.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_137=l9_138;
}
#else
{
...
#endif
vec3 l9_139=mix(l9_137.xyz,definedBlend(l9_137.xyz,l9_112.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_141=vec4(mix(vec3(1.0),l9_112.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_142;
...
#endif
l9_142=vec4(l9_112.xyz*l9_143,l9_143);
}
#else
{
l9_142=l9_112;
...
{
l9_146=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_146=vec4(0.0);
...
vec4 l9_148=outputMotionVectorsIfNeeded(varPos,max(l9_147,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_150-0.0039215689)),min(1.0,l9_150+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_152),packValue(l9_152),packValue(l9_152),packValue(l9_152)));
...
vec4 l9_190=texture(sc_OITFilteredDepthBoundsTexture,l9_164);
