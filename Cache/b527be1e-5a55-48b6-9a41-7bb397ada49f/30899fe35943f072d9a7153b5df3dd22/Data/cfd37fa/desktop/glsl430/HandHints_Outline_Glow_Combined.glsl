...
//texture texture2D Tweak_N0 0:3:0:22
...
//texture texture2DArray Tweak_N0ArrSC 0:34:0:22
//texture texture2DArray Tweak_N6ArrSC 0:35:0:23
...
uniform vec4 Port_Value_N017;
uniform float Port_Mask_N011;
...
l9_5=l9_10;
l9_4=l9_11;
l9_3=cross(l9_11,l9_10)*varTangent.w;
l9_2=normalize(sc_Camera.position-varPos);
l9_1=varPackedTex.xy;
l9_0=varPackedTex.zw;
}
mat3 l9_12=mat3(l9_5,l9_3,l9_4);
vec3 l9_13=-l9_2;
float l9_14=max(pow(1.0-abs(dot(l9_13,l9_12*Port_Normal_N041)),Tweak_N44),0.0)*fadeLevel;
vec4 l9_15;
#if (Tweak_N6Layout==2)
{
float l9_16=l9_1.x;
...
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_34);
float l9_35=l9_34;
...
{
float l9_39=l9_1.x;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_40=l9_39;
float l9_41=l9_1.y;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_42=l9_41;
vec2 l9_43;
float l9_44;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_46=l9_40;
float l9_47=1.0;
sc_ClampUV(l9_46,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_45,l9_47);
float l9_48=l9_46;
float l9_49=l9_47;
bool l9_50;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
...
float l9_51=l9_42;
float l9_52=l9_49;
sc_ClampUV(l9_51,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_50,l9_52);
l9_44=l9_52;
...
#endif
vec2 l9_53=sc_TransformUV(l9_43,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_54=l9_53.x;
float l9_55=l9_44;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_55);
float l9_56=l9_53.y;
float l9_57=l9_55;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_57);
float l9_58=l9_57;
vec3 l9_59=sc_SamplingCoordsViewToGlobal(vec2(l9_54,l9_56),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_60=texture(Tweak_N6,l9_59.xy,0.0);
vec4 l9_61;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_61=mix(Tweak_N6BorderColor,l9_60,vec4(l9_58));
}
#else
{
l9_61=l9_60;
...
#endif
vec4 l9_62=Port_Value_N017+l9_15;
vec4 l9_63=l9_62*l9_15;
vec4 l9_64=vec4(l9_14);
vec3 l9_65=l9_64.xyz*l9_14;
vec4 l9_66;
#if (Tweak_N0Layout==2)
{
float l9_67=l9_0.x;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_68=l9_67;
float l9_69=l9_0.y;
sc_SoftwareWrapEarly(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_70=l9_69;
vec2 l9_71;
float l9_72;
...
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_73=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_74=l9_68;
float l9_75=1.0;
sc_ClampUV(l9_74,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_73,l9_75);
float l9_76=l9_74;
float l9_77=l9_75;
bool l9_78;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_78=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_78=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_79=l9_70;
float l9_80=l9_77;
sc_ClampUV(l9_79,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_78,l9_80);
l9_72=l9_80;
...
#endif
vec2 l9_81=sc_TransformUV(l9_71,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_82=l9_81.x;
float l9_83=l9_72;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_83);
float l9_84=l9_81.y;
float l9_85=l9_83;
sc_SoftwareWrapLate(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_85);
float l9_86=l9_85;
vec3 l9_87=sc_SamplingCoordsViewToGlobal(vec2(l9_82,l9_84),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_88=texture(Tweak_N0ArrSC,l9_87,0.0);
vec4 l9_89;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_89=mix(Tweak_N0BorderColor,l9_88,vec4(l9_86));
}
#else
{
l9_89=l9_88;
...
{
float l9_90=l9_0.x;
sc_SoftwareWrapEarly(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_91=l9_90;
float l9_92=l9_0.y;
sc_SoftwareWrapEarly(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_93=l9_92;
vec2 l9_94;
float l9_95;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_96=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_96=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_97=l9_91;
float l9_98=1.0;
sc_ClampUV(l9_97,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_96,l9_98);
float l9_99=l9_97;
float l9_100=l9_98;
bool l9_101;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_101=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_101=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_102=l9_93;
float l9_103=l9_100;
sc_ClampUV(l9_102,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_101,l9_103);
l9_95=l9_103;
...
#endif
vec2 l9_104=sc_TransformUV(l9_94,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_105=l9_104.x;
float l9_106=l9_95;
sc_SoftwareWrapLate(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_106);
float l9_107=l9_104.y;
float l9_108=l9_106;
sc_SoftwareWrapLate(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_108);
float l9_109=l9_108;
vec3 l9_110=sc_SamplingCoordsViewToGlobal(vec2(l9_105,l9_107),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_111=texture(Tweak_N0,l9_110.xy,0.0);
vec4 l9_112;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_112=mix(Tweak_N0BorderColor,l9_111,vec4(l9_109));
}
#else
{
l9_112=l9_111;
...
#endif
vec4 l9_113=vec4(min(vec4(l9_65.x,l9_65.y,l9_65.z,l9_64.w)+((l9_63*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_66.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_66.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_66.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_114,vec4(0.0)));
return;
}
vec4 l9_116;
...
{
l9_118=clamp(l9_66.x*2.0,0.0,1.0);
}
#else
{
float l9_119;
...
{
l9_119=clamp(dot(l9_113.xyz,vec3(l9_66.x)),0.0,1.0);
}
#else
{
float l9_120;
...
{
l9_121=(1.0-dot(l9_113.xyz,vec3(0.33333001)))*l9_66.x;
}
#else
{
float l9_122;
...
{
l9_122=(1.0-clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0))*l9_66.x;
}
#else
{
float l9_123;
...
{
l9_123=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0)*l9_66.x;
}
#else
{
float l9_124;
#if (sc_BlendMode_Add)
{
l9_124=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_125;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_125=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0)*l9_66.x;
}
#else
{
float l9_126;
...
{
l9_126=dot(l9_113.xyz,vec3(0.33333001))*l9_66.x;
}
#else
{
float l9_127;
#if (sc_BlendMode_Min)
{
l9_127=1.0-clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_128;
#if (sc_BlendMode_Max)
{
l9_128=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_128=1.0;
...
#endif
l9_116=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_113.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_117);
}
#else
{
vec4 l9_129;
...
#if (sc_FramebufferFetch)
{
vec4 l9_132=sc_readFragData0_Platform();
vec4 l9_133;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_134=l9_132;
l9_134.x=l9_132.x+_sc_framebufferFetchMarker;
l9_133=l9_134;
}
#else
{
...
{
l9_137=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_135,sc_ScreenTextureLayout,l9_136),0.0);
}
#else
{
l9_137=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_135,sc_ScreenTextureLayout,l9_136).xy,0.0);
}
#endif
l9_131=l9_137;
}
...
{
vec4 l9_139=l9_131;
l9_139.x=l9_131.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_138=l9_139;
}
#else
{
...
#endif
vec3 l9_140=mix(l9_138.xyz,definedBlend(l9_138.xyz,l9_113.xyz).xyz,vec3(l9_66.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_142=vec4(mix(vec3(1.0),l9_113.xyz,vec3(l9_66.x)),l9_66.x);
}
#else
{
vec4 l9_143;
...
#endif
l9_143=vec4(l9_113.xyz*l9_144,l9_144);
}
#else
{
l9_143=l9_113;
...
{
l9_147=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_147=vec4(0.0);
...
vec4 l9_149=outputMotionVectorsIfNeeded(varPos,max(l9_148,vec4(0.0)));
...
vec4 l9_191=texture(sc_OITFilteredDepthBoundsTexture,l9_165);
