...
vec2 l9_7=((((((((l9_1.yz-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_4)+((((l9_1.zx-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_5))+((((l9_1.xy-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_6))/vec2((l9_4+l9_5)+l9_6))*2.0)-vec2(1.0);
vec3 l9_8=N0_getResolution();
vec3 l9_9=N0_getResolution();
float l9_10=l9_7.x*(l9_8.x/l9_9.y);
float l9_11=l9_0*2.0;
float l9_12=sin((l9_10*10.0)+l9_11);
float l9_13=l9_7.y;
float l9_14=l9_0*1.5;
float l9_15=sin((l9_13*15.0)+l9_14);
float l9_16=l9_0*3.0;
float l9_17=sin(((l9_10*l9_13)*20.0)+l9_16);
float l9_18=l9_0*4.5;
float l9_19=cos((l9_10*25.0)+l9_18)*cos((l9_13*25.0)+l9_18);
float l9_20=((l9_12+l9_15)+(0.5*l9_17))+(0.25*l9_19);
float l9_21=(l9_20*10.0)+l9_0;
float l9_22=sin(l9_21);
float l9_23=l9_0*0.5;
float l9_24=l9_0+(l9_20*2.0);
float l9_25=l9_0*0.69999999;
float l9_26=l9_17+l9_0;
float l9_27=l9_19-l9_0;
vec4 l9_28=vec4(vec3(0.5+(0.5*sin((l9_23+(l9_20*4.0))+l9_22)),0.5+(0.5*sin(l9_24-l9_22)),0.5+(0.5*cos((l9_25+(l9_20*6.0))+l9_22)))+(vec3(sin(l9_26),cos(l9_27),sin(l9_12-l9_15))*0.2),1.0);
...
{
l9_32=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_28.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_40;
...
{
l9_50=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_48,sc_ScreenTextureLayout,l9_49),0.0);
}
#else
{
l9_50=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_48,sc_ScreenTextureLayout,l9_49).xy,0.0);
}
#endif
l9_44=l9_50;
}
...
#endif
vec3 l9_53=definedBlend(l9_51.xyz,l9_28.xyz);
...
#endif
int l9_65=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_64).xy);
...
if (l9_82==0)
{
l9_85=texture(sc_OITAlpha0,l9_77);
l9_84=texture(sc_OITDepthLow0,l9_77);
l9_83=texture(sc_OITDepthHigh0,l9_77);
}
else
{
l9_85=vec4(0.0);
...
if (l9_82==1)
{
l9_88=texture(sc_OITAlpha1,l9_77);
l9_87=texture(sc_OITDepthLow1,l9_77);
l9_86=texture(sc_OITDepthHigh1,l9_77);
}
else
{
l9_88=l9_85;
...
vec4 l9_103=texture(sc_OITFilteredDepthBoundsTexture,l9_77);
