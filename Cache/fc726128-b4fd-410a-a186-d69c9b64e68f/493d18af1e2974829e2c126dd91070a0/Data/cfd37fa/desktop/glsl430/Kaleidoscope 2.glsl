...
uniform vec3 Port_Scale_N007;
uniform vec3 Port_Offset_N007;
uniform float Port_Sharpness_N007;
uniform vec3 Port_Position_N007;
uniform vec3 Port_Normal_N007;
uniform vec4 Port_Input_N007;
...
vec3 l9_1=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N007*0.99000001))));
float l9_2=l9_1.x;
float l9_3=l9_1.y;
float l9_4=l9_1.z;
N0_resolution=Port_resolution_N000;
vec2 l9_5=(((((Port_Input_N007*l9_2)+(Port_Input_N007*l9_3))+(Port_Input_N007*l9_4))/vec4((l9_2+l9_3)+l9_4)).xy*2.0)-vec2(1.0);
vec3 l9_6=N0_getResolution();
vec3 l9_7=N0_getResolution();
float l9_8=l9_5.x*(l9_6.x/l9_7.y);
float l9_9=l9_0*2.0;
float l9_10=sin((l9_8*10.0)+l9_9);
float l9_11=l9_5.y;
float l9_12=l9_0*1.5;
float l9_13=sin((l9_11*15.0)+l9_12);
float l9_14=l9_0*3.0;
float l9_15=sin(((l9_8*l9_11)*20.0)+l9_14);
float l9_16=l9_0*4.5;
float l9_17=cos((l9_8*25.0)+l9_16)*cos((l9_11*25.0)+l9_16);
float l9_18=((l9_10+l9_13)+(0.5*l9_15))+(0.25*l9_17);
float l9_19=(l9_18*10.0)+l9_0;
float l9_20=sin(l9_19);
float l9_21=l9_0*0.5;
float l9_22=l9_0+(l9_18*2.0);
float l9_23=l9_0*0.69999999;
float l9_24=l9_15+l9_0;
float l9_25=l9_17-l9_0;
vec4 l9_26=vec4(vec3(0.5+(0.5*sin((l9_21+(l9_18*4.0))+l9_20)),0.5+(0.5*sin(l9_22-l9_20)),0.5+(0.5*cos((l9_23+(l9_18*6.0))+l9_20)))+(vec3(sin(l9_24),cos(l9_25),sin(l9_10-l9_13))*0.2),1.0);
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_38;
...
{
l9_48=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,l9_47),0.0);
}
#else
{
l9_48=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,l9_47).xy,0.0);
}
#endif
l9_42=l9_48;
}
...
#endif
vec3 l9_51=definedBlend(l9_49.xyz,l9_26.xyz);
