...
vec2 l9_6=((((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5))*2.0)-vec2(1.0);
vec3 l9_7=N0_getResolution();
vec3 l9_8=N0_getResolution();
float l9_9=l9_6.x*(l9_7.x/l9_8.y);
float l9_10=l9_0*2.0;
float l9_11=sin((l9_9*10.0)+l9_10);
float l9_12=l9_6.y;
float l9_13=l9_0*1.5;
float l9_14=sin((l9_12*15.0)+l9_13);
float l9_15=l9_0*3.0;
float l9_16=sin(((l9_9*l9_12)*20.0)+l9_15);
float l9_17=l9_0*4.5;
float l9_18=cos((l9_9*25.0)+l9_17)*cos((l9_12*25.0)+l9_17);
float l9_19=((l9_11+l9_14)+(0.5*l9_16))+(0.25*l9_18);
float l9_20=(l9_19*10.0)+l9_0;
float l9_21=sin(l9_20);
float l9_22=l9_0*0.5;
float l9_23=l9_0+(l9_19*2.0);
float l9_24=l9_0*0.69999999;
float l9_25=l9_16+l9_0;
float l9_26=l9_18-l9_0;
vec4 l9_27=vec4(vec3(0.5+(0.5*sin((l9_22+(l9_19*4.0))+l9_21)),0.5+(0.5*sin(l9_23-l9_21)),0.5+(0.5*cos((l9_24+(l9_19*6.0))+l9_21)))+(vec3(sin(l9_25),cos(l9_26),sin(l9_11-l9_14))*0.2),1.0);
...
{
l9_49=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,l9_48),0.0);
}
#else
{
l9_49=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,l9_48).xy,0.0);
}
#endif
l9_43=l9_49;
}
...
{
vec4 l9_51=l9_43;
l9_51.x=l9_43.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_50=l9_51;
}
#else
{
...
#endif
vec3 l9_52=definedBlend(l9_50.xyz,l9_27.xyz);
