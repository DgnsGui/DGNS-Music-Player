...
vec2 l9_1=(Port_uv_input_N000*2.0)-vec2(1.0);
vec3 l9_2=N0_getResolution();
vec3 l9_3=N0_getResolution();
float l9_4=l9_1.x*(l9_2.x/l9_3.y);
float l9_5=l9_0*2.0;
float l9_6=sin((l9_4*10.0)+l9_5);
float l9_7=l9_1.y;
float l9_8=l9_0*1.5;
float l9_9=sin((l9_7*15.0)+l9_8);
float l9_10=l9_0*3.0;
float l9_11=sin(((l9_4*l9_7)*20.0)+l9_10);
float l9_12=l9_0*4.5;
float l9_13=cos((l9_4*25.0)+l9_12)*cos((l9_7*25.0)+l9_12);
float l9_14=((l9_6+l9_9)+(0.5*l9_11))+(0.25*l9_13);
float l9_15=(l9_14*10.0)+l9_0;
float l9_16=sin(l9_15);
float l9_17=l9_0*0.5;
float l9_18=l9_0+(l9_14*2.0);
float l9_19=l9_0*0.69999999;
float l9_20=l9_11+l9_0;
float l9_21=l9_13-l9_0;
vec4 l9_22=vec4(vec3(0.5+(0.5*sin((l9_17+(l9_14*4.0))+l9_16)),0.5+(0.5*sin(l9_18-l9_16)),0.5+(0.5*cos((l9_19+(l9_14*6.0))+l9_16)))+(vec3(sin(l9_20),cos(l9_21),sin(l9_6-l9_9))*0.2),1.0);
