...
vec3 l9_2=pow(abs(normalize((sc_ModelMatrixInverse*vec4(l9_1,0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N007*0.99000001))));
float l9_3=l9_2.x;
float l9_4=l9_2.y;
float l9_5=l9_2.z;
N0_resolution=Port_resolution_N000;
vec2 l9_6=(((((l9_1*l9_3)+(l9_1*l9_4))+(l9_1*l9_5))/vec3((l9_3+l9_4)+l9_5)).xy*2.0)-vec2(1.0);
