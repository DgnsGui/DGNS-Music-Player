...
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),opacityTextureLayout,l9_9);
...
#endif
float l9_33=clamp((l9_7.w*l9_8.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_34=vec4(l9_7.x,l9_7.y,l9_7.z,vec4(0.0).w);
l9_34.w=l9_33;
...
#endif
vec3 l9_58=mix(l9_56.xyz,definedBlend(l9_56.xyz,l9_34.xyz).xyz,vec3(l9_33));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_60=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_33)),l9_33);
}
#else
{
vec4 l9_61;
...
#endif
l9_61=vec4(l9_34.xyz*l9_62,l9_62);
}
#else
{
l9_61=l9_34;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_70=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_83=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
