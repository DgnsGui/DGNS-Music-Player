...
//sampler sampler handGlowTexSmpSC 0:21
...
//texture texture2D handGlowTex 0:3:0:21
...
//texture texture2DArray handGlowTexArrSC 0:32:0:21
...
{
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_24=texture(handGlowTexArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_25=mix(handGlowTexBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
{
float l9_26=l9_0.x;
sc_SoftwareWrapEarly(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_27=l9_26;
float l9_28=l9_0.y;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_29=l9_28;
vec2 l9_30;
float l9_31;
#if (SC_USE_UV_MIN_MAX_handGlowTex)
...
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_33=l9_27;
float l9_34=1.0;
sc_ClampUV(l9_33,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_32,l9_34);
float l9_35=l9_33;
float l9_36=l9_34;
bool l9_37;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_38=l9_29;
float l9_39=l9_36;
sc_ClampUV(l9_38,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_37,l9_39);
l9_31=l9_39;
...
#endif
vec2 l9_40=sc_TransformUV(l9_30,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_47=texture(handGlowTex,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_48=mix(handGlowTexBorderColor,l9_47,vec4(l9_45));
}
#else
{
l9_48=l9_47;
...
#endif
float l9_49=mix(Port_Input0_N003,indexBrightness,l9_2.x);
vec4 l9_50=vec4(indexGlowColor.xyz,l9_49);
vec3 l9_51=l9_50.xyz*l9_49;
vec4 l9_52=vec4(l9_51.x,l9_51.y,l9_51.z,l9_50.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_2.y))*(1.0-l9_49));
float l9_53=l9_52.w;
