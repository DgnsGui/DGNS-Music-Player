...
vec2 l9_6=((l9_4/l9_5.xy)*2.0)-vec2(1.0);
...
#endif
sc_writeFragData0(max(l9_28,vec4(0.0)));
return;
}
vec4 l9_30;
...
{
l9_33=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_35=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_36;
...
{
l9_36=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_Add)
{
l9_38=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_39=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_40;
...
{
l9_40=dot(l9_27.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_41;
#if (sc_BlendMode_Min)
{
l9_41=1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
...
#endif
l9_30=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_27.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_31);
}
#else
{
vec4 l9_43;
...
{
l9_51=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_49,sc_ScreenTextureLayout,l9_50),0.0);
}
#else
{
l9_51=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_49,sc_ScreenTextureLayout,l9_50).xy,0.0);
}
#endif
l9_45=l9_51;
}
...
{
vec4 l9_53=l9_45;
l9_53.x=l9_45.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_52=l9_53;
}
#else
{
...
#endif
vec3 l9_54=definedBlend(l9_52.xyz,l9_27.xyz);
