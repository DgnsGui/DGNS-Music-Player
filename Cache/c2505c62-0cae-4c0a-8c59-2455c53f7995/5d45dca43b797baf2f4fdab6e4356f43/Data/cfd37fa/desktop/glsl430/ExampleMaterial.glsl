...
vec2 l9_2=l9_0*stripeScale;
bool l9_3=(float(enableStripes)*1.0)!=0.0;
bool l9_4;
if (l9_3)
{
l9_4=(float((mod(l9_2,Port_Input1_N007)/(Port_Input1_N002+vec2(1.234e-06))).x>stripes)*1.0)!=0.0;
}
else
{
l9_4=l9_3;
...
{
l9_11=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_6.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_14=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_15;
...
{
l9_15=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_17;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_18=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_19;
...
{
l9_19=dot(l9_6.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_20;
...
{
l9_30=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_28,sc_ScreenTextureLayout,l9_29),0.0);
}
#else
{
l9_30=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_28,sc_ScreenTextureLayout,l9_29).xy,0.0);
}
#endif
l9_24=l9_30;
}
...
#endif
vec3 l9_33=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_6.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_6.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_36;
...
{
l9_37=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_37=Port_Value2_N001;
}
#endif
...
#endif
int l9_46=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_45).xy);
...
if (l9_63==0)
{
l9_66=texture(sc_OITAlpha0,l9_58);
l9_65=texture(sc_OITDepthLow0,l9_58);
l9_64=texture(sc_OITDepthHigh0,l9_58);
}
else
{
l9_66=vec4(0.0);
...
if (l9_63==1)
{
l9_69=texture(sc_OITAlpha1,l9_58);
l9_68=texture(sc_OITDepthLow1,l9_58);
l9_67=texture(sc_OITDepthHigh1,l9_58);
}
else
{
l9_69=l9_66;
...
vec4 l9_84=texture(sc_OITFilteredDepthBoundsTexture,l9_58);
vec2 l9_85=l9_84.xy;
int l9_86;
#if (sc_SkinBonesCount>0)
{
