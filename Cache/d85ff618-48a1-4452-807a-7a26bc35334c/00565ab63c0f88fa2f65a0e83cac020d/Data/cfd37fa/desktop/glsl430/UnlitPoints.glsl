...
//sampler sampler Tweak_N42SmpSC 0:21
...
//texture texture2D Tweak_N42 0:3:0:21
...
//texture texture2DArray Tweak_N42ArrSC 0:32:0:21
...
#endif
vec4 l9_51=l9_4*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_52=mix(Port_Input0_N102,mix(vec4(dot(l9_51,Port_Input1_N094)),l9_51,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
...
{
l9_58=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_53.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_53.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_64;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_65=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_66;
...
{
l9_66=dot(l9_53.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_67;
...
#endif
vec3 l9_80=mix(l9_78.xyz,definedBlend(l9_78.xyz,l9_53.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_53.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_83;
