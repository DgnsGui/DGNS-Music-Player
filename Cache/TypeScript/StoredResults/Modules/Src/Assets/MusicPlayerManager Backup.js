...
var __selfType = requireType("./MusicPlayerManager Backup");
function component(target) { target.getTypeName = function () { return __selfType; }; }
let MusicPlayerManager = class MusicPlayerManager extends BaseScriptComponent {
    onAwake() {
        // Expose stopTrack to the script API for PlayerSkinManager.js
    ...
    pauseTrack() {
        if (this.isPlaying && this.audioComponent) {
            try {
                ...
                // Forcer l'état de pause même en cas d'erreur
                this.isPlaying = false;
                this.isPaused = true;
                this.currentPlaybackTime = getTime() - this.trackStartTime;
            }
...
//# sourceMappingURL=MusicPlayerManager%20Backup.js.map