...
vec4 l9_25=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_22,0.0,1.0)-0.2,0.0,1.0),l9_24,l9_23).xxx+vec3(1.0,0.40000001,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_24))*l9_23,1.0);
