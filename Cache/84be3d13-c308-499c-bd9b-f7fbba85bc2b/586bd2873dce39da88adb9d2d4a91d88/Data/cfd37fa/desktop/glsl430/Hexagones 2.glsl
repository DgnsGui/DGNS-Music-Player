...
vec2 l9_11=abs(fract(l9_1)-(vec2(fract(sin(dot(l9_10,vec2(57.989799,4.1413999)))*43758.547),fract(sin(dot(l9_10+vec2(234.10001),vec2(57.989799,4.1413999)))*43758.547))+l9_9));
...
vec2 l9_7=(((((((l9_1.yz-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_4)+((((l9_1.zx-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_5))+((((l9_1.xy-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_6))/vec2((l9_4+l9_5)+l9_6))-vec2(0.5);
vec2 l9_8=l9_7;
l9_8.x=l9_7.x*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_9=N0_p6mmmap(l9_8*(N0_getResolution().x/2000.0),2.0);
vec3 l9_10=N0_getResolution();
vec3 l9_11=N0_getResolution();
vec3 l9_12=N0_getResolution();
float l9_13=((floor((Port_touchPosition_N000*vec4(l9_10.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_11.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_12.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_14;
if (l9_13>(-100000.0))
{
l9_14=l9_13;
...
float l9_15=radians(l9_14*12.7);
float l9_16=cos(l9_15);
float l9_17=sin(l9_15);
vec2 l9_18=((mat2(vec2(l9_16,-l9_17),vec2(l9_17,l9_16))*((l9_9*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_14*0.059999999);
float l9_19=l9_14*0.2;
float l9_20=N0_noise((N0_pyramids(l9_18)*15.0)+l9_19);
float l9_21=N0_noise((N0_pyramids(l9_18+vec2(135.0))*31.0)+l9_19);
float l9_22=N0_noise((N0_pyramids(l9_18+vec2(25.0))*63.0)+l9_19);
float l9_23=clamp((((l9_20*l9_21)*l9_22)-0.090000004)*41.0,0.0,1.0);
float l9_24=clamp(clamp(l9_21,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_25=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_22,0.0,1.0)-0.2,0.0,1.0),l9_24,l9_23).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_24))*l9_23,1.0);
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_37;
...
{
l9_47=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_45,sc_ScreenTextureLayout,l9_46),0.0);
}
#else
{
l9_47=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_45,sc_ScreenTextureLayout,l9_46).xy,0.0);
}
#endif
l9_41=l9_47;
}
...
{
vec4 l9_49=l9_41;
l9_49.x=l9_41.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_48=l9_49;
}
#else
{
...
#endif
vec3 l9_50=definedBlend(l9_48.xyz,l9_25.xyz);
...
vec4 l9_100=texture(sc_OITFilteredDepthBoundsTexture,l9_74);
