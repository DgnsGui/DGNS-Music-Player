...
vec2 l9_6=(((((((l9_1.yz-Port_Center_N003)*Port_Scale_N003)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Port_Scale_N003)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Port_Scale_N003)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5))-vec2(0.5);
vec2 l9_7=l9_6;
l9_7.x=l9_6.x*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_8=N0_p6mmmap(l9_7*(N0_getResolution().x/2000.0),2.0);
vec3 l9_9=N0_getResolution();
vec3 l9_10=N0_getResolution();
vec3 l9_11=N0_getResolution();
float l9_12=((floor((Port_touchPosition_N000*vec4(l9_9.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_10.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_11.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_13;
if (l9_12>(-100000.0))
{
l9_13=l9_12;
...
float l9_14=radians(l9_13*12.7);
float l9_15=cos(l9_14);
float l9_16=sin(l9_14);
vec2 l9_17=((mat2(vec2(l9_15,-l9_16),vec2(l9_16,l9_15))*((l9_8*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_13*0.059999999);
float l9_18=l9_13*0.2;
float l9_19=N0_noise((N0_pyramids(l9_17)*15.0)+l9_18);
float l9_20=N0_noise((N0_pyramids(l9_17+vec2(135.0))*31.0)+l9_18);
float l9_21=N0_noise((N0_pyramids(l9_17+vec2(25.0))*63.0)+l9_18);
float l9_22=clamp((((l9_19*l9_20)*l9_21)-0.090000004)*41.0,0.0,1.0);
float l9_23=clamp(clamp(l9_20,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_24=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_21,0.0,1.0)-0.2,0.0,1.0),l9_23,l9_22).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_23))*l9_22,1.0);
...
{
l9_28=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=(1.0-dot(l9_24.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_31;
...
{
l9_31=(1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_33;
#if (sc_BlendMode_Add)
{
l9_33=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_34;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_34=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_35;
...
{
l9_35=dot(l9_24.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_36;
#if (sc_BlendMode_Min)
{
l9_36=1.0-clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_37;
#if (sc_BlendMode_Max)
{
l9_37=clamp(dot(l9_24.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_37=1.0;
...
#endif
l9_25=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_24.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_26);
}
#else
{
vec4 l9_38;
...
{
l9_46=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_44,sc_ScreenTextureLayout,l9_45),0.0);
}
#else
{
l9_46=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_44,sc_ScreenTextureLayout,l9_45).xy,0.0);
}
#endif
l9_40=l9_46;
}
...
{
vec4 l9_48=l9_40;
l9_48.x=l9_40.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_47=l9_48;
}
#else
{
...
#endif
vec3 l9_49=definedBlend(l9_47.xyz,l9_24.xyz);
...
#endif
int l9_61=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_60).xy);
...
if (l9_78==0)
{
l9_81=texture(sc_OITAlpha0,l9_73);
l9_80=texture(sc_OITDepthLow0,l9_73);
l9_79=texture(sc_OITDepthHigh0,l9_73);
}
else
{
l9_81=vec4(0.0);
...
if (l9_78==1)
{
l9_84=texture(sc_OITAlpha1,l9_73);
l9_83=texture(sc_OITDepthLow1,l9_73);
l9_82=texture(sc_OITDepthHigh1,l9_73);
}
else
{
l9_84=l9_81;
...
vec4 l9_99=texture(sc_OITFilteredDepthBoundsTexture,l9_73);
