...
float l9_5=l9_3.y;
float l9_6=l9_3.z;
vec2 l9_7=((((((l9_1.yz-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_4)+((((l9_1.zx-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_5))+((((l9_1.xy-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_6))/vec2((l9_4+l9_5)+l9_6);
N0_resolution=Port_resolution_N000;
vec2 l9_8=l9_7-vec2(0.5);
vec2 l9_9=l9_8;
l9_9.x=l9_8.x*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_10=l9_9*2.0;
float l9_11=l9_0*0.029999999;
vec2 l9_12=l9_10*1.1;
float l9_13=N0_fbm(l9_12*0.5);
vec2 l9_14=l9_12-vec2(l9_13-l9_11);
float l9_15;
vec2 l9_16;
l9_16=l9_14;
l9_15=0.0;
vec2 l9_17;
int l9_18=0;
float l9_19=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_18<8)
{
float l9_20=l9_19*N0_noise(l9_16);
l9_16=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_16)+vec2(l9_11);
l9_19*=0.69999999;
l9_15+=abs(l9_20);
l9_18++;
continue;
...
vec2 l9_23;
int l9_24=0;
float l9_25=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_24<8)
{
float l9_26=l9_25*N0_noise(l9_22);
l9_22=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_22)+vec2(l9_11);
l9_25*=0.60000002;
l9_21+=l9_26;
l9_24++;
continue;
...
float l9_27=l9_21+l9_15;
float l9_28=l9_21*l9_15;
float l9_29=l9_11*2.0;
float l9_30;
vec2 l9_31;
l9_31=(l9_12*2.0)-vec2(l9_13-l9_29);
l9_30=0.0;
vec2 l9_32;
int l9_33=0;
float l9_34=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_33<7)
{
float l9_35=l9_34*N0_noise(l9_31);
l9_31=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_31)+vec2(l9_29);
l9_34*=0.60000002;
l9_30+=l9_35;
l9_33++;
continue;
...
float l9_36=l9_11*3.0;
float l9_37;
vec2 l9_38;
l9_38=(l9_12*3.0)-vec2(l9_13-l9_36);
l9_37=0.0;
vec2 l9_39;
int l9_40=0;
float l9_41=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_40<7)
{
float l9_42=l9_41*N0_noise(l9_38);
l9_38=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_38)+vec2(l9_36);
l9_41*=0.60000002;
l9_37+=abs(l9_42);
l9_40++;
continue;
...
float l9_43=l9_30*0.69999999;
float l9_44=l9_37*0.30000001;
float l9_45=l9_43+l9_44;
float l9_46=N0_fbm(l9_12);
float l9_47=N0_fbm((l9_10+vec2(0.0099999998,0.0))*1.1);
float l9_48=N0_fbm((l9_10+vec2(0.0,0.0099999998))*1.1);
vec3 l9_49=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_7.y));
float l9_50=(8.0*((l9_27*0.5)+(l9_28*0.5)))*l9_15;
vec3 l9_51=mix(l9_49,clamp((l9_49*0.5)+(vec3(1.1,1.1,0.89999998)*clamp((0.5+(0.30000001*l9_45))+(max(0.0,dot(normalize(vec3((-(l9_47-l9_46))/0.0099999998,(-(l9_48-l9_46))/0.0099999998,0.050000001)),vec3(0.40824831,0.40824831,0.81649661)))*0.2),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_50)+(l9_45*0.5),0.0,1.0)));
vec3 l9_52;
if ((Port_touchPosition_N000*vec4(0.0,0.0,N0_getResolution().z,1.0)).z>0.0)
{
l9_52=l9_51*mix(0.80000001,1.2,(Port_touchPosition_N000*vec4(N0_getResolution().x,0.0,0.0,1.0)).x/N0_getResolution().x);
}
else
{
l9_52=l9_51;
}
vec4 l9_53=vec4(l9_52,1.0);
...
{
l9_57=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
...
{
l9_59=(1.0-dot(l9_53.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_60;
...
{
l9_60=(1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_62;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_63=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_64;
...
{
l9_64=dot(l9_53.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_65;
...
#endif
vec3 l9_77=definedBlend(l9_75.xyz,l9_53.xyz);
