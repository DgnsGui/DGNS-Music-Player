...
export class MusicPlayerManager extends BaseScriptComponent {
    ...
    private setupTrackFinishedCallback(): void {
        ...
        if (this.audioComponent) {
            // Remplacement de onFinish par onPlaybackFinished
            this.audioComponent.onPlaybackFinished.add(this.onTrackFinishedCallback);
        }
    }
    ...
    onDestroy(): void {
        ...
        if (this.audioComponent && this.onTrackFinishedCallback) {
            this.audioComponent.onPlaybackFinished.remove(this.onTrackFinishedCallback);
        }
