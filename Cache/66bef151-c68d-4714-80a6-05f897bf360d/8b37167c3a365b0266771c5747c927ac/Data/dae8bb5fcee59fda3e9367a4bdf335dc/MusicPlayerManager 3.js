...
var __selfType = requireType("./MusicPlayerManager 3");
...
let MusicPlayerManager = class MusicPlayerManager extends BaseScriptComponent {
    ...
    setupTrackFinishedCallback() {
        ...
        if (this.audioComponent) {
            // Utiliser setOnFinish au lieu de onPlaybackFinished
    ...
    onDestroy() {
        ...
        if (this.audioComponent) {
            // Réinitialiser le callback setOnFinish pour éviter les appels après destruction
...
//# sourceMappingURL=MusicPlayerManager%203.js.map