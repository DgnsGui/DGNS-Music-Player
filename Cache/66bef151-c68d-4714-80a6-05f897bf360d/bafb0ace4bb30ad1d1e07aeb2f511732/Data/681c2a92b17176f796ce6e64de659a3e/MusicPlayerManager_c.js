...
// @input Asset.AudioTrackAsset[] localTracks {"hint":"Local: Liste des morceaux de musique intégrés"}
checkUndefined("localTracks", []);
// @input string[] localArtists {"hint":"Local: Liste des noms d'artistes correspondants aux morceaux intégrés"}
checkUndefined("localArtists", []);
// @input string[] localTitles {"hint":"Local: Liste des titres des morceaux intégrés"}
checkUndefined("localTitles", []);
// @input SceneObject[] localTrackPrefabs {"hint":"Local: Liste des prefabs à afficher pour chaque morceau intégré"}
checkUndefined("localTrackPrefabs", []);
// @input Asset.RemoteReferenceAsset[] remoteTracks {"hint":"Remote: Liste des assets audio distants (RemoteReferenceAsset)"}
checkUndefined("remoteTracks", []);
// @input string[] remoteArtists {"hint":"Remote: Liste des noms d'artistes correspondants aux morceaux distants"}
checkUndefined("remoteArtists", []);
// @input string[] remoteTitles {"hint":"Remote: Liste des titres des morceaux distants"}
checkUndefined("remoteTitles", []);
// @input SceneObject[] remoteTrackPrefabs {"hint":"Remote: Liste des prefabs à afficher pour chaque morceau distant"}
...
// @input Component.ScriptComponent shuffleButton {"hint":"Bouton pour activer/désactiver le mode shuffle"}
...
// @input bool loopPlayback = true {"hint":"Activer la lecture en boucle (retour au début après la dernière piste)"}
