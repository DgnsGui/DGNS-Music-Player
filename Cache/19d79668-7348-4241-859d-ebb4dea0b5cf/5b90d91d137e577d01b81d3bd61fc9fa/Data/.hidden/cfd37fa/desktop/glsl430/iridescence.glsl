...
l9_3=l9_5;
l9_2=(sc_ModelMatrixInverse*vec4(l9_5,1.0)).xyz;
l9_1=l9_4.normalWS;
l9_0=l9_4.viewDirWS;
}
else
...
float l9_6=dot(l9_0,l9_1);
float l9_7=1.0-clamp(l9_6,0.0,1.0);
float l9_8;
if (l9_7<=0.0)
{
l9_8=0.0;
...
{
l9_8=pow(l9_7,exponent);
}
float l9_9=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_2.x*10000.0)*9.9999997e-05,floor(l9_2.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_2.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_10=l9_8+((((floor(((l9_9*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_11=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_12;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_12=clamp(l9_11,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_12=clamp(l9_11,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
vec4 l9_13;
#if (iridescenceMapLayout==2)
{
float l9_14=l9_10;
sc_SoftwareWrapEarly(l9_14,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_15=l9_14;
float l9_16=l9_12;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_17=l9_16;
vec2 l9_18;
float l9_19;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
...
float l9_21=l9_15;
float l9_22=1.0;
sc_ClampUV(l9_21,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_20,l9_22);
float l9_23=l9_21;
float l9_24=l9_22;
bool l9_25;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_25=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_25=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_26=l9_17;
float l9_27=l9_24;
sc_ClampUV(l9_26,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_25,l9_27);
l9_19=l9_27;
...
#endif
vec2 l9_28=sc_TransformUV(l9_18,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_29=l9_28.x;
float l9_30=l9_19;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_30);
float l9_31=l9_28.y;
float l9_32=l9_30;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_32);
float l9_33=l9_32;
vec3 l9_34=sc_SamplingCoordsViewToGlobal(vec2(l9_29,l9_31),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_35=texture(iridescenceMapArrSC,l9_34,0.0);
vec4 l9_36;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_36=mix(iridescenceMapBorderColor,l9_35,vec4(l9_33));
}
#else
{
l9_36=l9_35;
...
{
float l9_37=l9_10;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_38=l9_37;
float l9_39=l9_12;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_40=l9_39;
vec2 l9_41;
float l9_42;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_44=l9_38;
float l9_45=1.0;
sc_ClampUV(l9_44,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_43,l9_45);
float l9_46=l9_44;
float l9_47=l9_45;
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_48=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_49=l9_40;
float l9_50=l9_47;
sc_ClampUV(l9_49,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_48,l9_50);
l9_42=l9_50;
...
#endif
vec2 l9_51=sc_TransformUV(l9_41,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_55);
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_58=texture(iridescenceMap,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_59=mix(iridescenceMapBorderColor,l9_58,vec4(l9_56));
}
#else
{
l9_59=l9_58;
...
#endif
vec3 l9_62=max(mix(baseColor,l9_60*vec4(intensity),vec4(mixAmount)).xyz,vec3(0.0));
vec4 l9_63;
#if (sc_ProjectiveShadowsCaster)
{
l9_63=vec4(l9_62,Port_Opacity_N006);
}
#else
{
l9_63=ngsCalculateLighting(l9_62,Port_Opacity_N006,l9_61,l9_3,l9_0,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
vec4 l9_64=max(l9_63,vec4(0.0));
if (isProxyMode)
{
vec4 l9_65;
#if (sc_ProxyAlphaOne)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_69=clamp(l9_64.w*2.0,0.0,1.0);
}
#else
{
float l9_70;
...
{
l9_70=clamp(dot(l9_64.xyz,vec3(l9_64.w)),0.0,1.0);
}
#else
{
float l9_71;
...
#if (sc_BlendMode_Multiply)
{
l9_72=(1.0-dot(l9_64.xyz,vec3(0.33333001)))*l9_64.w;
}
#else
{
float l9_73;
...
{
l9_73=(1.0-clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0))*l9_64.w;
}
#else
{
float l9_74;
#if (sc_BlendMode_ColoredGlass)
{
l9_74=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*l9_64.w;
}
#else
{
float l9_75;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_76=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*l9_64.w;
}
#else
{
float l9_77;
...
{
l9_77=dot(l9_64.xyz,vec3(0.33333001))*l9_64.w;
}
#else
{
float l9_78;
...
{
vec3 l9_82=sc_GetFramebufferColor().xyz;
vec3 l9_83=mix(l9_82,definedBlend(l9_82,l9_64.xyz).xyz,vec3(l9_64.w));
...
{
float l9_86=l9_64.w;
l9_85=vec4(mix(vec3(1.0),l9_64.xyz,vec3(l9_86)),l9_86);
}
#else
{
vec4 l9_87;
...
#endif
l9_87=vec4(l9_64.xyz*l9_89,l9_89);
}
#else
{
l9_87=l9_64;
