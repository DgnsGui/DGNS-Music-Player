...
#endif
vec3 l9_70=mix(l9_68.xyz,definedBlend(l9_68.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_72=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_73;
...
{
l9_74=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_74=Port_FinalColor_N004.w;
}
#endif
l9_73=vec4(Port_FinalColor_N004.xyz*l9_74,l9_74);
}
#else
{
l9_73=Port_FinalColor_N004;
}
#endif
l9_72=l9_73;
}
