...
vec3 l9_1=N0_getResolution();
vec3 l9_2=N0_getResolution();
vec2 l9_3=(varPackedTex.xy*l9_1.xy)/l9_2.xy;
vec3 l9_4=N0_getResolution();
vec3 l9_5=N0_getResolution();
float l9_6=l9_0*0.029999999;
vec2 l9_7=(l9_3*vec2(l9_4.x/l9_5.y,1.0))*1.1;
float l9_8;
vec2 l9_9;
l9_9=l9_7*0.5;
l9_8=0.0;
...
if (l9_11<7)
{
float l9_13=N0_noise(l9_9)*l9_12;
l9_12*=0.40000001;
l9_9=mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_9;
l9_8+=l9_13;
l9_11++;
continue;
}
...
float l9_14=l9_8-l9_6;
vec2 l9_15=vec2(l9_14);
float l9_16;
vec2 l9_17;
l9_17=l9_7-l9_15;
l9_16=0.0;
vec2 l9_18;
int l9_19=0;
float l9_20=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_19<8)
{
float l9_21=l9_20*N0_noise(l9_17);
l9_17=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_17)+vec2(l9_6);
l9_20*=0.69999999;
l9_16+=abs(l9_21);
l9_19++;
continue;
...
float l9_22;
vec2 l9_23;
l9_23=((l9_3*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*1.1)-l9_15;
l9_22=0.0;
vec2 l9_24;
int l9_25=0;
float l9_26=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_25<8)
{
float l9_27=l9_26*N0_noise(l9_23);
l9_23=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_23)+vec2(l9_6);
l9_26*=0.60000002;
l9_22+=l9_27;
l9_25++;
continue;
...
float l9_28=l9_16+l9_22;
float l9_29=l9_22*l9_28;
float l9_30=l9_6*2.0;
float l9_31;
vec2 l9_32;
l9_32=((l9_3*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*2.2)-vec2(l9_8-l9_30);
l9_31=0.0;
vec2 l9_33;
int l9_34=0;
float l9_35=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_34<7)
{
float l9_36=l9_35*N0_noise(l9_32);
l9_32=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_32)+vec2(l9_30);
l9_35*=0.60000002;
l9_31+=l9_36;
l9_34++;
continue;
...
float l9_37=l9_6*3.0;
float l9_38;
vec2 l9_39;
l9_39=((l9_3*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*3.3)-vec2(l9_8-l9_37);
l9_38=0.0;
vec2 l9_40;
int l9_41=0;
float l9_42=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_41<7)
{
float l9_43=l9_42*N0_noise(l9_39);
l9_39=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_39)+vec2(l9_37);
l9_42*=0.60000002;
l9_38+=abs(l9_43);
l9_41++;
continue;
...
float l9_44=l9_31+l9_38;
vec3 l9_45=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_3.y));
float l9_46=(8.0*l9_29)*l9_16;
vec4 l9_47;
...
{
l9_49=clamp(Port_FinalColor_N004.w*2.0,0.0,1.0);
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),0.0,1.0);
}
#else
{
float l9_51;
...
{
l9_52=(1.0-dot(Port_FinalColor_N004.xyz,vec3(0.33333001)))*Port_FinalColor_N004.w;
}
#else
{
float l9_53;
...
{
l9_53=(1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0))*Port_FinalColor_N004.w;
}
#else
{
float l9_54;
...
{
l9_54=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_55;
#if (sc_BlendMode_Add)
{
l9_55=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_56=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_57;
...
{
l9_57=dot(Port_FinalColor_N004.xyz,vec3(0.33333001))*Port_FinalColor_N004.w;
}
#else
{
float l9_58;
#if (sc_BlendMode_Min)
{
l9_58=1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_59;
#if (sc_BlendMode_Max)
{
l9_59=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_59=1.0;
...
#endif
l9_47=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*Port_FinalColor_N004.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_48);
}
#else
{
vec4 l9_60;
...
{
l9_60=vec4(Port_FinalColor_N004.w);
}
#else
{
vec4 l9_61;
...
{
l9_68=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_66,sc_ScreenTextureLayout,l9_67),0.0);
}
#else
{
l9_68=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_66,sc_ScreenTextureLayout,l9_67).xy,0.0);
}
#endif
l9_62=l9_68;
}
...
#endif
vec3 l9_71=mix(l9_69.xyz,definedBlend(l9_69.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_73=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_74;
...
{
l9_75=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_75=Port_FinalColor_N004.w;
}
#endif
l9_74=vec4(Port_FinalColor_N004.xyz*l9_75,l9_75);
}
#else
{
l9_74=Port_FinalColor_N004;
}
#endif
l9_73=l9_74;
}
...
gl_FragDepth=mix(l9_45,clamp((l9_45*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_44),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_46)+l9_44,0.0,1.0))).x;
