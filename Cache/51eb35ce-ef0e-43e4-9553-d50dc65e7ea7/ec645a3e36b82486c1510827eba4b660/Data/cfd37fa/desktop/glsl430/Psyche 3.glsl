...
vec3 l9_1=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_2=l9_1.x;
float l9_3=l9_1.y;
float l9_4=l9_1.z;
...
vec2 l9_7=(((((Port_Input_N005*l9_2)+(Port_Input_N005*l9_3))+(Port_Input_N005*l9_4))/vec4((l9_2+l9_3)+l9_4)).xy*l9_5.xy)/l9_6.xy;
float l9_8=1.0-l9_7.y;
vec2 l9_9=l9_7;
l9_9.y=l9_8;
...
if (l9_15<5)
{
float l9_17=N0_noise(l9_13)*l9_16;
l9_16*=0.40000001;
l9_13=mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_13;
l9_12+=l9_17;
l9_15++;
continue;
}
...
float l9_18=l9_12-l9_10;
vec2 l9_19=l9_11-vec2(l9_18);
float l9_20;
vec2 l9_21;
l9_21=l9_19;
l9_20=0.0;
...
vec2 l9_28;
int l9_29=0;
float l9_30=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_29<5)
{
float l9_31=l9_30*N0_noise(l9_27);
l9_27=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_27)+vec2(l9_10);
l9_30*=0.60000002;
l9_26+=l9_31;
l9_29++;
continue;
...
float l9_32=l9_20+l9_26;
float l9_33=l9_26*l9_32;
float l9_34=l9_10*2.0;
float l9_35;
vec2 l9_36;
l9_36=(l9_11*2.0)-vec2(l9_12-l9_34);
l9_35=0.0;
vec2 l9_37;
int l9_38=0;
float l9_39=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_38<4)
{
float l9_40=l9_39*N0_noise(l9_36);
l9_36=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_36)+vec2(l9_34);
l9_39*=0.60000002;
l9_35+=l9_40;
l9_38++;
continue;
...
float l9_41=l9_10*3.0;
float l9_42;
vec2 l9_43;
l9_43=(l9_11*3.0)-vec2(l9_12-l9_41);
l9_42=0.0;
vec2 l9_44;
int l9_45=0;
float l9_46=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_45<4)
{
float l9_47=l9_46*N0_noise(l9_43);
l9_43=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_43)+vec2(l9_41);
l9_46*=0.60000002;
l9_42+=abs(l9_47);
l9_45++;
continue;
...
float l9_48=l9_35+l9_42;
vec3 l9_49=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_8));
float l9_50=(8.0*l9_33)*l9_20;
vec4 l9_51=vec4(mix(l9_49,clamp((l9_49*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_48),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_50)+l9_48,0.0,1.0))),1.0);
...
{
l9_55=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_57=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_58;
...
{
l9_58=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_59;
...
{
l9_59=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_60;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_61=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_62;
...
{
l9_62=dot(l9_51.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_63;
...
#endif
vec3 l9_76=definedBlend(l9_74.xyz,l9_51.xyz);
