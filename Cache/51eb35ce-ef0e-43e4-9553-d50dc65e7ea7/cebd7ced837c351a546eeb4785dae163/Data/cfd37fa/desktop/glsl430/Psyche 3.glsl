...
vec4 l9_47=vec4(mix(l9_45,clamp((l9_45*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_44),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_46)+l9_44,0.0,1.0))),1.0);
