...
vec2 l9_3=((l9_2-Tweak_N6)*Tweak_N1)+Tweak_N6;
vec3 l9_4=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_5=l9_4.x;
float l9_6=l9_4.y;
float l9_7=l9_4.z;
...
vec2 l9_10=(((((l9_3*l9_5)+(l9_3*l9_6))+(l9_3*l9_7))/vec2((l9_5+l9_6)+l9_7))*l9_8.xy)/l9_9.xy;
float l9_11=1.0-l9_10.y;
vec2 l9_12=l9_10;
l9_12.y=l9_11;
float l9_13=l9_0*0.029999999;
vec2 l9_14=l9_12*1.1;
float l9_15;
vec2 l9_16;
l9_16=l9_14*0.5;
l9_15=0.0;
...
if (l9_18<5)
{
float l9_20=N0_noise(l9_16)*l9_19;
l9_19*=0.40000001;
l9_16=mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_16;
l9_15+=l9_20;
l9_18++;
continue;
}
...
float l9_21=l9_15-l9_13;
vec2 l9_22=l9_14-vec2(l9_21);
float l9_23;
vec2 l9_24;
l9_24=l9_22;
l9_23=0.0;
vec2 l9_25;
int l9_26=0;
float l9_27=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_26<5)
{
float l9_28=l9_27*N0_noise(l9_24);
l9_24=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_24)+vec2(l9_13);
l9_27*=0.69999999;
l9_23+=abs(l9_28);
l9_26++;
continue;
...
vec2 l9_31;
int l9_32=0;
float l9_33=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_32<5)
{
float l9_34=l9_33*N0_noise(l9_30);
l9_30=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_30)+vec2(l9_13);
l9_33*=0.60000002;
l9_29+=l9_34;
l9_32++;
continue;
...
float l9_35=l9_23+l9_29;
float l9_36=l9_29*l9_35;
float l9_37=l9_13*2.0;
float l9_38;
vec2 l9_39;
l9_39=(l9_14*2.0)-vec2(l9_15-l9_37);
l9_38=0.0;
vec2 l9_40;
int l9_41=0;
...
float l9_44=l9_13*3.0;
float l9_45;
vec2 l9_46;
l9_46=(l9_14*3.0)-vec2(l9_15-l9_44);
l9_45=0.0;
vec2 l9_47;
int l9_48=0;
float l9_49=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_48<4)
{
float l9_50=l9_49*N0_noise(l9_46);
l9_46=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_46)+vec2(l9_44);
l9_49*=0.60000002;
l9_45+=abs(l9_50);
l9_48++;
continue;
...
float l9_51=l9_38+l9_45;
vec3 l9_52=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_11));
float l9_53=(8.0*l9_36)*l9_23;
vec4 l9_54=vec4(mix(l9_52,clamp((l9_52*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_51),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_53)+l9_51,0.0,1.0))),1.0);
...
{
l9_58=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_63;
...
{
l9_65=dot(l9_54.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_66;
...
#endif
vec3 l9_79=definedBlend(l9_77.xyz,l9_54.xyz);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_90=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_103=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
