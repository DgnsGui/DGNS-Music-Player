...
uniform vec2 Tweak_N1;
uniform vec2 Tweak_N6;
uniform vec2 Port_resolution_N000;
uniform vec3 Port_Scale_N005;
uniform vec3 Port_Offset_N005;
uniform float Port_Sharpness_N005;
uniform vec3 Port_Position_N005;
uniform vec3 Port_Normal_N005;
...
in vec4 varColor;
vec2 N0_resolution;
void Node5_Loop_Triplanar_UV(vec2 Input,vec3 Position,vec3 Normal,vec3 Scale,vec3 Offset,float Sharpness,out vec2 Output,ssGlobals Globals)
{
vec3 l9_0=Globals.SurfacePosition_ObjectSpace;
vec3 l9_1=Globals.VertexNormal_ObjectSpace;
vec3 l9_2=(l9_0+Offset)*Scale;
Globals.gTriplanarCoords=l9_2.yz;
Input=((Globals.gTriplanarCoords-Tweak_N6)*Tweak_N1)+Tweak_N6;
vec2 l9_3=Input;
Globals.gTriplanarCoords=l9_2.zx;
Input=((Globals.gTriplanarCoords-Tweak_N6)*Tweak_N1)+Tweak_N6;
vec2 l9_4=Input;
Globals.gTriplanarCoords=l9_2.xy;
Input=((Globals.gTriplanarCoords-Tweak_N6)*Tweak_N1)+Tweak_N6;
vec3 l9_5=pow(abs(l9_1),vec3(1.0/(1.0-(Sharpness*0.99000001))));
float l9_6=l9_5.x;
float l9_7=l9_5.y;
float l9_8=l9_5.z;
Output=(((l9_3*l9_6)+(l9_4*l9_7))+(Input*l9_8))/vec2((l9_6+l9_7)+l9_8);
}
...
float N0_noise(vec2 p)
{
vec2 l9_0=floor(p+vec2((p.x+p.y)*0.36602542));
vec2 l9_1=(p-l9_0)+vec2((l9_0.x+l9_0.y)*0.21132487);
bvec2 l9_2=bvec2(l9_1.x>l9_1.y);
vec2 l9_3=vec2(l9_2.x ? vec2(1.0,0.0).x : vec2(0.0,1.0).x,l9_2.y ? vec2(1.0,0.0).y : vec2(0.0,1.0).y);
vec2 l9_4=(l9_1-l9_3)+vec2(0.21132487);
vec2 l9_5=(l9_1-vec2(1.0))+vec2(0.42264974);
vec3 l9_6=max(vec3(0.5)-vec3(dot(l9_1,l9_1),dot(l9_4,l9_4),dot(l9_5,l9_5)),vec3(0.0));
vec2 l9_7=l9_0+vec2(0.0);
vec2 l9_8=l9_0+l9_3;
vec2 l9_9=l9_0+vec2(1.0);
return dot((((l9_6*l9_6)*l9_6)*l9_6)*vec3(dot(l9_1,vec2(-1.0)+(fract(sin(vec2(dot(l9_7,vec2(127.1,311.70001)),dot(l9_7,vec2(269.5,183.3))))*43758.547)*2.0)),dot(l9_4,vec2(-1.0)+(fract(sin(vec2(dot(l9_8,vec2(127.1,311.70001)),dot(l9_8,vec2(269.5,183.3))))*43758.547)*2.0)),dot(l9_5,vec2(-1.0)+(fract(sin(vec2(dot(l9_9,vec2(127.1,311.70001)),dot(l9_9,vec2(269.5,183.3))))*43758.547)*2.0))),vec3(70.0));
}
float N0_fbm(vec2 n)
{
vec2 param;
...
ssGlobals l9_4=ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy,(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz,l9_3,normalize((sc_ModelMatrixInverse*vec4(l9_3,0.0)).xyz),vec2(0.0));
vec2 param_6;
Node5_Loop_Triplanar_UV(vec2(0.0),Port_Position_N005,Port_Normal_N005,Port_Scale_N005,Port_Offset_N005,Port_Sharpness_N005,param_6,l9_4);
N0_resolution=Port_resolution_N000;
vec3 l9_5=N0_getResolution();
vec3 l9_6=N0_getResolution();
vec2 l9_7=(varPackedTex.xy*l9_5.xy)/l9_6.xy;
float l9_8=l9_1*0.029999999;
vec2 l9_9=(l9_7*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*1.1;
float l9_10=N0_fbm(l9_9*0.5);
vec2 l9_11=vec2(l9_10-l9_8);
float l9_12;
vec2 l9_13;
l9_13=l9_9-l9_11;
l9_12=0.0;
vec2 l9_14;
int l9_15=0;
float l9_16=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_15<8)
{
float l9_17=l9_16*N0_noise(l9_13);
l9_13=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_13)+vec2(l9_8);
l9_16*=0.69999999;
l9_12+=abs(l9_17);
l9_15++;
continue;
...
float l9_18;
vec2 l9_19;
l9_19=((l9_7*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*1.1)-l9_11;
l9_18=0.0;
vec2 l9_20;
int l9_21=0;
float l9_22=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_21<8)
{
float l9_23=l9_22*N0_noise(l9_19);
l9_19=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_19)+vec2(l9_8);
l9_22*=0.60000002;
l9_18+=l9_23;
l9_21++;
continue;
...
float l9_24=l9_12+l9_18;
float l9_25=l9_18*l9_24;
float l9_26=l9_8*2.0;
float l9_27;
vec2 l9_28;
l9_28=((l9_7*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*2.2)-vec2(l9_10-l9_26);
l9_27=0.0;
vec2 l9_29;
int l9_30=0;
float l9_31=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_30<7)
{
float l9_32=l9_31*N0_noise(l9_28);
l9_28=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_28)+vec2(l9_26);
l9_31*=0.60000002;
l9_27+=l9_32;
l9_30++;
continue;
...
float l9_33=l9_8*3.0;
float l9_34;
vec2 l9_35;
l9_35=((l9_7*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*3.3)-vec2(l9_10-l9_33);
l9_34=0.0;
vec2 l9_36;
int l9_37=0;
float l9_38=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_37<7)
{
float l9_39=l9_38*N0_noise(l9_35);
l9_35=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_35)+vec2(l9_33);
l9_38*=0.60000002;
l9_34+=abs(l9_39);
l9_37++;
continue;
...
float l9_40=l9_27+l9_34;
vec3 l9_41=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_7.y));
float l9_42=(8.0*l9_25)*l9_12;
vec4 l9_43=vec4(mix(l9_41,clamp((l9_41*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_40),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_42)+l9_40,0.0,1.0))),1.0);
...
#endif
vec2 param_14;
Node5_Loop_Triplanar_UV(vec2(0.0),Port_Position_N005,Port_Normal_N005,Port_Scale_N005,Port_Offset_N005,Port_Sharpness_N005,param_14,l9_4);
N0_resolution=Port_resolution_N000;
vec3 l9_44=N0_getResolution();
vec3 l9_45=N0_getResolution();
vec2 l9_46=(varPackedTex.xy*l9_44.xy)/l9_45.xy;
vec2 l9_47=(l9_46*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*1.1;
float l9_48=N0_fbm(l9_47*0.5);
vec2 l9_49=vec2(l9_48-l9_8);
float l9_50;
vec2 l9_51;
l9_51=l9_47-l9_49;
l9_50=0.0;
vec2 l9_52;
int l9_53=0;
float l9_54=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_53<8)
{
float l9_55=l9_54*N0_noise(l9_51);
l9_51=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_51)+vec2(l9_8);
l9_54*=0.69999999;
l9_50+=abs(l9_55);
l9_53++;
continue;
...
float l9_56;
vec2 l9_57;
l9_57=((l9_46*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*1.1)-l9_49;
l9_56=0.0;
vec2 l9_58;
int l9_59=0;
float l9_60=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_59<8)
{
float l9_61=l9_60*N0_noise(l9_57);
l9_57=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_57)+vec2(l9_8);
l9_60*=0.60000002;
l9_56+=l9_61;
l9_59++;
continue;
...
float l9_62=l9_50+l9_56;
float l9_63=l9_56*l9_62;
float l9_64;
vec2 l9_65;
l9_65=((l9_46*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*2.2)-vec2(l9_48-l9_26);
l9_64=0.0;
vec2 l9_66;
int l9_67=0;
float l9_68=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_67<7)
{
float l9_69=l9_68*N0_noise(l9_65);
l9_65=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_65)+vec2(l9_26);
l9_68*=0.60000002;
l9_64+=l9_69;
l9_67++;
continue;
...
float l9_70;
vec2 l9_71;
l9_71=((l9_46*vec2(N0_getResolution().x/N0_getResolution().y,1.0))*3.3)-vec2(l9_48-l9_33);
l9_70=0.0;
vec2 l9_72;
int l9_73=0;
float l9_74=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_73<7)
{
float l9_75=l9_74*N0_noise(l9_71);
l9_71=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_71)+vec2(l9_33);
l9_74*=0.60000002;
l9_70+=abs(l9_75);
l9_73++;
continue;
...
float l9_76=l9_64+l9_70;
vec3 l9_77=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_46.y));
float l9_78=(8.0*l9_63)*l9_50;
vec4 l9_79;
...
{
l9_82=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_83;
...
{
l9_84=(1.0-dot(l9_43.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_85;
...
{
l9_85=(1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_86;
...
{
l9_86=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_87;
#if (sc_BlendMode_Add)
{
l9_87=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_88;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_88=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_89;
...
{
l9_89=dot(l9_43.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_90;
#if (sc_BlendMode_Min)
{
l9_90=1.0-clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
#if (sc_BlendMode_Max)
{
l9_91=clamp(dot(l9_43.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_91=1.0;
...
#endif
l9_79=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_43.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_80);
}
#else
{
vec4 l9_92;
...
#endif
vec3 l9_103=definedBlend(l9_101.xyz,l9_43.xyz);
...
{
l9_109=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_109=vec4(0.0);
...
gl_FragDepth=mix(l9_77,clamp((l9_77*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_76),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_78)+l9_76,0.0,1.0))).x;
vec4 l9_111=outputMotionVectorsIfNeeded(varPos,max(l9_110,vec4(0.0)));
vec4 l9_112=clamp(l9_111,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_113=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_113-0.0039215689)),min(1.0,l9_113+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_115=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_114).xy);
float l9_116=packValue(l9_115);
int l9_123=int(l9_112.w*255.0);
float l9_124=packValue(l9_123);
sc_writeFragData0(vec4(packValue(l9_115),packValue(l9_115),packValue(l9_115),packValue(l9_115)));
sc_writeFragData1(vec4(l9_116,packValue(l9_115),packValue(l9_115),packValue(l9_115)));
sc_writeFragData2(vec4(l9_124,packValue(l9_123),packValue(l9_123),packValue(l9_123)));
...
if (l9_132==0)
{
l9_135=texture(sc_OITAlpha0,l9_127);
l9_134=texture(sc_OITDepthLow0,l9_127);
l9_133=texture(sc_OITDepthHigh0,l9_127);
}
else
{
l9_135=vec4(0.0);
...
if (l9_132==1)
{
l9_138=texture(sc_OITAlpha1,l9_127);
l9_137=texture(sc_OITDepthLow1,l9_127);
l9_136=texture(sc_OITDepthHigh1,l9_127);
}
else
{
l9_138=l9_135;
...
if (any(notEqual(l9_136,vec4(0.0)))||any(notEqual(l9_137,vec4(0.0))))
{
int l9_139[8]=l9_128;
unpackValues(l9_136.w,l9_132,l9_139);
unpackValues(l9_136.z,l9_132,l9_139);
unpackValues(l9_136.y,l9_132,l9_139);
unpackValues(l9_136.x,l9_132,l9_139);
unpackValues(l9_137.w,l9_132,l9_139);
unpackValues(l9_137.z,l9_132,l9_139);
unpackValues(l9_137.y,l9_132,l9_139);
unpackValues(l9_137.x,l9_132,l9_139);
int l9_148[8]=l9_129;
unpackValues(l9_138.w,l9_132,l9_148);
unpackValues(l9_138.z,l9_132,l9_148);
unpackValues(l9_138.y,l9_132,l9_148);
unpackValues(l9_138.x,l9_132,l9_148);
}
l9_132++;
continue;
}
...
vec4 l9_153=texture(sc_OITFilteredDepthBoundsTexture,l9_127);
vec2 l9_154=l9_153.xy;
int l9_155;
#if (sc_SkinBonesCount>0)
{
l9_155=encodeDepth(((1.0-l9_153.x)*1000.0)+getDepthOrderingEpsilon(),l9_154);
}
#else
{
l9_155=0;
...
#endif
int l9_156=encodeDepth(viewSpaceDepth(),l9_154);
vec4 l9_157;
l9_157=l9_112*l9_112.w;
vec4 l9_158;
int l9_159=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_159<8)
{
int l9_160=l9_128[l9_159];
int l9_161=l9_156-l9_155;
bool l9_162=l9_160<l9_161;
bool l9_163;
if (l9_162)
{
l9_163=l9_128[l9_159]>0;
}
else
{
l9_163=l9_162;
...
if (l9_163)
{
vec3 l9_164=l9_157.xyz*(1.0-(float(l9_129[l9_159])/255.0));
l9_158=vec4(l9_164.x,l9_164.y,l9_164.z,l9_157.w);
}
else
{
l9_158=l9_157;
