...
vec3 l9_7=l9_6*l9_6;
vec2 l9_8=l9_0+vec2(0.0);
vec2 l9_9=l9_0+l9_3;
vec2 l9_10=l9_0+vec2(1.0);
return dot((l9_7*l9_7)*vec3(dot(l9_1,vec2(-1.0)+(fract(sin(vec2(dot(l9_8,vec2(127.1,311.70001)),dot(l9_8,vec2(269.5,183.3))))*43758.547)*2.0)),dot(l9_4,vec2(-1.0)+(fract(sin(vec2(dot(l9_9,vec2(127.1,311.70001)),dot(l9_9,vec2(269.5,183.3))))*43758.547)*2.0)),dot(l9_5,vec2(-1.0)+(fract(sin(vec2(dot(l9_10,vec2(127.1,311.70001)),dot(l9_10,vec2(269.5,183.3))))*43758.547)*2.0))),vec3(70.0));
}
float N0_fbm(vec2 n)
{
vec2 param;
...
float l9_4=l9_2.y;
float l9_5=l9_2.z;
N0_resolution=((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5);
vec3 l9_6=N0_getResolution();
vec3 l9_7=N0_getResolution();
vec2 l9_8=(varPackedTex.xy*l9_6.xy)/l9_7.xy;
vec3 l9_9=N0_getResolution();
vec3 l9_10=N0_getResolution();
vec2 l9_11=l9_8*vec2(l9_9.x/l9_10.y,1.0);
float l9_12=l9_0*0.029999999;
vec2 l9_13=l9_11*1.1;
float l9_14=N0_fbm(l9_13*0.5);
vec2 l9_15=l9_13-vec2(l9_14-l9_12);
float l9_16;
vec2 l9_17;
l9_17=l9_15;
l9_16=0.0;
...
l9_17=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_17)+vec2(l9_12);
l9_20*=0.69999999;
l9_16+=abs(l9_21);
l9_19++;
continue;
...
l9_23=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_23)+vec2(l9_12);
l9_26*=0.60000002;
l9_22+=l9_27;
l9_25++;
continue;
...
float l9_28=l9_22+l9_16;
float l9_29=l9_22*l9_16;
float l9_30=l9_12*2.0;
float l9_31;
vec2 l9_32;
l9_32=(l9_13*2.0)-vec2(l9_14-l9_30);
l9_31=0.0;
vec2 l9_33;
int l9_34=0;
...
float l9_37=l9_12*3.0;
float l9_38;
vec2 l9_39;
l9_39=(l9_13*3.0)-vec2(l9_14-l9_37);
l9_38=0.0;
vec2 l9_40;
int l9_41=0;
...
float l9_44=l9_31*0.69999999;
float l9_45=l9_38*0.30000001;
float l9_46=l9_44+l9_45;
float l9_47=N0_fbm(l9_13);
float l9_48=N0_fbm((l9_11+vec2(0.0099999998,0.0))*1.1);
float l9_49=N0_fbm((l9_11+vec2(0.0,0.0099999998))*1.1);
vec3 l9_50=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_8.y));
float l9_51=(8.0*((l9_28*0.5)+(l9_29*0.5)))*l9_16;
vec4 l9_52=vec4(mix(l9_50,clamp((l9_50*0.5)+(vec3(1.1,1.1,0.89999998)*clamp((0.5+(0.30000001*l9_46))+(max(0.0,dot(normalize(vec3((-(l9_48-l9_47))/0.0099999998,(-(l9_49-l9_47))/0.0099999998,0.050000001)),vec3(0.40824831,0.40824831,0.81649661)))*0.2),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_51)+(l9_46*0.5),0.0,1.0))),1.0);
...
{
l9_56=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_61;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_52.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_64;
...
#endif
vec3 l9_77=definedBlend(l9_75.xyz,l9_52.xyz);
...
#endif
int l9_89=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_88).xy);
...
if (l9_106==0)
{
l9_109=texture(sc_OITAlpha0,l9_101);
l9_108=texture(sc_OITDepthLow0,l9_101);
l9_107=texture(sc_OITDepthHigh0,l9_101);
}
else
{
l9_109=vec4(0.0);
...
if (l9_106==1)
{
l9_112=texture(sc_OITAlpha1,l9_101);
l9_111=texture(sc_OITDepthLow1,l9_101);
l9_110=texture(sc_OITDepthHigh1,l9_101);
}
else
{
l9_112=l9_109;
...
vec4 l9_127=texture(sc_OITFilteredDepthBoundsTexture,l9_101);
