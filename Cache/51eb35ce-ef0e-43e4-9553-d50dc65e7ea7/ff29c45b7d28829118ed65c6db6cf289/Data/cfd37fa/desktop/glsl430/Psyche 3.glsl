...
vec2 l9_8=((((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5))*l9_6.xy)/l9_7.xy;
float l9_9=1.0-l9_8.y;
vec2 l9_10=l9_8;
l9_10.y=l9_9;
...
if (l9_16<5)
{
float l9_18=N0_noise(l9_14)*l9_17;
l9_17*=0.40000001;
l9_14=mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_14;
l9_13+=l9_18;
l9_16++;
continue;
}
...
float l9_19=l9_13-l9_11;
vec2 l9_20=l9_12-vec2(l9_19);
float l9_21;
vec2 l9_22;
l9_22=l9_20;
l9_21=0.0;
...
vec2 l9_29;
int l9_30=0;
float l9_31=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_30<5)
{
float l9_32=l9_31*N0_noise(l9_28);
l9_28=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_28)+vec2(l9_11);
l9_31*=0.60000002;
l9_27+=l9_32;
l9_30++;
continue;
...
float l9_33=l9_21+l9_27;
float l9_34=l9_27*l9_33;
float l9_35=l9_11*2.0;
float l9_36;
vec2 l9_37;
l9_37=(l9_12*2.0)-vec2(l9_13-l9_35);
l9_36=0.0;
vec2 l9_38;
int l9_39=0;
...
float l9_42=l9_11*3.0;
float l9_43;
vec2 l9_44;
l9_44=(l9_12*3.0)-vec2(l9_13-l9_42);
l9_43=0.0;
vec2 l9_45;
int l9_46=0;
float l9_47=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_46<4)
{
float l9_48=l9_47*N0_noise(l9_44);
l9_44=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_44)+vec2(l9_42);
l9_47*=0.60000002;
l9_43+=abs(l9_48);
l9_46++;
continue;
...
float l9_49=l9_36+l9_43;
vec3 l9_50=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_9));
float l9_51=(8.0*l9_34)*l9_21;
vec4 l9_52=vec4(mix(l9_50,clamp((l9_50*0.5)+(vec3(1.1,1.1,0.89999998)*clamp(0.5+(0.30000001*l9_49),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_51)+l9_49,0.0,1.0))),1.0);
