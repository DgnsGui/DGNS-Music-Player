...
uniform vec2 Port_CoordsIn_N003;
...
vec2 l9_1=((Port_CoordsIn_N003-Tweak_N6)*Tweak_N1)+Tweak_N6;
...
vec2 l9_8=(((((l9_1*l9_3)+(l9_1*l9_4))+(l9_1*l9_5))/vec2((l9_3+l9_4)+l9_5))*l9_6.xy)/l9_7.xy;
