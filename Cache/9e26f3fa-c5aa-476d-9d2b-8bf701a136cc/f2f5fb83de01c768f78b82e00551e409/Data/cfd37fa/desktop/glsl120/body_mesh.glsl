...
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_4=l9_3;
float l9_5=varPackedTex.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
...
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),baseTextureLayout,l9_2);
vec4 l9_24=texture2D(baseTexture,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_25=mix(baseTextureBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#if (sc_ProjectiveShadowsCaster)
{
l9_28=vec4(l9_27,Port_Opacity_N023);
}
#else
{
...
vec3 l9_32=normalize(l9_26);
vec3 l9_33=ssSRGB_to_Linear(Port_Emissive_N023);
vec3 l9_34;
#if (sc_SSAOEnabled)
{
l9_34=evaluateSSAO(varPos);
}
#else
{
l9_34=Port_AO_N023;
...
SurfaceProperties l9_38=SurfaceProperties(l9_37,Port_Opacity_N023,l9_32,varPos,l9_0,l9_29,l9_30,l9_33,l9_34,Port_SpecularAO_N023,vec3(1.0),l9_36);
vec4 l9_39=vec4(1.0);
vec3 l9_40;
vec3 l9_41;
vec3 l9_42;
...
{
LightingComponents l9_59=accumulateLight(LightingComponents(l9_47,l9_48,l9_53,l9_52,l9_50,l9_49),LightProperties(sc_DirectionalLights[l9_58].direction,sc_DirectionalLights[l9_58].color.xyz,sc_DirectionalLights[l9_58].color.w*l9_39[(l9_51<3) ? l9_51 : 3]),l9_38,l9_0);
...
{
vec3 l9_78=sc_PointLights[l9_76].position-varPos;
...
l9_69=l9_77+1;
LightingComponents l9_84=accumulateLight(LightingComponents(l9_63,l9_64,l9_68,l9_67,l9_66,l9_65),LightProperties(l9_79,sc_PointLights[l9_76].color.xyz,l9_83),l9_38,l9_0);
...
#endif
l9_94=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_95,sc_EnvmapDiffuseLayout,l9_96).xy,-13.0);
}
#else
{
...
vec2 l9_127=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_32,reflect(-l9_0,l9_32),l9_30),sc_EnvmapRotation.y);
vec4 l9_128;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_125=vec3(0.0)+((((l9_128.xyz*(1.0/l9_128.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_38,abs(dot(l9_32,l9_0))));
}
#else
{
l9_125=vec3(0.0);
...
vec3 l9_136=reflect(-l9_0,l9_32);
float l9_137=dot(l9_32,l9_0);
...
l9_146=vec3(0.0);
l9_145=vec3(0.0);
l9_144=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_37,vec3(Port_Opacity_N023));
l9_143=1.0;
}
#else
{
...
vec3 l9_151=l9_131*Port_SpecularAO_N023;
...
{
vec4 l9_159=l9_157;
l9_159.x=l9_156+((l9_34.x*Port_SpecularAO_N023.x)*9.9999997e-06);
l9_158=l9_159;
}
#else
{
...
#endif
vec4 l9_164=max(l9_28,vec4(0.0));
vec4 l9_165;
#if (sc_ProjectiveShadowsCaster)
{
float l9_166;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_167=clamp(l9_164.w*2.0,0.0,1.0);
}
#else
{
float l9_168;
...
{
l9_168=clamp(dot(l9_164.xyz,vec3(l9_164.w)),0.0,1.0);
}
#else
{
float l9_169;
...
#if (sc_BlendMode_Multiply)
{
l9_170=(1.0-dot(l9_164.xyz,vec3(0.33333001)))*l9_164.w;
}
#else
{
float l9_171;
...
{
l9_171=(1.0-clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0))*l9_164.w;
}
#else
{
float l9_172;
#if (sc_BlendMode_ColoredGlass)
{
l9_172=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0)*l9_164.w;
}
#else
{
float l9_173;
#if (sc_BlendMode_Add)
{
l9_173=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_174;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_174=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0)*l9_164.w;
}
#else
{
float l9_175;
...
{
l9_175=dot(l9_164.xyz,vec3(0.33333001))*l9_164.w;
}
#else
{
float l9_176;
#if (sc_BlendMode_Min)
{
l9_176=1.0-clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_177;
#if (sc_BlendMode_Max)
{
l9_177=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_177=1.0;
...
#endif
l9_165=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_164.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_166);
}
#else
{
vec4 l9_178;
...
{
vec3 l9_180=sc_GetFramebufferColor().xyz;
vec3 l9_181=mix(l9_180,definedBlend(l9_180,l9_164.xyz).xyz,vec3(l9_164.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_184=l9_164.w;
l9_183=vec4(mix(vec3(1.0),l9_164.xyz,vec3(l9_184)),l9_184);
}
#else
{
vec4 l9_185;
...
{
float l9_186=l9_164.w;
float l9_187;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_187=clamp(l9_186,0.0,1.0);
}
#else
{
l9_187=l9_186;
...
#endif
l9_185=vec4(l9_164.xyz*l9_187,l9_187);
}
#else
{
l9_185=l9_164;
...
{
l9_190=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_190=vec4(0.0);
...
vec4 l9_192=outputMotionVectorsIfNeeded(varPos,max(l9_191,vec4(0.0)));
vec4 l9_193=clamp(l9_192,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_194=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_194-0.0039215689)),min(1.0,l9_194+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_195).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_196=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_195).xy);
float l9_197=packValue(l9_196);
int l9_204=int(l9_193.w*255.0);
float l9_205=packValue(l9_204);
sc_writeFragData0(vec4(packValue(l9_196),packValue(l9_196),packValue(l9_196),packValue(l9_196)));
sc_writeFragData1(vec4(l9_197,packValue(l9_196),packValue(l9_196),packValue(l9_196)));
sc_writeFragData2(vec4(l9_205,packValue(l9_204),packValue(l9_204),packValue(l9_204)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_208).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_213==0)
{
l9_216=texture2D(sc_OITAlpha0,l9_208);
l9_215=texture2D(sc_OITDepthLow0,l9_208);
l9_214=texture2D(sc_OITDepthHigh0,l9_208);
}
else
{
l9_216=vec4(0.0);
...
if (l9_213==1)
{
l9_219=texture2D(sc_OITAlpha1,l9_208);
l9_218=texture2D(sc_OITDepthLow1,l9_208);
l9_217=texture2D(sc_OITDepthHigh1,l9_208);
}
else
{
l9_219=l9_216;
...
if (any(notEqual(l9_217,vec4(0.0)))||any(notEqual(l9_218,vec4(0.0))))
{
int l9_220[8]=l9_209;
unpackValues(l9_217.w,l9_213,l9_220);
unpackValues(l9_217.z,l9_213,l9_220);
unpackValues(l9_217.y,l9_213,l9_220);
unpackValues(l9_217.x,l9_213,l9_220);
unpackValues(l9_218.w,l9_213,l9_220);
unpackValues(l9_218.z,l9_213,l9_220);
unpackValues(l9_218.y,l9_213,l9_220);
unpackValues(l9_218.x,l9_213,l9_220);
int l9_229[8]=l9_210;
unpackValues(l9_219.w,l9_213,l9_229);
unpackValues(l9_219.z,l9_213,l9_229);
unpackValues(l9_219.y,l9_213,l9_229);
unpackValues(l9_219.x,l9_213,l9_229);
}
l9_213++;
continue;
}
...
vec4 l9_234=texture2D(sc_OITFilteredDepthBoundsTexture,l9_208);
vec2 l9_235=l9_234.xy;
int l9_236;
#if (sc_SkinBonesCount>0)
{
l9_236=encodeDepth(((1.0-l9_234.x)*1000.0)+getDepthOrderingEpsilon(),l9_235);
}
#else
{
l9_236=0;
...
#endif
int l9_237=encodeDepth(viewSpaceDepth(),l9_235);
vec4 l9_238;
l9_238=l9_193*l9_193.w;
vec4 l9_239;
int l9_240=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_240<8)
{
int l9_241=l9_209[l9_240];
int l9_242=l9_237-l9_236;
bool l9_243=l9_241<l9_242;
bool l9_244;
if (l9_243)
{
l9_244=l9_209[l9_240]>0;
}
else
{
l9_244=l9_243;
...
if (l9_244)
{
vec3 l9_245=l9_238.xyz*(1.0-(float(l9_210[l9_240])/255.0));
l9_239=vec4(l9_245.x,l9_245.y,l9_245.z,l9_238.w);
}
else
{
l9_239=l9_238;
