...
{
float l9_7=l9_0.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_8=l9_7;
float l9_9=l9_0.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
#if (SC_USE_UV_MIN_MAX_baseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),baseTextureLayout,baseTextureGetStereoViewIndex());
vec4 l9_28=texture(baseTextureArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_29=mix(baseTextureBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
{
float l9_30=l9_0.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_31=l9_30;
float l9_32=l9_0.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_baseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0)),l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),baseTextureLayout,baseTextureGetStereoViewIndex());
vec4 l9_51=texture(baseTexture,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_52=mix(baseTextureBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
#endif
vec3 l9_54=max(l9_5.xyz,vec3(0.0));
vec4 l9_55;
#if (sc_ProjectiveShadowsCaster)
{
l9_55=vec4(l9_54,Port_Opacity_N023);
}
#else
{
l9_55=ngsCalculateLighting(l9_54,Port_Opacity_N023,l9_53,l9_2,l9_3,Port_Emissive_N023,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N023,Port_SpecularAO_N023);
}
#endif
vec4 l9_56=max(l9_55,vec4(0.0));
if (isProxyMode)
{
vec4 l9_57;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_57,vec4(0.0)));
return;
}
vec4 l9_59;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_61=clamp(l9_56.w*2.0,0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_56.xyz,vec3(l9_56.w)),0.0,1.0);
}
#else
{
float l9_63;
...
#if (sc_BlendMode_Multiply)
{
l9_64=(1.0-dot(l9_56.xyz,vec3(0.33333001)))*l9_56.w;
}
#else
{
float l9_65;
...
{
l9_65=(1.0-clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0))*l9_56.w;
}
#else
{
float l9_66;
#if (sc_BlendMode_ColoredGlass)
{
l9_66=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0)*l9_56.w;
}
#else
{
float l9_67;
#if (sc_BlendMode_Add)
{
l9_67=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_68=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0)*l9_56.w;
}
#else
{
float l9_69;
...
{
l9_69=dot(l9_56.xyz,vec3(0.33333001))*l9_56.w;
}
#else
{
float l9_70;
#if (sc_BlendMode_Min)
{
l9_70=1.0-clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_71;
#if (sc_BlendMode_Max)
{
l9_71=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_71=1.0;
...
#endif
l9_59=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_56.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_60);
}
#else
{
vec4 l9_72;
...
{
vec3 l9_74=sc_GetFramebufferColor().xyz;
vec3 l9_75=mix(l9_74,definedBlend(l9_74,l9_56.xyz).xyz,vec3(l9_56.w));
...
{
float l9_78=l9_56.w;
l9_77=vec4(mix(vec3(1.0),l9_56.xyz,vec3(l9_78)),l9_78);
}
#else
{
vec4 l9_79;
...
#endif
l9_79=vec4(l9_56.xyz*l9_81,l9_81);
}
#else
{
l9_79=l9_56;
