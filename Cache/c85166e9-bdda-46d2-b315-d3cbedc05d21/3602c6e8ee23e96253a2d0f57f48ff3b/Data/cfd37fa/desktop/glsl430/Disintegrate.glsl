...
//sampler sampler opacityTextureSmpSC 0:26
...
//texture texture2D opacityTexture 0:4:0:26
...
//texture texture2DArray opacityTextureArrSC 0:41:0:26
...
vec3 l9_9=abs(l9_7);
vec3 l9_10=l9_7/vec3(dot(l9_9,vec3(1.0)));
...
{
l9_18=uint(clamp(Port_Roughness_N006,0.0,1.0)*1000.0);
}
...
#endif
vec3 l9_20=(((l9_5/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(exp(density),0.0)))+vec3(Port_Value1_N011,Port_Value2_N011,l9_1*(l9_19-0.001)))*noiseFrequency;
vec2 l9_21=l9_20.yz;
float l9_22;
Node54_Noise_Simplex(l9_21,Port_Scale_N054,l9_22,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_21,varPackedTex.xy));
float l9_23=l9_22;
vec2 l9_24=l9_20.zx;
float l9_25;
Node54_Noise_Simplex(l9_24,Port_Scale_N054,l9_25,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_24,varPackedTex.xy));
float l9_26=l9_25;
vec2 l9_27=l9_20.xy;
float l9_28;
Node54_Noise_Simplex(l9_27,Port_Scale_N054,l9_28,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_27,varPackedTex.xy));
float l9_29=l9_28;
vec3 l9_30=pow(abs(l9_6),vec3(1.0/(1.0-((clamp(Port_Import_N081+0.001,Port_Input1_N082+0.001,Port_Input2_N082+0.001)-0.001)*0.99000001))));
float l9_31=l9_30.x;
float l9_32=l9_30.y;
float l9_33=l9_30.z;
float l9_34;
#if (animate)
{
float l9_35=((Port_TimeA_N028+Port_TimeTransition_N028)+Port_TimeB_N028)+9.9999997e-05;
l9_34=mix(Port_ValueA_N028,Port_ValueB_N028,smoothstep(Port_TimeA_N028/l9_35,1.0-(Port_TimeB_N028/l9_35),abs((mod((l9_1/l9_35)+Port_TimeBias_N028,1.0)*2.0)-1.0)));
}
#else
{
l9_34=disintegrate;
...
#endif
if ((floor((clamp((((((l9_23*l9_31)+(l9_26*l9_32))+(l9_29*l9_33))/((l9_31+l9_32)+l9_33))+((((l9_34-Port_RangeMinA_N017)/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001)+0.5)*1.0)!=0.0)
{
discard;
}
#if (Tweak_N27)
...
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_37=l9_36;
float l9_38=varPackedTex.y;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_39=l9_38;
vec2 l9_40;
float l9_41;
...
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_43=l9_37;
float l9_44=1.0;
sc_ClampUV(l9_43,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_42,l9_44);
float l9_45=l9_43;
float l9_46=l9_44;
bool l9_47;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_48=l9_39;
float l9_49=l9_46;
sc_ClampUV(l9_48,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_47,l9_49);
l9_41=l9_49;
...
#endif
vec2 l9_50=sc_TransformUV(l9_40,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_51=l9_50.x;
float l9_52=l9_41;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_52);
float l9_53=l9_50.y;
float l9_54=l9_52;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_54);
}
#else
{
float l9_55=varPackedTex.x;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_56=l9_55;
float l9_57=varPackedTex.y;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_73);
}
#endif
}
#else
...
float l9_56=l9_16[(l9_53<3) ? l9_53 : 3];
...
l9_45=l9_53+1;
LightingComponents l9_60=accumulateLight(LightingComponents(l9_39,l9_40,l9_44,l9_43,l9_42,l9_41),LightProperties(l9_55,sc_PointLights[l9_52].color.xyz,l9_59),l9_15,l9_5);
...
{
vec3 l9_70=getSpecularDominantDir(l9_3,reflect(-l9_5,l9_3),l9_8);
float l9_71=clamp(pow(l9_8,0.66666669),0.0,1.0)*5.0;
float l9_72=-l9_70.z;
float l9_73=l9_70.x;
vec2 l9_74=vec2((((l9_73<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_72/length(vec2(l9_73,l9_72)),-1.0,1.0)))-1.5707964,acos(l9_70.y))/vec2(6.2831855,3.1415927);
float l9_75=l9_74.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_76=vec2(l9_75,1.0-l9_74.y);
l9_76.x=fract((l9_75+floor(l9_75))+1.0);
vec4 l9_77;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_78=floor(l9_71);
float l9_79=ceil(l9_71);
l9_77=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_76,sc_EnvmapSpecularSize.xy,l9_78),sc_EnvmapSpecularGetStereoViewIndex(),l9_78),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_76,sc_EnvmapSpecularSize.xy,l9_79),sc_EnvmapSpecularGetStereoViewIndex(),l9_79),vec4(l9_71-l9_78));
}
#else
{
l9_77=sc_EnvmapSpecularSampleViewIndexLevel(l9_76,sc_EnvmapSpecularGetStereoViewIndex(),l9_71);
}
#endif
vec3 l9_80=((l9_77.xyz*(1.0/l9_77.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_81;
if (receivesRayTracedReflections)
{
vec4 l9_82=sampleRayTracedReflections();
l9_81=mix(l9_80,l9_82.xyz,vec3(l9_82.w));
}
else
{
l9_81=l9_80;
}
l9_69=vec3(0.0)+(l9_81*envBRDFApprox(l9_15,abs(dot(l9_3,l9_5))));
}
#else
{
l9_69=vec3(0.0);
...
{
float l9_84=clamp(l9_8*l9_8,0.0099999998,1.0);
vec3 l9_85;
l9_85=sc_LightEstimationData.ambientLight*l9_13;
int l9_86=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_86<sc_LightEstimationSGCount)
{
float l9_87=l9_84*l9_84;
vec3 l9_88=reflect(-l9_5,l9_3);
float l9_89=dot(l9_3,l9_5);
float l9_90=(2.0/l9_87)/(4.0*max(l9_89,9.9999997e-05));
float l9_91=length((l9_88*l9_90)+(sc_LightEstimationData.sg[l9_86].axis*sc_LightEstimationData.sg[l9_86].sharpness));
float l9_92=clamp(dot(l9_3,l9_88),0.0,1.0);
float l9_93=clamp(l9_89,0.0,1.0);
float l9_94=1.0-l9_87;
l9_85+=((((((((vec3(1.0/(3.1415927*l9_87))*exp((l9_91-l9_90)-sc_LightEstimationData.sg[l9_86].sharpness))*sc_LightEstimationData.sg[l9_86].color)*6.2831855)*(1.0-exp((-2.0)*l9_91)))/vec3(l9_91))*((1.0/(l9_92+sqrt(l9_87+((l9_94*l9_92)*l9_92))))*(1.0/(l9_93+sqrt(l9_87+((l9_94*l9_93)*l9_93))))))*(l9_13+((vec3(1.0)-l9_13)*pow(1.0-clamp(dot(l9_88,normalize(l9_88+l9_5)),0.0,1.0),5.0))))*l9_92);
l9_86++;
continue;
}
else
...
{
l9_96=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_14,vec3(l9_0));
l9_95=1.0;
}
#else
{
...
if (receivesRayTracedAo)
{
l9_98=l9_14*(vec3(0.0)+(vec3(0.0)*vec3(1.0-sampleRayTracedAo())));
}
else
{
l9_98=l9_14*(vec3(0.0)+(vec3(0.0)*l9_11));
}
vec3 l9_99=l9_83*l9_10;
vec3 l9_100=l9_65+l9_99;
vec3 l9_101;
if (l9_97)
{
l9_101=l9_98*srgbToLinear(l9_95);
}
else
{
l9_101=l9_98;
}
vec3 l9_102=l9_101+l9_100;
vec3 l9_103=(l9_102+l9_6)+l9_96;
float l9_104=l9_103.x;
vec4 l9_105=vec4(l9_104,l9_103.yz,l9_95);
vec4 l9_106;
#if (sc_IsEditor)
{
vec4 l9_107=l9_105;
l9_107.x=l9_104+((l9_11.x*l9_10.x)*9.9999997e-06);
l9_106=l9_107;
}
#else
{
...
{
vec3 l9_109=l9_106.xyz*1.8;
vec3 l9_110=(l9_106.xyz*(l9_109+vec3(1.4)))/((l9_106.xyz*(l9_109+vec3(0.5)))+vec3(1.5));
l9_108=vec4(l9_110.x,l9_110.y,l9_110.z,l9_106.w);
}
#else
{
l9_108=l9_106;
...
#endif
vec3 l9_111=vec3(linearToSrgb(l9_108.x),linearToSrgb(l9_108.y),linearToSrgb(l9_108.z));
return vec4(l9_111.x,l9_111.y,l9_111.z,l9_108.w);
}
float snoise(vec2 v)
{
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
...
#endif
vec3 l9_14=max(baseColor.xyz,vec3(0.0));
vec4 l9_15;
#if (sc_ProjectiveShadowsCaster)
{
l9_15=vec4(l9_14,Port_Opacity_N006);
}
#else
{
l9_15=ngsCalculateLighting(l9_14,Port_Opacity_N006,l9_13,l9_7,l9_8,Port_Emissive_N006,Port_Metallic_N006,Port_Roughness_N006,vec3(1.0),Port_SpecularAO_N006);
}
#endif
vec4 l9_16=max(l9_15,vec4(0.0));
float l9_17;
#if (animate)
{
l9_17=1.001;
...
#endif
vec3 l9_18=(((l9_5/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(exp(density),0.0)))+vec3(Port_Value1_N011,Port_Value2_N011,l9_1*(l9_17-0.001)))*noiseFrequency;
vec3 l9_19=abs(l9_4);
vec2 l9_20=l9_18.yz;
float l9_21;
Node54_Noise_Simplex(l9_20,Port_Scale_N054,l9_21,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_8,l9_7,l9_6,l9_5,l9_4,l9_20,l9_3));
float l9_22=l9_21;
vec2 l9_23=l9_18.zx;
float l9_24;
Node54_Noise_Simplex(l9_23,Port_Scale_N054,l9_24,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_8,l9_7,l9_6,l9_5,l9_4,l9_23,l9_3));
float l9_25=l9_24;
vec2 l9_26=l9_18.xy;
float l9_27;
Node54_Noise_Simplex(l9_26,Port_Scale_N054,l9_27,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_8,l9_7,l9_6,l9_5,l9_4,l9_26,l9_3));
float l9_28=l9_27;
vec3 l9_29=pow(l9_19,vec3(1.0/(1.0-((clamp(Port_Import_N081+0.001,Port_Input1_N082+0.001,Port_Input2_N082+0.001)-0.001)*0.99000001))));
float l9_30=l9_29.x;
float l9_31=l9_29.y;
float l9_32=l9_29.z;
float l9_33;
#if (animate)
{
float l9_34=((Port_TimeA_N028+Port_TimeTransition_N028)+Port_TimeB_N028)+9.9999997e-05;
l9_33=mix(Port_ValueA_N028,Port_ValueB_N028,smoothstep(Port_TimeA_N028/l9_34,1.0-(Port_TimeB_N028/l9_34),abs((mod((l9_1/l9_34)+Port_TimeBias_N028,1.0)*2.0)-1.0)));
}
#else
{
l9_33=disintegrate;
...
#endif
float l9_35=l9_33-Port_RangeMinA_N017;
float l9_36=clamp((((((l9_22*l9_30)+(l9_25*l9_31))+(l9_28*l9_32))/((l9_30+l9_31)+l9_32))+(((l9_35/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001;
float l9_37=(((l9_36-Port_RangeMinA_N064)/(Port_RangeMaxA_N064-Port_RangeMinA_N064))*(Port_RangeMaxB_N064-Port_RangeMinB_N064))+Port_RangeMinB_N064;
float l9_38;
if (Port_RangeMaxB_N064>Port_RangeMinB_N064)
{
l9_38=clamp(l9_37,Port_RangeMinB_N064,Port_RangeMaxB_N064);
}
else
{
l9_38=clamp(l9_37,Port_RangeMaxB_N064,Port_RangeMinB_N064);
}
vec4 l9_39=vec4(l9_38);
vec4 l9_40=mix(l9_16,edgeColor,l9_39);
if ((floor(l9_36+0.5)*1.0)!=0.0)
{
discard;
}
vec4 l9_41;
...
{
float l9_43=l9_3.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_44=l9_43;
float l9_45=l9_3.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_64=texture(opacityTextureArrSC,l9_63,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_65=mix(opacityTextureBorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
{
float l9_66=l9_3.x;
sc_SoftwareWrapEarly(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_67=l9_66;
float l9_68=l9_3.y;
sc_SoftwareWrapEarly(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_69=l9_68;
vec2 l9_70;
float l9_71;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_72=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_72=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_73=l9_67;
float l9_74=1.0;
sc_ClampUV(l9_73,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_72,l9_74);
float l9_75=l9_73;
float l9_76=l9_74;
bool l9_77;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_77=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_77=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_78=l9_69;
float l9_79=l9_76;
sc_ClampUV(l9_78,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_77,l9_79);
l9_71=l9_79;
...
#endif
vec2 l9_80=sc_TransformUV(l9_70,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_81=l9_80.x;
float l9_82=l9_71;
sc_SoftwareWrapLate(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_82);
float l9_83=l9_80.y;
float l9_84=l9_82;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_84);
float l9_85=l9_84;
vec3 l9_86=sc_SamplingCoordsViewToGlobal(vec2(l9_81,l9_83),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_87=texture(opacityTexture,l9_86.xy,0.0);
vec4 l9_88;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_88=mix(opacityTextureBorderColor,l9_87,vec4(l9_85));
}
#else
{
l9_88=l9_87;
...
#else
{
l9_41=vec4(Port_Input2_N044);
}
#endif
float l9_89=clamp((l9_40.w*l9_41.x)+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_90=vec4(l9_40.x,l9_40.y,l9_40.z,vec4(0.0).w);
l9_90.w=l9_89;
if (isProxyMode)
{
vec4 l9_91;
...
#endif
sc_writeFragData0(max(l9_91,vec4(0.0)));
return;
}
vec4 l9_93;
#if (sc_ProjectiveShadowsCaster)
...
{
l9_96=clamp(dot(l9_90.xyz,vec3(l9_89)),0.0,1.0);
}
#else
{
float l9_97;
...
#if (sc_BlendMode_Multiply)
{
l9_98=(1.0-dot(l9_90.xyz,vec3(0.33333001)))*l9_89;
}
#else
{
float l9_99;
...
{
l9_99=(1.0-clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0))*l9_89;
}
#else
{
float l9_100;
#if (sc_BlendMode_ColoredGlass)
{
l9_100=clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0)*l9_89;
}
#else
{
float l9_101;
#if (sc_BlendMode_Add)
{
l9_101=clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_102;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_102=clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0)*l9_89;
}
#else
{
float l9_103;
...
{
l9_103=dot(l9_90.xyz,vec3(0.33333001))*l9_89;
}
#else
{
float l9_104;
#if (sc_BlendMode_Min)
{
l9_104=1.0-clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_105;
#if (sc_BlendMode_Max)
{
l9_105=clamp(dot(l9_90.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_105=1.0;
...
#endif
l9_93=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_90.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_94);
}
#else
{
vec4 l9_106;
...
{
vec3 l9_108=sc_GetFramebufferColor().xyz;
vec3 l9_109=mix(l9_108,definedBlend(l9_108,l9_90.xyz).xyz,vec3(l9_89));
vec4 l9_110=vec4(l9_109.x,l9_109.y,l9_109.z,vec4(0.0).w);
l9_110.w=1.0;
l9_107=l9_110;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_111=vec4(mix(vec3(1.0),l9_90.xyz,vec3(l9_89)),l9_89);
}
#else
{
vec4 l9_112;
...
#endif
l9_112=vec4(l9_90.xyz*l9_113,l9_113);
}
#else
{
l9_112=l9_90;
...
{
l9_116=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_116=vec4(0.0);
...
vec4 l9_118=outputMotionVectorsIfNeeded(varPos,max(l9_117,vec4(0.0)));
vec4 l9_119=clamp(l9_118,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_120=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_120-0.0039215689)),min(1.0,l9_120+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_121).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_122=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_121).xy);
float l9_123=packValue(l9_122);
int l9_130=int(l9_119.w*255.0);
float l9_131=packValue(l9_130);
sc_writeFragData0(vec4(packValue(l9_122),packValue(l9_122),packValue(l9_122),packValue(l9_122)));
sc_writeFragData1(vec4(l9_123,packValue(l9_122),packValue(l9_122),packValue(l9_122)));
sc_writeFragData2(vec4(l9_131,packValue(l9_130),packValue(l9_130),packValue(l9_130)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_134).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_139==0)
{
l9_142=texture(sc_OITAlpha0,l9_134);
l9_141=texture(sc_OITDepthLow0,l9_134);
l9_140=texture(sc_OITDepthHigh0,l9_134);
}
else
{
l9_142=vec4(0.0);
...
if (l9_139==1)
{
l9_145=texture(sc_OITAlpha1,l9_134);
l9_144=texture(sc_OITDepthLow1,l9_134);
l9_143=texture(sc_OITDepthHigh1,l9_134);
}
else
{
l9_145=l9_142;
...
if (any(notEqual(l9_143,vec4(0.0)))||any(notEqual(l9_144,vec4(0.0))))
{
int l9_146[8]=l9_135;
unpackValues(l9_143.w,l9_139,l9_146);
unpackValues(l9_143.z,l9_139,l9_146);
unpackValues(l9_143.y,l9_139,l9_146);
unpackValues(l9_143.x,l9_139,l9_146);
unpackValues(l9_144.w,l9_139,l9_146);
unpackValues(l9_144.z,l9_139,l9_146);
unpackValues(l9_144.y,l9_139,l9_146);
unpackValues(l9_144.x,l9_139,l9_146);
int l9_155[8]=l9_136;
unpackValues(l9_145.w,l9_139,l9_155);
unpackValues(l9_145.z,l9_139,l9_155);
unpackValues(l9_145.y,l9_139,l9_155);
unpackValues(l9_145.x,l9_139,l9_155);
}
l9_139++;
continue;
}
...
vec4 l9_160=texture(sc_OITFilteredDepthBoundsTexture,l9_134);
vec2 l9_161=l9_160.xy;
int l9_162;
#if (sc_SkinBonesCount>0)
{
l9_162=encodeDepth(((1.0-l9_160.x)*1000.0)+getDepthOrderingEpsilon(),l9_161);
}
#else
{
l9_162=0;
...
#endif
int l9_163=encodeDepth(viewSpaceDepth(),l9_161);
vec4 l9_164;
l9_164=l9_119*l9_119.w;
vec4 l9_165;
int l9_166=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_166<8)
{
int l9_167=l9_135[l9_166];
int l9_168=l9_163-l9_162;
bool l9_169=l9_167<l9_168;
bool l9_170;
if (l9_169)
{
l9_170=l9_135[l9_166]>0;
}
else
{
l9_170=l9_169;
...
if (l9_170)
{
vec3 l9_171=l9_164.xyz*(1.0-(float(l9_136[l9_166])/255.0));
l9_165=vec4(l9_171.x,l9_171.y,l9_171.z,l9_164.w);
}
else
{
l9_165=l9_164;
