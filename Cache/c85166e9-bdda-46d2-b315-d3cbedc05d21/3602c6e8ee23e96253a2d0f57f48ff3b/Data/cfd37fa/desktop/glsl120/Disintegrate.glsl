...
#endif
vec3 l9_8=max(baseColor.xyz,vec3(0.0));
vec4 l9_9;
#if (sc_ProjectiveShadowsCaster)
{
l9_9=vec4(l9_8,Port_Opacity_N006);
}
#else
{
vec3 l9_10=ssSRGB_to_Linear(l9_8);
vec3 l9_11=normalize(l9_7);
...
#endif
vec3 l9_14=vec3(Port_Metallic_N006);
vec3 l9_15=mix(vec3(0.039999999),l9_10*Port_Metallic_N006,l9_14);
vec3 l9_16=mix(l9_10*(1.0-Port_Metallic_N006),vec3(0.0),l9_14);
SurfaceProperties l9_17=SurfaceProperties(l9_16,Port_Opacity_N006,l9_11,varPos,l9_3,Port_Metallic_N006,Port_Roughness_N006,l9_12,l9_13,Port_SpecularAO_N006,vec3(1.0),l9_15);
vec4 l9_18=vec4(1.0);
vec3 l9_19;
vec3 l9_20;
vec3 l9_21;
...
{
LightingComponents l9_38=accumulateLight(LightingComponents(l9_26,l9_27,l9_32,l9_31,l9_29,l9_28),LightProperties(sc_DirectionalLights[l9_37].direction,sc_DirectionalLights[l9_37].color.xyz,sc_DirectionalLights[l9_37].color.w*l9_18[(l9_30<3) ? l9_30 : 3]),l9_17,l9_3);
...
float l9_58=l9_18[(l9_55<3) ? l9_55 : 3];
...
l9_47=l9_55+1;
LightingComponents l9_62=accumulateLight(LightingComponents(l9_41,l9_42,l9_46,l9_45,l9_44,l9_43),LightProperties(l9_57,sc_PointLights[l9_54].color.xyz,l9_61),l9_17,l9_3);
...
{
vec3 l9_68=getSpecularDominantDir(l9_11,reflect(-l9_3,l9_11),Port_Roughness_N006);
float l9_69=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
float l9_70=-l9_68.z;
float l9_71=l9_68.x;
vec2 l9_72=vec2((((l9_71<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_70/length(vec2(l9_71,l9_70)),-1.0,1.0)))-1.5707964,acos(l9_68.y))/vec2(6.2831855,3.1415927);
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_76=floor(l9_69);
float l9_77=ceil(l9_69);
l9_75=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_74,sc_EnvmapSpecularSize.xy,l9_76),sc_EnvmapSpecularGetStereoViewIndex(),l9_76),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_74,sc_EnvmapSpecularSize.xy,l9_77),sc_EnvmapSpecularGetStereoViewIndex(),l9_77),vec4(l9_69-l9_76));
}
#else
{
l9_75=sc_EnvmapSpecularSampleViewIndexLevel(l9_74,sc_EnvmapSpecularGetStereoViewIndex(),l9_69);
}
#endif
l9_67=vec3(0.0)+((((l9_75.xyz*(1.0/l9_75.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_17,abs(dot(l9_11,l9_3))));
}
#else
{
l9_67=vec3(0.0);
...
{
float l9_79=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_80;
l9_80=sc_LightEstimationData.ambientLight*l9_15;
int l9_81=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_81<sc_LightEstimationSGCount)
{
float l9_82=l9_79*l9_79;
vec3 l9_83=reflect(-l9_3,l9_11);
float l9_84=dot(l9_11,l9_3);
float l9_85=(2.0/l9_82)/(4.0*max(l9_84,9.9999997e-05));
float l9_86=length((l9_83*l9_85)+(sc_LightEstimationData.sg[l9_81].axis*sc_LightEstimationData.sg[l9_81].sharpness));
float l9_87=clamp(dot(l9_11,l9_83),0.0,1.0);
float l9_88=clamp(l9_84,0.0,1.0);
float l9_89=1.0-l9_82;
l9_80+=((((((((vec3(1.0/(3.1415927*l9_82))*exp((l9_86-l9_85)-sc_LightEstimationData.sg[l9_81].sharpness))*sc_LightEstimationData.sg[l9_81].color)*6.2831855)*(1.0-exp((-2.0)*l9_86)))/vec3(l9_86))*((1.0/(l9_87+sqrt(l9_82+((l9_89*l9_87)*l9_87))))*(1.0/(l9_88+sqrt(l9_82+((l9_89*l9_88)*l9_88))))))*(l9_15+((vec3(1.0)-l9_15)*pow(1.0-clamp(dot(l9_83,normalize(l9_83+l9_3)),0.0,1.0),5.0))))*l9_87);
l9_81++;
continue;
}
else
...
{
l9_91=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_16,vec3(Port_Opacity_N006));
l9_90=1.0;
}
#else
{
l9_91=l9_40;
l9_90=Port_Opacity_N006;
}
#endif
bool l9_92;
...
#endif
vec3 l9_93=vec3(0.0)*l9_13;
vec3 l9_94=l9_16*(vec3(0.0)+l9_93);
vec3 l9_95=l9_78*Port_SpecularAO_N006;
vec3 l9_96=l9_63+l9_95;
vec3 l9_97;
if (l9_92)
{
l9_97=l9_94*srgbToLinear(l9_90);
}
else
{
l9_97=l9_94;
}
vec3 l9_98=l9_97+l9_96;
vec3 l9_99=(l9_98+l9_12)+l9_91;
float l9_100=l9_99.x;
vec4 l9_101=vec4(l9_100,l9_99.yz,l9_90);
vec4 l9_102;
#if (sc_IsEditor)
{
vec4 l9_103=l9_101;
l9_103.x=l9_100+((l9_13.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_102=l9_103;
}
#else
{
...
{
vec3 l9_105=l9_102.xyz*1.8;
vec3 l9_106=(l9_102.xyz*(l9_105+vec3(1.4)))/((l9_102.xyz*(l9_105+vec3(0.5)))+vec3(1.5));
l9_104=vec4(l9_106.x,l9_106.y,l9_106.z,l9_102.w);
}
#else
{
l9_104=l9_102;
...
#endif
vec3 l9_107=vec3(linearToSrgb(l9_104.x),linearToSrgb(l9_104.y),linearToSrgb(l9_104.z));
l9_9=vec4(l9_107.x,l9_107.y,l9_107.z,l9_104.w);
}
#endif
vec4 l9_108=max(l9_9,vec4(0.0));
float l9_109;
#if (animate)
{
l9_109=1.001;
...
#endif
vec3 l9_110=(((l9_5/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(exp(density),0.0)))+vec3(Port_Value1_N011,Port_Value2_N011,l9_1*(l9_109-0.001)))*noiseFrequency;
vec2 l9_111=l9_110.yz;
float l9_112;
Node54_Noise_Simplex(l9_111,Port_Scale_N054,l9_112,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_111,varPackedTex.xy));
float l9_113=l9_112;
vec2 l9_114=l9_110.zx;
float l9_115;
Node54_Noise_Simplex(l9_114,Port_Scale_N054,l9_115,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_114,varPackedTex.xy));
float l9_116=l9_115;
vec2 l9_117=l9_110.xy;
float l9_118;
Node54_Noise_Simplex(l9_117,Port_Scale_N054,l9_118,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,l9_5,l9_6,l9_117,varPackedTex.xy));
float l9_119=l9_118;
vec3 l9_120=pow(abs(l9_6),vec3(1.0/(1.0-((clamp(Port_Import_N081+0.001,Port_Input1_N082+0.001,Port_Input2_N082+0.001)-0.001)*0.99000001))));
float l9_121=l9_120.x;
float l9_122=l9_120.y;
float l9_123=l9_120.z;
float l9_124;
#if (animate)
{
float l9_125=((Port_TimeA_N028+Port_TimeTransition_N028)+Port_TimeB_N028)+9.9999997e-05;
l9_124=mix(Port_ValueA_N028,Port_ValueB_N028,smoothstep(Port_TimeA_N028/l9_125,1.0-(Port_TimeB_N028/l9_125),abs((mod((l9_1/l9_125)+Port_TimeBias_N028,1.0)*2.0)-1.0)));
}
#else
{
l9_124=disintegrate;
...
#endif
float l9_126=l9_124-Port_RangeMinA_N017;
float l9_127=clamp((((((l9_113*l9_121)+(l9_116*l9_122))+(l9_119*l9_123))/((l9_121+l9_122)+l9_123))+(((l9_126/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001;
float l9_128=(((l9_127-Port_RangeMinA_N064)/(Port_RangeMaxA_N064-Port_RangeMinA_N064))*(Port_RangeMaxB_N064-Port_RangeMinB_N064))+Port_RangeMinB_N064;
float l9_129;
if (Port_RangeMaxB_N064>Port_RangeMinB_N064)
{
l9_129=clamp(l9_128,Port_RangeMinB_N064,Port_RangeMaxB_N064);
}
else
{
l9_129=clamp(l9_128,Port_RangeMaxB_N064,Port_RangeMinB_N064);
}
vec4 l9_130=vec4(l9_129);
vec4 l9_131=mix(l9_108,edgeColor,l9_130);
if ((floor(l9_127+0.5)*1.0)!=0.0)
{
discard;
}
vec4 l9_132;
...
#endif
float l9_134=varPackedTex.x;
sc_SoftwareWrapEarly(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_135=l9_134;
float l9_136=varPackedTex.y;
sc_SoftwareWrapEarly(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_137=l9_136;
vec2 l9_138;
float l9_139;
...
{
l9_140=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_140=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_141=l9_135;
float l9_142=1.0;
sc_ClampUV(l9_141,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_140,l9_142);
float l9_143=l9_141;
float l9_144=l9_142;
bool l9_145;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_145=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
...
float l9_146=l9_137;
float l9_147=l9_144;
sc_ClampUV(l9_146,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_145,l9_147);
l9_139=l9_147;
...
#endif
vec2 l9_148=sc_TransformUV(l9_138,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_149=l9_148.x;
float l9_150=l9_139;
sc_SoftwareWrapLate(l9_149,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_150);
float l9_151=l9_148.y;
float l9_152=l9_150;
sc_SoftwareWrapLate(l9_151,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_152);
float l9_153=l9_152;
vec3 l9_154=sc_SamplingCoordsViewToGlobal(vec2(l9_149,l9_151),opacityTextureLayout,l9_133);
vec4 l9_155=texture2D(opacityTexture,l9_154.xy,0.0);
vec4 l9_156;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_156=mix(opacityTextureBorderColor,l9_155,vec4(l9_153));
}
#else
{
l9_156=l9_155;
...
#else
{
l9_132=vec4(Port_Input2_N044);
}
#endif
float l9_157=clamp((l9_131.w*l9_132.x)+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_158=vec4(l9_131.x,l9_131.y,l9_131.z,vec4(0.0).w);
l9_158.w=l9_157;
vec4 l9_159;
#if (sc_ProjectiveShadowsCaster)
{
...
{
vec3 l9_174=sc_GetFramebufferColor().xyz;
vec3 l9_175=mix(l9_174,definedBlend(l9_174,l9_158.xyz).xyz,vec3(l9_157));
vec4 l9_176=vec4(l9_175.x,l9_175.y,l9_175.z,vec4(0.0).w);
l9_176.w=1.0;
l9_173=l9_176;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_177=vec4(mix(vec3(1.0),l9_158.xyz,vec3(l9_157)),l9_157);
}
#else
{
vec4 l9_178;
...
#endif
l9_178=vec4(l9_158.xyz*l9_179,l9_179);
}
#else
{
l9_178=l9_158;
...
{
l9_182=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_182=vec4(0.0);
...
vec4 l9_184=outputMotionVectorsIfNeeded(varPos,max(l9_183,vec4(0.0)));
vec4 l9_185=clamp(l9_184,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_186=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_186-0.0039215689)),min(1.0,l9_186+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_188=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_187).xy);
float l9_189=packValue(l9_188);
int l9_196=int(l9_185.w*255.0);
float l9_197=packValue(l9_196);
sc_writeFragData0(vec4(packValue(l9_188),packValue(l9_188),packValue(l9_188),packValue(l9_188)));
sc_writeFragData1(vec4(l9_189,packValue(l9_188),packValue(l9_188),packValue(l9_188)));
sc_writeFragData2(vec4(l9_197,packValue(l9_196),packValue(l9_196),packValue(l9_196)));
...
if (l9_205==0)
{
l9_208=texture2D(sc_OITAlpha0,l9_200);
l9_207=texture2D(sc_OITDepthLow0,l9_200);
l9_206=texture2D(sc_OITDepthHigh0,l9_200);
}
else
{
l9_208=vec4(0.0);
...
if (l9_205==1)
{
l9_211=texture2D(sc_OITAlpha1,l9_200);
l9_210=texture2D(sc_OITDepthLow1,l9_200);
l9_209=texture2D(sc_OITDepthHigh1,l9_200);
}
else
{
l9_211=l9_208;
...
if (any(notEqual(l9_209,vec4(0.0)))||any(notEqual(l9_210,vec4(0.0))))
{
int l9_212[8]=l9_201;
unpackValues(l9_209.w,l9_205,l9_212);
unpackValues(l9_209.z,l9_205,l9_212);
unpackValues(l9_209.y,l9_205,l9_212);
unpackValues(l9_209.x,l9_205,l9_212);
unpackValues(l9_210.w,l9_205,l9_212);
unpackValues(l9_210.z,l9_205,l9_212);
unpackValues(l9_210.y,l9_205,l9_212);
unpackValues(l9_210.x,l9_205,l9_212);
int l9_221[8]=l9_202;
unpackValues(l9_211.w,l9_205,l9_221);
unpackValues(l9_211.z,l9_205,l9_221);
unpackValues(l9_211.y,l9_205,l9_221);
unpackValues(l9_211.x,l9_205,l9_221);
}
l9_205++;
continue;
}
...
vec4 l9_226=texture2D(sc_OITFilteredDepthBoundsTexture,l9_200);
vec2 l9_227=l9_226.xy;
int l9_228;
#if (sc_SkinBonesCount>0)
{
l9_228=encodeDepth(((1.0-l9_226.x)*1000.0)+getDepthOrderingEpsilon(),l9_227);
}
#else
{
l9_228=0;
...
#endif
int l9_229=encodeDepth(viewSpaceDepth(),l9_227);
vec4 l9_230;
l9_230=l9_185*l9_185.w;
vec4 l9_231;
int l9_232=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_232<8)
{
int l9_233=l9_201[l9_232];
int l9_234=l9_229-l9_228;
bool l9_235=l9_233<l9_234;
bool l9_236;
if (l9_235)
{
l9_236=l9_201[l9_232]>0;
}
else
{
l9_236=l9_235;
...
if (l9_236)
{
vec3 l9_237=l9_230.xyz*(1.0-(float(l9_202[l9_232])/255.0));
l9_231=vec4(l9_237.x,l9_237.y,l9_237.z,l9_230.w);
}
else
{
l9_231=l9_230;
