...
#if (sc_ProjectiveShadowsCaster)
{
l9_157=vec4(Port_Albedo_N006,l9_156);
}
#else
{
l9_157=ngsCalculateLighting(Port_Albedo_N006,l9_156,l9_155,l9_4,l9_5,Port_Emissive_N006,clamp(l9_108.x,0.0,1.0),clamp(l9_108.y,0.0,1.0),clamp(vec3(l9_108.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_158=max(l9_157,vec4(0.0));
if (isProxyMode)
{
vec4 l9_159;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_159,vec4(0.0)));
return;
}
vec4 l9_161;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_163=clamp(l9_158.w*2.0,0.0,1.0);
}
#else
{
float l9_164;
...
{
l9_164=clamp(dot(l9_158.xyz,vec3(l9_158.w)),0.0,1.0);
}
#else
{
float l9_165;
...
#if (sc_BlendMode_Multiply)
{
l9_166=(1.0-dot(l9_158.xyz,vec3(0.33333001)))*l9_158.w;
}
#else
{
float l9_167;
...
{
l9_167=(1.0-clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0))*l9_158.w;
}
#else
{
float l9_168;
#if (sc_BlendMode_ColoredGlass)
{
l9_168=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0)*l9_158.w;
}
#else
{
float l9_169;
#if (sc_BlendMode_Add)
{
l9_169=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_170;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_170=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0)*l9_158.w;
}
#else
{
float l9_171;
...
{
l9_171=dot(l9_158.xyz,vec3(0.33333001))*l9_158.w;
}
#else
{
float l9_172;
#if (sc_BlendMode_Min)
{
l9_172=1.0-clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_173;
#if (sc_BlendMode_Max)
{
l9_173=clamp(dot(l9_158.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_173=1.0;
...
#endif
l9_161=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_158.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_162);
}
#else
{
vec4 l9_174;
...
{
vec3 l9_176=sc_GetFramebufferColor().xyz;
vec3 l9_177=mix(l9_176,definedBlend(l9_176,l9_158.xyz).xyz,vec3(l9_158.w));
vec4 l9_178=vec4(l9_177.x,l9_177.y,l9_177.z,vec4(0.0).w);
l9_178.w=1.0;
l9_175=l9_178;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_180=l9_158.w;
l9_179=vec4(mix(vec3(1.0),l9_158.xyz,vec3(l9_180)),l9_180);
}
#else
{
vec4 l9_181;
...
{
float l9_182=l9_158.w;
float l9_183;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_183=clamp(l9_182,0.0,1.0);
}
#else
{
l9_183=l9_182;
...
#endif
l9_181=vec4(l9_158.xyz*l9_183,l9_183);
}
#else
{
l9_181=l9_158;
...
{
l9_186=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_186=vec4(0.0);
...
vec4 l9_188=outputMotionVectorsIfNeeded(varPos,max(l9_187,vec4(0.0)));
vec4 l9_189=clamp(l9_188,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_190=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_190-0.0039215689)),min(1.0,l9_190+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_191).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_192=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_191).xy);
float l9_193=packValue(l9_192);
int l9_200=int(l9_189.w*255.0);
float l9_201=packValue(l9_200);
sc_writeFragData0(vec4(packValue(l9_192),packValue(l9_192),packValue(l9_192),packValue(l9_192)));
sc_writeFragData1(vec4(l9_193,packValue(l9_192),packValue(l9_192),packValue(l9_192)));
sc_writeFragData2(vec4(l9_201,packValue(l9_200),packValue(l9_200),packValue(l9_200)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_204).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_209==0)
{
l9_212=texture(sc_OITAlpha0,l9_204);
l9_211=texture(sc_OITDepthLow0,l9_204);
l9_210=texture(sc_OITDepthHigh0,l9_204);
}
else
{
l9_212=vec4(0.0);
...
if (l9_209==1)
{
l9_215=texture(sc_OITAlpha1,l9_204);
l9_214=texture(sc_OITDepthLow1,l9_204);
l9_213=texture(sc_OITDepthHigh1,l9_204);
}
else
{
l9_215=l9_212;
...
if (any(notEqual(l9_213,vec4(0.0)))||any(notEqual(l9_214,vec4(0.0))))
{
int l9_216[8]=l9_205;
unpackValues(l9_213.w,l9_209,l9_216);
unpackValues(l9_213.z,l9_209,l9_216);
unpackValues(l9_213.y,l9_209,l9_216);
unpackValues(l9_213.x,l9_209,l9_216);
unpackValues(l9_214.w,l9_209,l9_216);
unpackValues(l9_214.z,l9_209,l9_216);
unpackValues(l9_214.y,l9_209,l9_216);
unpackValues(l9_214.x,l9_209,l9_216);
int l9_225[8]=l9_206;
unpackValues(l9_215.w,l9_209,l9_225);
unpackValues(l9_215.z,l9_209,l9_225);
unpackValues(l9_215.y,l9_209,l9_225);
unpackValues(l9_215.x,l9_209,l9_225);
}
l9_209++;
continue;
}
...
vec4 l9_230=texture(sc_OITFilteredDepthBoundsTexture,l9_204);
vec2 l9_231=l9_230.xy;
int l9_232;
#if (sc_SkinBonesCount>0)
{
l9_232=encodeDepth(((1.0-l9_230.x)*1000.0)+getDepthOrderingEpsilon(),l9_231);
}
#else
{
l9_232=0;
...
#endif
int l9_233=encodeDepth(viewSpaceDepth(),l9_231);
vec4 l9_234;
l9_234=l9_189*l9_189.w;
vec4 l9_235;
int l9_236=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_236<8)
{
int l9_237=l9_205[l9_236];
int l9_238=l9_233-l9_232;
bool l9_239=l9_237<l9_238;
bool l9_240;
if (l9_239)
{
l9_240=l9_205[l9_236]>0;
}
else
{
l9_240=l9_239;
...
if (l9_240)
{
vec3 l9_241=l9_234.xyz*(1.0-(float(l9_206[l9_236])/255.0));
l9_235=vec4(l9_241.x,l9_241.y,l9_241.z,l9_234.w);
}
else
{
l9_235=l9_234;
