...
#if (sc_ProjectiveShadowsCaster)
{
l9_80=vec4(Port_Albedo_N006,l9_79);
}
#else
{
float l9_81=clamp(l9_77.x,0.0,1.0);
float l9_82=clamp(l9_77.y,0.0,1.0);
vec3 l9_83=ssSRGB_to_Linear(Port_Albedo_N006);
vec3 l9_84=normalize(l9_78);
vec3 l9_85=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_86;
#if (sc_SSAOEnabled)
{
l9_86=evaluateSSAO(varPos);
}
#else
{
l9_86=clamp(vec3(l9_77.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_87=vec3(l9_81);
vec3 l9_88=mix(vec3(0.039999999),l9_83*l9_81,l9_87);
vec3 l9_89=mix(l9_83*(1.0-l9_81),vec3(0.0),l9_87);
SurfaceProperties l9_90=SurfaceProperties(l9_89,l9_79,l9_84,varPos,l9_0,l9_81,l9_82,l9_85,l9_86,Port_SpecularAO_N006,vec3(1.0),l9_88);
vec4 l9_91=vec4(1.0);
vec3 l9_92;
vec3 l9_93;
vec3 l9_94;
...
l9_100=vec3(0.0);
l9_99=vec3(0.0);
LightingComponents l9_106;
LightProperties l9_107;
SurfaceProperties l9_108;
vec3 l9_109;
int l9_110=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_110<sc_DirectionalLightsCount)
{
LightingComponents l9_111=accumulateLight(LightingComponents(l9_99,l9_100,l9_105,l9_104,l9_102,l9_101),LightProperties(sc_DirectionalLights[l9_110].direction,sc_DirectionalLights[l9_110].color.xyz,sc_DirectionalLights[l9_110].color.w*l9_91[(l9_103<3) ? l9_103 : 3]),l9_90,l9_0);
l9_105=l9_111.indirectDiffuse;
l9_104=l9_111.indirectSpecular;
l9_103++;
l9_102=l9_111.emitted;
l9_101=l9_111.transmitted;
l9_100=l9_111.directSpecular;
l9_99=l9_111.directDiffuse;
l9_110++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_128<sc_PointLightsCount)
{
vec3 l9_130=sc_PointLights[l9_128].position-varPos;
vec3 l9_131=normalize(l9_130);
float l9_132=l9_91[(l9_129<3) ? l9_129 : 3];
float l9_133=clamp((dot(l9_131,sc_PointLights[l9_128].direction)*sc_PointLights[l9_128].angleScale)+sc_PointLights[l9_128].angleOffset,0.0,1.0);
float l9_134=(sc_PointLights[l9_128].color.w*l9_132)*(l9_133*l9_133);
float l9_135;
if (sc_PointLights[l9_128].falloffEnabled)
{
l9_135=l9_134*computeDistanceAttenuation(length(l9_130),sc_PointLights[l9_128].falloffEndDistance);
}
else
{
l9_135=l9_134;
...
l9_121=l9_129+1;
LightingComponents l9_136=accumulateLight(LightingComponents(l9_115,l9_116,l9_120,l9_119,l9_118,l9_117),LightProperties(l9_131,sc_PointLights[l9_128].color.xyz,l9_135),l9_90,l9_0);
l9_122=l9_136.directDiffuse;
l9_123=l9_136.directSpecular;
l9_124=l9_136.indirectDiffuse;
l9_125=l9_136.indirectSpecular;
l9_126=l9_136.emitted;
l9_127=l9_136.transmitted;
l9_120=l9_124;
l9_119=l9_125;
l9_129=l9_121;
l9_118=l9_126;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_140=abs(varShadowTex-vec2(0.5));
vec4 l9_141=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_140.x,l9_140.y),0.5);
l9_139=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_141.xyz,vec3(sc_ShadowColor.w)),vec3(l9_141.w*sc_ShadowDensity));
}
#else
{
l9_139=vec3(1.0);
...
#endif
l9_138=l9_112*l9_139;
l9_137=l9_113*l9_139;
}
#else
{
l9_138=l9_112;
...
{
vec2 l9_143=calcPanoramicTexCoordsFromDir(l9_84,sc_EnvmapRotation.y);
vec4 l9_144;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_145=calcSeamlessPanoramicUvsForSampling(l9_143,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_145=l9_143;
...
#endif
l9_144=sc_EnvmapSpecularSampleViewIndexBias(l9_145,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_146;
...
{
vec2 l9_147=calcSeamlessPanoramicUvsForSampling(l9_143,sc_EnvmapDiffuseSize.xy,0.0);
int l9_148;
...
#endif
l9_146=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_147,sc_EnvmapDiffuseLayout,l9_148).xy,-13.0);
}
#else
{
l9_146=sc_EnvmapSpecularSampleViewIndexBias(l9_143,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_144=l9_146;
}
#endif
l9_142=(l9_144.xyz*(1.0/l9_144.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_149;
...
float l9_152=l9_150.y;
float l9_153=l9_150.z;
l9_149=(((((((sc_Sh[8]*0.42904299)*((l9_151*l9_151)-(l9_152*l9_152)))+((sc_Sh[6]*0.74312502)*(l9_153*l9_153)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_151*l9_152))+(sc_Sh[7]*(l9_151*l9_153)))+(sc_Sh[5]*(l9_152*l9_153)))*0.85808599))+((((sc_Sh[3]*l9_151)+(sc_Sh[1]*l9_152))+(sc_Sh[2]*l9_153))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_149=vec3(0.0);
...
{
l9_155=l9_142+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_156=l9_142;
l9_156.x=l9_142.x+(1e-06*sc_AmbientLights[0].color.x);
l9_155=l9_156;
}
#endif
l9_154=l9_155;
...
{
l9_158=l9_154+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_159=l9_154;
l9_159.x=l9_154.x+(1e-06*sc_AmbientLights[1].color.x);
l9_158=l9_159;
}
#endif
l9_157=l9_158;
...
{
l9_161=l9_157+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_162=l9_157;
l9_162.x=l9_157.x+(1e-06*sc_AmbientLights[2].color.x);
l9_161=l9_162;
}
#endif
l9_160=l9_161;
...
{
vec3 l9_164;
l9_164=sc_LightEstimationData.ambientLight;
vec3 l9_165;
int l9_166=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_166<sc_LightEstimationSGCount)
{
float l9_167=dot(sc_LightEstimationData.sg[l9_166].axis,l9_84);
float l9_168=exp(-sc_LightEstimationData.sg[l9_166].sharpness);
float l9_169=l9_168*l9_168;
float l9_170=1.0/sc_LightEstimationData.sg[l9_166].sharpness;
float l9_171=(1.0+(2.0*l9_169))-l9_170;
float l9_172=sqrt(1.0-l9_171);
float l9_173=0.36000001*l9_167;
float l9_174=(1.0/(4.0*0.36000001))*l9_172;
float l9_175=l9_173+l9_174;
float l9_176;
if (step(abs(l9_173),l9_174)>0.5)
{
l9_176=(l9_175*l9_175)/l9_172;
}
else
{
l9_176=clamp(l9_167,0.0,1.0);
}
l9_165=l9_164+((((sc_LightEstimationData.sg[l9_166].color/vec3(sc_LightEstimationData.sg[l9_166].sharpness))*6.2831855)*((l9_171*l9_176)+(((l9_168-l9_169)*l9_170)-l9_169)))/vec3(3.1415927));
l9_164=l9_165;
l9_166++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_178=clamp(pow(l9_82,0.66666669),0.0,1.0)*5.0;
vec2 l9_179=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_84,reflect(-l9_0,l9_84),l9_82),sc_EnvmapRotation.y);
vec4 l9_180;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_181=floor(l9_178);
float l9_182=ceil(l9_178);
l9_180=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_179,sc_EnvmapSpecularSize.xy,l9_181),sc_EnvmapSpecularGetStereoViewIndex(),l9_181),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_179,sc_EnvmapSpecularSize.xy,l9_182),sc_EnvmapSpecularGetStereoViewIndex(),l9_182),vec4(l9_178-l9_181));
}
#else
{
l9_180=sc_EnvmapSpecularSampleViewIndexLevel(l9_179,sc_EnvmapSpecularGetStereoViewIndex(),l9_178);
}
#endif
l9_177=vec3(0.0)+((((l9_180.xyz*(1.0/l9_180.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_90,abs(dot(l9_84,l9_0))));
}
#else
{
l9_177=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_184=clamp(l9_82*l9_82,0.0099999998,1.0);
vec3 l9_185;
l9_185=sc_LightEstimationData.ambientLight*l9_88;
int l9_186=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_186<sc_LightEstimationSGCount)
{
float l9_187=l9_184*l9_184;
vec3 l9_188=reflect(-l9_0,l9_84);
float l9_189=dot(l9_84,l9_0);
float l9_190=(2.0/l9_187)/(4.0*max(l9_189,9.9999997e-05));
float l9_191=length((l9_188*l9_190)+(sc_LightEstimationData.sg[l9_186].axis*sc_LightEstimationData.sg[l9_186].sharpness));
float l9_192=clamp(dot(l9_84,l9_188),0.0,1.0);
float l9_193=clamp(l9_189,0.0,1.0);
float l9_194=1.0-l9_187;
l9_185+=((((((((vec3(1.0/(3.1415927*l9_187))*exp((l9_191-l9_190)-sc_LightEstimationData.sg[l9_186].sharpness))*sc_LightEstimationData.sg[l9_186].color)*6.2831855)*(1.0-exp((-2.0)*l9_191)))/vec3(l9_191))*((1.0/(l9_192+sqrt(l9_187+((l9_194*l9_192)*l9_192))))*(1.0/(l9_193+sqrt(l9_187+((l9_194*l9_193)*l9_193))))))*(l9_88+((vec3(1.0)-l9_88)*pow(1.0-clamp(dot(l9_188,normalize(l9_188+l9_0)),0.0,1.0),5.0))))*l9_192);
l9_186++;
continue;
}
else
...
l9_198=vec3(0.0);
l9_197=vec3(0.0);
l9_196=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_89,vec3(l9_79));
l9_195=1.0;
}
#else
{
...
#endif
vec3 l9_200=l9_197*l9_86;
vec3 l9_201=l9_198+l9_200;
vec3 l9_202=l9_89*l9_201;
vec3 l9_203=l9_183*Port_SpecularAO_N006;
vec3 l9_204=l9_137+l9_203;
vec3 l9_205;
if (l9_199)
{
l9_205=l9_202*srgbToLinear(l9_195);
}
else
{
l9_205=l9_202;
}
vec3 l9_206=l9_205+l9_204;
vec3 l9_207=(l9_206+l9_85)+l9_196;
float l9_208=l9_207.x;
vec4 l9_209=vec4(l9_208,l9_207.yz,l9_195);
vec4 l9_210;
#if (sc_IsEditor)
{
vec4 l9_211=l9_209;
l9_211.x=l9_208+((l9_86.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_210=l9_211;
}
#else
{
...
{
vec3 l9_213=l9_210.xyz*1.8;
vec3 l9_214=(l9_210.xyz*(l9_213+vec3(1.4)))/((l9_210.xyz*(l9_213+vec3(0.5)))+vec3(1.5));
l9_212=vec4(l9_214.x,l9_214.y,l9_214.z,l9_210.w);
}
#else
{
l9_212=l9_210;
...
#endif
vec3 l9_215=vec3(linearToSrgb(l9_212.x),linearToSrgb(l9_212.y),linearToSrgb(l9_212.z));
l9_80=vec4(l9_215.x,l9_215.y,l9_215.z,l9_212.w);
}
#endif
vec4 l9_216=max(l9_80,vec4(0.0));
vec4 l9_217;
#if (sc_ProjectiveShadowsCaster)
{
float l9_218;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_219=clamp(l9_216.w*2.0,0.0,1.0);
}
#else
{
float l9_220;
...
{
l9_220=clamp(dot(l9_216.xyz,vec3(l9_216.w)),0.0,1.0);
}
#else
{
float l9_221;
...
#if (sc_BlendMode_Multiply)
{
l9_222=(1.0-dot(l9_216.xyz,vec3(0.33333001)))*l9_216.w;
}
#else
{
float l9_223;
...
{
l9_223=(1.0-clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0))*l9_216.w;
}
#else
{
float l9_224;
#if (sc_BlendMode_ColoredGlass)
{
l9_224=clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0)*l9_216.w;
}
#else
{
float l9_225;
#if (sc_BlendMode_Add)
{
l9_225=clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_226;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_226=clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0)*l9_216.w;
}
#else
{
float l9_227;
...
{
l9_227=dot(l9_216.xyz,vec3(0.33333001))*l9_216.w;
}
#else
{
float l9_228;
#if (sc_BlendMode_Min)
{
l9_228=1.0-clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_229;
#if (sc_BlendMode_Max)
{
l9_229=clamp(dot(l9_216.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_229=1.0;
...
#endif
l9_217=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_216.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_218);
}
#else
{
vec4 l9_230;
...
{
vec3 l9_232=sc_GetFramebufferColor().xyz;
vec3 l9_233=mix(l9_232,definedBlend(l9_232,l9_216.xyz).xyz,vec3(l9_216.w));
vec4 l9_234=vec4(l9_233.x,l9_233.y,l9_233.z,vec4(0.0).w);
l9_234.w=1.0;
l9_231=l9_234;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_236=l9_216.w;
l9_235=vec4(mix(vec3(1.0),l9_216.xyz,vec3(l9_236)),l9_236);
}
#else
{
vec4 l9_237;
...
{
float l9_238=l9_216.w;
float l9_239;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_239=clamp(l9_238,0.0,1.0);
}
#else
{
l9_239=l9_238;
...
#endif
l9_237=vec4(l9_216.xyz*l9_239,l9_239);
}
#else
{
l9_237=l9_216;
...
{
l9_242=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_242=vec4(0.0);
...
vec4 l9_244=outputMotionVectorsIfNeeded(varPos,max(l9_243,vec4(0.0)));
vec4 l9_245=clamp(l9_244,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_246=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_246-0.0039215689)),min(1.0,l9_246+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_247=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_247).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_248=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_247).xy);
float l9_249=packValue(l9_248);
int l9_256=int(l9_245.w*255.0);
float l9_257=packValue(l9_256);
sc_writeFragData0(vec4(packValue(l9_248),packValue(l9_248),packValue(l9_248),packValue(l9_248)));
sc_writeFragData1(vec4(l9_249,packValue(l9_248),packValue(l9_248),packValue(l9_248)));
sc_writeFragData2(vec4(l9_257,packValue(l9_256),packValue(l9_256),packValue(l9_256)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_260=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_260).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_265==0)
{
l9_268=texture2D(sc_OITAlpha0,l9_260);
l9_267=texture2D(sc_OITDepthLow0,l9_260);
l9_266=texture2D(sc_OITDepthHigh0,l9_260);
}
else
{
l9_268=vec4(0.0);
...
if (l9_265==1)
{
l9_271=texture2D(sc_OITAlpha1,l9_260);
l9_270=texture2D(sc_OITDepthLow1,l9_260);
l9_269=texture2D(sc_OITDepthHigh1,l9_260);
}
else
{
l9_271=l9_268;
...
if (any(notEqual(l9_269,vec4(0.0)))||any(notEqual(l9_270,vec4(0.0))))
{
int l9_272[8]=l9_261;
unpackValues(l9_269.w,l9_265,l9_272);
unpackValues(l9_269.z,l9_265,l9_272);
unpackValues(l9_269.y,l9_265,l9_272);
unpackValues(l9_269.x,l9_265,l9_272);
unpackValues(l9_270.w,l9_265,l9_272);
unpackValues(l9_270.z,l9_265,l9_272);
unpackValues(l9_270.y,l9_265,l9_272);
unpackValues(l9_270.x,l9_265,l9_272);
int l9_281[8]=l9_262;
unpackValues(l9_271.w,l9_265,l9_281);
unpackValues(l9_271.z,l9_265,l9_281);
unpackValues(l9_271.y,l9_265,l9_281);
unpackValues(l9_271.x,l9_265,l9_281);
}
l9_265++;
continue;
}
...
vec4 l9_286=texture2D(sc_OITFilteredDepthBoundsTexture,l9_260);
vec2 l9_287=l9_286.xy;
int l9_288;
#if (sc_SkinBonesCount>0)
{
l9_288=encodeDepth(((1.0-l9_286.x)*1000.0)+getDepthOrderingEpsilon(),l9_287);
}
#else
{
l9_288=0;
...
#endif
int l9_289=encodeDepth(viewSpaceDepth(),l9_287);
vec4 l9_290;
l9_290=l9_245*l9_245.w;
vec4 l9_291;
int l9_292=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_292<8)
{
int l9_293=l9_261[l9_292];
int l9_294=l9_289-l9_288;
bool l9_295=l9_293<l9_294;
bool l9_296;
if (l9_295)
{
l9_296=l9_261[l9_292]>0;
}
else
{
l9_296=l9_295;
...
if (l9_296)
{
vec3 l9_297=l9_290.xyz*(1.0-(float(l9_262[l9_292])/255.0));
l9_291=vec4(l9_297.x,l9_297.y,l9_297.z,l9_290.w);
}
else
{
l9_291=l9_290;
