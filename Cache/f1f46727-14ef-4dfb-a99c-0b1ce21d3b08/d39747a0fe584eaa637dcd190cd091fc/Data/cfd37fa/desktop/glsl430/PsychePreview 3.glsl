...
vec3 l9_3=N0_getResolution();
vec2 l9_4=l9_1*l9_3.xy;
vec3 l9_5=N0_getResolution();
vec2 l9_6=l9_4/l9_5.xy;
vec3 l9_7=N0_getResolution();
vec3 l9_8=N0_getResolution();
vec2 l9_9=l9_6*vec2(l9_7.x/l9_8.y,1.0);
float l9_10=l9_0*0.029999999;
vec2 l9_11=l9_9*1.1;
float l9_12=N0_fbm(l9_11*0.5);
vec2 l9_13=l9_11-vec2(l9_12-l9_10);
float l9_14;
vec2 l9_15;
l9_15=l9_13;
l9_14=0.0;
vec2 l9_16;
int l9_17=0;
float l9_18=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_17<8)
{
float l9_19=l9_18*N0_noise(l9_15);
l9_15=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_15)+vec2(l9_10);
l9_18*=0.69999999;
l9_14+=abs(l9_19);
l9_17++;
continue;
...
vec2 l9_22;
int l9_23=0;
float l9_24=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_23<8)
{
float l9_25=l9_24*N0_noise(l9_21);
l9_21=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_21)+vec2(l9_10);
l9_24*=0.60000002;
l9_20+=l9_25;
l9_23++;
continue;
...
float l9_26=l9_20+l9_14;
float l9_27=l9_20*l9_14;
float l9_28=l9_10*2.0;
float l9_29;
vec2 l9_30;
l9_30=(l9_11*2.0)-vec2(l9_12-l9_28);
l9_29=0.0;
vec2 l9_31;
int l9_32=0;
float l9_33=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_32<7)
{
float l9_34=l9_33*N0_noise(l9_30);
l9_30=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_30)+vec2(l9_28);
l9_33*=0.60000002;
l9_29+=l9_34;
l9_32++;
continue;
...
float l9_35=l9_10*3.0;
float l9_36;
vec2 l9_37;
l9_37=(l9_11*3.0)-vec2(l9_12-l9_35);
l9_36=0.0;
vec2 l9_38;
int l9_39=0;
float l9_40=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_39<7)
{
float l9_41=l9_40*N0_noise(l9_37);
l9_37=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_37)+vec2(l9_35);
l9_40*=0.60000002;
l9_36+=abs(l9_41);
l9_39++;
continue;
...
float l9_42=l9_29*0.69999999;
float l9_43=l9_36*0.30000001;
float l9_44=l9_42+l9_43;
float l9_45=N0_fbm(l9_11);
float l9_46=N0_fbm((l9_9+vec2(0.0099999998,0.0))*1.1);
float l9_47=N0_fbm((l9_9+vec2(0.0,0.0099999998))*1.1);
vec3 l9_48=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_6.y));
float l9_49=(8.0*((l9_26*0.5)+(l9_27*0.5)))*l9_14;
vec4 l9_50=vec4(mix(l9_48,clamp((l9_48*0.5)+(vec3(1.1,1.1,0.89999998)*clamp((0.5+(0.30000001*l9_44))+(max(0.0,dot(normalize(vec3((-(l9_46-l9_45))/0.0099999998,(-(l9_47-l9_45))/0.0099999998,0.050000001)),vec3(0.40824831,0.40824831,0.81649661)))*0.2),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_49)+(l9_44*0.5),0.0,1.0))),1.0);
...
{
l9_56=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_50.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_50.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_50.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_50.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
#endif
vec3 l9_77=definedBlend(l9_75.xyz,l9_50.xyz);
