...
float N0_smoothnoise(vec4 p)
{
vec4 l9_0=floor(p);
vec4 l9_1=fract(p);
vec4 l9_2=(l9_1*l9_1)*(vec4(3.0)-(l9_1*2.0));
vec4 l9_3=l9_0+vec4(0.0);
vec4 l9_4=l9_0+vec4(1.0,0.0,0.0,0.0);
float l9_5=l9_2.x;
vec4 l9_6=l9_0+vec4(0.0,1.0,0.0,0.0);
vec4 l9_7=l9_0+vec4(1.0,1.0,0.0,0.0);
float l9_8=l9_2.y;
vec4 l9_9=l9_0+vec4(0.0,0.0,1.0,0.0);
vec4 l9_10=l9_0+vec4(1.0,0.0,1.0,0.0);
vec4 l9_11=l9_0+vec4(0.0,1.0,1.0,0.0);
vec4 l9_12=l9_0+vec4(1.0,1.0,1.0,0.0);
float l9_13=l9_2.z;
vec4 l9_14=l9_0+vec4(0.0,0.0,0.0,1.0);
vec4 l9_15=l9_0+vec4(1.0,0.0,0.0,1.0);
vec4 l9_16=l9_0+vec4(0.0,1.0,0.0,1.0);
vec4 l9_17=l9_0+vec4(1.0,1.0,0.0,1.0);
vec4 l9_18=l9_0+vec4(0.0,0.0,1.0,1.0);
vec4 l9_19=l9_0+vec4(1.0,0.0,1.0,1.0);
vec4 l9_20=l9_0+vec4(0.0,1.0,1.0,1.0);
vec4 l9_21=l9_0+vec4(1.0);
return mix(mix(mix(mix(fract(sin((((l9_3.x*1234.0)+(l9_3.y*2345.0))+(l9_3.z*3456.0))+(l9_3.w*4567.0))*5678.0),fract(sin((((l9_4.x*1234.0)+(l9_4.y*2345.0))+(l9_4.z*3456.0))+(l9_4.w*4567.0))*5678.0),l9_5),mix(fract(sin((((l9_6.x*1234.0)+(l9_6.y*2345.0))+(l9_6.z*3456.0))+(l9_6.w*4567.0))*5678.0),fract(sin((((l9_7.x*1234.0)+(l9_7.y*2345.0))+(l9_7.z*3456.0))+(l9_7.w*4567.0))*5678.0),l9_5),l9_8),mix(mix(fract(sin((((l9_9.x*1234.0)+(l9_9.y*2345.0))+(l9_9.z*3456.0))+(l9_9.w*4567.0))*5678.0),fract(sin((((l9_10.x*1234.0)+(l9_10.y*2345.0))+(l9_10.z*3456.0))+(l9_10.w*4567.0))*5678.0),l9_5),mix(fract(sin((((l9_11.x*1234.0)+(l9_11.y*2345.0))+(l9_11.z*3456.0))+(l9_11.w*4567.0))*5678.0),fract(sin((((l9_12.x*1234.0)+(l9_12.y*2345.0))+(l9_12.z*3456.0))+(l9_12.w*4567.0))*5678.0),l9_5),l9_8),l9_13),mix(mix(mix(fract(sin((((l9_14.x*1234.0)+(l9_14.y*2345.0))+(l9_14.z*3456.0))+(l9_14.w*4567.0))*5678.0),fract(sin((((l9_15.x*1234.0)+(l9_15.y*2345.0))+(l9_15.z*3456.0))+(l9_15.w*4567.0))*5678.0),l9_5),mix(fract(sin((((l9_16.x*1234.0)+(l9_16.y*2345.0))+(l9_16.z*3456.0))+(l9_16.w*4567.0))*5678.0),fract(sin((((l9_17.x*1234.0)+(l9_17.y*2345.0))+(l9_17.z*3456.0))+(l9_17.w*4567.0))*5678.0),l9_5),l9_8),mix(mix(fract(sin((((l9_18.x*1234.0)+(l9_18.y*2345.0))+(l9_18.z*3456.0))+(l9_18.w*4567.0))*5678.0),fract(sin((((l9_19.x*1234.0)+(l9_19.y*2345.0))+(l9_19.z*3456.0))+(l9_19.w*4567.0))*5678.0),l9_5),mix(fract(sin((((l9_20.x*1234.0)+(l9_20.y*2345.0))+(l9_20.z*3456.0))+(l9_20.w*4567.0))*5678.0),fract(sin((((l9_21.x*1234.0)+(l9_21.y*2345.0))+(l9_21.z*3456.0))+(l9_21.w*4567.0))*5678.0),l9_5),l9_8),l9_13),l9_2.w);
}
float N0_fbm(vec3 x)
{
vec4 param;
...
if (l9_0<10)
{
float l9_3=l9_2*N0_smoothnoise(vec4(x,cos(tempGlobals.gTimeElapsed*0.0020000001)*200.0));
x=(x*2.0)+vec3(1.0);
l9_2*=0.5;
l9_1+=l9_3;
l9_0++;
...
float l9_5=(tempGlobals.Surface_UVCoord0.x*2.0)*3.1415927;
float l9_6=tempGlobals.Surface_UVCoord0.y*3.1415927;
float l9_7=sin(l9_6);
vec3 l9_8=vec3((l9_7*cos(l9_5))+cos(tempGlobals.gTimeElapsed/5.0),(l9_7*sin(l9_5))+sin(tempGlobals.gTimeElapsed/5.0),cos(l9_6)+sin(tempGlobals.gTimeElapsed/5.0));
float l9_9=N0_fbm(l9_8);
vec3 l9_10=vec3(l9_9,sin(l9_9),cos(l9_9));
float l9_11=N0_fbm((l9_8+(l9_10*5.0))+vec3(tempGlobals.gTimeElapsed*0.0049999999));
vec3 l9_12=clamp(l9_10,vec3(0.0),vec3(1.0));
float l9_13=(l9_11*2.0)-1.0;
vec3 l9_14=mix(mix(mix(mix(vec3(0.15000001,0.07,0.029999999),vec3(0.34999999,0.17,0.079999998),l9_12),vec3(0.55000001,0.27000001,0.13),l9_12),vec3(1.0),vec3(clamp(l9_13,0.0,1.0))),vec3(0.0),vec3(clamp(-l9_13,0.0,1.0)));
float l9_15=ssPow(l9_11,3.0);
float l9_16=ssPow(l9_11,2.0);
vec4 l9_17=vec4((l9_14/vec3(max(max(l9_14.x,l9_14.y),l9_14.z)))*((clamp(((0.40000001*l9_15)+l9_16)+(0.5*l9_11),0.0,1.0)*0.89999998)+0.1),1.0);
...
{
l9_23=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_28;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_29=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_30;
...
{
l9_30=dot(l9_17.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_31;
...
#endif
vec3 l9_44=definedBlend(l9_42.xyz,l9_17.xyz);
...
#endif
int l9_56=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_55).xy);
...
if (l9_73==0)
{
l9_76=texture(sc_OITAlpha0,l9_68);
l9_75=texture(sc_OITDepthLow0,l9_68);
l9_74=texture(sc_OITDepthHigh0,l9_68);
}
else
{
l9_76=vec4(0.0);
...
if (l9_73==1)
{
l9_79=texture(sc_OITAlpha1,l9_68);
l9_78=texture(sc_OITDepthLow1,l9_68);
l9_77=texture(sc_OITDepthHigh1,l9_68);
}
else
{
l9_79=l9_76;
...
vec4 l9_94=texture(sc_OITFilteredDepthBoundsTexture,l9_68);
vec2 l9_95=l9_94.xy;
int l9_96;
#if (sc_SkinBonesCount>0)
{
