...
tempGlobals=ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy);
N0_resolution=Port_resolution_N000;
float l9_3=(tempGlobals.Surface_UVCoord0.x*2.0)*3.1415927;
float l9_4=tempGlobals.Surface_UVCoord0.y*3.1415927;
float l9_5=sin(l9_4);
vec3 l9_6=vec3((l9_5*cos(l9_3))+cos(tempGlobals.gTimeElapsed/5.0),(l9_5*sin(l9_3))+sin(tempGlobals.gTimeElapsed/5.0),cos(l9_4)+sin(tempGlobals.gTimeElapsed/5.0));
float l9_7=N0_fbm(l9_6);
vec3 l9_8=vec3(l9_7,sin(l9_7),cos(l9_7));
float l9_9=N0_fbm((l9_6+(l9_8*5.0))+vec3(tempGlobals.gTimeElapsed*0.0049999999));
vec3 l9_10=clamp(l9_8,vec3(0.0),vec3(1.0));
float l9_11=(l9_9*2.0)-1.0;
vec3 l9_12=mix(mix(mix(mix(vec3(0.15000001,0.07,0.029999999),vec3(0.34999999,0.17,0.079999998),l9_10),vec3(0.55000001,0.27000001,0.13),l9_10),vec3(1.0),vec3(clamp(l9_11,0.0,1.0))),vec3(0.0),vec3(clamp(-l9_11,0.0,1.0)));
float l9_13=ssPow(l9_9,3.0);
float l9_14=ssPow(l9_9,2.0);
vec4 l9_15=vec4((l9_12/vec3(max(max(l9_12.x,l9_12.y),l9_12.z)))*((clamp(((0.40000001*l9_13)+l9_14)+(0.5*l9_9),0.0,1.0)*0.89999998)+0.1),1.0);
...
{
l9_19=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_15.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_15.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_15.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_15.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
#endif
vec3 l9_39=definedBlend(l9_37.xyz,l9_15.xyz);
