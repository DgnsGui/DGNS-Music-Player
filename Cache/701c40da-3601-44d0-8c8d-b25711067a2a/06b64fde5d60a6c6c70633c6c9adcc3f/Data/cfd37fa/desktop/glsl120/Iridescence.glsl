...
//sampler sampler Tweak_N50SmpSC 0:18
//sampler sampler intensityTextureSmpSC 0:19
//sampler sampler iridescenceMapSmpSC 0:20
//sampler sampler opacityTextureSmpSC 0:21
...
//texture texture2D Tweak_N50 0:0:0:18
//texture texture2D intensityTexture 0:1:0:19
//texture texture2D iridescenceMap 0:2:0:20
//texture texture2D opacityTexture 0:3:0:21
...
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).x);
float l9_5=l9_4;
float l9_6=varPackedTex.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N50)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,Tweak_N50UvMinMax.x,Tweak_N50UvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N50)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N50)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,Tweak_N50UvMinMax.y,Tweak_N50UvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_Tweak_N50)!=0),Tweak_N50Transform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N50)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N50)!=0)),l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N50,SC_SOFTWARE_WRAP_MODE_V_Tweak_N50).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N50)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N50)!=0)),l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),Tweak_N50Layout,l9_3);
vec4 l9_25=texture2D(Tweak_N50,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N50)
{
l9_26=mix(Tweak_N50BorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
float l9_27=1.0-clamp(dot(l9_1,l9_0),0.0,1.0);
float l9_28;
if (l9_27<=0.0)
{
l9_28=0.0;
...
{
l9_28=pow(l9_27,exponent);
}
float l9_29=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_2.x*10000.0)*9.9999997e-05,floor(l9_2.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_2.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_30=l9_28+((((floor(((l9_29*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_31=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_32;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_32=clamp(l9_31,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_32=clamp(l9_31,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
int l9_33;
...
#endif
float l9_34=l9_30;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_35=l9_34;
float l9_36=l9_32;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_37=l9_36;
vec2 l9_38;
float l9_39;
...
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
...
float l9_41=l9_35;
float l9_42=1.0;
sc_ClampUV(l9_41,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_40,l9_42);
float l9_43=l9_41;
float l9_44=l9_42;
bool l9_45;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_46=l9_37;
float l9_47=l9_44;
sc_ClampUV(l9_46,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_45,l9_47);
l9_39=l9_47;
...
#endif
vec2 l9_48=sc_TransformUV(l9_38,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),iridescenceMapLayout,l9_33);
vec4 l9_55=texture2D(iridescenceMap,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_56=mix(iridescenceMapBorderColor,l9_55,vec4(l9_53));
}
#else
{
l9_56=l9_55;
...
#endif
vec4 l9_57=l9_26*l9_56;
vec4 l9_58=mix(l9_26,l9_57*vec4(intensity),vec4(mixAmount));
vec3 l9_59;
...
#endif
vec3 l9_60=max(l9_58.xyz,vec3(0.0));
vec4 l9_61;
#if (sc_ProjectiveShadowsCaster)
{
l9_61=vec4(l9_60,Port_Opacity_N006);
}
#else
{
float l9_62=clamp(metallic,0.0,1.0);
float l9_63=clamp(roughness,0.0,1.0);
vec3 l9_64=ssSRGB_to_Linear(l9_60);
vec3 l9_65=normalize(l9_59);
vec3 l9_66=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_67;
#if (sc_SSAOEnabled)
{
l9_67=evaluateSSAO(varPos);
}
#else
{
l9_67=Port_AO_N006;
...
#endif
vec3 l9_68=vec3(l9_62);
vec3 l9_69=mix(vec3(0.039999999),l9_64*l9_62,l9_68);
vec3 l9_70=mix(l9_64*(1.0-l9_62),vec3(0.0),l9_68);
SurfaceProperties l9_71=SurfaceProperties(l9_70,Port_Opacity_N006,l9_65,varPos,l9_1,l9_62,l9_63,l9_66,l9_67,Port_SpecularAO_N006,vec3(1.0),l9_69);
vec4 l9_72=vec4(1.0);
vec3 l9_73;
vec3 l9_74;
vec3 l9_75;
...
l9_81=vec3(0.0);
l9_80=vec3(0.0);
LightingComponents l9_87;
LightProperties l9_88;
SurfaceProperties l9_89;
vec3 l9_90;
int l9_91=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_91<sc_DirectionalLightsCount)
{
LightingComponents l9_92=accumulateLight(LightingComponents(l9_80,l9_81,l9_86,l9_85,l9_83,l9_82),LightProperties(sc_DirectionalLights[l9_91].direction,sc_DirectionalLights[l9_91].color.xyz,sc_DirectionalLights[l9_91].color.w*l9_72[(l9_84<3) ? l9_84 : 3]),l9_71,l9_1);
l9_86=l9_92.indirectDiffuse;
l9_85=l9_92.indirectSpecular;
l9_84++;
l9_83=l9_92.emitted;
l9_82=l9_92.transmitted;
l9_81=l9_92.directSpecular;
l9_80=l9_92.directDiffuse;
l9_91++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_109<sc_PointLightsCount)
{
vec3 l9_111=sc_PointLights[l9_109].position-varPos;
vec3 l9_112=normalize(l9_111);
float l9_113=l9_72[(l9_110<3) ? l9_110 : 3];
float l9_114=clamp((dot(l9_112,sc_PointLights[l9_109].direction)*sc_PointLights[l9_109].angleScale)+sc_PointLights[l9_109].angleOffset,0.0,1.0);
float l9_115=(sc_PointLights[l9_109].color.w*l9_113)*(l9_114*l9_114);
float l9_116;
if (sc_PointLights[l9_109].falloffEnabled)
{
l9_116=l9_115*computeDistanceAttenuation(length(l9_111),sc_PointLights[l9_109].falloffEndDistance);
}
else
{
l9_116=l9_115;
...
l9_102=l9_110+1;
LightingComponents l9_117=accumulateLight(LightingComponents(l9_96,l9_97,l9_101,l9_100,l9_99,l9_98),LightProperties(l9_112,sc_PointLights[l9_109].color.xyz,l9_116),l9_71,l9_1);
l9_103=l9_117.directDiffuse;
l9_104=l9_117.directSpecular;
l9_105=l9_117.indirectDiffuse;
l9_106=l9_117.indirectSpecular;
l9_107=l9_117.emitted;
l9_108=l9_117.transmitted;
l9_101=l9_105;
l9_100=l9_106;
l9_110=l9_102;
l9_99=l9_107;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_121=abs(varShadowTex-vec2(0.5));
vec4 l9_122=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_121.x,l9_121.y),0.5);
l9_120=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_122.xyz,vec3(sc_ShadowColor.w)),vec3(l9_122.w*sc_ShadowDensity));
}
#else
{
l9_120=vec3(1.0);
...
{
vec2 l9_124=calcPanoramicTexCoordsFromDir(l9_65,sc_EnvmapRotation.y);
vec4 l9_125;
...
#endif
l9_127=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_128,sc_EnvmapDiffuseLayout,l9_129).xy,-13.0);
}
#else
{
...
#endif
l9_123=(l9_125.xyz*(1.0/l9_125.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_130;
...
{
l9_136=l9_123+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_137=l9_123;
l9_137.x=l9_123.x+(1e-06*sc_AmbientLights[0].color.x);
l9_136=l9_137;
}
#endif
l9_135=l9_136;
...
{
float l9_148=dot(sc_LightEstimationData.sg[l9_147].axis,l9_65);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_159=clamp(pow(l9_63,0.66666669),0.0,1.0)*5.0;
vec2 l9_160=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_65,reflect(-l9_1,l9_65),l9_63),sc_EnvmapRotation.y);
vec4 l9_161;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_162=floor(l9_159);
float l9_163=ceil(l9_159);
l9_161=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_160,sc_EnvmapSpecularSize.xy,l9_162),sc_EnvmapSpecularGetStereoViewIndex(),l9_162),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_160,sc_EnvmapSpecularSize.xy,l9_163),sc_EnvmapSpecularGetStereoViewIndex(),l9_163),vec4(l9_159-l9_162));
}
#else
{
l9_161=sc_EnvmapSpecularSampleViewIndexLevel(l9_160,sc_EnvmapSpecularGetStereoViewIndex(),l9_159);
}
#endif
l9_158=vec3(0.0)+((((l9_161.xyz*(1.0/l9_161.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_71,abs(dot(l9_65,l9_1))));
}
#else
{
l9_158=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_165=clamp(l9_63*l9_63,0.0099999998,1.0);
vec3 l9_166;
l9_166=sc_LightEstimationData.ambientLight*l9_69;
int l9_167=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_167<sc_LightEstimationSGCount)
{
float l9_168=l9_165*l9_165;
vec3 l9_169=reflect(-l9_1,l9_65);
float l9_170=dot(l9_65,l9_1);
float l9_171=(2.0/l9_168)/(4.0*max(l9_170,9.9999997e-05));
float l9_172=length((l9_169*l9_171)+(sc_LightEstimationData.sg[l9_167].axis*sc_LightEstimationData.sg[l9_167].sharpness));
float l9_173=clamp(dot(l9_65,l9_169),0.0,1.0);
float l9_174=clamp(l9_170,0.0,1.0);
float l9_175=1.0-l9_168;
l9_166+=((((((((vec3(1.0/(3.1415927*l9_168))*exp((l9_172-l9_171)-sc_LightEstimationData.sg[l9_167].sharpness))*sc_LightEstimationData.sg[l9_167].color)*6.2831855)*(1.0-exp((-2.0)*l9_172)))/vec3(l9_172))*((1.0/(l9_173+sqrt(l9_168+((l9_175*l9_173)*l9_173))))*(1.0/(l9_174+sqrt(l9_168+((l9_175*l9_174)*l9_174))))))*(l9_69+((vec3(1.0)-l9_69)*pow(1.0-clamp(dot(l9_169,normalize(l9_169+l9_1)),0.0,1.0),5.0))))*l9_173);
l9_167++;
continue;
}
else
...
l9_179=vec3(0.0);
l9_178=vec3(0.0);
l9_177=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_70,vec3(Port_Opacity_N006));
l9_176=1.0;
}
#else
{
...
#endif
vec3 l9_181=l9_178*l9_67;
vec3 l9_182=l9_179+l9_181;
vec3 l9_183=l9_70*l9_182;
vec3 l9_184=l9_164*Port_SpecularAO_N006;
vec3 l9_185=l9_118+l9_184;
vec3 l9_186;
if (l9_180)
{
l9_186=l9_183*srgbToLinear(l9_176);
}
else
{
l9_186=l9_183;
}
vec3 l9_187=l9_186+l9_185;
vec3 l9_188=(l9_187+l9_66)+l9_177;
float l9_189=l9_188.x;
vec4 l9_190=vec4(l9_189,l9_188.yz,l9_176);
vec4 l9_191;
#if (sc_IsEditor)
{
vec4 l9_192=l9_190;
l9_192.x=l9_189+((l9_67.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_191=l9_192;
}
#else
{
...
{
vec3 l9_194=l9_191.xyz*1.8;
vec3 l9_195=(l9_191.xyz*(l9_194+vec3(1.4)))/((l9_191.xyz*(l9_194+vec3(0.5)))+vec3(1.5));
l9_193=vec4(l9_195.x,l9_195.y,l9_195.z,l9_191.w);
}
#else
{
l9_193=l9_191;
...
#endif
vec3 l9_196=vec3(linearToSrgb(l9_193.x),linearToSrgb(l9_193.y),linearToSrgb(l9_193.z));
l9_61=vec4(l9_196.x,l9_196.y,l9_196.z,l9_193.w);
}
#endif
vec4 l9_197=max(l9_61,vec4(0.0));
vec4 l9_198;
#if (Tweak_N38)
{
int l9_199;
...
{
l9_199=1-sc_GetStereoViewIndex();
}
#else
{
l9_199=sc_GetStereoViewIndex();
}
#endif
float l9_200=varPackedTex.x;
sc_SoftwareWrapEarly(l9_200,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_201=l9_200;
float l9_202=varPackedTex.y;
sc_SoftwareWrapEarly(l9_202,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_203=l9_202;
vec2 l9_204;
float l9_205;
...
{
l9_206=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_206=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_207=l9_201;
float l9_208=1.0;
sc_ClampUV(l9_207,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_206,l9_208);
float l9_209=l9_207;
float l9_210=l9_208;
bool l9_211;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_211=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_211=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_212=l9_203;
float l9_213=l9_210;
sc_ClampUV(l9_212,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_211,l9_213);
l9_205=l9_213;
...
#endif
vec2 l9_214=sc_TransformUV(l9_204,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_215=l9_214.x;
float l9_216=l9_205;
sc_SoftwareWrapLate(l9_215,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_216);
float l9_217=l9_214.y;
float l9_218=l9_216;
sc_SoftwareWrapLate(l9_217,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_218);
float l9_219=l9_218;
vec3 l9_220=sc_SamplingCoordsViewToGlobal(vec2(l9_215,l9_217),opacityTextureLayout,l9_199);
vec4 l9_221=texture2D(opacityTexture,l9_220.xy,0.0);
vec4 l9_222;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_222=mix(opacityTextureBorderColor,l9_221,vec4(l9_219));
}
#else
{
l9_222=l9_221;
...
#else
{
l9_198=vec4(Port_Input2_N040);
}
#endif
float l9_223=clamp((l9_58.w*l9_198.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_224=vec4(l9_197.x,l9_197.y,l9_197.z,vec4(0.0).w);
l9_224.w=l9_223;
vec4 l9_225;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_227=clamp(l9_223*2.0,0.0,1.0);
}
#else
{
float l9_228;
...
{
l9_228=clamp(dot(l9_224.xyz,vec3(l9_223)),0.0,1.0);
}
#else
{
float l9_229;
...
#if (sc_BlendMode_Multiply)
{
l9_230=(1.0-dot(l9_224.xyz,vec3(0.33333001)))*l9_223;
}
#else
{
float l9_231;
...
{
l9_231=(1.0-clamp(dot(l9_224.xyz,vec3(1.0)),0.0,1.0))*l9_223;
}
#else
{
float l9_232;
#if (sc_BlendMode_ColoredGlass)
{
l9_232=clamp(dot(l9_224.xyz,vec3(1.0)),0.0,1.0)*l9_223;
}
#else
{
float l9_233;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_234=clamp(dot(l9_224.xyz,vec3(1.0)),0.0,1.0)*l9_223;
}
#else
{
float l9_235;
...
{
l9_235=dot(l9_224.xyz,vec3(0.33333001))*l9_223;
}
#else
{
float l9_236;
...
vec3 l9_241=mix(l9_240,definedBlend(l9_240,l9_224.xyz).xyz,vec3(l9_223));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_243=vec4(mix(vec3(1.0),l9_224.xyz,vec3(l9_223)),l9_223);
}
#else
{
vec4 l9_244;
...
#endif
l9_244=vec4(l9_224.xyz*l9_245,l9_245);
}
#else
{
l9_244=l9_224;
...
{
l9_248=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_248=vec4(0.0);
...
vec4 l9_250=outputMotionVectorsIfNeeded(varPos,max(l9_249,vec4(0.0)));
vec4 l9_251=clamp(l9_250,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_252=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_252-0.0039215689)),min(1.0,l9_252+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_254=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_253).xy);
float l9_255=packValue(l9_254);
int l9_262=int(l9_251.w*255.0);
float l9_263=packValue(l9_262);
sc_writeFragData0(vec4(packValue(l9_254),packValue(l9_254),packValue(l9_254),packValue(l9_254)));
sc_writeFragData1(vec4(l9_255,packValue(l9_254),packValue(l9_254),packValue(l9_254)));
sc_writeFragData2(vec4(l9_263,packValue(l9_262),packValue(l9_262),packValue(l9_262)));
...
if (l9_271==0)
{
l9_274=texture2D(sc_OITAlpha0,l9_266);
l9_273=texture2D(sc_OITDepthLow0,l9_266);
l9_272=texture2D(sc_OITDepthHigh0,l9_266);
}
else
{
l9_274=vec4(0.0);
...
if (l9_271==1)
{
l9_277=texture2D(sc_OITAlpha1,l9_266);
l9_276=texture2D(sc_OITDepthLow1,l9_266);
l9_275=texture2D(sc_OITDepthHigh1,l9_266);
}
else
{
l9_277=l9_274;
...
if (any(notEqual(l9_275,vec4(0.0)))||any(notEqual(l9_276,vec4(0.0))))
{
int l9_278[8]=l9_267;
unpackValues(l9_275.w,l9_271,l9_278);
unpackValues(l9_275.z,l9_271,l9_278);
unpackValues(l9_275.y,l9_271,l9_278);
unpackValues(l9_275.x,l9_271,l9_278);
unpackValues(l9_276.w,l9_271,l9_278);
unpackValues(l9_276.z,l9_271,l9_278);
unpackValues(l9_276.y,l9_271,l9_278);
unpackValues(l9_276.x,l9_271,l9_278);
int l9_287[8]=l9_268;
unpackValues(l9_277.w,l9_271,l9_287);
unpackValues(l9_277.z,l9_271,l9_287);
unpackValues(l9_277.y,l9_271,l9_287);
unpackValues(l9_277.x,l9_271,l9_287);
}
l9_271++;
continue;
}
...
vec4 l9_292=texture2D(sc_OITFilteredDepthBoundsTexture,l9_266);
vec2 l9_293=l9_292.xy;
int l9_294;
#if (sc_SkinBonesCount>0)
{
l9_294=encodeDepth(((1.0-l9_292.x)*1000.0)+getDepthOrderingEpsilon(),l9_293);
}
#else
{
l9_294=0;
...
#endif
int l9_295=encodeDepth(viewSpaceDepth(),l9_293);
vec4 l9_296;
l9_296=l9_251*l9_251.w;
vec4 l9_297;
int l9_298=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_298<8)
{
int l9_299=l9_267[l9_298];
int l9_300=l9_295-l9_294;
bool l9_301=l9_299<l9_300;
bool l9_302;
if (l9_301)
{
l9_302=l9_267[l9_298]>0;
}
else
{
l9_302=l9_301;
...
if (l9_302)
{
vec3 l9_303=l9_296.xyz*(1.0-(float(l9_268[l9_298])/255.0));
l9_297=vec4(l9_303.x,l9_303.y,l9_303.z,l9_296.w);
}
else
{
l9_297=l9_296;
