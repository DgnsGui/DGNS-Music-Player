...
uniform float Port_Value_N017;
uniform float Port_Value_N009;
uniform vec2 Port_resolution_N005;
uniform vec3 Port_Scale_N003;
uniform vec3 Port_Offset_N003;
uniform float Port_Sharpness_N003;
uniform vec3 Port_Position_N003;
uniform vec3 Port_Normal_N003;
uniform vec2 Port_Scale_N002;
uniform vec2 Port_Center_N002;
uniform vec4 Port_touchPosition_N015;
uniform vec2 Port_resolution_N015;
uniform vec3 Port_Scale_N014;
uniform vec3 Port_Offset_N014;
uniform float Port_Sharpness_N014;
uniform vec3 Port_Position_N014;
...
in vec4 varColor;
vec2 N15_resolution;
vec3 N15_getResolution()
{
if (N15_resolution.x==0.0)
{
return vec3(640.0,640.0,1.0);
}
return vec3(N15_resolution,1.0);
}
vec2 N15_p6mmmap(vec2 uv,float repeats)
{
uv.x/=1.7320508;
...
vec3 l9_2=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
float l9_3=l9_1.y;
vec3 l9_4=normalize((sc_ModelMatrixInverse*vec4(l9_1.x,l9_3,l9_1.z,0.0)).xyz);
vec4 l9_5;
if ((float(float(l9_3>((Port_Value_N017+0.001)-0.001))==float(l9_3>((Port_Value_N009+0.001)-0.001)))*1.0)!=0.0)
{
vec3 l9_6=(l9_2+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_7=pow(abs(l9_4),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_8=l9_7.x;
float l9_9=l9_7.y;
float l9_10=l9_7.z;
float l9_11=l9_0*0.5;
vec2 l9_12=mod((((((((l9_6.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_8)+((((l9_6.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_9))+((((l9_6.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_10))/vec2((l9_8+l9_9)+l9_10))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_13;
vec2 l9_14;
l9_14=l9_12;
l9_13=1.0;
...
{
int l9_16=l9_15+1;
float l9_17=(l9_11+23.0)*(1.0-(3.5/float(l9_16)));
vec2 l9_18=l9_12+vec2(cos(l9_17-l9_14.x)+sin(l9_17+l9_14.y),sin(l9_17-l9_14.y)+cos(l9_17+l9_14.x));
l9_14=l9_18;
l9_13+=(1.0/length(vec2(l9_12.x/(sin(l9_18.x+l9_17)/0.0049999999),l9_12.y/(cos(l9_18.y+l9_17)/0.0049999999))));
l9_15=l9_16;
continue;
}
else
...
l9_5=vec4(clamp(vec3(ssPow(abs(1.17-ssPow(l9_13/5.0,1.4)),8.0))+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
}
else
{
vec3 l9_19=(l9_2+Port_Offset_N014)*Port_Scale_N014;
vec2 l9_20=vec2(Tweak_N1);
vec3 l9_21=pow(abs(l9_4),vec3(1.0/(1.0-(Port_Sharpness_N014*0.99000001))));
float l9_22=l9_21.x;
float l9_23=l9_21.y;
float l9_24=l9_21.z;
N15_resolution=Port_resolution_N015;
vec2 l9_25=(((((((l9_19.yz-Port_Center_N013)*l9_20)+Port_Center_N013)*l9_22)+((((l9_19.zx-Port_Center_N013)*l9_20)+Port_Center_N013)*l9_23))+((((l9_19.xy-Port_Center_N013)*l9_20)+Port_Center_N013)*l9_24))/vec2((l9_22+l9_23)+l9_24))-vec2(0.5);
vec2 l9_26=l9_25;
l9_26.x=l9_25.x*(N15_getResolution().x/N15_getResolution().y);
vec2 l9_27=N15_p6mmmap(l9_26*(N15_getResolution().x/2000.0),2.0);
vec3 l9_28=N15_getResolution();
vec3 l9_29=N15_getResolution();
vec3 l9_30=N15_getResolution();
float l9_31=((floor((Port_touchPosition_N015*vec4(l9_28.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_29.x)/10.0)*floor((Port_touchPosition_N015*vec4(0.0,l9_30.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_32;
if (l9_31>(-100000.0))
{
l9_32=l9_31;
...
float l9_33=radians(l9_32*12.7);
float l9_34=cos(l9_33);
float l9_35=sin(l9_33);
vec2 l9_36=((mat2(vec2(l9_34,-l9_35),vec2(l9_35,l9_34))*((l9_27*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_32*0.059999999);
float l9_37=l9_32*0.2;
float l9_38=N15_noise((N15_pyramids(l9_36+vec2(135.0))*31.0)+l9_37);
float l9_39=N15_noise((N15_pyramids(l9_36+vec2(25.0))*63.0)+l9_37);
float l9_40=clamp((((N15_noise((N15_pyramids(l9_36)*15.0)+l9_37)*l9_38)*l9_39)-0.090000004)*41.0,0.0,1.0);
float l9_41=clamp(clamp(l9_38,0.0,1.0)-0.2,0.0,1.0);
l9_5=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_39,0.0,1.0)-0.2,0.0,1.0),l9_41,l9_40).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_41))*l9_40,1.0);
}
...
{
l9_44=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_5.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_50;
#if (sc_BlendMode_Add)
{
l9_50=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_5.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_53;
#if (sc_BlendMode_Min)
{
l9_53=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_54;
#if (sc_BlendMode_Max)
{
l9_54=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_54=1.0;
...
#endif
l9_42=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_43);
}
#else
{
vec4 l9_55;
...
#endif
vec3 l9_66=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_5.xyz).xyz,vec3(l9_5.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_69;
...
#endif
l9_69=vec4(l9_5.xyz*l9_70,l9_70);
}
#else
{
l9_69=l9_5;
