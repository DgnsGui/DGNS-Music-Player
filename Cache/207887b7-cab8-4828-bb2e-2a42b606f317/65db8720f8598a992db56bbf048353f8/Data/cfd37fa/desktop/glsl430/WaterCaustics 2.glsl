...
#endif
vec3 l9_65=mix(l9_63.xyz,definedBlend(l9_63.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_67=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_68;
...
#endif
l9_68=vec4(l9_4.xyz*l9_69,l9_69);
}
#else
{
l9_68=l9_4;
