...
import { MusicPlayerManager } from 'Assets/MusicPlayerManager'; // Assurez-vous que ce chemin correspond à l'emplacement de MusicPlayerManager.ts
...
export class WorldEffectsManager extends BaseScriptComponent {
    ...
    onAwake(): void {
        ...
        if (!this.musicPlayerManager) {
            print("Error: MusicPlayerManager not set in Inspector for WorldEffectsManager");
            return;
        }
