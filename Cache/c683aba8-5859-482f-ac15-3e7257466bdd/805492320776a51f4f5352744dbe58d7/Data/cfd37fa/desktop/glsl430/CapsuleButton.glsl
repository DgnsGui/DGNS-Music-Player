...
//sampler sampler additional_setting_btn_icon_texSmpSC 0:22
...
//texture texture2D additional_setting_btn_icon_tex 0:3:0:22
...
//texture texture2DArray additional_setting_btn_icon_texArrSC 0:34:0:22
//texture texture2DArray additional_settings_btn_refl_texArrSC 0:35:0:23
...
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_38);
float l9_39=l9_38;
...
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_61);
float l9_62=l9_61;
...
#endif
vec4 l9_66=vec4(Port_Import_N006)*l9_19;
vec3 l9_67=l9_13*Port_Import_N068;
float l9_68=dot(l9_67,l9_67);
float l9_69;
if (l9_68>0.0)
{
l9_69=1.0/sqrt(l9_68);
}
else
{
l9_69=0.0;
}
vec3 l9_70=l9_67*l9_69;
vec3 l9_71=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_70,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
vec4 l9_72;
#if (additional_settings_btn_refl_texLayout==2)
{
float l9_73=l9_71.x;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_74=l9_73;
float l9_75=l9_71.y;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_80=l9_74;
float l9_81=1.0;
sc_ClampUV(l9_80,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
l9_77=vec2(l9_82,l9_85);
}
#else
...
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_94=texture(additional_settings_btn_refl_texArrSC,l9_93,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_95=mix(additional_settings_btn_refl_texBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
{
float l9_96=l9_71.x;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_97=l9_96;
float l9_98=l9_71.y;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_99=l9_98;
vec2 l9_100;
float l9_101;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_103=l9_97;
float l9_104=1.0;
sc_ClampUV(l9_103,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_102,l9_104);
float l9_105=l9_103;
float l9_106=l9_104;
bool l9_107;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
...
float l9_108=l9_99;
float l9_109=l9_106;
sc_ClampUV(l9_108,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_107,l9_109);
l9_101=l9_109;
...
#endif
vec2 l9_110=sc_TransformUV(l9_100,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_111=l9_110.x;
float l9_112=l9_101;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_112);
float l9_113=l9_110.y;
float l9_114=l9_112;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_114);
float l9_115=l9_114;
vec3 l9_116=sc_SamplingCoordsViewToGlobal(vec2(l9_111,l9_113),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_117=texture(additional_settings_btn_refl_tex,l9_116.xy,0.0);
vec4 l9_118;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_118=mix(additional_settings_btn_refl_texBorderColor,l9_117,vec4(l9_115));
}
#else
{
l9_118=l9_117;
...
#endif
vec4 l9_119=vec4(Port_Import_N062)*l9_72;
vec2 l9_120=l9_4*Port_Input1_N009;
float l9_121=clamp(length(l9_120+Port_Input2_N009),0.0,1.0);
vec4 l9_122;
if (l9_121<Port_Position1_N007)
{
l9_122=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_121/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_123;
if (l9_121<Port_Position2_N007)
{
l9_123=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_121-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
l9_123=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_121-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_122=l9_123;
}
...
vec3 l9_129=-l9_6;
vec4 l9_130=mix(l9_122,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_129,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_131=clamp(status,0.0,1.0);
vec4 l9_132;
if (l9_131<Port_Position1_N021)
{
l9_132=mix(l9_122,l9_130,vec4(clamp(l9_131/Port_Position1_N021,0.0,1.0)));
}
else
{
vec4 l9_133;
if (l9_131<Port_Position2_N021)
{
l9_133=mix(l9_130,l9_122,vec4(clamp((l9_131-Port_Position1_N021)/(Port_Position2_N021-Port_Position1_N021),0.0,1.0)));
}
else
{
l9_133=mix(l9_122,l9_130,vec4(clamp((l9_131-Port_Position2_N021)/(1.0-Port_Position2_N021),0.0,1.0)));
}
l9_132=l9_133;
}
bool l9_134;
...
vec4 l9_138=mix(l9_66,l9_119,vec4(status))+l9_132;
...
sc_SoftwareWrapEarly(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x);
float l9_143=l9_142;
float l9_144=l9_140.y;
sc_SoftwareWrapEarly(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y);
float l9_145=l9_144;
vec2 l9_146;
float l9_147;
...
{
l9_148=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x==3;
}
#else
{
l9_148=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_149=l9_143;
float l9_150=1.0;
sc_ClampUV(l9_149,additional_setting_btn_icon_texUvMinMax.x,additional_setting_btn_icon_texUvMinMax.z,l9_148,l9_150);
float l9_151=l9_149;
float l9_152=l9_150;
bool l9_153;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_153=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y==3;
}
#else
{
l9_153=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_154=l9_145;
float l9_155=l9_152;
sc_ClampUV(l9_154,additional_setting_btn_icon_texUvMinMax.y,additional_setting_btn_icon_texUvMinMax.w,l9_153,l9_155);
l9_147=l9_155;
...
#endif
vec2 l9_156=sc_TransformUV(l9_146,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform);
float l9_157=l9_156.x;
float l9_158=l9_147;
sc_SoftwareWrapLate(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_158);
float l9_159=l9_156.y;
float l9_160=l9_158;
sc_SoftwareWrapLate(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_160);
float l9_161=l9_160;
vec3 l9_162=sc_SamplingCoordsViewToGlobal(vec2(l9_157,l9_159),additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex());
vec4 l9_163=texture(additional_setting_btn_icon_texArrSC,l9_162,0.0);
vec4 l9_164;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_164=mix(additional_setting_btn_icon_texBorderColor,l9_163,vec4(l9_161));
}
#else
{
l9_164=l9_163;
...
#else
{
float l9_165=l9_140.x;
sc_SoftwareWrapEarly(l9_165,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x);
float l9_166=l9_165;
float l9_167=l9_140.y;
sc_SoftwareWrapEarly(l9_167,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y);
float l9_168=l9_167;
vec2 l9_169;
float l9_170;
#if (SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_171=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x==3;
}
#else
{
l9_171=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_172=l9_166;
float l9_173=1.0;
sc_ClampUV(l9_172,additional_setting_btn_icon_texUvMinMax.x,additional_setting_btn_icon_texUvMinMax.z,l9_171,l9_173);
float l9_174=l9_172;
float l9_175=l9_173;
bool l9_176;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_176=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y==3;
}
#else
{
l9_176=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_177=l9_168;
float l9_178=l9_175;
sc_ClampUV(l9_177,additional_setting_btn_icon_texUvMinMax.y,additional_setting_btn_icon_texUvMinMax.w,l9_176,l9_178);
l9_170=l9_178;
...
#endif
vec2 l9_179=sc_TransformUV(l9_169,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform);
float l9_180=l9_179.x;
float l9_181=l9_170;
sc_SoftwareWrapLate(l9_180,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_181);
float l9_182=l9_179.y;
float l9_183=l9_181;
sc_SoftwareWrapLate(l9_182,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_183);
float l9_184=l9_183;
vec3 l9_185=sc_SamplingCoordsViewToGlobal(vec2(l9_180,l9_182),additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex());
vec4 l9_186=texture(additional_setting_btn_icon_tex,l9_185.xy,0.0);
vec4 l9_187;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_187=mix(additional_setting_btn_icon_texBorderColor,l9_186,vec4(l9_184));
}
#else
{
l9_187=l9_186;
...
#if (additional_setting_btn_icon_texLayout==2)
{
float l9_189=l9_140.x;
sc_SoftwareWrapEarly(l9_189,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x);
float l9_190=l9_189;
float l9_191=l9_140.y;
sc_SoftwareWrapEarly(l9_191,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y);
float l9_192=l9_191;
vec2 l9_193;
float l9_194;
#if (SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_195=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x==3;
}
#else
{
l9_195=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_196=l9_190;
float l9_197=1.0;
sc_ClampUV(l9_196,additional_setting_btn_icon_texUvMinMax.x,additional_setting_btn_icon_texUvMinMax.z,l9_195,l9_197);
float l9_198=l9_196;
float l9_199=l9_197;
bool l9_200;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_200=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y==3;
}
#else
{
l9_200=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_201=l9_192;
float l9_202=l9_199;
sc_ClampUV(l9_201,additional_setting_btn_icon_texUvMinMax.y,additional_setting_btn_icon_texUvMinMax.w,l9_200,l9_202);
l9_194=l9_202;
...
#endif
vec2 l9_203=sc_TransformUV(l9_193,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform);
float l9_204=l9_203.x;
float l9_205=l9_194;
sc_SoftwareWrapLate(l9_204,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_205);
float l9_206=l9_203.y;
float l9_207=l9_205;
sc_SoftwareWrapLate(l9_206,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_207);
float l9_208=l9_207;
vec3 l9_209=sc_SamplingCoordsViewToGlobal(vec2(l9_204,l9_206),additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex());
vec4 l9_210=texture(additional_setting_btn_icon_texArrSC,l9_209,0.0);
vec4 l9_211;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_211=mix(additional_setting_btn_icon_texBorderColor,l9_210,vec4(l9_208));
}
#else
{
l9_211=l9_210;
...
#else
{
float l9_212=l9_140.x;
sc_SoftwareWrapEarly(l9_212,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x);
float l9_213=l9_212;
float l9_214=l9_140.y;
sc_SoftwareWrapEarly(l9_214,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y);
float l9_215=l9_214;
vec2 l9_216;
float l9_217;
#if (SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_218=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x==3;
}
#else
{
l9_218=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_219=l9_213;
float l9_220=1.0;
sc_ClampUV(l9_219,additional_setting_btn_icon_texUvMinMax.x,additional_setting_btn_icon_texUvMinMax.z,l9_218,l9_220);
float l9_221=l9_219;
float l9_222=l9_220;
bool l9_223;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_223=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y==3;
}
#else
{
l9_223=(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0);
}
#endif
float l9_224=l9_215;
float l9_225=l9_222;
sc_ClampUV(l9_224,additional_setting_btn_icon_texUvMinMax.y,additional_setting_btn_icon_texUvMinMax.w,l9_223,l9_225);
l9_217=l9_225;
...
#endif
vec2 l9_226=sc_TransformUV(l9_216,(int(SC_USE_UV_TRANSFORM_additional_setting_btn_icon_tex)!=0),additional_setting_btn_icon_texTransform);
float l9_227=l9_226.x;
float l9_228=l9_217;
sc_SoftwareWrapLate(l9_227,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_228);
float l9_229=l9_226.y;
float l9_230=l9_228;
sc_SoftwareWrapLate(l9_229,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_setting_btn_icon_tex,SC_SOFTWARE_WRAP_MODE_V_additional_setting_btn_icon_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_setting_btn_icon_tex)!=0)),l9_230);
float l9_231=l9_230;
vec3 l9_232=sc_SamplingCoordsViewToGlobal(vec2(l9_227,l9_229),additional_setting_btn_icon_texLayout,additional_setting_btn_icon_texGetStereoViewIndex());
vec4 l9_233=texture(additional_setting_btn_icon_tex,l9_232.xy,0.0);
vec4 l9_234;
#if (SC_USE_CLAMP_TO_BORDER_additional_setting_btn_icon_tex)
{
l9_234=mix(additional_setting_btn_icon_texBorderColor,l9_233,vec4(l9_231));
}
#else
{
l9_234=l9_233;
...
#endif
vec4 l9_235;
if (l9_131<Port_Position1_N136)
{
l9_235=mix(l9_141,l9_141,vec4(clamp(l9_131/Port_Position1_N136,0.0,1.0)));
}
else
{
vec4 l9_236;
if (l9_131<Port_Position2_N136)
{
l9_236=mix(l9_141,l9_188,vec4(clamp((l9_131-Port_Position1_N136)/(Port_Position2_N136-Port_Position1_N136),0.0,1.0)));
}
else
{
l9_236=mix(l9_188,l9_188,vec4(clamp((l9_131-Port_Position2_N136)/(1.0-Port_Position2_N136),0.0,1.0)));
}
l9_235=l9_236;
}
bool l9_237;
...
vec4 l9_241=mix(l9_138,vec4(l9_235.xyz,0.0),vec4(l9_235.w));
...
#endif
sc_writeFragData0(max(l9_243,vec4(0.0)));
return;
}
vec4 l9_245;
...
{
l9_247=clamp(alpha*2.0,0.0,1.0);
}
#else
{
float l9_248;
...
{
l9_248=clamp(dot(l9_242.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_249;
...
{
l9_250=(1.0-dot(l9_242.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_251;
...
{
l9_251=(1.0-clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_252;
...
{
l9_252=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_253;
#if (sc_BlendMode_Add)
{
l9_253=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_254;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_254=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_255;
...
{
l9_255=dot(l9_242.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_256;
#if (sc_BlendMode_Min)
{
l9_256=1.0-clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_257;
#if (sc_BlendMode_Max)
{
l9_257=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_257=1.0;
...
#endif
l9_245=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_242.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_246);
}
#else
{
vec4 l9_258;
...
#endif
vec3 l9_269=mix(l9_267.xyz,definedBlend(l9_267.xyz,l9_242.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_271=vec4(mix(vec3(1.0),l9_242.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_272;
...
#endif
l9_272=vec4(l9_242.xyz*l9_273,l9_273);
}
#else
{
l9_272=l9_242;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_280-0.0039215689)),min(1.0,l9_280+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_282),packValue(l9_282),packValue(l9_282),packValue(l9_282)));
