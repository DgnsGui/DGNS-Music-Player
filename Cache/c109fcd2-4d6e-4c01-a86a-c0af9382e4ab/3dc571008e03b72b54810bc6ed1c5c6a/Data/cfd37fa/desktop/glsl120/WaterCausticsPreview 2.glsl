...
vec2 l9_1=varPackedTex.xy*3.0;
float l9_2=l9_0*0.25;
float l9_3=l9_1.x+l9_2;
vec2 l9_4=l9_1;
l9_4.x=l9_3;
vec4 l9_5=round(vec4(l9_3,l9_1.y,l9_4-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_6=l9_4-(l9_5.xy*vec2(1.0,1.7320508));
vec2 l9_7=l9_4-((l9_5.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_8=l9_6.x;
float l9_9=l9_7.x;
vec4 l9_10=vec4(l9_8,l9_6.y,l9_9,l9_7.y);
vec2 l9_11=l9_10.xy;
vec2 l9_12=l9_10.zw;
vec4 l9_13;
if (dot(l9_11,l9_11)<dot(l9_12,l9_12))
{
l9_13=vec4(l9_8,l9_6.y,l9_5.xy);
}
else
{
l9_13=vec4(l9_9,l9_7.y,l9_5.zw);
}
vec2 l9_14=abs(l9_13.xy);
float l9_15=max(dot(l9_14,vec2(0.5,0.86602539)),l9_14.x)+0.02;
float l9_16=fract(sin(dot(l9_13.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_17;
if (l9_13.y==0.0)
{
l9_17=0.0;
...
{
l9_17=atan(l9_13.y,l9_13.x);
}
float l9_18=l9_17+(l9_16*5.0);
float l9_19=l9_18+l9_0;
vec3 l9_20=N0_getResolution();
vec3 l9_21=N0_getResolution();
float l9_22=l9_0+(l9_16*8.0);
vec3 l9_23=N0_getResolution();
float l9_24=5.0/l9_23.y;
float l9_25=1.0-max(0.0,0.5-l9_15);
float l9_26;
if (l9_25<=0.0)
{
l9_26=0.0;
...
{
l9_26=pow(l9_25,20.0);
}
float l9_27=l9_26*1.5;
float l9_28=0.2+sin(l9_22);
vec3 l9_29=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_16))*(smoothstep(0.50999999,0.50999999-l9_24,l9_15)+l9_27))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_20.y,0.0,abs(l9_15-0.40000001)))*step(3.0+(l9_16*0.5),mod(l9_19,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_21.y,0.0,abs(l9_15-0.32499999)))*step(4.0+(l9_16*1.5),mod(l9_19+(l9_16*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_28,l9_28-l9_24,l9_15));
...
{
l9_34=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_30.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_39;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_30.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_30.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_42;
...
#endif
l9_46=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_50,sc_ScreenTextureLayout,l9_51).xy,0.0);
}
#endif
vec4 l9_52;
...
#endif
vec3 l9_54=definedBlend(l9_52.xyz,l9_30.xyz);
