...
vec2 l9_3=l9_1*3.0;
float l9_4=l9_0*0.25;
float l9_5=l9_3.x+l9_4;
vec2 l9_6=l9_3;
l9_6.x=l9_5;
vec4 l9_7=round(vec4(l9_5,l9_3.y,l9_6-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_8=l9_6-(l9_7.xy*vec2(1.0,1.7320508));
vec2 l9_9=l9_6-((l9_7.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_10=l9_8.x;
float l9_11=l9_9.x;
vec4 l9_12=vec4(l9_10,l9_8.y,l9_11,l9_9.y);
vec2 l9_13=l9_12.xy;
vec2 l9_14=l9_12.zw;
vec4 l9_15;
if (dot(l9_13,l9_13)<dot(l9_14,l9_14))
{
l9_15=vec4(l9_10,l9_8.y,l9_7.xy);
}
else
{
l9_15=vec4(l9_11,l9_9.y,l9_7.zw);
}
vec2 l9_16=abs(l9_15.xy);
float l9_17=max(dot(l9_16,vec2(0.5,0.86602539)),l9_16.x)+0.02;
float l9_18=fract(sin(dot(l9_15.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_19;
if (l9_15.y==0.0)
{
l9_19=0.0;
...
{
l9_19=atan(l9_15.y,l9_15.x);
}
float l9_20=l9_19+(l9_18*5.0);
float l9_21=l9_20+l9_0;
vec3 l9_22=N0_getResolution();
vec3 l9_23=N0_getResolution();
float l9_24=l9_0+(l9_18*8.0);
vec3 l9_25=N0_getResolution();
float l9_26=5.0/l9_25.y;
float l9_27=1.0-max(0.0,0.5-l9_17);
float l9_28;
if (l9_27<=0.0)
{
l9_28=0.0;
...
{
l9_28=pow(l9_27,20.0);
}
float l9_29=l9_28*1.5;
float l9_30=0.2+sin(l9_24);
vec3 l9_31=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_18))*(smoothstep(0.50999999,0.50999999-l9_26,l9_17)+l9_29))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_22.y,0.0,abs(l9_17-0.40000001)))*step(3.0+(l9_18*0.5),mod(l9_21,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_23.y,0.0,abs(l9_17-0.32499999)))*step(4.0+(l9_18*1.5),mod(l9_21+(l9_18*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_30,l9_30-l9_26,l9_17));
...
#endif
sc_writeFragData0(max(l9_33,vec4(0.0)));
return;
}
vec4 l9_35;
...
{
l9_38=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_40=(1.0-dot(l9_32.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_43;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_45;
...
{
l9_45=dot(l9_32.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_46;
...
#endif
vec3 l9_59=definedBlend(l9_57.xyz,l9_32.xyz);
