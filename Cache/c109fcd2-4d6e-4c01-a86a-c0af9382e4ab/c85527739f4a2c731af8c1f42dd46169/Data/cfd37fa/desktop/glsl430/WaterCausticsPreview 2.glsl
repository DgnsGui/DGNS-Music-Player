...
vec2 l9_4=l9_3;
l9_4.x=l9_3.x*(N0_getResolution().x/N0_getResolution().y);
...
float l9_9=((floor((Port_touchPosition_N000*vec4(l9_6.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_7.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_8.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_10;
if (l9_9>(-100000.0))
{
l9_10=l9_9;
...
float l9_11=radians(l9_10*12.7);
float l9_12=cos(l9_11);
float l9_13=sin(l9_11);
vec2 l9_14=((mat2(vec2(l9_12,-l9_13),vec2(l9_13,l9_12))*((l9_5*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_10*0.059999999);
float l9_15=l9_10*0.2;
float l9_16=N0_noise((N0_pyramids(l9_14)*15.0)+l9_15);
float l9_17=N0_noise((N0_pyramids(l9_14+vec2(135.0))*31.0)+l9_15);
float l9_18=N0_noise((N0_pyramids(l9_14+vec2(25.0))*63.0)+l9_15);
float l9_19=clamp((((l9_16*l9_17)*l9_18)-0.090000004)*41.0,0.0,1.0);
float l9_20=clamp(clamp(l9_17,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_21=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_18,0.0,1.0)-0.2,0.0,1.0),l9_20,l9_19).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_20))*l9_19,1.0);
...
{
l9_27=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_29=(1.0-dot(l9_21.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_30;
...
{
l9_30=(1.0-clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_32;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_33=clamp(dot(l9_21.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_34;
...
{
l9_34=dot(l9_21.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_35;
...
{
l9_45=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_43,sc_ScreenTextureLayout,l9_44),0.0);
}
#else
{
l9_45=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_43,sc_ScreenTextureLayout,l9_44).xy,0.0);
}
#endif
l9_39=l9_45;
}
...
{
vec4 l9_47=l9_39;
l9_47.x=l9_39.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_46=l9_47;
}
#else
{
...
#endif
vec3 l9_48=definedBlend(l9_46.xyz,l9_21.xyz);
