...
vec2 l9_10=l9_7;
l9_10.x=l9_9;
vec4 l9_11=round(vec4(l9_9,l9_7.y,l9_10-vec2(0.5,1.0))/vec4(1.0,8.7320509,1.0,8.7320509));
vec2 l9_12=l9_10-(l9_11.xy*vec2(1.0,8.7320509));
vec2 l9_13=l9_10-((l9_11.zw+vec2(0.5))*vec2(1.0,8.7320509));
float l9_14=l9_12.x;
float l9_15=l9_13.x;
...
float l9_21=max(dot(l9_20,vec2(0.5,4.3660254)),l9_20.x)+0.02;
