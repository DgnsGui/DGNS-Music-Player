...
float l9_36=l9_0*Tweak_N9;
vec3 l9_37=vec3(l9_36);
vec3 l9_38=((l9_37*l9_35.x)+(Port_Green_N006*l9_35.y))+(l9_37*l9_35.z);
...
{
l9_43=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_45=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_46;
...
{
l9_46=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_48;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_50;
...
{
l9_50=dot(l9_39.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_51;
...
#endif
vec3 l9_64=definedBlend(l9_62.xyz,l9_39.xyz);
