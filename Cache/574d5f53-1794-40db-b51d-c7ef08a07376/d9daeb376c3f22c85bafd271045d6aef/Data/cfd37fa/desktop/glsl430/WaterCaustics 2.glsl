...
vec2 l9_1=varPackedTex.xy-vec2(0.5);
float l9_2=l9_1.x;
vec2 l9_3=l9_1;
l9_3.x=l9_2*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_4=N0_p6mmmap(l9_3*(N0_getResolution().x/2000.0),2.0);
vec3 l9_5=N0_getResolution();
vec3 l9_6=N0_getResolution();
vec3 l9_7=N0_getResolution();
float l9_8=((floor((Port_touchPosition_N000*vec4(l9_5.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_6.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_7.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_9;
if (l9_8>(-100000.0))
{
l9_9=l9_8;
...
vec4 l9_10=N0_animate_noise(l9_4*0.64999998,l9_9);
N0_resolution=Port_resolution_N000;
vec2 l9_11=l9_1;
l9_11.x=l9_2*(N0_getResolution().x/N0_getResolution().y);
...
N0_resolution=Port_resolution_N000;
vec2 l9_19=l9_1;
l9_19.x=l9_2*(N0_getResolution().x/N0_getResolution().y);
...
vec3 l9_27=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_28=l9_27.x;
float l9_29=l9_27.y;
float l9_30=l9_27.z;
vec4 l9_31=(((l9_10*l9_28)+(l9_18*l9_29))+(l9_26*l9_30))/vec4((l9_28+l9_29)+l9_30);
float l9_32=l9_31.w;
...
{
l9_54=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_52,sc_ScreenTextureLayout,l9_53),0.0);
}
#else
{
l9_54=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_52,sc_ScreenTextureLayout,l9_53).xy,0.0);
}
#endif
l9_48=l9_54;
}
...
#endif
vec3 l9_57=mix(l9_55.xyz,definedBlend(l9_55.xyz,l9_31.xyz).xyz,vec3(l9_32));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_32)),l9_32);
}
#else
{
vec4 l9_60;
...
#endif
l9_60=vec4(l9_31.xyz*l9_61,l9_61);
}
#else
{
l9_60=l9_31;
