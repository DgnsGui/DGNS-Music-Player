...
float l9_36=l9_0*Port_Multiplier_N007;
vec3 l9_37=(((vec3(l9_36)*Port_Input1_N008)*l9_35.x)+(Port_Green_N006*l9_35.y))+(Port_Blue_N006*l9_35.z);
...
{
l9_42=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_44=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_45;
...
{
l9_45=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_47;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_49;
...
{
l9_49=dot(l9_38.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_50;
...
{
l9_60=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,l9_59),0.0);
}
#else
{
l9_60=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,l9_59).xy,0.0);
}
#endif
l9_54=l9_60;
}
...
#endif
vec3 l9_63=definedBlend(l9_61.xyz,l9_38.xyz);
