...
uniform vec2 Port_uv_input_N000;
...
vec3 l9_1=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_2=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_3=l9_2.x;
float l9_4=l9_2.y;
float l9_5=l9_2.z;
N0_resolution=((((((l9_1.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_3)+((((l9_1.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_4))+((((l9_1.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5))/vec2((l9_3+l9_4)+l9_5);
vec2 l9_6=varPackedTex.xy-vec2(0.5);
vec2 l9_7=l9_6;
