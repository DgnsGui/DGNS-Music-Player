...
vec2 l9_3=vec2(Tweak_N1);
Input=((Globals.gTriplanarCoords-Port_Center_N003)*l9_3)+Port_Center_N003;
vec2 l9_4=Input;
...
Input=((Globals.gTriplanarCoords-Port_Center_N003)*l9_3)+Port_Center_N003;
vec3 l9_6=pow(abs(l9_1),vec3(1.0/(1.0-(Sharpness*0.99000001))));
float l9_7=l9_6.x;
float l9_8=l9_6.y;
float l9_9=l9_6.z;
Output=(((l9_4*l9_7)+(l9_5*l9_8))+(Input*l9_9))/vec2((l9_7+l9_8)+l9_9);
}
vec4 N0_calcHexInfo(vec2 uv)
{
vec2 l9_0=uv;
vec4 l9_1=round(vec4(uv,l9_0-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_2=uv;
vec2 l9_3=l9_2-(l9_1.xy*vec2(1.0,1.7320508));
vec2 l9_4=uv;
vec2 l9_5=l9_4-((l9_1.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_6=l9_3.x;
float l9_7=l9_5.x;
vec4 l9_8=vec4(l9_6,l9_3.y,l9_7,l9_5.y);
vec2 l9_9=l9_8.xy;
vec2 l9_10=l9_8.zw;
vec4 l9_11;
if (dot(l9_9,l9_9)<dot(l9_10,l9_10))
{
l9_11=vec4(l9_6,l9_3.y,l9_1.xy);
}
else
{
l9_11=vec4(l9_7,l9_5.y,l9_1.zw);
}
return l9_11;
}
float ssATan(float A,float B)
{
float l9_0;
if (A==0.0)
{
...
ssGlobals l9_4=ssGlobals(l9_1,l9_2,0.0,(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz,l9_3,normalize((sc_ModelMatrixInverse*vec4(l9_3,0.0)).xyz),vec2(0.0));
vec2 param_6;
...
vec2 l9_5=param_6*3.0;
float l9_6=l9_1*0.25;
vec2 l9_7=l9_5;
l9_7.x=l9_5.x+l9_6;
vec4 l9_8=N0_calcHexInfo(l9_7);
vec2 l9_9=abs(l9_8.xy);
float l9_10=max(dot(l9_9,vec2(0.5,0.86602539)),l9_9.x)+0.02;
float l9_11=fract(sin(dot(l9_8.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_12=ssATan(l9_8.y,l9_8.x);
float l9_13=(l9_12+(l9_11*5.0))+l9_1;
vec3 l9_14=N0_getResolution();
vec3 l9_15=N0_getResolution();
float l9_16=l9_1+(l9_11*8.0);
vec3 l9_17=N0_getResolution();
float l9_18=5.0/l9_17.y;
float l9_19=ssPow(1.0-max(0.0,0.5-l9_10),20.0);
float l9_20=0.2+sin(l9_16);
float l9_21=dot(((((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_11))*(smoothstep(0.50999999,0.50999999-l9_18,l9_10)+(l9_19*1.5)))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_14.y,0.0,abs(l9_10-0.40000001)))*step(3.0+(l9_11*0.5),mod(l9_13,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_15.y,0.0,abs(l9_10-0.32499999)))*step(4.0+(l9_11*1.5),mod(l9_13+(l9_11*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_20,l9_20-l9_18,l9_10))).xyz,vec3(0.29899999,0.58700001,0.114));
vec4 l9_22=vec4(l9_21);
...
N0_resolution=Port_resolution_N000;
vec2 l9_23=param_14*3.0;
vec2 l9_24=l9_23;
l9_24.x=l9_23.x+l9_6;
vec4 l9_25=N0_calcHexInfo(l9_24);
vec2 l9_26=abs(l9_25.xy);
float l9_27=max(dot(l9_26,vec2(0.5,0.86602539)),l9_26.x)+0.02;
float l9_28=fract(sin(dot(l9_25.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_29=ssATan(l9_25.y,l9_25.x);
float l9_30=(l9_29+(l9_28*5.0))+l9_1;
vec3 l9_31=N0_getResolution();
vec3 l9_32=N0_getResolution();
float l9_33=l9_1+(l9_28*8.0);
vec3 l9_34=N0_getResolution();
float l9_35=5.0/l9_34.y;
float l9_36=ssPow(1.0-max(0.0,0.5-l9_27),20.0);
float l9_37=0.2+sin(l9_33);
vec4 l9_38;
...
{
l9_41=clamp(dot(l9_22.xyz,vec3(l9_21)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*l9_21;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*l9_21;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_46;
#if (sc_BlendMode_Add)
{
l9_46=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*l9_21;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_22.xyz,vec3(0.33333001))*l9_21;
}
#else
{
float l9_49;
#if (sc_BlendMode_Min)
{
l9_49=1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_Max)
{
l9_50=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_50=1.0;
...
#endif
l9_38=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_22.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_39);
}
#else
{
vec4 l9_51;
...
{
l9_59=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_57,sc_ScreenTextureLayout,l9_58),0.0);
}
#else
{
l9_59=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_57,sc_ScreenTextureLayout,l9_58).xy,0.0);
}
#endif
l9_53=l9_59;
}
...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_22.xyz).xyz,vec3(l9_21));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_22.xyz,vec3(l9_21)),l9_21);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_22.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_22;
...
gl_FragDepth=dot(((((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_28))*(smoothstep(0.50999999,0.50999999-l9_35,l9_27)+(l9_36*1.5)))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_31.y,0.0,abs(l9_27-0.40000001)))*step(3.0+(l9_28*0.5),mod(l9_30,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_32.y,0.0,abs(l9_27-0.32499999)))*step(4.0+(l9_28*1.5),mod(l9_30+(l9_28*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_37,l9_37-l9_35,l9_27))).xyz,vec3(0.29899999,0.58700001,0.114));
