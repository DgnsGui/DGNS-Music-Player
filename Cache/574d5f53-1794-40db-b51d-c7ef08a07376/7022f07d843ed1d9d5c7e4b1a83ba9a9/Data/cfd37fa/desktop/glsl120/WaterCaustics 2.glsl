...
#endif
vec3 l9_61=mix(l9_59.xyz,definedBlend(l9_59.xyz,l9_22.xyz).xyz,vec3(l9_21));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_63=vec4(mix(vec3(1.0),l9_22.xyz,vec3(l9_21)),l9_21);
}
#else
{
vec4 l9_64;
...
#endif
l9_64=vec4(l9_22.xyz*l9_65,l9_65);
}
#else
{
l9_64=l9_22;
