...
vec2 l9_6=(((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5))*3.0;
float l9_7=l9_0*0.25;
float l9_8=l9_6.x+l9_7;
vec2 l9_9=l9_6;
l9_9.x=l9_8;
vec4 l9_10=round(vec4(l9_8,l9_6.y,l9_9-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_11=l9_9-(l9_10.xy*vec2(1.0,1.7320508));
vec2 l9_12=l9_9-((l9_10.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_13=l9_11.x;
float l9_14=l9_12.x;
vec4 l9_15=vec4(l9_13,l9_11.y,l9_14,l9_12.y);
vec2 l9_16=l9_15.xy;
vec2 l9_17=l9_15.zw;
vec4 l9_18;
if (dot(l9_16,l9_16)<dot(l9_17,l9_17))
{
l9_18=vec4(l9_13,l9_11.y,l9_10.xy);
}
else
{
l9_18=vec4(l9_14,l9_12.y,l9_10.zw);
}
vec2 l9_19=abs(l9_18.xy);
float l9_20=max(dot(l9_19,vec2(0.5,0.86602539)),l9_19.x)+0.02;
float l9_21=fract(sin(dot(l9_18.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_22;
if (l9_18.y==0.0)
{
l9_22=0.0;
...
{
l9_22=atan(l9_18.y,l9_18.x);
}
float l9_23=l9_22+(l9_21*5.0);
float l9_24=l9_23+l9_0;
vec3 l9_25=N0_getResolution();
vec3 l9_26=N0_getResolution();
float l9_27=l9_0+(l9_21*8.0);
vec3 l9_28=N0_getResolution();
float l9_29=5.0/l9_28.y;
float l9_30=1.0-max(0.0,0.5-l9_20);
float l9_31;
if (l9_30<=0.0)
{
l9_31=0.0;
...
{
l9_31=pow(l9_30,20.0);
}
float l9_32=l9_31*1.5;
float l9_33=0.2+sin(l9_27);
vec3 l9_34=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_21))*(smoothstep(0.50999999,0.50999999-l9_29,l9_20)+l9_32))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_25.y,0.0,abs(l9_20-0.40000001)))*step(3.0+(l9_21*0.5),mod(l9_24,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_26.y,0.0,abs(l9_20-0.32499999)))*step(4.0+(l9_21*1.5),mod(l9_24+(l9_21*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_33,l9_33-l9_29,l9_20));
...
{
l9_39=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_41=(1.0-dot(l9_35.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_42;
...
{
l9_42=(1.0-clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_43;
...
{
l9_43=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_44;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_45=clamp(dot(l9_35.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_46;
...
{
l9_46=dot(l9_35.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_47;
...
{
l9_57=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_55,sc_ScreenTextureLayout,l9_56),0.0);
}
#else
{
l9_57=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_55,sc_ScreenTextureLayout,l9_56).xy,0.0);
}
#endif
l9_51=l9_57;
}
...
#endif
vec3 l9_60=definedBlend(l9_58.xyz,l9_35.xyz);
