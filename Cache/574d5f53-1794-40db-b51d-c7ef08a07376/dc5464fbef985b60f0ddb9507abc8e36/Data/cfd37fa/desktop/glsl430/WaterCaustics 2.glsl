...
vec3 l9_35=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_22))*(smoothstep(0.50999999,0.50999999-l9_30,l9_21)+l9_33))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_26.y,0.0,abs(l9_21-0.40000001)))*step(3.0+(l9_22*0.5),mod(l9_25,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_27.y,0.0,abs(l9_21-0.32499999)))*step(4.0+(l9_22*1.5),mod(l9_25+(l9_22*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_34,l9_34-l9_30,l9_21));
float l9_36=3.0*fract(l9_35.x+0.16666667);
float l9_37=2.0*fract(l9_36);
vec2 l9_38=l9_35.zz-((vec2(1.0,l9_37)-vec2(max(0.0,l9_37-1.0)))*(l9_35.z*clamp(l9_35.y,0.0,1.0)));
vec3 l9_39=vec3(l9_35.z,l9_38.x,l9_38.y);
vec3 l9_40;
if (l9_36>=1.0)
{
l9_40=l9_39.zxy;
...
{
l9_46=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_42.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_51;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_42.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_42.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_54;
...
#endif
vec3 l9_67=definedBlend(l9_65.xyz,l9_42.xyz);
