...
uniform vec4 Port_touchPosition_N005;
...
uniform vec2 Port_uv_input_N005;
...
in vec4 varColor;
vec2 N5_resolution;
vec3 N5_getResolution()
{
if (N5_resolution.x==0.0)
{
return vec3(640.0,640.0,1.0);
}
return vec3(N5_resolution,1.0);
}
vec2 N5_p6mmmap(vec2 uv,float repeats)
{
uv.x/=1.7320508;
...
float l9_4=l9_2.y;
float l9_5=l9_2.z;
N5_resolution=((((((l9_1.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_3)+((((l9_1.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_4))+((((l9_1.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5))/vec2((l9_3+l9_4)+l9_5);
vec2 l9_6=varPackedTex.xy-vec2(0.5);
vec2 l9_7=l9_6;
l9_7.x=l9_6.x*(N5_getResolution().x/N5_getResolution().y);
vec2 l9_8=N5_p6mmmap(l9_7*(N5_getResolution().x/2000.0),2.0);
vec3 l9_9=N5_getResolution();
vec3 l9_10=N5_getResolution();
vec3 l9_11=N5_getResolution();
float l9_12=((floor((Port_touchPosition_N005*vec4(l9_9.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_10.x)/10.0)*floor((Port_touchPosition_N005*vec4(0.0,l9_11.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_13;
if (l9_12>(-100000.0))
{
l9_13=l9_12;
...
float l9_19=N5_noise((N5_pyramids(l9_17)*15.0)+l9_18);
float l9_20=N5_noise((N5_pyramids(l9_17+vec2(135.0))*31.0)+l9_18);
float l9_21=N5_noise((N5_pyramids(l9_17+vec2(25.0))*63.0)+l9_18);
