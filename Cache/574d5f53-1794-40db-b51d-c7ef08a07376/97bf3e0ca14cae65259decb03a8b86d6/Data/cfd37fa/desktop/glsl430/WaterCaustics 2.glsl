...
vec3 l9_3=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N005)*Port_Scale_N005;
vec2 l9_4=vec2(Tweak_N1);
vec3 l9_5=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_6=l9_5.x;
float l9_7=l9_5.y;
float l9_8=l9_5.z;
N0_resolution=Port_resolution_N000;
vec2 l9_9=(((((((l9_3.yz-Port_Center_N003)*l9_4)+Port_Center_N003)*l9_6)+((((l9_3.zx-Port_Center_N003)*l9_4)+Port_Center_N003)*l9_7))+((((l9_3.xy-Port_Center_N003)*l9_4)+Port_Center_N003)*l9_8))/vec2((l9_6+l9_7)+l9_8))*3.0;
float l9_10=l9_1*0.25;
float l9_11=l9_9.x+l9_10;
vec2 l9_12=l9_9;
l9_12.x=l9_11;
vec4 l9_13=round(vec4(l9_11,l9_9.y,l9_12-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_14=l9_12-(l9_13.xy*vec2(1.0,1.7320508));
vec2 l9_15=l9_12-((l9_13.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_16=l9_14.x;
float l9_17=l9_15.x;
vec4 l9_18=vec4(l9_16,l9_14.y,l9_17,l9_15.y);
vec2 l9_19=l9_18.xy;
vec2 l9_20=l9_18.zw;
vec4 l9_21;
if (dot(l9_19,l9_19)<dot(l9_20,l9_20))
{
l9_21=vec4(l9_16,l9_14.y,l9_13.xy);
}
else
{
l9_21=vec4(l9_17,l9_15.y,l9_13.zw);
}
vec2 l9_22=abs(l9_21.xy);
float l9_23=max(dot(l9_22,vec2(0.5,0.86602539)),l9_22.x)+0.02;
float l9_24=fract(sin(dot(l9_21.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_25;
if (l9_21.y==0.0)
{
l9_25=0.0;
...
{
l9_25=atan(l9_21.y,l9_21.x);
}
float l9_26=l9_25+(l9_24*5.0);
float l9_27=l9_26+l9_1;
vec3 l9_28=N0_getResolution();
vec3 l9_29=N0_getResolution();
float l9_30=l9_1+(l9_24*8.0);
vec3 l9_31=N0_getResolution();
float l9_32=5.0/l9_31.y;
float l9_33=1.0-max(0.0,0.5-l9_23);
float l9_34;
if (l9_33<=0.0)
{
l9_34=0.0;
...
{
l9_34=pow(l9_33,20.0);
}
float l9_35=l9_34*1.5;
float l9_36=0.2+sin(l9_30);
vec3 l9_37=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_24))*(smoothstep(0.50999999,0.50999999-l9_32,l9_23)+l9_35))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_28.y,0.0,abs(l9_23-0.40000001)))*step(3.0+(l9_24*0.5),mod(l9_27,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_29.y,0.0,abs(l9_23-0.32499999)))*step(4.0+(l9_24*1.5),mod(l9_27+(l9_24*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_36,l9_36-l9_32,l9_23));
float l9_38=l9_2*Port_Multiplier_N007;
vec3 l9_39=((vec3(l9_38)*l9_37.x)+(Port_Green_N006*l9_37.y))+(Port_Blue_N006*l9_37.z);
...
{
l9_44=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_40.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_49;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_40.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_52;
...
#endif
vec3 l9_65=definedBlend(l9_63.xyz,l9_40.xyz);
