...
vec2 l9_8=varPackedTex.xy-vec2(0.5);
float l9_9=l9_8.x;
vec2 l9_10=l9_8;
l9_10.x=l9_9*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_11=N0_p6mmmap(l9_10*(N0_getResolution().x/2000.0),2.0);
vec3 l9_12=N0_getResolution();
vec3 l9_13=N0_getResolution();
vec3 l9_14=N0_getResolution();
float l9_15=((floor((Port_touchPosition_N000*vec4(l9_12.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_13.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_14.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_16;
if (l9_15>(-100000.0))
{
l9_16=l9_15;
...
vec4 l9_17=N0_animate_noise(l9_11*0.64999998,l9_16);
vec2 l9_18;
Node8_Loop_Triplanar_UV(vec2(0.0),Port_Position_N008,Port_Normal_N008,Port_Scale_N008,Port_Offset_N008,Port_Sharpness_N008,l9_18,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6.zx,varPackedTex.xy));
N0_resolution=Port_resolution_N000;
vec2 l9_19=l9_8;
l9_19.x=l9_9*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_20=N0_p6mmmap(l9_19*(N0_getResolution().x/2000.0),2.0);
vec3 l9_21=N0_getResolution();
vec3 l9_22=N0_getResolution();
vec3 l9_23=N0_getResolution();
float l9_24=((floor((Port_touchPosition_N000*vec4(l9_21.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_22.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_23.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_25;
if (l9_24>(-100000.0))
{
l9_25=l9_24;
...
vec4 l9_26=N0_animate_noise(l9_20*0.64999998,l9_25);
vec2 l9_27;
Node8_Loop_Triplanar_UV(vec2(0.0),Port_Position_N008,Port_Normal_N008,Port_Scale_N008,Port_Offset_N008,Port_Sharpness_N008,l9_27,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6.xy,varPackedTex.xy));
N0_resolution=Port_resolution_N000;
vec2 l9_28=l9_8;
l9_28.x=l9_9*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_29=N0_p6mmmap(l9_28*(N0_getResolution().x/2000.0),2.0);
vec3 l9_30=N0_getResolution();
vec3 l9_31=N0_getResolution();
vec3 l9_32=N0_getResolution();
float l9_33=((floor((Port_touchPosition_N000*vec4(l9_30.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_31.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_32.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_34;
if (l9_33>(-100000.0))
{
l9_34=l9_33;
...
vec4 l9_35=N0_animate_noise(l9_29*0.64999998,l9_34);
vec3 l9_36=pow(abs(l9_5),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_37=l9_36.x;
float l9_38=l9_36.y;
float l9_39=l9_36.z;
vec4 l9_40=(((l9_17*l9_37)+(l9_26*l9_38))+(l9_35*l9_39))/vec4((l9_37+l9_38)+l9_39);
float l9_41=l9_40.w;
...
{
l9_63=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_61,sc_ScreenTextureLayout,l9_62),0.0);
}
#else
{
l9_63=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_61,sc_ScreenTextureLayout,l9_62).xy,0.0);
}
#endif
l9_57=l9_63;
}
...
{
vec4 l9_65=l9_57;
l9_65.x=l9_57.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_64=l9_65;
}
#else
{
...
#endif
vec3 l9_66=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_40.xyz).xyz,vec3(l9_41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_40.xyz,vec3(l9_41)),l9_41);
}
#else
{
vec4 l9_69;
...
#endif
l9_69=vec4(l9_40.xyz*l9_70,l9_70);
}
#else
{
l9_69=l9_40;
...
#endif
int l9_79=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_78).xy);
...
if (l9_96==0)
{
l9_99=texture(sc_OITAlpha0,l9_91);
l9_98=texture(sc_OITDepthLow0,l9_91);
l9_97=texture(sc_OITDepthHigh0,l9_91);
}
else
{
l9_99=vec4(0.0);
...
if (l9_96==1)
{
l9_102=texture(sc_OITAlpha1,l9_91);
l9_101=texture(sc_OITDepthLow1,l9_91);
l9_100=texture(sc_OITDepthHigh1,l9_91);
}
else
{
l9_102=l9_99;
...
vec4 l9_117=texture(sc_OITFilteredDepthBoundsTexture,l9_91);
