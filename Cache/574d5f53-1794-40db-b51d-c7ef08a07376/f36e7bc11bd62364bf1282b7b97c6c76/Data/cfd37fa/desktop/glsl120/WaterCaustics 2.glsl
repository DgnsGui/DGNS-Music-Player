...
vec4 l9_1=vec4(Tweak_N10.xy,0.0,0.0);
N0_resolution=Tweak_N9;
vec2 l9_2=varPackedTex.xy-vec2(0.5);
float l9_3=l9_2.x;
vec2 l9_4=l9_2;
l9_4.x=l9_3*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_5=N0_p6mmmap(l9_4*(N0_getResolution().x/2000.0),2.0);
vec3 l9_6=N0_getResolution();
vec3 l9_7=N0_getResolution();
vec3 l9_8=N0_getResolution();
float l9_9=((floor((l9_1*vec4(l9_6.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_7.x)/10.0)*floor((l9_1*vec4(0.0,l9_8.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_10;
if (l9_9>(-100000.0))
{
l9_10=l9_9;
...
vec4 l9_11=N0_animate_noise(l9_5*0.64999998,l9_10);
N0_resolution=Tweak_N9;
vec2 l9_12=l9_2;
l9_12.x=l9_3*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_13=N0_p6mmmap(l9_12*(N0_getResolution().x/2000.0),2.0);
vec3 l9_14=N0_getResolution();
vec3 l9_15=N0_getResolution();
vec3 l9_16=N0_getResolution();
float l9_17=((floor((l9_1*vec4(l9_14.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_15.x)/10.0)*floor((l9_1*vec4(0.0,l9_16.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_18;
if (l9_17>(-100000.0))
{
l9_18=l9_17;
...
vec4 l9_19=N0_animate_noise(l9_13*0.64999998,l9_18);
N0_resolution=Tweak_N9;
vec2 l9_20=l9_2;
l9_20.x=l9_3*(N0_getResolution().x/N0_getResolution().y);
...
float l9_25=((floor((l9_1*vec4(l9_22.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_23.x)/10.0)*floor((l9_1*vec4(0.0,l9_24.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_26;
if (l9_25>(-100000.0))
{
l9_26=l9_25;
...
vec3 l9_28=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_29=l9_28.x;
float l9_30=l9_28.y;
float l9_31=l9_28.z;
vec4 l9_32=(((l9_11*l9_29)+(l9_19*l9_30))+(l9_27*l9_31))/vec4((l9_29+l9_30)+l9_31);
float l9_33=l9_32.w;
...
{
l9_37=clamp(dot(l9_32.xyz,vec3(l9_33)),0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_39=(1.0-dot(l9_32.xyz,vec3(0.33333001)))*l9_33;
}
#else
{
float l9_40;
...
{
l9_40=(1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0))*l9_33;
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*l9_33;
}
#else
{
float l9_42;
#if (sc_BlendMode_Add)
{
l9_42=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_43=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*l9_33;
}
#else
{
float l9_44;
...
{
l9_44=dot(l9_32.xyz,vec3(0.33333001))*l9_33;
}
#else
{
float l9_45;
#if (sc_BlendMode_Min)
{
l9_45=1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_46;
#if (sc_BlendMode_Max)
{
l9_46=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_46=1.0;
...
#endif
l9_34=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_32.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_35);
}
#else
{
vec4 l9_47;
...
#endif
vec3 l9_57=mix(l9_55.xyz,definedBlend(l9_55.xyz,l9_32.xyz).xyz,vec3(l9_33));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_32.xyz,vec3(l9_33)),l9_33);
}
#else
{
vec4 l9_60;
...
#endif
l9_60=vec4(l9_32.xyz*l9_61,l9_61);
}
#else
{
l9_60=l9_32;
