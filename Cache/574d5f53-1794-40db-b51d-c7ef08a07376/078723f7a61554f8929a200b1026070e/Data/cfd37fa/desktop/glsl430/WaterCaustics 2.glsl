...
N5_resolution=Port_resolution_N005;
vec2 l9_2=varPackedTex.xy-vec2(0.5);
vec2 l9_3=l9_2;
l9_3.x=l9_2.x*(N5_getResolution().x/N5_getResolution().y);
vec2 l9_4=N5_p6mmmap(l9_3*(N5_getResolution().x/2000.0),2.0);
vec3 l9_5=N5_getResolution();
vec3 l9_6=N5_getResolution();
vec3 l9_7=N5_getResolution();
float l9_8=((floor((Port_touchPosition_N005*vec4(l9_5.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_6.x)/10.0)*floor((Port_touchPosition_N005*vec4(0.0,l9_7.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_9;
if (l9_8>(-100000.0))
{
l9_9=l9_8;
...
float l9_10=radians(l9_9*12.7);
float l9_11=cos(l9_10);
float l9_12=sin(l9_10);
vec2 l9_13=((mat2(vec2(l9_11,-l9_12),vec2(l9_12,l9_11))*((l9_4*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_9*0.059999999);
float l9_14=l9_9*0.2;
float l9_15=N5_noise((N5_pyramids(l9_13)*15.0)+l9_14);
float l9_16=N5_noise((N5_pyramids(l9_13+vec2(135.0))*31.0)+l9_14);
float l9_17=N5_noise((N5_pyramids(l9_13+vec2(25.0))*63.0)+l9_14);
float l9_18=clamp((((l9_15*l9_16)*l9_17)-0.090000004)*41.0,0.0,1.0);
float l9_19=clamp(clamp(l9_16,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_20=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_17,0.0,1.0)-0.2,0.0,1.0),l9_19,l9_18).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_19))*l9_18,1.0);
...
{
l9_24=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_20.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_29;
#if (sc_BlendMode_Add)
{
l9_29=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_20.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_32;
#if (sc_BlendMode_Min)
{
l9_32=1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_Max)
{
l9_33=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_33=1.0;
...
#endif
l9_21=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_20.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_22);
}
#else
{
vec4 l9_34;
...
#else
{
vec2 l9_40=sc_ScreenCoordsGlobalToView(l9_1);
int l9_41;
...
{
l9_42=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_40,sc_ScreenTextureLayout,l9_41),0.0);
}
#else
{
l9_42=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_40,sc_ScreenTextureLayout,l9_41).xy,0.0);
}
#endif
l9_36=l9_42;
}
...
{
vec4 l9_44=l9_36;
l9_44.x=l9_36.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_43=l9_44;
}
#else
{
...
#endif
vec3 l9_45=definedBlend(l9_43.xyz,l9_20.xyz);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_56=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_69=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
