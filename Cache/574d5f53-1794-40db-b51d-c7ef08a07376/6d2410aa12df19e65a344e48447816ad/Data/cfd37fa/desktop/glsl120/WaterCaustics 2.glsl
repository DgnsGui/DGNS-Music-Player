...
#endif
vec3 l9_58=mix(l9_56.xyz,definedBlend(l9_56.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_60=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_61;
...
{
l9_62=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_62=Port_FinalColor_N004.w;
}
#endif
l9_61=vec4(Port_FinalColor_N004.xyz*l9_62,l9_62);
}
#else
{
l9_61=Port_FinalColor_N004;
}
#endif
l9_60=l9_61;
}
