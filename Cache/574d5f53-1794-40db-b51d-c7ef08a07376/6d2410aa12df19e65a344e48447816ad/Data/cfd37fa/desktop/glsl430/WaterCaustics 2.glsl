...
vec2 l9_2=vec2(Tweak_N1);
vec3 l9_3=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_4=l9_3.x;
float l9_5=l9_3.y;
float l9_6=l9_3.z;
N0_resolution=Port_resolution_N000;
vec2 l9_7=(((((((l9_1.yz-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_4)+((((l9_1.zx-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_5))+((((l9_1.xy-Port_Center_N003)*l9_2)+Port_Center_N003)*l9_6))/vec2((l9_4+l9_5)+l9_6))*3.0;
float l9_8=l9_0*0.25;
float l9_9=l9_7.x+l9_8;
vec2 l9_10=l9_7;
l9_10.x=l9_9;
vec4 l9_11=round(vec4(l9_9,l9_7.y,l9_10-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_12=l9_10-(l9_11.xy*vec2(1.0,1.7320508));
vec2 l9_13=l9_10-((l9_11.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_14=l9_12.x;
float l9_15=l9_13.x;
vec4 l9_16=vec4(l9_14,l9_12.y,l9_15,l9_13.y);
vec2 l9_17=l9_16.xy;
vec2 l9_18=l9_16.zw;
vec4 l9_19;
if (dot(l9_17,l9_17)<dot(l9_18,l9_18))
{
l9_19=vec4(l9_14,l9_12.y,l9_11.xy);
}
else
{
l9_19=vec4(l9_15,l9_13.y,l9_11.zw);
}
vec2 l9_20=abs(l9_19.xy);
float l9_21=max(dot(l9_20,vec2(0.5,0.86602539)),l9_20.x)+0.02;
float l9_22=fract(sin(dot(l9_19.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_23;
if (l9_19.y==0.0)
{
l9_23=0.0;
...
{
l9_23=atan(l9_19.y,l9_19.x);
}
float l9_24=l9_23+(l9_22*5.0);
float l9_25=l9_24+l9_0;
vec3 l9_26=N0_getResolution();
vec3 l9_27=N0_getResolution();
float l9_28=l9_0+(l9_22*8.0);
vec3 l9_29=N0_getResolution();
float l9_30=5.0/l9_29.y;
float l9_31=1.0-max(0.0,0.5-l9_21);
float l9_32;
if (l9_31<=0.0)
{
l9_32=0.0;
...
{
l9_32=pow(l9_31,20.0);
}
float l9_33=l9_32*1.5;
float l9_34=0.2+sin(l9_28);
vec4 l9_35;
...
{
l9_37=clamp(Port_FinalColor_N004.w*2.0,0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_40=(1.0-dot(Port_FinalColor_N004.xyz,vec3(0.33333001)))*Port_FinalColor_N004.w;
}
#else
{
float l9_41;
...
{
l9_41=(1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0))*Port_FinalColor_N004.w;
}
#else
{
float l9_42;
...
{
l9_42=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_43;
#if (sc_BlendMode_Add)
{
l9_43=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_44;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_44=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0)*Port_FinalColor_N004.w;
}
#else
{
float l9_45;
...
{
l9_45=dot(Port_FinalColor_N004.xyz,vec3(0.33333001))*Port_FinalColor_N004.w;
}
#else
{
float l9_46;
#if (sc_BlendMode_Min)
{
l9_46=1.0-clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_Max)
{
l9_47=clamp(dot(Port_FinalColor_N004.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_47=1.0;
...
#endif
l9_35=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*Port_FinalColor_N004.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_36);
}
#else
{
vec4 l9_48;
...
{
l9_48=vec4(Port_FinalColor_N004.w);
}
#else
{
vec4 l9_49;
...
{
l9_56=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_54,sc_ScreenTextureLayout,l9_55),0.0);
}
#else
{
l9_56=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_54,sc_ScreenTextureLayout,l9_55).xy,0.0);
}
#endif
l9_50=l9_56;
}
...
{
vec4 l9_58=l9_50;
l9_58.x=l9_50.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_57=l9_58;
}
#else
{
...
#endif
vec3 l9_59=mix(l9_57.xyz,definedBlend(l9_57.xyz,Port_FinalColor_N004.xyz).xyz,vec3(Port_FinalColor_N004.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_61=vec4(mix(vec3(1.0),Port_FinalColor_N004.xyz,vec3(Port_FinalColor_N004.w)),Port_FinalColor_N004.w);
}
#else
{
vec4 l9_62;
...
{
l9_63=clamp(Port_FinalColor_N004.w,0.0,1.0);
}
#else
{
l9_63=Port_FinalColor_N004.w;
}
#endif
l9_62=vec4(Port_FinalColor_N004.xyz*l9_63,l9_63);
}
#else
{
l9_62=Port_FinalColor_N004;
}
#endif
l9_61=l9_62;
}
...
gl_FragDepth=dot(((((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_22))*(smoothstep(0.50999999,0.50999999-l9_30,l9_21)+l9_33))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_26.y,0.0,abs(l9_21-0.40000001)))*step(3.0+(l9_22*0.5),mod(l9_25,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_27.y,0.0,abs(l9_21-0.32499999)))*step(4.0+(l9_22*1.5),mod(l9_25+(l9_22*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_34,l9_34-l9_30,l9_21))).xyz,vec3(0.29899999,0.58700001,0.114));
...
#endif
int l9_72=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_71).xy);
...
if (l9_89==0)
{
l9_92=texture(sc_OITAlpha0,l9_84);
l9_91=texture(sc_OITDepthLow0,l9_84);
l9_90=texture(sc_OITDepthHigh0,l9_84);
}
else
{
l9_92=vec4(0.0);
...
if (l9_89==1)
{
l9_95=texture(sc_OITAlpha1,l9_84);
l9_94=texture(sc_OITDepthLow1,l9_84);
l9_93=texture(sc_OITDepthHigh1,l9_84);
}
else
{
l9_95=l9_92;
...
vec4 l9_110=texture(sc_OITFilteredDepthBoundsTexture,l9_84);
