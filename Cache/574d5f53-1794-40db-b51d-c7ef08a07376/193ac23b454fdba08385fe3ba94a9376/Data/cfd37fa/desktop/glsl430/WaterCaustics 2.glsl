...
float l9_33=0.2+sin(l9_28);
vec3 l9_34=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_22))*(smoothstep(0.50999999,0.50999999-l9_30,l9_21)+(l9_32*1.5)))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_26.y,0.0,abs(l9_21-0.40000001)))*step(3.0+(l9_22*0.5),mod(l9_25,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_27.y,0.0,abs(l9_21-0.32499999)))*step(4.0+(l9_22*1.5),mod(l9_25+(l9_22*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_33,l9_33-l9_30,l9_21));
vec4 l9_35=vec4(l9_34.x,l9_34.y,l9_34.z,vec4(0.0).w);
l9_35.w=1.0;
vec4 l9_36=sin(l9_35);
float l9_37=l9_36.w;
...
{
l9_41=clamp(dot(l9_36.xyz,vec3(l9_37)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_36.xyz,vec3(0.33333001)))*l9_37;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0))*l9_37;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_37;
}
#else
{
float l9_46;
#if (sc_BlendMode_Add)
{
l9_46=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_47;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*l9_37;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_36.xyz,vec3(0.33333001))*l9_37;
}
#else
{
float l9_49;
#if (sc_BlendMode_Min)
{
l9_49=1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_Max)
{
l9_50=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_50=1.0;
...
#endif
l9_38=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_36.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_39);
}
#else
{
vec4 l9_51;
...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_36.xyz).xyz,vec3(l9_37));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_37)),l9_37);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_36.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_36;
