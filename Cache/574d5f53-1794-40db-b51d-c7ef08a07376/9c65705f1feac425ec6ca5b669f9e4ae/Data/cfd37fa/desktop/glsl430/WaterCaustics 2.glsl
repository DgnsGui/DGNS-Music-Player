...
vec2 l9_4=((((varPackedTex.xy*l9_1.xy)*2.0)-l9_2.xy)*3.0)/vec2(l9_3.y);
float l9_5=l9_0*0.25;
float l9_6=l9_4.x+l9_5;
vec2 l9_7=l9_4;
l9_7.x=l9_6;
vec4 l9_8=round(vec4(l9_6,l9_4.y,l9_7-vec2(0.5,1.0))/vec4(1.0,1.7320508,1.0,1.7320508));
vec2 l9_9=l9_7-(l9_8.xy*vec2(1.0,1.7320508));
vec2 l9_10=l9_7-((l9_8.zw+vec2(0.5))*vec2(1.0,1.7320508));
float l9_11=l9_9.x;
float l9_12=l9_10.x;
vec4 l9_13=vec4(l9_11,l9_9.y,l9_12,l9_10.y);
vec2 l9_14=l9_13.xy;
vec2 l9_15=l9_13.zw;
vec4 l9_16;
if (dot(l9_14,l9_14)<dot(l9_15,l9_15))
{
l9_16=vec4(l9_11,l9_9.y,l9_8.xy);
}
else
{
l9_16=vec4(l9_12,l9_10.y,l9_8.zw);
}
vec2 l9_17=abs(l9_16.xy);
float l9_18=max(dot(l9_17,vec2(0.5,0.86602539)),l9_17.x)+0.02;
float l9_19=fract(sin(dot(l9_16.zw,vec2(12.9898,78.233002)))*43758.547);
float l9_20;
if (l9_16.y==0.0)
{
l9_20=0.0;
...
{
l9_20=atan(l9_16.y,l9_16.x);
}
float l9_21=l9_20+(l9_19*5.0);
float l9_22=l9_21+l9_0;
vec3 l9_23=N0_getResolution();
vec3 l9_24=N0_getResolution();
float l9_25=l9_0+(l9_19*8.0);
vec3 l9_26=N0_getResolution();
float l9_27=5.0/l9_26.y;
float l9_28=1.0-max(0.0,0.5-l9_18);
float l9_29;
if (l9_28<=0.0)
{
l9_29=0.0;
...
{
l9_29=pow(l9_28,20.0);
}
float l9_30=l9_29*1.5;
float l9_31=0.2+sin(l9_25);
vec3 l9_32=(((vec3(0.050980002,0.25097999,0.2784)+(vec3(0.0,0.1,0.090000004)*l9_19))*(smoothstep(0.50999999,0.50999999-l9_27,l9_18)+l9_30))+(((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_23.y,0.0,abs(l9_18-0.40000001)))*step(3.0+(l9_19*0.5),mod(l9_22,6.2800002)))+((vec3(0.050980002,0.25097999,0.2784)*smoothstep(9.0/l9_24.y,0.0,abs(l9_18-0.32499999)))*step(4.0+(l9_19*1.5),mod(l9_22+(l9_19*2.0),6.2800002)))))+(vec3(0.050980002,0.25097999,0.2784)*smoothstep(l9_31,l9_31-l9_27,l9_18));
...
{
l9_38=(1.0-dot(l9_32.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_39;
...
{
l9_39=(1.0-clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_40;
...
{
l9_40=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_41;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_42=clamp(dot(l9_32.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_43;
...
{
l9_43=dot(l9_32.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_44;
...
#else
{
l9_59=vec4(l9_32.x,l9_32.y,l9_32.z,vec4(0.0).w);
}
#endif
l9_58=l9_59;
}
