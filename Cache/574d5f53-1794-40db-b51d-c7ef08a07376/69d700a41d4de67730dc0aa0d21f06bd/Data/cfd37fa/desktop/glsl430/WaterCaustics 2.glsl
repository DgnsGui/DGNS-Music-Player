...
if (l9_1<10)
{
l9_0=vec4(1.0)-((vec4(1.0)-l9_0)*(vec4(1.0)-vec4(0.0)));
l9_1++;
continue;
}
else
...
{
l9_5=clamp(dot(l9_0.xyz,vec3(l9_0.w)),0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_7=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*l9_0.w;
}
#else
{
float l9_8;
...
{
l9_8=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*l9_0.w;
}
#else
{
float l9_9;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_11=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*l9_0.w;
}
#else
{
float l9_12;
...
{
l9_12=dot(l9_0.xyz,vec3(0.33333001))*l9_0.w;
}
#else
{
float l9_13;
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_0.xyz).xyz,vec3(l9_0.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_0.xyz,vec3(l9_0.w)),l9_0.w);
}
#else
{
vec4 l9_29;
