...
float l9_3=l9_1.y;
float l9_4=l9_1.z;
vec4 l9_5=(((Port_Input_N003*l9_2)+(Port_Input_N003*l9_3))+(Port_Input_N003*l9_4))/vec4((l9_2+l9_3)+l9_4);
...
float l9_12=((floor((l9_5*vec4(l9_9.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_10.x)/10.0)*floor((l9_5*vec4(0.0,l9_11.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_13;
if (l9_12>(-100000.0))
{
l9_13=l9_12;
