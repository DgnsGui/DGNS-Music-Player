...
vec2 l9_4=mod(((varPackedTex.xy*l9_1.xy)/l9_3.xy)*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_5;
vec2 l9_6;
l9_6=l9_4;
l9_5=1.0;
...
{
int l9_8=l9_7+1;
float l9_9=(l9_2+23.0)*(1.0-(3.5/float(l9_8)));
vec2 l9_10=l9_4+vec2(cos(l9_9-l9_6.x)+sin(l9_9+l9_6.y),sin(l9_9-l9_6.y)+cos(l9_9+l9_6.x));
l9_6=l9_10;
l9_5+=(1.0/length(vec2(l9_4.x/(sin(l9_10.x+l9_9)/0.0049999999),l9_4.y/(cos(l9_10.y+l9_9)/0.0049999999))));
l9_7=l9_8;
continue;
}
else
...
float l9_11=ssPow(abs(1.17-ssPow(l9_5/5.0,1.4)),8.0);
vec4 l9_12=vec4(clamp(vec3(l9_11)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_16=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
...
{
l9_18=(1.0-dot(l9_12.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_19;
...
{
l9_19=(1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_20;
...
{
l9_20=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_21;
#if (sc_BlendMode_Add)
{
l9_21=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_22=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_23;
...
{
l9_23=dot(l9_12.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_24;
#if (sc_BlendMode_Min)
{
l9_24=1.0-clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_Max)
{
l9_25=clamp(dot(l9_12.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_25=1.0;
...
#endif
l9_13=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_12.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_14);
}
#else
{
vec4 l9_26;
...
#if (sc_FramebufferFetch)
{
vec4 l9_29=sc_readFragData0_Platform();
vec4 l9_30;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_31=l9_29;
l9_31.x=l9_29.x+_sc_framebufferFetchMarker;
l9_30=l9_31;
}
#else
{
...
{
l9_34=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_32,sc_ScreenTextureLayout,l9_33),0.0);
}
#else
{
l9_34=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_32,sc_ScreenTextureLayout,l9_33).xy,0.0);
}
#endif
l9_28=l9_34;
}
...
{
vec4 l9_36=l9_28;
l9_36.x=l9_28.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_35=l9_36;
}
#else
{
...
#endif
vec3 l9_37=definedBlend(l9_35.xyz,l9_12.xyz);
