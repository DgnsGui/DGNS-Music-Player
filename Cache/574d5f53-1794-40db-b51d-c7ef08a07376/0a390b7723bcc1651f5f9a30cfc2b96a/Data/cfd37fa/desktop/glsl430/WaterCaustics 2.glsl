...
float l9_8=((floor((Tweak_N10*vec4(l9_5.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_6.x)/10.0)*floor((Tweak_N10*vec4(0.0,l9_7.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_9;
if (l9_8>(-100000.0))
{
l9_9=l9_8;
...
float l9_16=((floor((Tweak_N10*vec4(l9_13.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_14.x)/10.0)*floor((Tweak_N10*vec4(0.0,l9_15.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_17;
if (l9_16>(-100000.0))
{
l9_17=l9_16;
...
float l9_24=((floor((Tweak_N10*vec4(l9_21.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_22.x)/10.0)*floor((Tweak_N10*vec4(0.0,l9_23.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_25;
if (l9_24>(-100000.0))
{
l9_25=l9_24;
