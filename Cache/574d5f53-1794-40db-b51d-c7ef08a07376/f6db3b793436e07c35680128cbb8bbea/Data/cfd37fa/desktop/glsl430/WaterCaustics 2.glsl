...
uniform vec4 Port_Input0_N009;
uniform vec3 Port_Green_N006;
uniform vec3 Port_Blue_N006;
...
float l9_36;
if (Port_Input0_N009.x<=0.0)
{
l9_36=0.0;
}
else
{
l9_36=log(Port_Input0_N009.x);
}
float l9_37;
if (Port_Input0_N009.y<=0.0)
{
l9_37=0.0;
}
else
{
l9_37=log(Port_Input0_N009.y);
}
float l9_38;
if (Port_Input0_N009.z<=0.0)
{
l9_38=0.0;
}
else
{
l9_38=log(Port_Input0_N009.z);
}
vec4 l9_39=vec4(l9_36,l9_37,l9_38,0.0);
vec3 l9_40=((l9_39.xyz*l9_35.x)+(Port_Green_N006*l9_35.y))+(Port_Blue_N006*l9_35.z);
...
{
l9_45=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_46;
...
{
l9_47=(1.0-dot(l9_41.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_48;
...
{
l9_48=(1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_49;
...
{
l9_49=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_50;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_51=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_52;
...
{
l9_52=dot(l9_41.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_53;
...
#endif
vec3 l9_66=definedBlend(l9_64.xyz,l9_41.xyz);
