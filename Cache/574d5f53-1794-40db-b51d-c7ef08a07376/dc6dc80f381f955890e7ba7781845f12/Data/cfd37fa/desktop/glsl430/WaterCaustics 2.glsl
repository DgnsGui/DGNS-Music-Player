...
uniform vec2 Port_CoordsIn_N002;
...
vec2 l9_2=l9_1;
l9_2.x=l9_1.x*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_3=N0_p6mmmap(l9_2*(N0_getResolution().x/2000.0),2.0);
vec3 l9_4=N0_getResolution();
vec3 l9_5=N0_getResolution();
vec3 l9_6=N0_getResolution();
float l9_7=((floor((Port_touchPosition_N000*vec4(l9_4.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_5.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_6.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_8;
if (l9_7>(-100000.0))
{
l9_8=l9_7;
...
float l9_9=radians(l9_8*12.7);
float l9_10=cos(l9_9);
float l9_11=sin(l9_9);
vec2 l9_12=((mat2(vec2(l9_10,-l9_11),vec2(l9_11,l9_10))*((l9_3*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_8*0.059999999);
float l9_13=l9_8*0.2;
float l9_14=N0_noise((N0_pyramids(l9_12)*15.0)+l9_13);
float l9_15=N0_noise((N0_pyramids(l9_12+vec2(135.0))*31.0)+l9_13);
float l9_16=N0_noise((N0_pyramids(l9_12+vec2(25.0))*63.0)+l9_13);
float l9_17=clamp((((l9_14*l9_15)*l9_16)-0.090000004)*41.0,0.0,1.0);
float l9_18=clamp(clamp(l9_15,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_19=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_16,0.0,1.0)-0.2,0.0,1.0),l9_18,l9_17).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_18))*l9_17,1.0);
...
{
l9_23=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_28;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_30;
...
{
l9_30=dot(l9_19.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_31;
...
#endif
vec3 l9_44=definedBlend(l9_42.xyz,l9_19.xyz);
