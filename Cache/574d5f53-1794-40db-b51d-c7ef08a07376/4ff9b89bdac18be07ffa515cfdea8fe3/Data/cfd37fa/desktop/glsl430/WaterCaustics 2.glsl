...
{
l9_40=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_42=(1.0-dot(l9_36.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_43;
...
{
l9_43=(1.0-clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_44;
...
{
l9_44=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_45;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_46=clamp(dot(l9_36.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_47;
...
{
l9_47=dot(l9_36.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_48;
...
{
l9_58=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_56,sc_ScreenTextureLayout,l9_57),0.0);
}
#else
{
l9_58=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_56,sc_ScreenTextureLayout,l9_57).xy,0.0);
}
#endif
l9_52=l9_58;
}
...
#endif
vec3 l9_61=definedBlend(l9_59.xyz,l9_36.xyz);
