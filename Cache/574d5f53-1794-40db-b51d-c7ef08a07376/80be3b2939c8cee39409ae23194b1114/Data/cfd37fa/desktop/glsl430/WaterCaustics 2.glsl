...
vec2 l9_2=l9_1;
l9_2.x=l9_1.x*(N5_getResolution().x/N5_getResolution().y);
vec2 l9_3=N5_p6mmmap(l9_2*(N5_getResolution().x/2000.0),2.0);
vec3 l9_4=N5_getResolution();
vec3 l9_5=N5_getResolution();
vec3 l9_6=N5_getResolution();
float l9_7=((floor((Port_touchPosition_N005*vec4(l9_4.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_5.x)/10.0)*floor((Port_touchPosition_N005*vec4(0.0,l9_6.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_8;
if (l9_7>(-100000.0))
{
l9_8=l9_7;
...
float l9_14=N5_noise((N5_pyramids(l9_12)*15.0)+l9_13);
float l9_15=N5_noise((N5_pyramids(l9_12+vec2(135.0))*31.0)+l9_13);
float l9_16=N5_noise((N5_pyramids(l9_12+vec2(25.0))*63.0)+l9_13);
