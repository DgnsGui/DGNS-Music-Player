...
uniform vec4 Port_touchPosition_N000;
uniform vec3 Port_Scale_N008;
uniform vec3 Port_Offset_N008;
uniform float Port_Sharpness_N008;
uniform vec3 Port_Position_N008;
uniform vec3 Port_Normal_N008;
...
in vec4 varColor;
vec2 N0_resolution;
void Node8_Loop_Triplanar_UV(vec2 Input,vec3 Position,vec3 Normal,vec3 Scale,vec3 Offset,float Sharpness,out vec2 Output,ssGlobals Globals)
{
...
Input=((Globals.gTriplanarCoords-Port_Center_N007)*Port_Scale_N007)+Port_Center_N007;
vec2 l9_3=Input;
...
vec2 N0_p6mmmap(vec2 uv,float repeats)
{
uv.x/=1.7320508;
uv=fract((uv*repeats)-vec2(0.5))-vec2(0.5);
uv.x*=1.7320508;
uv=abs(uv);
vec2 l9_0=uv;
vec2 l9_1=uv;
vec2 l9_2=mat2(vec2(0.86602533,0.50000018),vec2(-0.50000018,0.86602533))*l9_1;
float l9_3=l9_2.x;
if (l9_3<0.0)
{
return vec2(l9_0.x*1.7320508,(l9_0.y-0.5)*(-1.0))*2.0;
}
else
{
if (l9_3>0.5)
{
vec2 l9_4=l9_0;
l9_4.x=((l9_0.x-0.86602539)*(-1.0))*1.7320508;
return l9_4*2.0;
}
}
vec2 l9_5=uv;
vec2 l9_6=mat2(vec2(0.86602539,-0.5),vec2(0.5,0.86602539))*l9_5;
float l9_7=l9_6.y;
bool l9_8=l9_7<0.0;
bool l9_9;
if (l9_8)
...
vec2 l9_16=l9_6;
l9_16.x=l9_6.x-0.5;
uv=mat2(vec2(1.1924881e-08,1.0),vec2(-1.0,1.1924881e-08))*l9_16;
vec2 l9_17=uv*l9_10;
vec2 l9_18=l9_17;
l9_18.x=l9_17.x*1.7320508;
return l9_18*2.0;
}
float N0_pyramids(vec2 p)
{
vec2 l9_0=p;
vec2 l9_1=p;
float l9_2;
...
if (l9_6<2)
{
float l9_7=float(l9_4);
float l9_8=float(l9_6);
vec2 l9_9=vec2(l9_7,l9_8);
vec2 l9_10=floor(l9_0)+l9_9;
vec2 l9_11=abs(fract(l9_1)-(vec2(fract(sin(dot(l9_10,vec2(12.9898,4.1413999)))*43758.547),fract(sin(dot(l9_10+vec2(234.10001),vec2(12.9898,4.1413999)))*43758.547))+l9_9));
float l9_12=l9_11.x+l9_11.y;
if (l9_12<l9_3)
{
l9_5=l9_12;
}
...
float N0_noise(float p)
{
float l9_0=floor(p);
return mix(fract(sin(l9_0)*43758.547),fract(sin(l9_0+1.0)*43758.547),fract(p));
}
vec3 N0_hsv2rgb(vec3 c)
{
return mix(vec3(1.0),clamp(abs((fract(c.xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(c.y))*c.z;
}
vec3 N0_square_noise(vec2 uv,float t)
{
float l9_0=N0_noise((N0_pyramids(uv+vec2(135.0))*31.0)+t);
float l9_1=N0_noise((N0_pyramids(uv+vec2(25.0))*63.0)+t);
return N0_hsv2rgb(vec3(clamp(clamp(l9_1,0.0,1.0)-0.2,0.0,1.0),clamp(clamp(l9_0,0.0,1.0)-0.2,0.0,1.0),clamp((((N0_noise((N0_pyramids(uv)*15.0)+t)*l9_0)*l9_1)-0.090000004)*41.0,0.0,1.0)));
}
vec4 N0_animate_noise(vec2 uv,float t)
{
float l9_0=radians(t*12.7);
float l9_1=cos(l9_0);
float l9_2=sin(l9_0);
return vec4(N0_square_noise(((mat2(vec2(l9_1,-l9_2),vec2(l9_2,l9_1))*(uv-vec2(0.25)))+vec2(0.25))+vec2(t*0.059999999),t*0.2),1.0);
}
int sc_GetStereoViewIndex()
{
int l9_0;
...
vec3 l9_3=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
vec3 l9_4=normalize(varNormal);
vec3 l9_5=normalize((sc_ModelMatrixInverse*vec4(l9_4,0.0)).xyz);
vec3 l9_6=(l9_3+Port_Offset_N005)*Port_Scale_N005;
vec2 l9_7;
Node8_Loop_Triplanar_UV(vec2(0.0),Port_Position_N008,Port_Normal_N008,Port_Scale_N008,Port_Offset_N008,Port_Sharpness_N008,l9_7,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6.yz,varPackedTex.xy));
vec2 l9_8=vec2(Tweak_N9);
N0_resolution=l9_8;
vec2 l9_9=varPackedTex.xy-vec2(0.5);
float l9_10=l9_9.x;
vec2 l9_11=l9_9;
l9_11.x=l9_10*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_12=N0_p6mmmap(l9_11*(N0_getResolution().x/2000.0),2.0);
vec3 l9_13=N0_getResolution();
vec3 l9_14=N0_getResolution();
vec3 l9_15=N0_getResolution();
float l9_16=((floor((Port_touchPosition_N000*vec4(l9_13.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_14.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_15.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_17;
if (l9_16>(-100000.0))
{
l9_17=l9_16;
...
vec4 l9_18=N0_animate_noise(l9_12*0.64999998,l9_17);
vec2 l9_19;
Node8_Loop_Triplanar_UV(vec2(0.0),Port_Position_N008,Port_Normal_N008,Port_Scale_N008,Port_Offset_N008,Port_Sharpness_N008,l9_19,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6.zx,varPackedTex.xy));
N0_resolution=l9_8;
vec2 l9_20=l9_9;
l9_20.x=l9_10*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_21=N0_p6mmmap(l9_20*(N0_getResolution().x/2000.0),2.0);
vec3 l9_22=N0_getResolution();
vec3 l9_23=N0_getResolution();
vec3 l9_24=N0_getResolution();
float l9_25=((floor((Port_touchPosition_N000*vec4(l9_22.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_23.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_24.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_26;
if (l9_25>(-100000.0))
{
l9_26=l9_25;
...
vec4 l9_27=N0_animate_noise(l9_21*0.64999998,l9_26);
vec2 l9_28;
Node8_Loop_Triplanar_UV(vec2(0.0),Port_Position_N008,Port_Normal_N008,Port_Scale_N008,Port_Offset_N008,Port_Sharpness_N008,l9_28,ssGlobals(l9_1,l9_2,0.0,l9_3,l9_4,l9_5,l9_6.xy,varPackedTex.xy));
N0_resolution=l9_8;
vec2 l9_29=l9_9;
l9_29.x=l9_10*(N0_getResolution().x/N0_getResolution().y);
vec2 l9_30=N0_p6mmmap(l9_29*(N0_getResolution().x/2000.0),2.0);
vec3 l9_31=N0_getResolution();
vec3 l9_32=N0_getResolution();
vec3 l9_33=N0_getResolution();
float l9_34=((floor((Port_touchPosition_N000*vec4(l9_31.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_32.x)/10.0)*floor((Port_touchPosition_N000*vec4(0.0,l9_33.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_35;
if (l9_34>(-100000.0))
{
l9_35=l9_34;
...
vec4 l9_36=N0_animate_noise(l9_30*0.64999998,l9_35);
vec3 l9_37=pow(abs(l9_5),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_38=l9_37.x;
float l9_39=l9_37.y;
float l9_40=l9_37.z;
vec4 l9_41=(((l9_18*l9_38)+(l9_27*l9_39))+(l9_36*l9_40))/vec4((l9_38+l9_39)+l9_40);
float l9_42=l9_41.w;
...
{
l9_46=clamp(dot(l9_41.xyz,vec3(l9_42)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_41.xyz,vec3(0.33333001)))*l9_42;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0))*l9_42;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_42;
}
#else
{
float l9_51;
#if (sc_BlendMode_Add)
{
l9_51=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0)*l9_42;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_41.xyz,vec3(0.33333001))*l9_42;
}
#else
{
float l9_54;
#if (sc_BlendMode_Min)
{
l9_54=1.0-clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_55;
#if (sc_BlendMode_Max)
{
l9_55=clamp(dot(l9_41.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_55=1.0;
...
#endif
l9_43=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_41.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_44);
}
#else
{
vec4 l9_56;
...
{
l9_64=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_62,sc_ScreenTextureLayout,l9_63),0.0);
}
#else
{
l9_64=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_62,sc_ScreenTextureLayout,l9_63).xy,0.0);
}
#endif
l9_58=l9_64;
}
...
{
vec4 l9_66=l9_58;
l9_66.x=l9_58.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_65=l9_66;
}
#else
{
...
#endif
vec3 l9_67=mix(l9_65.xyz,definedBlend(l9_65.xyz,l9_41.xyz).xyz,vec3(l9_42));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_69=vec4(mix(vec3(1.0),l9_41.xyz,vec3(l9_42)),l9_42);
}
#else
{
vec4 l9_70;
...
#endif
l9_70=vec4(l9_41.xyz*l9_71,l9_71);
}
#else
{
l9_70=l9_41;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_79).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_80=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_79).xy);
...
if (l9_97==0)
{
l9_100=texture(sc_OITAlpha0,l9_92);
l9_99=texture(sc_OITDepthLow0,l9_92);
l9_98=texture(sc_OITDepthHigh0,l9_92);
}
else
{
l9_100=vec4(0.0);
...
if (l9_97==1)
{
l9_103=texture(sc_OITAlpha1,l9_92);
l9_102=texture(sc_OITDepthLow1,l9_92);
l9_101=texture(sc_OITDepthHigh1,l9_92);
}
else
{
l9_103=l9_100;
...
vec4 l9_118=texture(sc_OITFilteredDepthBoundsTexture,l9_92);
