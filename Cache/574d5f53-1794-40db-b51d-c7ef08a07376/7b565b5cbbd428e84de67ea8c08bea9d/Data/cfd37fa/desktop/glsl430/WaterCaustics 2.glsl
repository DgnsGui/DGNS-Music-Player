...
vec3 l9_36=((Port_Red_N006*l9_35.x)+(Port_Green_N006*l9_35.y))+(Port_Blue_N006*l9_35.z);
...
{
l9_41=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_37.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_46;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_37.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_49;
...
#endif
vec3 l9_62=definedBlend(l9_60.xyz,l9_37.xyz);
