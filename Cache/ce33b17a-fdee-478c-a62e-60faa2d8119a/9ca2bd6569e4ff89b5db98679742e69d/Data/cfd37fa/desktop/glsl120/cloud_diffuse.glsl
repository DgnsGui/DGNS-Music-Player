...
{
vec2 l9_159;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_159,l9_8);
...
float l9_176=l9_165;
sc_SoftwareWrapLate(l9_175,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_176);
float l9_177=l9_174.y;
float l9_178=l9_176;
sc_SoftwareWrapLate(l9_177,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_178);
float l9_179=l9_178;
...
#endif
l9_158=varColor.xyz*vec3(l9_182.z);
}
#else
{
vec2 l9_183;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_183,l9_8);
float l9_184=l9_183.x;
sc_SoftwareWrapEarly(l9_184,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_185=l9_184;
float l9_186=l9_183.y;
sc_SoftwareWrapEarly(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_187=l9_186;
vec2 l9_188;
float l9_189;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_190=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_190=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_191=l9_185;
float l9_192=1.0;
sc_ClampUV(l9_191,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_190,l9_192);
float l9_193=l9_191;
float l9_194=l9_192;
bool l9_195;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_195=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_195=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_196=l9_187;
float l9_197=l9_194;
sc_ClampUV(l9_196,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_195,l9_197);
l9_189=l9_197;
...
#endif
vec2 l9_198=sc_TransformUV(l9_188,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_199=l9_198.x;
float l9_200=l9_189;
sc_SoftwareWrapLate(l9_199,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_200);
float l9_201=l9_198.y;
float l9_202=l9_200;
sc_SoftwareWrapLate(l9_201,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_202);
float l9_203=l9_202;
vec3 l9_204=sc_SamplingCoordsViewToGlobal(vec2(l9_199,l9_201),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_205=texture2D(materialParamsTex,l9_204.xy,0.0);
vec4 l9_206;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_206=mix(materialParamsTexBorderColor,l9_205,vec4(l9_203));
}
#else
{
l9_206=l9_205;
...
#endif
float l9_208=clamp(l9_46,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_208<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_208<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_209=max(l9_9.xyz,vec3(0.0));
vec4 l9_210;
#if (sc_ProjectiveShadowsCaster)
{
l9_210=vec4(l9_209,l9_208);
}
#else
{
vec3 l9_211=clamp(l9_158,vec3(0.0),vec3(1.0));
vec3 l9_212=ssSRGB_to_Linear(l9_209);
vec3 l9_213=normalize(l9_207);
vec3 l9_214=ssSRGB_to_Linear(max(l9_157,vec3(0.0)));
vec3 l9_215;
#if (sc_SSAOEnabled)
{
l9_215=evaluateSSAO(varPos);
}
#else
{
l9_215=l9_211;
...
#endif
vec3 l9_216=l9_212*(1.0-0.0);
SurfaceProperties l9_217=SurfaceProperties(l9_216,l9_208,l9_213,varPos,l9_7,0.0,1.0,l9_214,l9_215,vec3(1.0),vec3(1.0),vec3(0.039999999));
vec4 l9_218=vec4(1.0);
vec3 l9_219;
vec3 l9_220;
vec3 l9_221;
vec3 l9_222;
...
l9_227=vec3(0.0);
l9_226=vec3(0.0);
LightingComponents l9_233;
LightProperties l9_234;
SurfaceProperties l9_235;
vec3 l9_236;
int l9_237=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_237<sc_DirectionalLightsCount)
{
LightingComponents l9_238=accumulateLight(LightingComponents(l9_226,l9_227,l9_232,l9_230,l9_229,l9_228),LightProperties(sc_DirectionalLights[l9_237].direction,sc_DirectionalLights[l9_237].color.xyz,sc_DirectionalLights[l9_237].color.w*l9_218[(l9_231<3) ? l9_231 : 3]),l9_217,l9_7);
l9_232=l9_238.indirectDiffuse;
l9_231++;
l9_230=l9_238.indirectSpecular;
l9_229=l9_238.emitted;
l9_228=l9_238.transmitted;
l9_227=l9_238.directSpecular;
l9_226=l9_238.directDiffuse;
l9_237++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_255<sc_PointLightsCount)
{
vec3 l9_257=sc_PointLights[l9_255].position-varPos;
vec3 l9_258=normalize(l9_257);
float l9_259=l9_218[(l9_256<3) ? l9_256 : 3];
float l9_260=clamp((dot(l9_258,sc_PointLights[l9_255].direction)*sc_PointLights[l9_255].angleScale)+sc_PointLights[l9_255].angleOffset,0.0,1.0);
float l9_261=(sc_PointLights[l9_255].color.w*l9_259)*(l9_260*l9_260);
float l9_262;
if (sc_PointLights[l9_255].falloffEnabled)
{
l9_262=l9_261*computeDistanceAttenuation(length(l9_257),sc_PointLights[l9_255].falloffEndDistance);
}
else
{
l9_262=l9_261;
...
l9_248=l9_256+1;
LightingComponents l9_263=accumulateLight(LightingComponents(l9_242,l9_243,l9_247,l9_246,l9_245,l9_244),LightProperties(l9_258,sc_PointLights[l9_255].color.xyz,l9_262),l9_217,l9_7);
l9_249=l9_263.directDiffuse;
l9_250=l9_263.directSpecular;
l9_251=l9_263.indirectDiffuse;
l9_252=l9_263.indirectSpecular;
l9_253=l9_263.emitted;
l9_254=l9_263.transmitted;
l9_247=l9_251;
l9_256=l9_248;
l9_246=l9_252;
l9_245=l9_253;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_266=abs(varShadowTex-vec2(0.5));
vec4 l9_267=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_266.x,l9_266.y),0.5);
l9_265=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_267.xyz,vec3(sc_ShadowColor.w)),vec3(l9_267.w*sc_ShadowDensity));
}
#else
{
l9_265=vec3(1.0);
...
{
float l9_269=-l9_213.z;
float l9_270=l9_213.x;
vec2 l9_271=vec2((((l9_270<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_269/length(vec2(l9_270,l9_269)),-1.0,1.0)))-1.5707964,acos(l9_213.y))/vec2(6.2831855,3.1415927);
float l9_272=l9_271.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_273=vec2(l9_272,1.0-l9_271.y);
l9_273.x=fract((l9_272+floor(l9_272))+1.0);
vec4 l9_274;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_275=calcSeamlessPanoramicUvsForSampling(l9_273,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_275=l9_273;
...
#endif
l9_274=sc_EnvmapSpecularSampleViewIndexBias(l9_275,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_276;
...
{
vec2 l9_277=calcSeamlessPanoramicUvsForSampling(l9_273,sc_EnvmapDiffuseSize.xy,0.0);
int l9_278;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_278=1-sc_GetStereoViewIndex();
}
#else
{
l9_278=sc_GetStereoViewIndex();
}
#endif
l9_276=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_277,sc_EnvmapDiffuseLayout,l9_278).xy,-13.0);
}
#else
{
l9_276=sc_EnvmapSpecularSampleViewIndexBias(l9_273,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_274=l9_276;
}
#endif
l9_268=(l9_274.xyz*(1.0/l9_274.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_279;
...
float l9_282=l9_280.y;
float l9_283=l9_280.z;
l9_279=(((((((sc_Sh[8]*0.42904299)*((l9_281*l9_281)-(l9_282*l9_282)))+((sc_Sh[6]*0.74312502)*(l9_283*l9_283)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_281*l9_282))+(sc_Sh[7]*(l9_281*l9_283)))+(sc_Sh[5]*(l9_282*l9_283)))*0.85808599))+((((sc_Sh[3]*l9_281)+(sc_Sh[1]*l9_282))+(sc_Sh[2]*l9_283))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_279=vec3(0.0);
...
{
l9_285=l9_268+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_286=l9_268;
l9_286.x=l9_268.x+(1e-06*sc_AmbientLights[0].color.x);
l9_285=l9_286;
}
#endif
l9_284=l9_285;
...
{
l9_288=l9_284+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_289=l9_284;
l9_289.x=l9_284.x+(1e-06*sc_AmbientLights[1].color.x);
l9_288=l9_289;
}
#endif
l9_287=l9_288;
...
{
l9_291=l9_287+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_292=l9_287;
l9_292.x=l9_287.x+(1e-06*sc_AmbientLights[2].color.x);
l9_291=l9_292;
}
#endif
l9_290=l9_291;
...
{
vec3 l9_294;
l9_294=sc_LightEstimationData.ambientLight;
vec3 l9_295;
int l9_296=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_296<sc_LightEstimationSGCount)
{
float l9_297=dot(sc_LightEstimationData.sg[l9_296].axis,l9_213);
float l9_298=exp(-sc_LightEstimationData.sg[l9_296].sharpness);
float l9_299=l9_298*l9_298;
float l9_300=1.0/sc_LightEstimationData.sg[l9_296].sharpness;
float l9_301=(1.0+(2.0*l9_299))-l9_300;
float l9_302=sqrt(1.0-l9_301);
float l9_303=0.36000001*l9_297;
float l9_304=(1.0/(4.0*0.36000001))*l9_302;
float l9_305=l9_303+l9_304;
float l9_306;
if (step(abs(l9_303),l9_304)>0.5)
{
l9_306=(l9_305*l9_305)/l9_302;
}
else
{
l9_306=clamp(l9_297,0.0,1.0);
}
l9_295=l9_294+((((sc_LightEstimationData.sg[l9_296].color/vec3(sc_LightEstimationData.sg[l9_296].sharpness))*6.2831855)*((l9_301*l9_306)+(((l9_298-l9_299)*l9_300)-l9_299)))/vec3(3.1415927));
l9_294=l9_295;
l9_296++;
continue;
}
...
l9_310=vec3(0.0);
l9_309=vec3(0.0);
l9_308=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_216,vec3(l9_208));
l9_307=1.0;
}
#else
{
...
#endif
vec3 l9_312=l9_309*l9_215;
vec3 l9_313=l9_310+l9_312;
vec3 l9_314=l9_216*l9_313;
vec3 l9_315=l9_241*vec3(1.0);
vec3 l9_316;
if (l9_311)
{
l9_316=l9_314*srgbToLinear(l9_307);
}
else
{
l9_316=l9_314;
}
vec3 l9_317=l9_316+(vec3(0.0)+l9_315);
vec3 l9_318=(l9_317+l9_214)+l9_308;
float l9_319=l9_318.x;
vec4 l9_320=vec4(l9_319,l9_318.yz,l9_307);
vec4 l9_321;
#if (sc_IsEditor)
{
vec4 l9_322=l9_320;
l9_322.x=l9_319+((l9_215.x*1.0)*9.9999997e-06);
l9_321=l9_322;
}
#else
{
...
{
vec3 l9_324=l9_321.xyz*1.8;
vec3 l9_325=(l9_321.xyz*(l9_324+vec3(1.4)))/((l9_321.xyz*(l9_324+vec3(0.5)))+vec3(1.5));
l9_323=vec4(l9_325.x,l9_325.y,l9_325.z,l9_321.w);
}
#else
{
l9_323=l9_321;
...
#endif
vec3 l9_326=vec3(linearToSrgb(l9_323.x),linearToSrgb(l9_323.y),linearToSrgb(l9_323.z));
l9_210=vec4(l9_326.x,l9_326.y,l9_326.z,l9_323.w);
}
#endif
vec4 l9_327=max(l9_210,vec4(0.0));
vec4 l9_328;
#if (sc_ProjectiveShadowsCaster)
{
float l9_329;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_330=clamp(l9_327.w*2.0,0.0,1.0);
}
#else
{
float l9_331;
...
{
l9_331=clamp(dot(l9_327.xyz,vec3(l9_327.w)),0.0,1.0);
}
#else
{
float l9_332;
...
#if (sc_BlendMode_Multiply)
{
l9_333=(1.0-dot(l9_327.xyz,vec3(0.33333001)))*l9_327.w;
}
#else
{
float l9_334;
...
{
l9_334=(1.0-clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0))*l9_327.w;
}
#else
{
float l9_335;
#if (sc_BlendMode_ColoredGlass)
{
l9_335=clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0)*l9_327.w;
}
#else
{
float l9_336;
#if (sc_BlendMode_Add)
{
l9_336=clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_337;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_337=clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0)*l9_327.w;
}
#else
{
float l9_338;
...
{
l9_338=dot(l9_327.xyz,vec3(0.33333001))*l9_327.w;
}
#else
{
float l9_339;
#if (sc_BlendMode_Min)
{
l9_339=1.0-clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_340;
#if (sc_BlendMode_Max)
{
l9_340=clamp(dot(l9_327.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_340=1.0;
...
#endif
l9_328=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_327.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_329);
}
#else
{
vec4 l9_341;
...
{
vec3 l9_343=sc_GetFramebufferColor().xyz;
vec3 l9_344=mix(l9_343,definedBlend(l9_343,l9_327.xyz).xyz,vec3(l9_327.w));
vec4 l9_345=vec4(l9_344.x,l9_344.y,l9_344.z,vec4(0.0).w);
l9_345.w=1.0;
l9_342=l9_345;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_347=l9_327.w;
l9_346=vec4(mix(vec3(1.0),l9_327.xyz,vec3(l9_347)),l9_347);
}
#else
{
vec4 l9_348;
...
{
float l9_349=l9_327.w;
float l9_350;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_350=clamp(l9_349,0.0,1.0);
}
#else
{
l9_350=l9_349;
...
#endif
l9_348=vec4(l9_327.xyz*l9_350,l9_350);
}
#else
{
l9_348=l9_327;
...
{
l9_353=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_353=vec4(0.0);
...
vec4 l9_355=outputMotionVectorsIfNeeded(varPos,max(l9_354,vec4(0.0)));
vec4 l9_356=clamp(l9_355,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_357=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_357-0.0039215689)),min(1.0,l9_357+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_358=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_358).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_359=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_358).xy);
float l9_360=packValue(l9_359);
int l9_367=int(l9_356.w*255.0);
float l9_368=packValue(l9_367);
sc_writeFragData0(vec4(packValue(l9_359),packValue(l9_359),packValue(l9_359),packValue(l9_359)));
sc_writeFragData1(vec4(l9_360,packValue(l9_359),packValue(l9_359),packValue(l9_359)));
sc_writeFragData2(vec4(l9_368,packValue(l9_367),packValue(l9_367),packValue(l9_367)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_371=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_371).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_376==0)
{
l9_379=texture2D(sc_OITAlpha0,l9_371);
l9_378=texture2D(sc_OITDepthLow0,l9_371);
l9_377=texture2D(sc_OITDepthHigh0,l9_371);
}
else
{
l9_379=vec4(0.0);
...
if (l9_376==1)
{
l9_382=texture2D(sc_OITAlpha1,l9_371);
l9_381=texture2D(sc_OITDepthLow1,l9_371);
l9_380=texture2D(sc_OITDepthHigh1,l9_371);
}
else
{
l9_382=l9_379;
...
if (any(notEqual(l9_380,vec4(0.0)))||any(notEqual(l9_381,vec4(0.0))))
{
int l9_383[8]=l9_372;
unpackValues(l9_380.w,l9_376,l9_383);
unpackValues(l9_380.z,l9_376,l9_383);
unpackValues(l9_380.y,l9_376,l9_383);
unpackValues(l9_380.x,l9_376,l9_383);
unpackValues(l9_381.w,l9_376,l9_383);
unpackValues(l9_381.z,l9_376,l9_383);
unpackValues(l9_381.y,l9_376,l9_383);
unpackValues(l9_381.x,l9_376,l9_383);
int l9_392[8]=l9_373;
unpackValues(l9_382.w,l9_376,l9_392);
unpackValues(l9_382.z,l9_376,l9_392);
unpackValues(l9_382.y,l9_376,l9_392);
unpackValues(l9_382.x,l9_376,l9_392);
}
l9_376++;
continue;
}
...
vec4 l9_397=texture2D(sc_OITFilteredDepthBoundsTexture,l9_371);
vec2 l9_398=l9_397.xy;
int l9_399;
#if (sc_SkinBonesCount>0)
{
l9_399=encodeDepth(((1.0-l9_397.x)*1000.0)+getDepthOrderingEpsilon(),l9_398);
}
#else
{
l9_399=0;
...
#endif
int l9_400=encodeDepth(viewSpaceDepth(),l9_398);
vec4 l9_401;
l9_401=l9_356*l9_356.w;
vec4 l9_402;
int l9_403=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_403<8)
{
int l9_404=l9_372[l9_403];
int l9_405=l9_400-l9_399;
bool l9_406=l9_404<l9_405;
bool l9_407;
if (l9_406)
{
l9_407=l9_372[l9_403]>0;
}
else
{
l9_407=l9_406;
...
if (l9_407)
{
vec3 l9_408=l9_401.xyz*(1.0-(float(l9_373[l9_403])/255.0));
l9_402=vec4(l9_408.x,l9_408.y,l9_408.z,l9_401.w);
}
else
{
l9_402=l9_401;
