...
#endif
float l9_10=l9_6;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_11=l9_10;
float l9_12=l9_8;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_13=l9_12;
vec2 l9_14;
float l9_15;
...
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_17=l9_11;
float l9_18=1.0;
sc_ClampUV(l9_17,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_16,l9_18);
float l9_19=l9_17;
float l9_20=l9_18;
bool l9_21;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
...
float l9_22=l9_13;
float l9_23=l9_20;
sc_ClampUV(l9_22,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_21,l9_23);
l9_15=l9_23;
...
#endif
vec2 l9_24=sc_TransformUV(l9_14,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_25=l9_24.x;
float l9_26=l9_15;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_26);
float l9_27=l9_24.y;
float l9_28=l9_26;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_28);
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),iridescenceMapLayout,l9_9);
vec4 l9_31=texture2D(iridescenceMap,l9_30.xy,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_32=mix(iridescenceMapBorderColor,l9_31,vec4(l9_29));
}
#else
{
l9_32=l9_31;
...
#endif
vec4 l9_33=baseColor*l9_32;
vec4 l9_34=mix(baseColor,l9_33*vec4(intensity),vec4(mixAmount));
vec3 l9_35;
...
#endif
vec3 l9_36=max(l9_34.xyz,vec3(0.0));
vec4 l9_37;
#if (sc_ProjectiveShadowsCaster)
{
l9_37=vec4(l9_36,Port_Opacity_N006);
}
#else
{
float l9_38=clamp(metallic,0.0,1.0);
float l9_39=clamp(roughness,0.0,1.0);
vec3 l9_40=ssSRGB_to_Linear(l9_36);
vec3 l9_41=normalize(l9_35);
vec3 l9_42=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_43;
#if (sc_SSAOEnabled)
{
l9_43=evaluateSSAO(varPos);
}
#else
{
l9_43=Port_AO_N006;
...
#endif
vec3 l9_44=vec3(l9_38);
vec3 l9_45=mix(vec3(0.039999999),l9_40*l9_38,l9_44);
vec3 l9_46=mix(l9_40*(1.0-l9_38),vec3(0.0),l9_44);
SurfaceProperties l9_47=SurfaceProperties(l9_46,Port_Opacity_N006,l9_41,varPos,l9_1,l9_38,l9_39,l9_42,l9_43,Port_SpecularAO_N006,vec3(1.0),l9_45);
vec4 l9_48=vec4(1.0);
vec3 l9_49;
vec3 l9_50;
vec3 l9_51;
...
l9_57=vec3(0.0);
l9_56=vec3(0.0);
LightingComponents l9_63;
LightProperties l9_64;
SurfaceProperties l9_65;
vec3 l9_66;
int l9_67=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_67<sc_DirectionalLightsCount)
{
LightingComponents l9_68=accumulateLight(LightingComponents(l9_56,l9_57,l9_62,l9_61,l9_59,l9_58),LightProperties(sc_DirectionalLights[l9_67].direction,sc_DirectionalLights[l9_67].color.xyz,sc_DirectionalLights[l9_67].color.w*l9_48[(l9_60<3) ? l9_60 : 3]),l9_47,l9_1);
l9_62=l9_68.indirectDiffuse;
l9_61=l9_68.indirectSpecular;
l9_60++;
l9_59=l9_68.emitted;
l9_58=l9_68.transmitted;
l9_57=l9_68.directSpecular;
l9_56=l9_68.directDiffuse;
l9_67++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_85<sc_PointLightsCount)
{
vec3 l9_87=sc_PointLights[l9_85].position-varPos;
vec3 l9_88=normalize(l9_87);
float l9_89=l9_48[(l9_86<3) ? l9_86 : 3];
float l9_90=clamp((dot(l9_88,sc_PointLights[l9_85].direction)*sc_PointLights[l9_85].angleScale)+sc_PointLights[l9_85].angleOffset,0.0,1.0);
float l9_91=(sc_PointLights[l9_85].color.w*l9_89)*(l9_90*l9_90);
float l9_92;
if (sc_PointLights[l9_85].falloffEnabled)
{
l9_92=l9_91*computeDistanceAttenuation(length(l9_87),sc_PointLights[l9_85].falloffEndDistance);
}
else
{
l9_92=l9_91;
...
l9_78=l9_86+1;
LightingComponents l9_93=accumulateLight(LightingComponents(l9_72,l9_73,l9_77,l9_76,l9_75,l9_74),LightProperties(l9_88,sc_PointLights[l9_85].color.xyz,l9_92),l9_47,l9_1);
l9_79=l9_93.directDiffuse;
l9_80=l9_93.directSpecular;
l9_81=l9_93.indirectDiffuse;
l9_82=l9_93.indirectSpecular;
l9_83=l9_93.emitted;
l9_84=l9_93.transmitted;
l9_77=l9_81;
l9_76=l9_82;
l9_86=l9_78;
l9_75=l9_83;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_97=abs(varShadowTex-vec2(0.5));
vec4 l9_98=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_97.x,l9_97.y),0.5);
l9_96=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_98.xyz,vec3(sc_ShadowColor.w)),vec3(l9_98.w*sc_ShadowDensity));
}
#else
{
l9_96=vec3(1.0);
...
{
vec2 l9_100=calcPanoramicTexCoordsFromDir(l9_41,sc_EnvmapRotation.y);
vec4 l9_101;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_102=calcSeamlessPanoramicUvsForSampling(l9_100,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_102=l9_100;
...
#endif
l9_101=sc_EnvmapSpecularSampleViewIndexBias(l9_102,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_103;
...
{
vec2 l9_104=calcSeamlessPanoramicUvsForSampling(l9_100,sc_EnvmapDiffuseSize.xy,0.0);
int l9_105;
...
#endif
l9_103=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_104,sc_EnvmapDiffuseLayout,l9_105).xy,-13.0);
}
#else
{
l9_103=sc_EnvmapSpecularSampleViewIndexBias(l9_100,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_101=l9_103;
}
#endif
l9_99=(l9_101.xyz*(1.0/l9_101.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_106;
...
float l9_109=l9_107.y;
float l9_110=l9_107.z;
l9_106=(((((((sc_Sh[8]*0.42904299)*((l9_108*l9_108)-(l9_109*l9_109)))+((sc_Sh[6]*0.74312502)*(l9_110*l9_110)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_108*l9_109))+(sc_Sh[7]*(l9_108*l9_110)))+(sc_Sh[5]*(l9_109*l9_110)))*0.85808599))+((((sc_Sh[3]*l9_108)+(sc_Sh[1]*l9_109))+(sc_Sh[2]*l9_110))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_106=vec3(0.0);
...
{
l9_112=l9_99+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_113=l9_99;
l9_113.x=l9_99.x+(1e-06*sc_AmbientLights[0].color.x);
l9_112=l9_113;
}
#endif
l9_111=l9_112;
...
{
float l9_124=dot(sc_LightEstimationData.sg[l9_123].axis,l9_41);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_135=clamp(pow(l9_39,0.66666669),0.0,1.0)*5.0;
vec2 l9_136=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_41,reflect(-l9_1,l9_41),l9_39),sc_EnvmapRotation.y);
vec4 l9_137;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_134=vec3(0.0)+((((l9_137.xyz*(1.0/l9_137.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_47,abs(dot(l9_41,l9_1))));
}
#else
{
l9_134=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_141=clamp(l9_39*l9_39,0.0099999998,1.0);
vec3 l9_142;
l9_142=sc_LightEstimationData.ambientLight*l9_45;
int l9_143=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_143<sc_LightEstimationSGCount)
{
float l9_144=l9_141*l9_141;
vec3 l9_145=reflect(-l9_1,l9_41);
float l9_146=dot(l9_41,l9_1);
float l9_147=(2.0/l9_144)/(4.0*max(l9_146,9.9999997e-05));
float l9_148=length((l9_145*l9_147)+(sc_LightEstimationData.sg[l9_143].axis*sc_LightEstimationData.sg[l9_143].sharpness));
float l9_149=clamp(dot(l9_41,l9_145),0.0,1.0);
float l9_150=clamp(l9_146,0.0,1.0);
float l9_151=1.0-l9_144;
l9_142+=((((((((vec3(1.0/(3.1415927*l9_144))*exp((l9_148-l9_147)-sc_LightEstimationData.sg[l9_143].sharpness))*sc_LightEstimationData.sg[l9_143].color)*6.2831855)*(1.0-exp((-2.0)*l9_148)))/vec3(l9_148))*((1.0/(l9_149+sqrt(l9_144+((l9_151*l9_149)*l9_149))))*(1.0/(l9_150+sqrt(l9_144+((l9_151*l9_150)*l9_150))))))*(l9_45+((vec3(1.0)-l9_45)*pow(1.0-clamp(dot(l9_145,normalize(l9_145+l9_1)),0.0,1.0),5.0))))*l9_149);
l9_143++;
continue;
}
else
...
l9_155=vec3(0.0);
l9_154=vec3(0.0);
l9_153=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_46,vec3(Port_Opacity_N006));
l9_152=1.0;
}
#else
{
...
#endif
vec3 l9_157=l9_154*l9_43;
vec3 l9_158=l9_155+l9_157;
vec3 l9_159=l9_46*l9_158;
vec3 l9_160=l9_140*Port_SpecularAO_N006;
vec3 l9_161=l9_94+l9_160;
vec3 l9_162;
if (l9_156)
{
l9_162=l9_159*srgbToLinear(l9_152);
}
else
{
l9_162=l9_159;
}
vec3 l9_163=l9_162+l9_161;
vec3 l9_164=(l9_163+l9_42)+l9_153;
float l9_165=l9_164.x;
vec4 l9_166=vec4(l9_165,l9_164.yz,l9_152);
vec4 l9_167;
#if (sc_IsEditor)
{
vec4 l9_168=l9_166;
l9_168.x=l9_165+((l9_43.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_167=l9_168;
}
#else
{
...
{
vec3 l9_170=l9_167.xyz*1.8;
vec3 l9_171=(l9_167.xyz*(l9_170+vec3(1.4)))/((l9_167.xyz*(l9_170+vec3(0.5)))+vec3(1.5));
l9_169=vec4(l9_171.x,l9_171.y,l9_171.z,l9_167.w);
}
#else
{
l9_169=l9_167;
...
#endif
vec3 l9_172=vec3(linearToSrgb(l9_169.x),linearToSrgb(l9_169.y),linearToSrgb(l9_169.z));
l9_37=vec4(l9_172.x,l9_172.y,l9_172.z,l9_169.w);
}
#endif
vec4 l9_173=max(l9_37,vec4(0.0));
vec4 l9_174;
#if (Tweak_N38)
{
int l9_175;
...
#endif
float l9_176=varPackedTex.x;
sc_SoftwareWrapEarly(l9_176,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_177=l9_176;
float l9_178=varPackedTex.y;
sc_SoftwareWrapEarly(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_179=l9_178;
vec2 l9_180;
float l9_181;
...
{
l9_182=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_182=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_183=l9_177;
float l9_184=1.0;
sc_ClampUV(l9_183,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_182,l9_184);
float l9_185=l9_183;
float l9_186=l9_184;
bool l9_187;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_187=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_187=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_188=l9_179;
float l9_189=l9_186;
sc_ClampUV(l9_188,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_187,l9_189);
l9_181=l9_189;
...
#endif
vec2 l9_190=sc_TransformUV(l9_180,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_191=l9_190.x;
float l9_192=l9_181;
sc_SoftwareWrapLate(l9_191,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_192);
float l9_193=l9_190.y;
float l9_194=l9_192;
sc_SoftwareWrapLate(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_194);
float l9_195=l9_194;
vec3 l9_196=sc_SamplingCoordsViewToGlobal(vec2(l9_191,l9_193),opacityTextureLayout,l9_175);
vec4 l9_197=texture2D(opacityTexture,l9_196.xy,0.0);
vec4 l9_198;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_198=mix(opacityTextureBorderColor,l9_197,vec4(l9_195));
}
#else
{
l9_198=l9_197;
...
#else
{
l9_174=vec4(Port_Input2_N040);
}
#endif
float l9_199=clamp((l9_34.w*l9_174.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_200=vec4(l9_173.x,l9_173.y,l9_173.z,vec4(0.0).w);
l9_200.w=l9_199;
vec4 l9_201;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_203=clamp(l9_199*2.0,0.0,1.0);
}
#else
{
float l9_204;
...
{
l9_204=clamp(dot(l9_200.xyz,vec3(l9_199)),0.0,1.0);
}
#else
{
float l9_205;
...
#if (sc_BlendMode_Multiply)
{
l9_206=(1.0-dot(l9_200.xyz,vec3(0.33333001)))*l9_199;
}
#else
{
float l9_207;
...
{
l9_207=(1.0-clamp(dot(l9_200.xyz,vec3(1.0)),0.0,1.0))*l9_199;
}
#else
{
float l9_208;
#if (sc_BlendMode_ColoredGlass)
{
l9_208=clamp(dot(l9_200.xyz,vec3(1.0)),0.0,1.0)*l9_199;
}
#else
{
float l9_209;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_210=clamp(dot(l9_200.xyz,vec3(1.0)),0.0,1.0)*l9_199;
}
#else
{
float l9_211;
...
{
l9_211=dot(l9_200.xyz,vec3(0.33333001))*l9_199;
}
#else
{
float l9_212;
...
{
vec3 l9_216=sc_GetFramebufferColor().xyz;
vec3 l9_217=mix(l9_216,definedBlend(l9_216,l9_200.xyz).xyz,vec3(l9_199));
vec4 l9_218=vec4(l9_217.x,l9_217.y,l9_217.z,vec4(0.0).w);
l9_218.w=1.0;
l9_215=l9_218;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_219=vec4(mix(vec3(1.0),l9_200.xyz,vec3(l9_199)),l9_199);
}
#else
{
vec4 l9_220;
...
#endif
l9_220=vec4(l9_200.xyz*l9_221,l9_221);
}
#else
{
l9_220=l9_200;
...
{
l9_224=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_224=vec4(0.0);
...
vec4 l9_226=outputMotionVectorsIfNeeded(varPos,max(l9_225,vec4(0.0)));
vec4 l9_227=clamp(l9_226,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_228=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_228-0.0039215689)),min(1.0,l9_228+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_229=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_229).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_230=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_229).xy);
float l9_231=packValue(l9_230);
int l9_238=int(l9_227.w*255.0);
float l9_239=packValue(l9_238);
sc_writeFragData0(vec4(packValue(l9_230),packValue(l9_230),packValue(l9_230),packValue(l9_230)));
sc_writeFragData1(vec4(l9_231,packValue(l9_230),packValue(l9_230),packValue(l9_230)));
sc_writeFragData2(vec4(l9_239,packValue(l9_238),packValue(l9_238),packValue(l9_238)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_242).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_247==0)
{
l9_250=texture2D(sc_OITAlpha0,l9_242);
l9_249=texture2D(sc_OITDepthLow0,l9_242);
l9_248=texture2D(sc_OITDepthHigh0,l9_242);
}
else
{
l9_250=vec4(0.0);
...
if (l9_247==1)
{
l9_253=texture2D(sc_OITAlpha1,l9_242);
l9_252=texture2D(sc_OITDepthLow1,l9_242);
l9_251=texture2D(sc_OITDepthHigh1,l9_242);
}
else
{
l9_253=l9_250;
...
if (any(notEqual(l9_251,vec4(0.0)))||any(notEqual(l9_252,vec4(0.0))))
{
int l9_254[8]=l9_243;
unpackValues(l9_251.w,l9_247,l9_254);
unpackValues(l9_251.z,l9_247,l9_254);
unpackValues(l9_251.y,l9_247,l9_254);
unpackValues(l9_251.x,l9_247,l9_254);
unpackValues(l9_252.w,l9_247,l9_254);
unpackValues(l9_252.z,l9_247,l9_254);
unpackValues(l9_252.y,l9_247,l9_254);
unpackValues(l9_252.x,l9_247,l9_254);
int l9_263[8]=l9_244;
unpackValues(l9_253.w,l9_247,l9_263);
unpackValues(l9_253.z,l9_247,l9_263);
unpackValues(l9_253.y,l9_247,l9_263);
unpackValues(l9_253.x,l9_247,l9_263);
}
l9_247++;
continue;
}
...
vec4 l9_268=texture2D(sc_OITFilteredDepthBoundsTexture,l9_242);
vec2 l9_269=l9_268.xy;
int l9_270;
#if (sc_SkinBonesCount>0)
{
l9_270=encodeDepth(((1.0-l9_268.x)*1000.0)+getDepthOrderingEpsilon(),l9_269);
}
#else
{
l9_270=0;
...
#endif
int l9_271=encodeDepth(viewSpaceDepth(),l9_269);
vec4 l9_272;
l9_272=l9_227*l9_227.w;
vec4 l9_273;
int l9_274=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_274<8)
{
int l9_275=l9_243[l9_274];
int l9_276=l9_271-l9_270;
bool l9_277=l9_275<l9_276;
bool l9_278;
if (l9_277)
{
l9_278=l9_243[l9_274]>0;
}
else
{
l9_278=l9_277;
...
if (l9_278)
{
vec3 l9_279=l9_272.xyz*(1.0-(float(l9_244[l9_274])/255.0));
l9_273=vec4(l9_279.x,l9_279.y,l9_279.z,l9_272.w);
}
else
{
l9_273=l9_272;
