...
//texture texture2D iridescenceMap 0:4:0:27
...
//texture texture2DArray intensityTextureArrSC 0:42:0:26
//texture texture2DArray iridescenceMapArrSC 0:43:0:27
...
float l9_7=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_8;
...
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_27);
}
#else
{
float l9_28=l9_6;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_29=l9_28;
float l9_30=l9_8;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_46);
}
#endif
vec3 l9_47;
...
#endif
if (dot(l9_1,l9_47)>=(-0.050000001))
{
uvec3 l9_48=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_48.x,l9_48.y,l9_48.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_49=abs(l9_47);
vec3 l9_50=l9_47/vec3(dot(l9_49,vec3(1.0)));
float l9_51=clamp(-l9_50.z,0.0,1.0);
float l9_52=l9_50.x;
float l9_53;
if (l9_52>=0.0)
{
...
uvec2 l9_57=uvec2(packHalf2x16(vec2(l9_54,0.0)),packHalf2x16(vec2(l9_55+l9_56,0.0)));
normal_and_more=uvec4(l9_57.x,l9_57.y,normal_and_more.z,normal_and_more.w);
...
{
l9_58=uint(clamp(roughness,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_58|uint((receiverId%32)<<int(10u));
}
else
{
...
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_60=l9_59;
float l9_61=varPackedTex.y;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_62=l9_61;
vec2 l9_63;
float l9_64;
...
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_66=l9_60;
float l9_67=1.0;
sc_ClampUV(l9_66,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_65,l9_67);
float l9_68=l9_66;
float l9_69=l9_67;
bool l9_70;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_70=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_71=l9_62;
float l9_72=l9_69;
sc_ClampUV(l9_71,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_70,l9_72);
l9_64=l9_72;
...
#endif
vec2 l9_73=sc_TransformUV(l9_63,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_74=l9_73.x;
float l9_75=l9_64;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_75);
float l9_76=l9_73.y;
float l9_77=l9_75;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_77);
}
#else
{
float l9_78=varPackedTex.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_79=l9_78;
float l9_80=varPackedTex.y;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_81=l9_80;
vec2 l9_82;
float l9_83;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
...
float l9_85=l9_79;
float l9_86=1.0;
sc_ClampUV(l9_85,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_84,l9_86);
float l9_87=l9_85;
float l9_88=l9_86;
bool l9_89;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_90=l9_81;
float l9_91=l9_88;
sc_ClampUV(l9_90,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_89,l9_91);
l9_83=l9_91;
...
#endif
vec2 l9_92=sc_TransformUV(l9_82,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_96);
}
#endif
}
#else
...
l9_4=l9_6;
l9_3=l9_5.uv0;
l9_2=(sc_ModelMatrixInverse*vec4(l9_6,1.0)).xyz;
l9_1=l9_5.normalWS;
l9_0=l9_5.viewDirWS;
}
else
...
float l9_7=dot(l9_0,l9_1);
float l9_8=1.0-clamp(l9_7,0.0,1.0);
float l9_9;
if (l9_8<=0.0)
{
l9_9=0.0;
...
{
l9_9=pow(l9_8,exponent);
}
float l9_10=snoise(vec2(floor((((floor(((snoise(vec2(floor(l9_2.x*10000.0)*9.9999997e-05,floor(l9_2.y*10000.0)*9.9999997e-05)*(noiseScale*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N011)-Port_Input1_N012)*10000.0)*9.9999997e-05,floor(l9_2.z*10000.0)*9.9999997e-05)*(Port_Scale_N041*0.5));
float l9_11=l9_9+((((floor(((l9_10*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_Input1_N025)*noiseIntensity)*Port_Input2_N021);
float l9_12=(((clamp(thinFilmWeight,0.0,1.0)-Port_RangeMinA_N049)/(Port_RangeMaxA_N049-Port_RangeMinA_N049))*(Port_RangeMaxB_N049-Port_RangeMinB_N049))+Port_RangeMinB_N049;
float l9_13;
if (Port_RangeMaxB_N049>Port_RangeMinB_N049)
{
l9_13=clamp(l9_12,Port_RangeMinB_N049,Port_RangeMaxB_N049);
}
else
{
l9_13=clamp(l9_12,Port_RangeMaxB_N049,Port_RangeMinB_N049);
}
vec4 l9_14;
#if (iridescenceMapLayout==2)
{
float l9_15=l9_11;
sc_SoftwareWrapEarly(l9_15,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_16=l9_15;
float l9_17=l9_13;
sc_SoftwareWrapEarly(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_18=l9_17;
vec2 l9_19;
float l9_20;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_22=l9_16;
float l9_23=1.0;
sc_ClampUV(l9_22,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_21,l9_23);
float l9_24=l9_22;
float l9_25=l9_23;
bool l9_26;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_27=l9_18;
float l9_28=l9_25;
sc_ClampUV(l9_27,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_26,l9_28);
l9_20=l9_28;
...
#endif
vec2 l9_29=sc_TransformUV(l9_19,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_30=l9_29.x;
float l9_31=l9_20;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_31);
float l9_32=l9_29.y;
float l9_33=l9_31;
sc_SoftwareWrapLate(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_33);
float l9_34=l9_33;
vec3 l9_35=sc_SamplingCoordsViewToGlobal(vec2(l9_30,l9_32),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_36=texture(iridescenceMapArrSC,l9_35,0.0);
vec4 l9_37;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_37=mix(iridescenceMapBorderColor,l9_36,vec4(l9_34));
}
#else
{
l9_37=l9_36;
...
{
float l9_38=l9_11;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x);
float l9_39=l9_38;
float l9_40=l9_13;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y);
float l9_41=l9_40;
vec2 l9_42;
float l9_43;
#if (SC_USE_UV_MIN_MAX_iridescenceMap)
...
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_45=l9_39;
float l9_46=1.0;
sc_ClampUV(l9_45,iridescenceMapUvMinMax.x,iridescenceMapUvMinMax.z,l9_44,l9_46);
float l9_47=l9_45;
float l9_48=l9_46;
bool l9_49;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0);
}
#endif
float l9_50=l9_41;
float l9_51=l9_48;
sc_ClampUV(l9_50,iridescenceMapUvMinMax.y,iridescenceMapUvMinMax.w,l9_49,l9_51);
l9_43=l9_51;
...
#endif
vec2 l9_52=sc_TransformUV(l9_42,(int(SC_USE_UV_TRANSFORM_iridescenceMap)!=0),iridescenceMapTransform);
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).x,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_iridescenceMap,SC_SOFTWARE_WRAP_MODE_V_iridescenceMap).y,(int(SC_USE_CLAMP_TO_BORDER_iridescenceMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_iridescenceMap)!=0)),l9_56);
float l9_57=l9_56;
vec3 l9_58=sc_SamplingCoordsViewToGlobal(vec2(l9_53,l9_55),iridescenceMapLayout,iridescenceMapGetStereoViewIndex());
vec4 l9_59=texture(iridescenceMap,l9_58.xy,0.0);
vec4 l9_60;
#if (SC_USE_CLAMP_TO_BORDER_iridescenceMap)
{
l9_60=mix(iridescenceMapBorderColor,l9_59,vec4(l9_57));
}
#else
{
l9_60=l9_59;
...
#endif
vec4 l9_61=baseColor*l9_14;
vec4 l9_62=mix(baseColor,l9_61*vec4(intensity),vec4(mixAmount));
vec3 l9_63;
#if (!sc_ProjectiveShadowsCaster)
{
l9_63=l9_1;
...
#endif
vec3 l9_64=max(l9_62.xyz,vec3(0.0));
vec4 l9_65;
#if (sc_ProjectiveShadowsCaster)
{
l9_65=vec4(l9_64,Port_Opacity_N006);
}
#else
{
l9_65=ngsCalculateLighting(l9_64,Port_Opacity_N006,l9_63,l9_4,l9_0,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
...
{
float l9_69=l9_3.x;
sc_SoftwareWrapEarly(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_70=l9_69;
float l9_71=l9_3.y;
sc_SoftwareWrapEarly(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_72=l9_71;
vec2 l9_73;
float l9_74;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_75=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_75=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_76=l9_70;
float l9_77=1.0;
sc_ClampUV(l9_76,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_75,l9_77);
float l9_78=l9_76;
float l9_79=l9_77;
bool l9_80;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_80=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
...
float l9_81=l9_72;
float l9_82=l9_79;
sc_ClampUV(l9_81,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_80,l9_82);
l9_74=l9_82;
...
#endif
vec2 l9_83=sc_TransformUV(l9_73,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_84=l9_83.x;
float l9_85=l9_74;
sc_SoftwareWrapLate(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_85);
float l9_86=l9_83.y;
float l9_87=l9_85;
sc_SoftwareWrapLate(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_87);
float l9_88=l9_87;
vec3 l9_89=sc_SamplingCoordsViewToGlobal(vec2(l9_84,l9_86),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_90=texture(opacityTextureArrSC,l9_89,0.0);
vec4 l9_91;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_91=mix(opacityTextureBorderColor,l9_90,vec4(l9_88));
}
#else
{
l9_91=l9_90;
...
{
float l9_92=l9_3.x;
sc_SoftwareWrapEarly(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_93=l9_92;
float l9_94=l9_3.y;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_95=l9_94;
vec2 l9_96;
float l9_97;
#if (SC_USE_UV_MIN_MAX_opacityTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_98=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_98=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_99=l9_93;
float l9_100=1.0;
sc_ClampUV(l9_99,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_98,l9_100);
float l9_101=l9_99;
float l9_102=l9_100;
bool l9_103;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_103=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
...
float l9_104=l9_95;
float l9_105=l9_102;
sc_ClampUV(l9_104,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_103,l9_105);
l9_97=l9_105;
...
#endif
vec2 l9_106=sc_TransformUV(l9_96,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_107=l9_106.x;
float l9_108=l9_97;
sc_SoftwareWrapLate(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_108);
float l9_109=l9_106.y;
float l9_110=l9_108;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_110);
float l9_111=l9_110;
vec3 l9_112=sc_SamplingCoordsViewToGlobal(vec2(l9_107,l9_109),opacityTextureLayout,opacityTextureGetStereoViewIndex());
vec4 l9_113=texture(opacityTexture,l9_112.xy,0.0);
vec4 l9_114;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_114=mix(opacityTextureBorderColor,l9_113,vec4(l9_111));
}
#else
{
l9_114=l9_113;
...
#else
{
l9_67=vec4(Port_Input2_N040);
}
#endif
float l9_115=clamp((l9_62.w*l9_67.x)+0.001,Port_Input1_N058+0.001,Port_Input2_N058+0.001)-0.001;
vec4 l9_116=vec4(l9_66.x,l9_66.y,l9_66.z,vec4(0.0).w);
l9_116.w=l9_115;
if (isProxyMode)
{
vec4 l9_117;
...
{
vec3 l9_134=sc_GetFramebufferColor().xyz;
vec3 l9_135=mix(l9_134,definedBlend(l9_134,l9_116.xyz).xyz,vec3(l9_115));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_137=vec4(mix(vec3(1.0),l9_116.xyz,vec3(l9_115)),l9_115);
}
#else
{
vec4 l9_138;
...
#endif
l9_138=vec4(l9_116.xyz*l9_139,l9_139);
}
#else
{
l9_138=l9_116;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_146-0.0039215689)),min(1.0,l9_146+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_148),packValue(l9_148),packValue(l9_148),packValue(l9_148)));
