...
//texture texture2DArray Tweak_N0ArrSC 0:25:0:16
...
#endif
vec3 l9_0=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_1=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_2=l9_1.x;
float l9_3=l9_1.y;
float l9_4=l9_1.z;
vec2 l9_5=((((((l9_0.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_2)+((((l9_0.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_3))+((((l9_0.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_4))/vec2((l9_2+l9_3)+l9_4);
vec4 l9_6;
#if (Tweak_N0Layout==2)
{
float l9_7=l9_5.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_8=l9_7;
float l9_9=l9_5.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_28=texture(Tweak_N0ArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_29=mix(Tweak_N0BorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
{
float l9_30=l9_5.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_31=l9_30;
float l9_32=l9_5.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
...
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0)),l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_51=texture(Tweak_N0,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_52=mix(Tweak_N0BorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
{
l9_55=clamp(l9_6.w*2.0,0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_56=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
#endif
vec3 l9_77=mix(l9_75.xyz,definedBlend(l9_75.xyz,l9_6.xyz).xyz,vec3(l9_6.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_6.w)),l9_6.w);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_6.xyz*l9_81,l9_81);
}
#else
{
l9_80=l9_6;
