...
vec2 l9_6=((l9_3-vec2(1.0))*l9_4.x)/vec2(l9_5.y);
float l9_7=sin(l9_0);
vec3 l9_8;
vec2 l9_9;
l9_9=l9_6;
...
if (l9_12<2.0)
{
l9_10=fract(l9_9*2.5999999)-vec2(0.5);
float l9_13=length(l9_6);
float l9_14=l9_12*0.2;
float l9_15=l9_0*0.40000001;
float l9_16;
l9_16=length(l9_10)*exp(-l9_13);
float l9_17=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_17<0.80000001)
{
l9_16=abs(sin((l9_16*16.0)+l9_0)/16.0);
l9_17+=1.0;
continue;
}
else
...
l9_11=l9_8+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_13+l9_14)+l9_15))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+(vec4(0.0)-vec4(fract(sin(dot(l9_6,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_7+2.0)))).xyz)*l9_19);
l9_9=l9_10;
l9_8=l9_11;
l9_12+=1.0;
continue;
