...
l9_74.w=Port_Value2_N014;
vec4 l9_75=l9_74*vec4(notification_tile_opacity);
float l9_76=l9_75.w;
...
#endif
sc_writeFragData0(max(l9_77,vec4(0.0)));
return;
}
vec4 l9_79;
...
{
l9_82=clamp(dot(l9_75.xyz,vec3(l9_76)),0.0,1.0);
}
#else
{
float l9_83;
...
{
l9_84=(1.0-dot(l9_75.xyz,vec3(0.33333001)))*l9_76;
}
#else
{
float l9_85;
...
{
l9_85=(1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0))*l9_76;
}
#else
{
float l9_86;
...
{
l9_86=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_76;
}
#else
{
float l9_87;
#if (sc_BlendMode_Add)
{
l9_87=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_88;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_88=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0)*l9_76;
}
#else
{
float l9_89;
...
{
l9_89=dot(l9_75.xyz,vec3(0.33333001))*l9_76;
}
#else
{
float l9_90;
#if (sc_BlendMode_Min)
{
l9_90=1.0-clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
#if (sc_BlendMode_Max)
{
l9_91=clamp(dot(l9_75.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_91=1.0;
...
#endif
l9_79=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_75.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_80);
}
#else
{
vec4 l9_92;
...
#endif
vec3 l9_103=mix(l9_101.xyz,definedBlend(l9_101.xyz,l9_75.xyz).xyz,vec3(l9_76));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_105=vec4(mix(vec3(1.0),l9_75.xyz,vec3(l9_76)),l9_76);
}
#else
{
vec4 l9_106;
...
#endif
l9_106=vec4(l9_75.xyz*l9_107,l9_107);
}
#else
{
l9_106=l9_75;
