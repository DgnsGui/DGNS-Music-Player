...
uniform vec3 Port_Scale_N002;
uniform vec3 Port_Offset_N002;
uniform float Port_Sharpness_N002;
uniform vec3 Port_Position_N002;
...
int N0_binarySearch(float nums[3],float searchnum)
{
int l9_0;
int l9_1;
int l9_2;
...
if (l9_3<l9_4)
{
if (nums[l9_5]<searchnum)
{
int l9_6=l9_5+1;
if (nums[l9_6]>searchnum)
{
return l9_5;
}
l9_2=l9_4;
...
float N0_lerp(float x0,float x1,float y0,float y1,float x)
{
float l9_0=x1;
float l9_1=x0;
...
vec2 l9_3=l9_1/vec2(0.25);
float l9_4=l9_3.x;
float l9_5=floor(l9_4);
float l9_6=l9_3.y;
float l9_7=floor(l9_6);
vec2 l9_8=sin(vec2(l9_5,l9_7));
float l9_9=ceil(l9_4);
vec2 l9_10=sin(vec2(l9_9,l9_7));
float l9_11=ceil(l9_6);
vec2 l9_12=sin(vec2(l9_5,l9_11));
vec2 l9_13=sin(vec2(l9_9,l9_11));
float l9_14=fract(l9_4);
float l9_15=fract(l9_6);
vec2 l9_16=vec2(l9_14,l9_15);
float l9_17=1.0-l9_14;
float l9_18=mix(l9_14*l9_14,1.0-(l9_17*l9_17),l9_14);
float l9_19=1.0-l9_15;
float l9_20=fract(((mix(mix(dot((vec2(fract(sin(dot(l9_8,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_8,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_16-vec2(0.0)),dot((vec2(fract(sin(dot(l9_10,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_10,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_16-vec2(1.0,0.0)),l9_18),mix(dot((vec2(fract(sin(dot(l9_12,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_12,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_16-vec2(0.0,1.0)),dot((vec2(fract(sin(dot(l9_13,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_13,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_16-vec2(1.0)),l9_18),mix(l9_15*l9_15,1.0-(l9_19*l9_19),l9_15))+(0.5*(l9_0*0.1)))+0.5)*mix(6.0,9.0,abs(sin(l9_0*0.001))));
float l9_21[3]=float[](0.0,(0.25*sin(l9_0))+0.5,1.0);
float l9_22[3]=l9_21;
vec3 l9_23[3]=vec3[](vec3(1.0/255.0,166.0/255.0,185.0/255.0),vec3(7.0/255.0),vec3(196.0/255.0,85.0/255.0,118.0/255.0));
int l9_24=N0_binarySearch(l9_21,l9_20);
int l9_25=l9_24+1;
float l9_26=N0_lerp(l9_22[l9_24],l9_22[l9_25],l9_23[l9_24].x,l9_23[l9_25].x,l9_20);
float l9_27=N0_lerp(l9_22[l9_24],l9_22[l9_25],l9_23[l9_24].y,l9_23[l9_25].y,l9_20);
float l9_28=N0_lerp(l9_22[l9_24],l9_22[l9_25],l9_23[l9_24].z,l9_23[l9_25].z,l9_20);
vec4 l9_29=vec4(l9_26,l9_27,l9_28,1.0);
...
{
l9_35=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_40;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_41=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_42;
...
{
l9_42=dot(l9_29.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_43;
...
{
l9_53=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_51,sc_ScreenTextureLayout,l9_52),0.0);
}
#else
{
l9_53=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_51,sc_ScreenTextureLayout,l9_52).xy,0.0);
}
#endif
l9_47=l9_53;
}
...
#endif
vec3 l9_56=definedBlend(l9_54.xyz,l9_29.xyz);
