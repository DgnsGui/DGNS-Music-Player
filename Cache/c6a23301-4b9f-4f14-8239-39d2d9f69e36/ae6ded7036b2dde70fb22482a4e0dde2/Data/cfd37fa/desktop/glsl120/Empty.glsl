...
vec2 l9_1=varPackedTex.xy/vec2(0.25);
float l9_2=l9_1.x;
float l9_3=floor(l9_2);
float l9_4=l9_1.y;
float l9_5=floor(l9_4);
vec2 l9_6=sin(vec2(l9_3,l9_5));
float l9_7=ceil(l9_2);
vec2 l9_8=sin(vec2(l9_7,l9_5));
float l9_9=ceil(l9_4);
vec2 l9_10=sin(vec2(l9_3,l9_9));
vec2 l9_11=sin(vec2(l9_7,l9_9));
float l9_12=fract(l9_2);
float l9_13=fract(l9_4);
vec2 l9_14=vec2(l9_12,l9_13);
float l9_15=1.0-l9_12;
float l9_16=mix(l9_12*l9_12,1.0-(l9_15*l9_15),l9_12);
float l9_17=1.0-l9_13;
float l9_18=fract(((mix(mix(dot((vec2(fract(sin(dot(l9_6,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_6,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_14-vec2(0.0)),dot((vec2(fract(sin(dot(l9_8,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_8,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_14-vec2(1.0,0.0)),l9_16),mix(dot((vec2(fract(sin(dot(l9_10,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_10,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_14-vec2(0.0,1.0)),dot((vec2(fract(sin(dot(l9_11,vec2(12.989,78.233002)))*143758.55),fract(sin(dot(l9_11,vec2(39.346001,11.135)))*143758.55))*2.0)-vec2(1.0),l9_14-vec2(1.0)),l9_16),mix(l9_13*l9_13,1.0-(l9_17*l9_17),l9_13))+(0.5*(l9_0*0.1)))+0.5)*mix(6.0,9.0,abs(sin(l9_0*0.001))));
float l9_19[3]=float[](0.0,(0.25*sin(l9_0))+0.5,1.0);
float l9_20[3]=l9_19;
vec3 l9_21[3]=vec3[](vec3(1.0/255.0,166.0/255.0,185.0/255.0),vec3(7.0/255.0),vec3(196.0/255.0,85.0/255.0,118.0/255.0));
int l9_22=N0_binarySearch(l9_19,l9_18);
int l9_23=l9_22+1;
float l9_24=N0_lerp(l9_20[l9_22],l9_20[l9_23],l9_21[l9_22].x,l9_21[l9_23].x,l9_18);
float l9_25=N0_lerp(l9_20[l9_22],l9_20[l9_23],l9_21[l9_22].y,l9_21[l9_23].y,l9_18);
float l9_26=N0_lerp(l9_20[l9_22],l9_20[l9_23],l9_21[l9_22].z,l9_21[l9_23].z,l9_18);
vec4 l9_27=vec4(l9_24,l9_25,l9_26,1.0);
...
{
l9_31=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_36;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_27.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_39;
...
#endif
vec3 l9_51=definedBlend(l9_49.xyz,l9_27.xyz);
