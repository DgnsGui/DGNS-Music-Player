...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_140=l9_120.w;
l9_139=vec4(mix(vec3(1.0),l9_120.xyz,vec3(l9_140)),l9_140);
}
#else
{
vec4 l9_141;
...
{
float l9_142=l9_120.w;
float l9_143;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_143=clamp(l9_142,0.0,1.0);
}
#else
{
l9_143=l9_142;
...
#endif
l9_141=vec4(l9_120.xyz*l9_143,l9_143);
}
#else
{
l9_141=l9_120;
...
#endif
int l9_152=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_151).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_164).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_169==0)
{
l9_172=texture2D(sc_OITAlpha0,l9_164);
l9_171=texture2D(sc_OITDepthLow0,l9_164);
l9_170=texture2D(sc_OITDepthHigh0,l9_164);
}
else
{
l9_172=vec4(0.0);
...
if (l9_169==1)
{
l9_175=texture2D(sc_OITAlpha1,l9_164);
l9_174=texture2D(sc_OITDepthLow1,l9_164);
l9_173=texture2D(sc_OITDepthHigh1,l9_164);
}
else
{
l9_175=l9_172;
...
vec4 l9_190=texture2D(sc_OITFilteredDepthBoundsTexture,l9_164);
