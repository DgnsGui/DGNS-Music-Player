...
// Déclarer le décorateur @component globalement (Lens Studio le fournit implicitement)
declare function component(target: any): void;

// Déclarer une interface pour ScriptComponent si nécessaire
interface ScriptComponent {
    createEvent(eventType: string): any; // Déclarer createEvent
    getSceneObject(): SceneObject;
    getTransform(): Transform;
    // Ajoutez d'autres méthodes nécessaires selon la doc Lens Studio
}

// Étendre une classe implicite ou déclarée
@component
export class OptimizedMusicPlayer extends (globalThis as any).ScriptComponent {
