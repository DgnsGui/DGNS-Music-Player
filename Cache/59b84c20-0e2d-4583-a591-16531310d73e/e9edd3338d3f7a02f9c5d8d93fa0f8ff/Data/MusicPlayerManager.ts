...
export class MusicPlayerManager extends BaseScriptComponent {
    ...
    onDestroy(): void {
        ...
        // The PinchButton component doesn't appear to have a method to remove event listeners
        // We'll null out the callbacks instead and disable our events
        
        // Null out callback references
        this.onPlayPauseCallback = null;
        this.onNextTrackCallback = null;
        this.onPrevTrackCallback = null;
