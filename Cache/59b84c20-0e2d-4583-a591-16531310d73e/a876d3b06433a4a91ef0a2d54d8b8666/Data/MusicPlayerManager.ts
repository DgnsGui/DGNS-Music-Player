// Pas d'import explicite de BaseScriptComponent car il est souvent implicite dans Lens Studio
// Si nécessaire, vérifiez la documentation officielle pour l'import exact
import { PinchButton } from 'SpectaclesInteractionKit/Components/UI/PinchButton/PinchButton';
import { InteractorEvent } from 'SpectaclesInteractionKit/Core/Interactor/InteractorEvent';

// Déclarer le décorateur @component globalement si non défini
declare function component(target: any): void;

@component
export class OptimizedMusicPlayer extends globalThis.ScriptComponent { // Utilisation de l'espace global de Lens Studio
    ...
    private initializePlayer(): void {
        this.delayedCall(0.1, () => {
            this.loadTrack(this.currentTrackIndex); // Correction de la faute de frappe
