...
// Déclarer le décorateur @component (fourni par Lens Studio)
declare function component(target: any): void;

// Déclarer les types de Lens Studio globalement pour éviter les erreurs TS2339
declare global {
    interface ScriptComponent {
        createEvent(eventType: "UpdateEvent"): SceneEvent;
    }
    ...
    interface SceneEvent {
        ...
        isSame(other: SceneEvent): boolean;
    }
}

@component
export class OptimizedMusicPlayer {
    ...
    @input('Component.ScriptComponent') nextTrackButton: PinchButton; // Corrigé la faute de frappe
