...
export class MusicPlayerManager {
    ...
    private audioComponent: any; // Use proper type if available
    private progressSphere: any; // Use proper type if available
    private startPosition: any; // Use proper type if available
    private musicTracks: any[] = []; // Use proper type if available
