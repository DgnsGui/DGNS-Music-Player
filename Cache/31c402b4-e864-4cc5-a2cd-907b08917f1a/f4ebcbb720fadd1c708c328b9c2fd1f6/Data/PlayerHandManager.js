...
function bindPinchButtonY2K() {
    ...
    if (script.pinchButtonY2K && script.pinchButtonY2K.onButtonPinched) {
        pinchButtonY2KHandler = function() {
            ...
            if (currentSkin === "Y2K") {
                switchToHand(); // Hand button in Y2K
            } else if (currentSkin === "Modern") {
                switchToY2K(); // Skin button in Modern
            } else if (currentSkin === "Hand") {
                switchToY2K(); // Skin button in Hand
            }
        };
    ...
    if (script.pinchButtonModern && script.pinchButtonModern.onButtonPinched) {
        pinchButtonModernHandler = function() {
            ...
            if (currentSkin === "Modern") {
                switchToHand(); // Hand button in Modern
            } else if (currentSkin === "Y2K") {
                switchToModern(); // Skin button in Y2K
            } else if (currentSkin === "Hand") {
                switchToModern(); // Skin button in Hand
            }
        };
...
function bindPinchButtonHand() {
    ...
    if (script.pinchButtonHand && script.pinchButtonHand.onButtonPinched) {
        pinchButtonHandHandler = function() {
            ...
            if (currentSkin === "Hand") {
                switchToModern(); // Hand button in Hand (returns to Modern)
            } else {
                switchToHand(); // Hand button in Y2K or Modern
            }
        };
...
function switchToY2K() {
    ...
    bindPinchButtonY2K(); // Hand button in Y2K
    bindPinchButtonModern(); // Skin button in Y2K
    currentSkin = "Y2K";
...
function switchToModern() {
    ...
    bindPinchButtonModern(); // Hand button in Modern
    bindPinchButtonY2K(); // Skin button in Modern
    currentSkin = "Modern";
...
function switchToHand() {
    ...
    bindPinchButtonHand(); // Hand button in Hand
    bindPinchButtonY2K(); // Skin button in Hand (to Y2K)
    currentSkin = "Hand";
