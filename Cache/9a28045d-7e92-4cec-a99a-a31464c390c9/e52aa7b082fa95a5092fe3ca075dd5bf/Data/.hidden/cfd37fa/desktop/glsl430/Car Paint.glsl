...
//sampler sampler noiseTextureSmpSC 0:26
...
//texture texture2D noiseTexture 0:4:0:26
...
//texture texture2DArray noiseTextureArrSC 0:41:0:26
...
uniform float clearRoughness;
uniform vec4 baseColor;
uniform vec4 glitterColor;
uniform float scale;
uniform vec4 noiseTextureSize;
uniform vec4 noiseTextureView;
uniform mat3 noiseTextureTransform;
uniform vec4 noiseTextureUvMinMax;
uniform vec4 noiseTextureBorderColor;
uniform float Intensity;
uniform vec4 fresnelColor;
uniform float baseRoughness;
uniform vec3 Port_Albedo_N090;
uniform float Port_Opacity_N090;
uniform vec3 Port_Normal_N090;
uniform vec3 Port_Emissive_N090;
uniform float Port_Metallic_N090;
uniform vec3 Port_SpecularAO_N090;
uniform vec3 Port_Import_N207;
uniform float Port_Input1_N208;
uniform vec3 Port_Import_N206;
uniform float Port_Import_N209;
uniform float Port_Input1_N018;
uniform float Port_Input2_N018;
uniform float Port_Import_N026;
uniform vec3 Port_Import_N020;
uniform float Port_Import_N054;
uniform vec4 Port_Input1_N019;
uniform vec4 Port_Input1_N044;
uniform float Port_Input1_N014;
uniform float Port_Opacity_N009;
uniform vec3 Port_Normal_N009;
uniform vec3 Port_Emissive_N009;
uniform float Port_Metallic_N009;
uniform vec3 Port_AO_N009;
uniform vec3 Port_SpecularAO_N009;
...
#endif
#ifndef noiseTextureHasSwappedViews
#define noiseTextureHasSwappedViews 0
#elif noiseTextureHasSwappedViews==1
#undef noiseTextureHasSwappedViews
#define noiseTextureHasSwappedViews 1
#endif
#ifndef noiseTextureLayout
#define noiseTextureLayout 0
#endif
struct sc_LightEstimationData_t
{
sc_SphericalGaussianLight_t sg[12];
...
#endif
#ifndef normalizeScale
#define normalizeScale 0
#elif normalizeScale==1
#undef normalizeScale
#define normalizeScale 1
#endif
#ifndef SC_USE_UV_TRANSFORM_noiseTexture
#define SC_USE_UV_TRANSFORM_noiseTexture 0
#elif SC_USE_UV_TRANSFORM_noiseTexture==1
#undef SC_USE_UV_TRANSFORM_noiseTexture
#define SC_USE_UV_TRANSFORM_noiseTexture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_noiseTexture
#define SC_SOFTWARE_WRAP_MODE_U_noiseTexture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_noiseTexture
#define SC_SOFTWARE_WRAP_MODE_V_noiseTexture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_noiseTexture
#define SC_USE_UV_MIN_MAX_noiseTexture 0
#elif SC_USE_UV_MIN_MAX_noiseTexture==1
#undef SC_USE_UV_MIN_MAX_noiseTexture
#define SC_USE_UV_MIN_MAX_noiseTexture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_noiseTexture
#define SC_USE_CLAMP_TO_BORDER_noiseTexture 0
#elif SC_USE_CLAMP_TO_BORDER_noiseTexture==1
#undef SC_USE_CLAMP_TO_BORDER_noiseTexture
#define SC_USE_CLAMP_TO_BORDER_noiseTexture 1
#endif
#ifndef sc_DepthOnly
...
int noiseTextureGetStereoViewIndex()
{
int l9_0;
#if (noiseTextureHasSwappedViews)
{
...
#endif
ngsAlphaTest(Port_Opacity_N090);
sc_WriteReceiverData(varPos,l9_2,clearRoughness);
vec3 l9_3;
#if (normalizeScale)
{
l9_3=(l9_1/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(Port_Import_N054,0.0));
}
#else
{
l9_3=l9_1;
...
#endif
vec3 l9_4=(l9_3+Port_Import_N206)*(vec3(scale)*vec3(Port_Input1_N208));
vec3 l9_5=abs(normalize((sc_ModelMatrixInverse*vec4(l9_0,0.0)).xyz));
float l9_6=l9_5.x;
float l9_7=l9_5.y;
bool l9_8=l9_6>l9_7;
bool l9_9;
...
{
bvec3 l9_15=bvec3(l9_7<l9_5.z);
l9_14=ivec3(l9_15.x ? ivec3(1,2,0).x : ivec3(2,0,1).x,l9_15.y ? ivec3(1,2,0).y : ivec3(2,0,1).y,l9_15.z ? ivec3(1,2,0).z : ivec3(2,0,1).z);
}
ivec3 l9_16=ivec3(3)-l9_14;
ivec3 l9_17=l9_16-l9_10;
float l9_18=l9_4[l9_10.y];
float l9_19=l9_4[l9_10.z];
#if (noiseTextureLayout==2)
{
float l9_20=l9_18;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_21=l9_20;
float l9_22=l9_19;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
{
bool l9_26;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_38);
}
#else
{
float l9_39=l9_18;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_40=l9_39;
float l9_41=l9_19;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_42=l9_41;
vec2 l9_43;
float l9_44;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_46=l9_40;
float l9_47=1.0;
sc_ClampUV(l9_46,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_45,l9_47);
float l9_48=l9_46;
float l9_49=l9_47;
bool l9_50;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_51=l9_42;
float l9_52=l9_49;
sc_ClampUV(l9_51,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_50,l9_52);
l9_44=l9_52;
...
#endif
vec2 l9_53=sc_TransformUV(l9_43,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_54=l9_53.x;
float l9_55=l9_44;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_55);
float l9_56=l9_53.y;
float l9_57=l9_55;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_57);
}
#endif
int l9_58=l9_17.y;
float l9_59=l9_4[l9_58];
int l9_60=l9_17.z;
float l9_61=l9_4[l9_60];
#if (noiseTextureLayout==2)
{
float l9_62=l9_59;
sc_SoftwareWrapEarly(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_63=l9_62;
float l9_64=l9_61;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_65=l9_64;
vec2 l9_66;
float l9_67;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_68=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_69=l9_63;
float l9_70=1.0;
sc_ClampUV(l9_69,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_68,l9_70);
float l9_71=l9_69;
float l9_72=l9_70;
bool l9_73;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_73=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_74=l9_65;
float l9_75=l9_72;
sc_ClampUV(l9_74,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_73,l9_75);
l9_67=l9_75;
...
#endif
vec2 l9_76=sc_TransformUV(l9_66,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_77=l9_76.x;
float l9_78=l9_67;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_78);
float l9_79=l9_76.y;
float l9_80=l9_78;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_80);
}
#else
{
float l9_81=l9_59;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_82=l9_81;
float l9_83=l9_61;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_99);
}
#endif
vec3 l9_100;
#if (!sc_ProjectiveShadowsCaster)
...
#endif
ngsAlphaTest(Port_Opacity_N009);
sc_WriteReceiverData(varPos,l9_100,baseRoughness);
}
...
uniform sampler2DArray noiseTextureArrSC;
...
l9_3=l9_6;
l9_2=l9_7;
l9_1=(sc_ModelMatrixInverse*vec4(l9_6,1.0)).xyz;
l9_0=normalize((sc_ModelMatrixInverse*vec4(l9_7,0.0)).xyz);
}
else
{
vec3 l9_8=normalize(varNormal);
l9_4=normalize(sc_Camera.position-varPos);
l9_3=varPos;
l9_2=l9_8;
l9_1=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
l9_0=normalize((sc_ModelMatrixInverse*vec4(l9_8,0.0)).xyz);
}
vec3 l9_9;
#if (!sc_ProjectiveShadowsCaster)
{
...
#if (sc_ProjectiveShadowsCaster)
{
l9_10=vec4(Port_Albedo_N090,Port_Opacity_N090);
}
#else
{
l9_10=ngsCalculateLighting(Port_Albedo_N090,Port_Opacity_N090,l9_9,l9_3,l9_4,Port_Emissive_N090,Port_Metallic_N090,clamp(clearRoughness,0.0,1.0),vec3(1.0),Port_SpecularAO_N090);
}
#endif
...
#if (normalizeScale)
{
l9_12=(l9_1/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(Port_Import_N054,0.0));
}
#else
{
l9_12=l9_1;
...
#endif
vec3 l9_13=(l9_12+Port_Import_N206)*(vec3(scale)*vec3(Port_Input1_N208));
vec3 l9_14=abs(l9_0);
float l9_15=l9_14.x;
float l9_16=l9_14.y;
bool l9_17=l9_15>l9_16;
bool l9_18;
if (l9_17)
{
l9_18=l9_14.x>l9_14.z;
}
else
{
l9_18=l9_17;
...
{
bvec3 l9_20=bvec3(l9_14.y>l9_14.z);
l9_19=ivec3(l9_20.x ? ivec3(1,2,0).x : ivec3(2,0,1).x,l9_20.y ? ivec3(1,2,0).y : ivec3(2,0,1).y,l9_20.z ? ivec3(1,2,0).z : ivec3(2,0,1).z);
}
float l9_21=l9_14.x;
float l9_22=l9_14.y;
bool l9_23=l9_21<l9_22;
bool l9_24;
if (l9_23)
{
l9_24=l9_14.x<l9_14.z;
}
else
{
l9_24=l9_23;
...
{
bvec3 l9_26=bvec3(l9_14.y<l9_14.z);
l9_25=ivec3(l9_26.x ? ivec3(1,2,0).x : ivec3(2,0,1).x,l9_26.y ? ivec3(1,2,0).y : ivec3(2,0,1).y,l9_26.z ? ivec3(1,2,0).z : ivec3(2,0,1).z);
}
ivec3 l9_27=ivec3(3)-l9_25;
ivec3 l9_28=l9_27-l9_19;
float l9_29=l9_13[l9_19.y];
float l9_30=l9_13[l9_19.z];
vec4 l9_31;
#if (noiseTextureLayout==2)
{
float l9_32=l9_29;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_33=l9_32;
float l9_34=l9_30;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_35=l9_34;
vec2 l9_36;
float l9_37;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_39=l9_33;
float l9_40=1.0;
sc_ClampUV(l9_39,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_38,l9_40);
float l9_41=l9_39;
float l9_42=l9_40;
bool l9_43;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_44=l9_35;
float l9_45=l9_42;
sc_ClampUV(l9_44,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_43,l9_45);
l9_37=l9_45;
...
#endif
vec2 l9_46=sc_TransformUV(l9_36,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_47=l9_46.x;
float l9_48=l9_37;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_48);
float l9_49=l9_46.y;
float l9_50=l9_48;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_50);
float l9_51=l9_50;
vec3 l9_52=sc_SamplingCoordsViewToGlobal(vec2(l9_47,l9_49),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_53=texture(noiseTextureArrSC,l9_52,0.0);
vec4 l9_54;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_54=mix(noiseTextureBorderColor,l9_53,vec4(l9_51));
}
#else
{
l9_54=l9_53;
...
{
float l9_55=l9_29;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_56=l9_55;
float l9_57=l9_30;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_73);
float l9_74=l9_73;
vec3 l9_75=sc_SamplingCoordsViewToGlobal(vec2(l9_70,l9_72),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_76=texture(noiseTexture,l9_75.xy,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_77=mix(noiseTextureBorderColor,l9_76,vec4(l9_74));
}
#else
{
l9_77=l9_76;
...
#endif
int l9_78=l9_28.y;
float l9_79=l9_13[l9_78];
int l9_80=l9_28.z;
float l9_81=l9_13[l9_80];
vec4 l9_82;
#if (noiseTextureLayout==2)
{
float l9_83=l9_79;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_84=l9_83;
float l9_85=l9_81;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_86=l9_85;
vec2 l9_87;
float l9_88;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_90=l9_84;
float l9_91=1.0;
sc_ClampUV(l9_90,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_89,l9_91);
float l9_92=l9_90;
float l9_93=l9_91;
bool l9_94;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_94=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_94=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_95=l9_86;
float l9_96=l9_93;
sc_ClampUV(l9_95,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_94,l9_96);
l9_88=l9_96;
...
#endif
vec2 l9_97=sc_TransformUV(l9_87,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_98=l9_97.x;
float l9_99=l9_88;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_99);
float l9_100=l9_97.y;
float l9_101=l9_99;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_101);
float l9_102=l9_101;
vec3 l9_103=sc_SamplingCoordsViewToGlobal(vec2(l9_98,l9_100),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_104=texture(noiseTextureArrSC,l9_103,0.0);
vec4 l9_105;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_105=mix(noiseTextureBorderColor,l9_104,vec4(l9_102));
}
#else
{
l9_105=l9_104;
...
{
float l9_106=l9_79;
sc_SoftwareWrapEarly(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_107=l9_106;
float l9_108=l9_81;
sc_SoftwareWrapEarly(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_109=l9_108;
vec2 l9_110;
float l9_111;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_112=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_113=l9_107;
float l9_114=1.0;
sc_ClampUV(l9_113,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_112,l9_114);
float l9_115=l9_113;
float l9_116=l9_114;
bool l9_117;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_117=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_117=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_118=l9_109;
float l9_119=l9_116;
sc_ClampUV(l9_118,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_117,l9_119);
l9_111=l9_119;
...
#endif
vec2 l9_120=sc_TransformUV(l9_110,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_121=l9_120.x;
float l9_122=l9_111;
sc_SoftwareWrapLate(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_122);
float l9_123=l9_120.y;
float l9_124=l9_122;
sc_SoftwareWrapLate(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_124);
float l9_125=l9_124;
vec3 l9_126=sc_SamplingCoordsViewToGlobal(vec2(l9_121,l9_123),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_127=texture(noiseTexture,l9_126.xy,0.0);
vec4 l9_128;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_128=mix(noiseTextureBorderColor,l9_127,vec4(l9_125));
}
#else
{
l9_128=l9_127;
...
#endif
float l9_129=l9_14[l9_19.x];
float l9_130=l9_14[l9_28.x];
vec2 l9_131=pow(vec2(l9_129,l9_130),vec2(1.0/(1.0-((clamp(Port_Import_N209+0.001,Port_Input1_N018+0.001,Port_Input2_N018+0.001)-0.001)*0.99000001))));
float l9_132=l9_131.x;
vec4 l9_133=l9_31*l9_132;
float l9_134=l9_131.y;
vec4 l9_135=l9_82*l9_134;
float l9_136=dot(abs((((l9_133+l9_135)/vec4(l9_132+l9_134))*Port_Input1_N019)-Port_Input1_N044).xyz,vec3(0.29899999,0.58700001,0.114));
float l9_137=dot(l9_4,l9_2);
float l9_138=clamp(l9_137,0.0,1.0);
vec3 l9_139;
#if (!sc_ProjectiveShadowsCaster)
{
l9_139=l9_2;
...
#endif
ngsAlphaTest(Port_Opacity_N009);
vec3 l9_140=max(mix(baseColor,(glitterColor*vec4(mix((l9_136*l9_136)*Intensity,Port_Input1_N014,l9_138)))+fresnelColor,vec4(l9_138)).xyz,vec3(0.0));
vec4 l9_141;
#if (sc_ProjectiveShadowsCaster)
{
l9_141=vec4(l9_140,Port_Opacity_N009);
}
#else
{
l9_141=ngsCalculateLighting(l9_140,Port_Opacity_N009,l9_139,l9_3,l9_4,Port_Emissive_N009,Port_Metallic_N009,clamp(baseRoughness,0.0,1.0),Port_AO_N009,Port_SpecularAO_N009);
}
#endif
vec4 l9_142=max(l9_141,vec4(0.0));
vec4 l9_143=l9_11+l9_142;
if (isProxyMode)
{
vec4 l9_144;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_144,vec4(0.0)));
return;
}
vec4 l9_146;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_148=clamp(l9_143.w*2.0,0.0,1.0);
}
#else
{
float l9_149;
...
{
l9_149=clamp(dot(l9_143.xyz,vec3(l9_143.w)),0.0,1.0);
}
#else
{
float l9_150;
...
#if (sc_BlendMode_Multiply)
{
l9_151=(1.0-dot(l9_143.xyz,vec3(0.33333001)))*l9_143.w;
}
#else
{
float l9_152;
...
{
l9_152=(1.0-clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0))*l9_143.w;
}
#else
{
float l9_153;
...
#if (sc_BlendMode_Add)
{
l9_154=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_155;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_155=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0)*l9_143.w;
}
#else
{
float l9_156;
...
{
l9_156=dot(l9_143.xyz,vec3(0.33333001))*l9_143.w;
}
#else
{
float l9_157;
#if (sc_BlendMode_Min)
{
l9_157=1.0-clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_158;
#if (sc_BlendMode_Max)
{
l9_158=clamp(dot(l9_143.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_158=1.0;
...
#endif
l9_146=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_143.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_147);
}
#else
{
vec4 l9_159;
...
{
vec3 l9_161=sc_GetFramebufferColor().xyz;
vec3 l9_162=mix(l9_161,definedBlend(l9_161,l9_143.xyz).xyz,vec3(l9_143.w));
...
l9_164=vec4(mix(vec3(1.0),l9_143.xyz,vec3(l9_165)),l9_165);
}
#else
{
vec4 l9_166;
...
{
float l9_167=l9_143.w;
float l9_168;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_168=clamp(l9_167,0.0,1.0);
}
#else
{
l9_168=l9_167;
...
#endif
l9_166=vec4(l9_143.xyz*l9_168,l9_168);
}
#else
{
l9_166=l9_143;
...
{
l9_171=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_171=vec4(0.0);
...
vec4 l9_173=outputMotionVectorsIfNeeded(varPos,max(l9_172,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_175-0.0039215689)),min(1.0,l9_175+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_177),packValue(l9_177),packValue(l9_177),packValue(l9_177)));
