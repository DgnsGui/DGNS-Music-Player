...
//sampler sampler noiseTextureSmpSC 0:17
...
//texture texture2D noiseTexture 0:1:0:17
...
#if (sc_ProjectiveShadowsCaster)
{
l9_4=vec4(Port_Albedo_N090,Port_Opacity_N090);
}
#else
{
l9_4=ngsCalculateLighting(Port_Albedo_N090,Port_Opacity_N090,l9_3,varPos,l9_2,Port_Emissive_N090,Port_Metallic_N090,clamp(clearRoughness,0.0,1.0),vec3(1.0),Port_SpecularAO_N090);
}
#endif
vec4 l9_5=max(l9_4,vec4(0.0));
vec3 l9_6;
#if (normalizeScale)
{
l9_6=(l9_1/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(Port_Import_N054,0.0));
}
#else
{
l9_6=l9_1;
...
#endif
vec3 l9_7=(l9_6+Port_Import_N206)*(vec3(scale)*vec3(Port_Input1_N208));
vec3 l9_8=abs(normalize((sc_ModelMatrixInverse*vec4(l9_0,0.0)).xyz));
float l9_9=l9_8.x;
float l9_10=l9_8.y;
bool l9_11=l9_9>l9_10;
bool l9_12;
if (l9_11)
{
l9_12=l9_8.x>l9_8.z;
...
{
bvec3 l9_14=bvec3(l9_8.y>l9_8.z);
l9_13=ivec3(l9_14.x ? ivec3(1,2,0).x : ivec3(2,0,1).x,l9_14.y ? ivec3(1,2,0).y : ivec3(2,0,1).y,l9_14.z ? ivec3(1,2,0).z : ivec3(2,0,1).z);
}
float l9_15=l9_8.x;
float l9_16=l9_8.y;
...
{
bvec3 l9_20=bvec3(l9_8.y<l9_8.z);
l9_19=ivec3(l9_20.x ? ivec3(1,2,0).x : ivec3(2,0,1).x,l9_20.y ? ivec3(1,2,0).y : ivec3(2,0,1).y,l9_20.z ? ivec3(1,2,0).z : ivec3(2,0,1).z);
}
ivec3 l9_21=ivec3(3)-l9_19;
ivec3 l9_22=l9_21-l9_13;
float l9_23=l9_7[l9_13.y];
sc_SoftwareWrapEarly(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_24=l9_23;
float l9_25=l9_7[l9_13.z];
sc_SoftwareWrapEarly(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_26=l9_25;
vec2 l9_27;
float l9_28;
...
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_30=l9_24;
float l9_31=1.0;
sc_ClampUV(l9_30,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_29,l9_31);
float l9_32=l9_30;
float l9_33=l9_31;
bool l9_34;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_35=l9_26;
float l9_36=l9_33;
sc_ClampUV(l9_35,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_34,l9_36);
l9_28=l9_36;
...
#endif
vec2 l9_37=sc_TransformUV(l9_27,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_38=l9_37.x;
float l9_39=l9_28;
sc_SoftwareWrapLate(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_39);
float l9_40=l9_37.y;
float l9_41=l9_39;
sc_SoftwareWrapLate(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_41);
float l9_42=l9_41;
vec3 l9_43=sc_SamplingCoordsViewToGlobal(vec2(l9_38,l9_40),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_44=texture2D(noiseTexture,l9_43.xy,0.0);
vec4 l9_45;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_45=mix(noiseTextureBorderColor,l9_44,vec4(l9_42));
}
#else
{
l9_45=l9_44;
...
#endif
float l9_46=l9_7[l9_22.y];
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x);
float l9_47=l9_46;
float l9_48=l9_7[l9_22.z];
sc_SoftwareWrapEarly(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y);
float l9_49=l9_48;
vec2 l9_50;
float l9_51;
#if (SC_USE_UV_MIN_MAX_noiseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_53=l9_47;
float l9_54=1.0;
sc_ClampUV(l9_53,noiseTextureUvMinMax.x,noiseTextureUvMinMax.z,l9_52,l9_54);
float l9_55=l9_53;
float l9_56=l9_54;
bool l9_57;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0);
}
#endif
float l9_58=l9_49;
float l9_59=l9_56;
sc_ClampUV(l9_58,noiseTextureUvMinMax.y,noiseTextureUvMinMax.w,l9_57,l9_59);
l9_51=l9_59;
...
#endif
vec2 l9_60=sc_TransformUV(l9_50,(int(SC_USE_UV_TRANSFORM_noiseTexture)!=0),noiseTextureTransform);
float l9_61=l9_60.x;
float l9_62=l9_51;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).x,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_62);
float l9_63=l9_60.y;
float l9_64=l9_62;
sc_SoftwareWrapLate(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_noiseTexture,SC_SOFTWARE_WRAP_MODE_V_noiseTexture).y,(int(SC_USE_CLAMP_TO_BORDER_noiseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_noiseTexture)!=0)),l9_64);
float l9_65=l9_64;
vec3 l9_66=sc_SamplingCoordsViewToGlobal(vec2(l9_61,l9_63),noiseTextureLayout,noiseTextureGetStereoViewIndex());
vec4 l9_67=texture2D(noiseTexture,l9_66.xy,0.0);
vec4 l9_68;
#if (SC_USE_CLAMP_TO_BORDER_noiseTexture)
{
l9_68=mix(noiseTextureBorderColor,l9_67,vec4(l9_65));
}
#else
{
l9_68=l9_67;
...
#endif
float l9_69=l9_8[l9_13.x];
float l9_70=l9_8[l9_22.x];
vec2 l9_71=pow(vec2(l9_69,l9_70),vec2(1.0/(1.0-((clamp(Port_Import_N209+0.001,Port_Input1_N018+0.001,Port_Input2_N018+0.001)-0.001)*0.99000001))));
float l9_72=l9_71.x;
vec4 l9_73=l9_45*l9_72;
float l9_74=l9_71.y;
vec4 l9_75=l9_68*l9_74;
float l9_76=dot(abs((((l9_73+l9_75)/vec4(l9_72+l9_74))*Port_Input1_N019)-Port_Input1_N044).xyz,vec3(0.29899999,0.58700001,0.114));
float l9_77=clamp(dot(l9_2,l9_0),0.0,1.0);
vec3 l9_78;
#if (!sc_ProjectiveShadowsCaster)
{
l9_78=l9_0;
...
vec3 l9_79=max(mix(baseColor,(glitterColor*vec4(mix((l9_76*l9_76)*Intensity,Port_Input1_N014,l9_77)))+fresnelColor,vec4(l9_77)).xyz,vec3(0.0));
vec4 l9_80;
#if (sc_ProjectiveShadowsCaster)
{
l9_80=vec4(l9_79,Port_Opacity_N009);
}
#else
{
l9_80=ngsCalculateLighting(l9_79,Port_Opacity_N009,l9_78,varPos,l9_2,Port_Emissive_N009,Port_Metallic_N009,clamp(baseRoughness,0.0,1.0),Port_AO_N009,Port_SpecularAO_N009);
}
#endif
vec4 l9_81=max(l9_80,vec4(0.0));
vec4 l9_82=l9_5+l9_81;
vec4 l9_83;
#if (sc_ProjectiveShadowsCaster)
{
float l9_84;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_85=clamp(l9_82.w*2.0,0.0,1.0);
}
#else
{
float l9_86;
...
{
l9_86=clamp(dot(l9_82.xyz,vec3(l9_82.w)),0.0,1.0);
}
#else
{
float l9_87;
...
#if (sc_BlendMode_Multiply)
{
l9_88=(1.0-dot(l9_82.xyz,vec3(0.33333001)))*l9_82.w;
}
#else
{
float l9_89;
...
{
l9_89=(1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0))*l9_82.w;
}
#else
{
float l9_90;
#if (sc_BlendMode_ColoredGlass)
{
l9_90=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0)*l9_82.w;
}
#else
{
float l9_91;
#if (sc_BlendMode_Add)
{
l9_91=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_92;
...
{
l9_93=dot(l9_82.xyz,vec3(0.33333001))*l9_82.w;
}
#else
{
float l9_94;
#if (sc_BlendMode_Min)
{
l9_94=1.0-clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_95;
#if (sc_BlendMode_Max)
{
l9_95=clamp(dot(l9_82.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_95=1.0;
...
#endif
l9_83=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_82.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_84);
}
#else
{
vec4 l9_96;
...
{
vec3 l9_98=sc_GetFramebufferColor().xyz;
vec3 l9_99=mix(l9_98,definedBlend(l9_98,l9_82.xyz).xyz,vec3(l9_82.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_102=l9_82.w;
l9_101=vec4(mix(vec3(1.0),l9_82.xyz,vec3(l9_102)),l9_102);
}
#else
{
vec4 l9_103;
...
#endif
l9_103=vec4(l9_82.xyz*l9_105,l9_105);
}
#else
{
l9_103=l9_82;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_112-0.0039215689)),min(1.0,l9_112+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_114=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_113).xy);
float l9_115=packValue(l9_114);
int l9_122=int(l9_111.w*255.0);
float l9_123=packValue(l9_122);
sc_writeFragData0(vec4(packValue(l9_114),packValue(l9_114),packValue(l9_114),packValue(l9_114)));
...
if (l9_131==0)
{
l9_134=texture2D(sc_OITAlpha0,l9_126);
l9_133=texture2D(sc_OITDepthLow0,l9_126);
l9_132=texture2D(sc_OITDepthHigh0,l9_126);
}
else
{
l9_134=vec4(0.0);
...
if (l9_131==1)
{
l9_137=texture2D(sc_OITAlpha1,l9_126);
l9_136=texture2D(sc_OITDepthLow1,l9_126);
l9_135=texture2D(sc_OITDepthHigh1,l9_126);
}
else
{
l9_137=l9_134;
...
vec4 l9_152=texture2D(sc_OITFilteredDepthBoundsTexture,l9_126);
