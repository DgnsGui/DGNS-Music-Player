...
//sampler sampler Tweak_N24SmpSC 0:17
...
//texture texture2D Tweak_N24 0:0:0:17
...
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).x);
float l9_9=l9_8;
float l9_10=varPackedTex.y;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).y);
float l9_11=l9_10;
vec2 l9_12;
float l9_13;
...
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).x==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N24)!=0);
}
#endif
float l9_15=l9_9;
float l9_16=1.0;
sc_ClampUV(l9_15,Tweak_N24UvMinMax.x,Tweak_N24UvMinMax.z,l9_14,l9_16);
float l9_17=l9_15;
float l9_18=l9_16;
bool l9_19;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N24)
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).y==3;
}
#else
{
l9_19=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N24)!=0);
}
#endif
float l9_20=l9_11;
float l9_21=l9_18;
sc_ClampUV(l9_20,Tweak_N24UvMinMax.y,Tweak_N24UvMinMax.w,l9_19,l9_21);
l9_13=l9_21;
...
#endif
vec2 l9_22=sc_TransformUV(l9_12,(int(SC_USE_UV_TRANSFORM_Tweak_N24)!=0),Tweak_N24Transform);
float l9_23=l9_22.x;
float l9_24=l9_13;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N24)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N24)!=0)),l9_24);
float l9_25=l9_22.y;
float l9_26=l9_24;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N24,SC_SOFTWARE_WRAP_MODE_V_Tweak_N24).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N24)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N24)!=0)),l9_26);
float l9_27=l9_26;
vec3 l9_28=sc_SamplingCoordsViewToGlobal(vec2(l9_23,l9_25),Tweak_N24Layout,l9_7);
vec4 l9_29=texture2D(Tweak_N24,l9_28.xy,0.0);
vec4 l9_30;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N24)
{
l9_30=mix(Tweak_N24BorderColor,l9_29,vec4(l9_27));
}
#else
{
l9_30=l9_29;
...
#endif
vec3 l9_32=max(baseColor.xyz,vec3(0.0));
vec4 l9_33;
#if (sc_ProjectiveShadowsCaster)
{
l9_33=vec4(l9_32,Port_Opacity_N006);
}
#else
{
vec3 l9_34=ssSRGB_to_Linear(l9_32);
vec3 l9_35=normalize(l9_31);
vec3 l9_36=ssSRGB_to_Linear(max(l9_30.xyz,vec3(0.0)));
vec3 l9_37;
#if (sc_SSAOEnabled)
{
l9_37=evaluateSSAO(varPos);
}
#else
{
l9_37=Port_AO_N006;
...
#endif
vec3 l9_38=vec3(Port_Metallic_N006);
vec3 l9_39=mix(vec3(0.039999999),l9_34*Port_Metallic_N006,l9_38);
vec3 l9_40=mix(l9_34*(1.0-Port_Metallic_N006),vec3(0.0),l9_38);
SurfaceProperties l9_41=SurfaceProperties(l9_40,Port_Opacity_N006,l9_35,varPos,l9_3,Port_Metallic_N006,Port_Roughness_N006,l9_36,l9_37,Port_SpecularAO_N006,vec3(1.0),l9_39);
vec4 l9_42=vec4(1.0);
vec3 l9_43;
vec3 l9_44;
vec3 l9_45;
...
l9_51=vec3(0.0);
l9_50=vec3(0.0);
LightingComponents l9_57;
LightProperties l9_58;
SurfaceProperties l9_59;
vec3 l9_60;
int l9_61=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_61<sc_DirectionalLightsCount)
{
LightingComponents l9_62=accumulateLight(LightingComponents(l9_50,l9_51,l9_56,l9_55,l9_53,l9_52),LightProperties(sc_DirectionalLights[l9_61].direction,sc_DirectionalLights[l9_61].color.xyz,sc_DirectionalLights[l9_61].color.w*l9_42[(l9_54<3) ? l9_54 : 3]),l9_41,l9_3);
l9_56=l9_62.indirectDiffuse;
l9_55=l9_62.indirectSpecular;
l9_54++;
l9_53=l9_62.emitted;
l9_52=l9_62.transmitted;
l9_51=l9_62.directSpecular;
l9_50=l9_62.directDiffuse;
l9_61++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_79<sc_PointLightsCount)
{
vec3 l9_81=sc_PointLights[l9_79].position-varPos;
vec3 l9_82=normalize(l9_81);
float l9_83=l9_42[(l9_80<3) ? l9_80 : 3];
float l9_84=clamp((dot(l9_82,sc_PointLights[l9_79].direction)*sc_PointLights[l9_79].angleScale)+sc_PointLights[l9_79].angleOffset,0.0,1.0);
float l9_85=(sc_PointLights[l9_79].color.w*l9_83)*(l9_84*l9_84);
float l9_86;
if (sc_PointLights[l9_79].falloffEnabled)
{
l9_86=l9_85*computeDistanceAttenuation(length(l9_81),sc_PointLights[l9_79].falloffEndDistance);
}
else
{
l9_86=l9_85;
...
l9_72=l9_80+1;
LightingComponents l9_87=accumulateLight(LightingComponents(l9_66,l9_67,l9_71,l9_70,l9_69,l9_68),LightProperties(l9_82,sc_PointLights[l9_79].color.xyz,l9_86),l9_41,l9_3);
l9_73=l9_87.directDiffuse;
l9_74=l9_87.directSpecular;
l9_75=l9_87.indirectDiffuse;
l9_76=l9_87.indirectSpecular;
l9_77=l9_87.emitted;
l9_78=l9_87.transmitted;
l9_71=l9_75;
l9_70=l9_76;
l9_80=l9_72;
l9_69=l9_77;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_91=abs(varShadowTex-vec2(0.5));
vec4 l9_92=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_91.x,l9_91.y),0.5);
l9_90=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_92.xyz,vec3(sc_ShadowColor.w)),vec3(l9_92.w*sc_ShadowDensity));
}
#else
{
l9_90=vec3(1.0);
...
{
vec2 l9_94=calcPanoramicTexCoordsFromDir(l9_35,sc_EnvmapRotation.y);
vec4 l9_95;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_96=calcSeamlessPanoramicUvsForSampling(l9_94,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_96=l9_94;
...
#endif
l9_95=sc_EnvmapSpecularSampleViewIndexBias(l9_96,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_97;
...
{
vec2 l9_98=calcSeamlessPanoramicUvsForSampling(l9_94,sc_EnvmapDiffuseSize.xy,0.0);
int l9_99;
...
#endif
l9_97=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_98,sc_EnvmapDiffuseLayout,l9_99).xy,-13.0);
}
#else
{
l9_97=sc_EnvmapSpecularSampleViewIndexBias(l9_94,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_95=l9_97;
}
#endif
l9_93=(l9_95.xyz*(1.0/l9_95.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_100;
...
float l9_103=l9_101.y;
float l9_104=l9_101.z;
l9_100=(((((((sc_Sh[8]*0.42904299)*((l9_102*l9_102)-(l9_103*l9_103)))+((sc_Sh[6]*0.74312502)*(l9_104*l9_104)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_102*l9_103))+(sc_Sh[7]*(l9_102*l9_104)))+(sc_Sh[5]*(l9_103*l9_104)))*0.85808599))+((((sc_Sh[3]*l9_102)+(sc_Sh[1]*l9_103))+(sc_Sh[2]*l9_104))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_100=vec3(0.0);
...
{
l9_106=l9_93+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_107=l9_93;
l9_107.x=l9_93.x+(1e-06*sc_AmbientLights[0].color.x);
l9_106=l9_107;
}
#endif
l9_105=l9_106;
...
{
l9_109=l9_105+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_110=l9_105;
l9_110.x=l9_105.x+(1e-06*sc_AmbientLights[1].color.x);
l9_109=l9_110;
}
#endif
l9_108=l9_109;
...
{
l9_112=l9_108+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_113=l9_108;
l9_113.x=l9_108.x+(1e-06*sc_AmbientLights[2].color.x);
l9_112=l9_113;
}
#endif
l9_111=l9_112;
...
{
vec3 l9_115;
l9_115=sc_LightEstimationData.ambientLight;
vec3 l9_116;
int l9_117=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_117<sc_LightEstimationSGCount)
{
float l9_118=dot(sc_LightEstimationData.sg[l9_117].axis,l9_35);
float l9_119=exp(-sc_LightEstimationData.sg[l9_117].sharpness);
float l9_120=l9_119*l9_119;
float l9_121=1.0/sc_LightEstimationData.sg[l9_117].sharpness;
float l9_122=(1.0+(2.0*l9_120))-l9_121;
float l9_123=sqrt(1.0-l9_122);
float l9_124=0.36000001*l9_118;
float l9_125=(1.0/(4.0*0.36000001))*l9_123;
float l9_126=l9_124+l9_125;
float l9_127;
if (step(abs(l9_124),l9_125)>0.5)
{
l9_127=(l9_126*l9_126)/l9_123;
}
else
{
l9_127=clamp(l9_118,0.0,1.0);
}
l9_116=l9_115+((((sc_LightEstimationData.sg[l9_117].color/vec3(sc_LightEstimationData.sg[l9_117].sharpness))*6.2831855)*((l9_122*l9_127)+(((l9_119-l9_120)*l9_121)-l9_120)))/vec3(3.1415927));
l9_115=l9_116;
l9_117++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_129=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_130=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_35,reflect(-l9_3,l9_35),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_131;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_132=floor(l9_129);
float l9_133=ceil(l9_129);
l9_131=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_130,sc_EnvmapSpecularSize.xy,l9_132),sc_EnvmapSpecularGetStereoViewIndex(),l9_132),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_130,sc_EnvmapSpecularSize.xy,l9_133),sc_EnvmapSpecularGetStereoViewIndex(),l9_133),vec4(l9_129-l9_132));
}
#else
{
l9_131=sc_EnvmapSpecularSampleViewIndexLevel(l9_130,sc_EnvmapSpecularGetStereoViewIndex(),l9_129);
}
#endif
l9_128=vec3(0.0)+((((l9_131.xyz*(1.0/l9_131.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_41,abs(dot(l9_35,l9_3))));
}
#else
{
l9_128=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_135=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_136;
l9_136=sc_LightEstimationData.ambientLight*l9_39;
int l9_137=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_137<sc_LightEstimationSGCount)
{
float l9_138=l9_135*l9_135;
vec3 l9_139=reflect(-l9_3,l9_35);
float l9_140=dot(l9_35,l9_3);
float l9_141=(2.0/l9_138)/(4.0*max(l9_140,9.9999997e-05));
float l9_142=length((l9_139*l9_141)+(sc_LightEstimationData.sg[l9_137].axis*sc_LightEstimationData.sg[l9_137].sharpness));
float l9_143=clamp(dot(l9_35,l9_139),0.0,1.0);
float l9_144=clamp(l9_140,0.0,1.0);
float l9_145=1.0-l9_138;
l9_136+=((((((((vec3(1.0/(3.1415927*l9_138))*exp((l9_142-l9_141)-sc_LightEstimationData.sg[l9_137].sharpness))*sc_LightEstimationData.sg[l9_137].color)*6.2831855)*(1.0-exp((-2.0)*l9_142)))/vec3(l9_142))*((1.0/(l9_143+sqrt(l9_138+((l9_145*l9_143)*l9_143))))*(1.0/(l9_144+sqrt(l9_138+((l9_145*l9_144)*l9_144))))))*(l9_39+((vec3(1.0)-l9_39)*pow(1.0-clamp(dot(l9_139,normalize(l9_139+l9_3)),0.0,1.0),5.0))))*l9_143);
l9_137++;
continue;
}
else
...
l9_149=vec3(0.0);
l9_148=vec3(0.0);
l9_147=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_40,vec3(Port_Opacity_N006));
l9_146=1.0;
}
#else
{
...
#endif
vec3 l9_151=l9_148*l9_37;
vec3 l9_152=l9_149+l9_151;
vec3 l9_153=l9_40*l9_152;
vec3 l9_154=l9_134*Port_SpecularAO_N006;
vec3 l9_155=l9_88+l9_154;
vec3 l9_156;
if (l9_150)
{
l9_156=l9_153*srgbToLinear(l9_146);
}
else
{
l9_156=l9_153;
}
vec3 l9_157=l9_156+l9_155;
vec3 l9_158=(l9_157+l9_36)+l9_147;
float l9_159=l9_158.x;
vec4 l9_160=vec4(l9_159,l9_158.yz,l9_146);
vec4 l9_161;
#if (sc_IsEditor)
{
vec4 l9_162=l9_160;
l9_162.x=l9_159+((l9_37.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_161=l9_162;
}
#else
{
...
{
vec3 l9_164=l9_161.xyz*1.8;
vec3 l9_165=(l9_161.xyz*(l9_164+vec3(1.4)))/((l9_161.xyz*(l9_164+vec3(0.5)))+vec3(1.5));
l9_163=vec4(l9_165.x,l9_165.y,l9_165.z,l9_161.w);
}
#else
{
l9_163=l9_161;
...
#endif
vec3 l9_166=vec3(linearToSrgb(l9_163.x),linearToSrgb(l9_163.y),linearToSrgb(l9_163.z));
l9_33=vec4(l9_166.x,l9_166.y,l9_166.z,l9_163.w);
}
#endif
vec4 l9_167=max(l9_33,vec4(0.0));
float l9_168;
#if (animate)
{
l9_168=1.001;
...
#endif
vec3 l9_169=(((l9_5/(vec3(length(sc_LocalAabbMax-sc_LocalAabbMin))+vec3(1.234e-06)))*vec3(max(exp(density),0.0)))+vec3(Port_Value1_N011,Port_Value2_N011,l9_1*(l9_168-0.001)))*noiseFrequency;
vec2 l9_170=l9_169.yz;
float l9_171;
Node54_Noise_Simplex(l9_170,Port_Scale_N054,l9_171,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,varPackedTex.xy,l9_5,l9_6,l9_170));
float l9_172=l9_171;
vec2 l9_173=l9_169.zx;
float l9_174;
Node54_Noise_Simplex(l9_173,Port_Scale_N054,l9_174,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,varPackedTex.xy,l9_5,l9_6,l9_173));
float l9_175=l9_174;
vec2 l9_176=l9_169.xy;
float l9_177;
Node54_Noise_Simplex(l9_176,Port_Scale_N054,l9_177,ssGlobals(l9_1,l9_2,0.0,vec3(0.0),l9_3,varPos,l9_4,varPackedTex.xy,l9_5,l9_6,l9_176));
float l9_178=l9_177;
vec3 l9_179=pow(abs(l9_6),vec3(1.0/(1.0-((clamp(Port_Import_N081+0.001,Port_Input1_N082+0.001,Port_Input2_N082+0.001)-0.001)*0.99000001))));
float l9_180=l9_179.x;
float l9_181=l9_179.y;
float l9_182=l9_179.z;
float l9_183;
#if (animate)
{
float l9_184=((Port_TimeA_N028+Port_TimeTransition_N028)+Port_TimeB_N028)+9.9999997e-05;
l9_183=mix(Port_ValueA_N028,Port_ValueB_N028,smoothstep(Port_TimeA_N028/l9_184,1.0-(Port_TimeB_N028/l9_184),abs((mod((l9_1/l9_184)+Port_TimeBias_N028,1.0)*2.0)-1.0)));
}
#else
{
l9_183=disintegrate;
...
#endif
float l9_185=l9_183-Port_RangeMinA_N017;
float l9_186=clamp((((((l9_172*l9_180)+(l9_175*l9_181))+(l9_178*l9_182))/((l9_180+l9_181)+l9_182))+(((l9_185/(Port_RangeMaxA_N017-Port_RangeMinA_N017))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+Port_RangeMinB_N017))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001;
float l9_187=(((l9_186-Port_RangeMinA_N064)/(Port_RangeMaxA_N064-Port_RangeMinA_N064))*(Port_RangeMaxB_N064-Port_RangeMinB_N064))+Port_RangeMinB_N064;
float l9_188;
if (Port_RangeMaxB_N064>Port_RangeMinB_N064)
{
l9_188=clamp(l9_187,Port_RangeMinB_N064,Port_RangeMaxB_N064);
}
else
{
l9_188=clamp(l9_187,Port_RangeMaxB_N064,Port_RangeMinB_N064);
}
vec4 l9_189=vec4(l9_188);
vec4 l9_190=mix(l9_167,edgeColor,l9_189);
if ((floor(l9_186+0.5)*1.0)!=0.0)
{
discard;
}
vec4 l9_191;
...
{
l9_192=1-sc_GetStereoViewIndex();
}
#else
{
l9_192=sc_GetStereoViewIndex();
}
#endif
float l9_193=varPackedTex.x;
sc_SoftwareWrapEarly(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x);
float l9_194=l9_193;
float l9_195=varPackedTex.y;
sc_SoftwareWrapEarly(l9_195,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y);
float l9_196=l9_195;
vec2 l9_197;
float l9_198;
...
{
l9_199=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x==3;
}
#else
{
l9_199=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_200=l9_194;
float l9_201=1.0;
sc_ClampUV(l9_200,opacityTextureUvMinMax.x,opacityTextureUvMinMax.z,l9_199,l9_201);
float l9_202=l9_200;
float l9_203=l9_201;
bool l9_204;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_204=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y==3;
}
#else
{
l9_204=(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0);
}
#endif
float l9_205=l9_196;
float l9_206=l9_203;
sc_ClampUV(l9_205,opacityTextureUvMinMax.y,opacityTextureUvMinMax.w,l9_204,l9_206);
l9_198=l9_206;
...
#endif
vec2 l9_207=sc_TransformUV(l9_197,(int(SC_USE_UV_TRANSFORM_opacityTexture)!=0),opacityTextureTransform);
float l9_208=l9_207.x;
float l9_209=l9_198;
sc_SoftwareWrapLate(l9_208,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_209);
float l9_210=l9_207.y;
float l9_211=l9_209;
sc_SoftwareWrapLate(l9_210,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTexture,SC_SOFTWARE_WRAP_MODE_V_opacityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTexture)!=0)),l9_211);
float l9_212=l9_211;
vec3 l9_213=sc_SamplingCoordsViewToGlobal(vec2(l9_208,l9_210),opacityTextureLayout,l9_192);
vec4 l9_214=texture2D(opacityTexture,l9_213.xy,0.0);
vec4 l9_215;
#if (SC_USE_CLAMP_TO_BORDER_opacityTexture)
{
l9_215=mix(opacityTextureBorderColor,l9_214,vec4(l9_212));
}
#else
{
l9_215=l9_214;
...
#else
{
l9_191=vec4(Port_Input2_N044);
}
#endif
float l9_216=clamp((l9_190.w*l9_191.x)+0.001,Port_Input1_N049+0.001,Port_Input2_N049+0.001)-0.001;
vec4 l9_217=vec4(l9_190.x,l9_190.y,l9_190.z,vec4(0.0).w);
l9_217.w=l9_216;
vec4 l9_218;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_220=clamp(l9_216*2.0,0.0,1.0);
}
#else
{
float l9_221;
...
{
l9_221=clamp(dot(l9_217.xyz,vec3(l9_216)),0.0,1.0);
}
#else
{
float l9_222;
...
#if (sc_BlendMode_Multiply)
{
l9_223=(1.0-dot(l9_217.xyz,vec3(0.33333001)))*l9_216;
}
#else
{
float l9_224;
...
{
l9_224=(1.0-clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0))*l9_216;
}
#else
{
float l9_225;
#if (sc_BlendMode_ColoredGlass)
{
l9_225=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0)*l9_216;
}
#else
{
float l9_226;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_227=clamp(dot(l9_217.xyz,vec3(1.0)),0.0,1.0)*l9_216;
}
#else
{
float l9_228;
...
{
l9_228=dot(l9_217.xyz,vec3(0.33333001))*l9_216;
}
#else
{
float l9_229;
...
vec3 l9_234=mix(l9_233,definedBlend(l9_233,l9_217.xyz).xyz,vec3(l9_216));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_236=vec4(mix(vec3(1.0),l9_217.xyz,vec3(l9_216)),l9_216);
}
#else
{
vec4 l9_237;
...
#endif
l9_237=vec4(l9_217.xyz*l9_238,l9_238);
}
#else
{
l9_237=l9_217;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_246=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
