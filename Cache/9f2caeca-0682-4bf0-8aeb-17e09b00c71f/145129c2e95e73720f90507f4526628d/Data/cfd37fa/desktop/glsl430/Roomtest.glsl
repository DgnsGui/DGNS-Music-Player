...
vec3 l9_2=normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz);
vec4 l9_3;
if ((Port_Input0_N000*1.0)!=0.0)
{
vec3 l9_4=(l9_1+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_5=pow(abs(l9_2),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_6=l9_5.x;
float l9_7=l9_5.y;
float l9_8=l9_5.z;
float l9_9=l9_0*0.5;
vec2 l9_10=mod((((((((l9_4.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_6)+((((l9_4.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_7))+((((l9_4.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_8))/vec2((l9_6+l9_7)+l9_8))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_11;
vec2 l9_12;
l9_12=l9_10;
l9_11=1.0;
...
{
int l9_14=l9_13+1;
float l9_15=(l9_9+23.0)*(1.0-(3.5/float(l9_14)));
vec2 l9_16=l9_10+vec2(cos(l9_15-l9_12.x)+sin(l9_15+l9_12.y),sin(l9_15-l9_12.y)+cos(l9_15+l9_12.x));
l9_12=l9_16;
l9_11+=(1.0/length(vec2(l9_10.x/(sin(l9_16.x+l9_15)/0.0049999999),l9_10.y/(cos(l9_16.y+l9_15)/0.0049999999))));
l9_13=l9_14;
continue;
}
else
...
l9_3=vec4(clamp(vec3(ssPow(abs(1.17-ssPow(l9_11/5.0,1.4)),8.0))+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
}
else
{
vec3 l9_17=(l9_1+Port_Offset_N014)*Port_Scale_N014;
vec2 l9_18=vec2(Tweak_N1);
vec3 l9_19=pow(abs(l9_2),vec3(1.0/(1.0-(Port_Sharpness_N014*0.99000001))));
float l9_20=l9_19.x;
float l9_21=l9_19.y;
float l9_22=l9_19.z;
...
float l9_36=N15_noise((N15_pyramids(l9_34+vec2(135.0))*31.0)+l9_35);
float l9_37=N15_noise((N15_pyramids(l9_34+vec2(25.0))*63.0)+l9_35);
float l9_38=clamp((((N15_noise((N15_pyramids(l9_34)*15.0)+l9_35)*l9_36)*l9_37)-0.090000004)*41.0,0.0,1.0);
float l9_39=clamp(clamp(l9_36,0.0,1.0)-0.2,0.0,1.0);
l9_3=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_37,0.0,1.0)-0.2,0.0,1.0),l9_39,l9_38).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_39))*l9_38,1.0);
}
...
{
l9_42=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_43=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_45=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_46;
...
{
l9_46=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_48;
#if (sc_BlendMode_Add)
{
l9_48=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_49;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_49=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_50;
...
{
l9_50=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_51;
#if (sc_BlendMode_Min)
{
l9_51=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_Max)
{
l9_52=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_52=1.0;
...
#endif
l9_40=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_41);
}
#else
{
vec4 l9_53;
...
{
l9_61=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_59,sc_ScreenTextureLayout,l9_60),0.0);
}
#else
{
l9_61=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_59,sc_ScreenTextureLayout,l9_60).xy,0.0);
}
#endif
l9_55=l9_61;
}
...
{
vec4 l9_63=l9_55;
l9_63.x=l9_55.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_62=l9_63;
}
#else
{
...
#endif
vec3 l9_64=mix(l9_62.xyz,definedBlend(l9_62.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=vec4(l9_3.xyz*l9_68,l9_68);
}
#else
{
l9_67=l9_3;
...
#endif
int l9_77=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_76).xy);
...
if (l9_94==0)
{
l9_97=texture(sc_OITAlpha0,l9_89);
l9_96=texture(sc_OITDepthLow0,l9_89);
l9_95=texture(sc_OITDepthHigh0,l9_89);
}
else
{
l9_97=vec4(0.0);
...
if (l9_94==1)
{
l9_100=texture(sc_OITAlpha1,l9_89);
l9_99=texture(sc_OITDepthLow1,l9_89);
l9_98=texture(sc_OITDepthHigh1,l9_89);
}
else
{
l9_100=l9_97;
...
vec4 l9_115=texture(sc_OITFilteredDepthBoundsTexture,l9_89);
