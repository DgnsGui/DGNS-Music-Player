...
vec4 l9_15=mix(vec4(clamp(vec3(l9_14)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0),Port_Input1_N006,Port_Input2_N006);
float l9_16=l9_15.w;
...
#endif
vec3 l9_41=mix(l9_39.xyz,definedBlend(l9_39.xyz,l9_15.xyz).xyz,vec3(l9_16));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_43=vec4(mix(vec3(1.0),l9_15.xyz,vec3(l9_16)),l9_16);
}
#else
{
vec4 l9_44;
...
#endif
l9_44=vec4(l9_15.xyz*l9_45,l9_45);
}
#else
{
l9_44=l9_15;
