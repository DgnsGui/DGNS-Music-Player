...
vec3 l9_2=(l9_1+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_3=abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz));
vec3 l9_4=pow(l9_3,vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_5=l9_4.x;
float l9_6=l9_4.y;
float l9_7=l9_4.z;
float l9_8=l9_0*0.5;
vec2 l9_9=mod((((((((l9_2.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5)+((((l9_2.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_6))+((((l9_2.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_7))/vec2((l9_5+l9_6)+l9_7))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_10;
vec2 l9_11;
l9_11=l9_9;
l9_10=1.0;
...
{
int l9_13=l9_12+1;
float l9_14=(l9_8+23.0)*(1.0-(3.5/float(l9_13)));
vec2 l9_15=l9_9+vec2(cos(l9_14-l9_11.x)+sin(l9_14+l9_11.y),sin(l9_14-l9_11.y)+cos(l9_14+l9_11.x));
l9_11=l9_15;
l9_10+=(1.0/length(vec2(l9_9.x/(sin(l9_15.x+l9_14)/0.0049999999),l9_9.y/(cos(l9_15.y+l9_14)/0.0049999999))));
l9_12=l9_13;
continue;
}
else
...
float l9_16=ssPow(abs(1.17-ssPow(l9_10/5.0,1.4)),8.0);
vec3 l9_17=(l9_1+Port_Offset_N014)*Port_Scale_N014;
vec2 l9_18=vec2(Tweak_N1);
vec3 l9_19=pow(l9_3,vec3(1.0/(1.0-(Port_Sharpness_N014*0.99000001))));
float l9_20=l9_19.x;
float l9_21=l9_19.y;
float l9_22=l9_19.z;
N15_resolution=Port_resolution_N015;
vec2 l9_23=(((((((l9_17.yz-Port_Center_N013)*l9_18)+Port_Center_N013)*l9_20)+((((l9_17.zx-Port_Center_N013)*l9_18)+Port_Center_N013)*l9_21))+((((l9_17.xy-Port_Center_N013)*l9_18)+Port_Center_N013)*l9_22))/vec2((l9_20+l9_21)+l9_22))-vec2(0.5);
vec2 l9_24=l9_23;
l9_24.x=l9_23.x*(N15_getResolution().x/N15_getResolution().y);
vec2 l9_25=N15_p6mmmap(l9_24*(N15_getResolution().x/2000.0),2.0);
vec3 l9_26=N15_getResolution();
vec3 l9_27=N15_getResolution();
vec3 l9_28=N15_getResolution();
float l9_29=((floor((Port_touchPosition_N015*vec4(l9_26.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_27.x)/10.0)*floor((Port_touchPosition_N015*vec4(0.0,l9_28.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_30;
if (l9_29>(-100000.0))
{
l9_30=l9_29;
...
float l9_31=radians(l9_30*12.7);
float l9_32=cos(l9_31);
float l9_33=sin(l9_31);
vec2 l9_34=((mat2(vec2(l9_32,-l9_33),vec2(l9_33,l9_32))*((l9_25*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_30*0.059999999);
float l9_35=l9_30*0.2;
float l9_36=N15_noise((N15_pyramids(l9_34)*15.0)+l9_35);
float l9_37=N15_noise((N15_pyramids(l9_34+vec2(135.0))*31.0)+l9_35);
float l9_38=N15_noise((N15_pyramids(l9_34+vec2(25.0))*63.0)+l9_35);
float l9_39=clamp((((l9_36*l9_37)*l9_38)-0.090000004)*41.0,0.0,1.0);
float l9_40=clamp(clamp(l9_37,0.0,1.0)-0.2,0.0,1.0);
vec4 l9_41=mix(vec4(clamp(vec3(l9_16)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0),vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_38,0.0,1.0)-0.2,0.0,1.0),l9_40,l9_39).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_40))*l9_39,1.0),Port_Input2_N006);
float l9_42=l9_41.w;
