...
float l9_1=l9_0*0.5;
vec2 l9_2=mod(Port_uv_input_N005*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_3;
vec2 l9_4;
l9_4=l9_2;
l9_3=1.0;
...
{
int l9_6=l9_5+1;
float l9_7=(l9_1+23.0)*(1.0-(3.5/float(l9_6)));
vec2 l9_8=l9_2+vec2(cos(l9_7-l9_4.x)+sin(l9_7+l9_4.y),sin(l9_7-l9_4.y)+cos(l9_7+l9_4.x));
l9_4=l9_8;
l9_3+=(1.0/length(vec2(l9_2.x/(sin(l9_8.x+l9_7)/0.0049999999),l9_2.y/(cos(l9_8.y+l9_7)/0.0049999999))));
l9_5=l9_6;
continue;
}
else
...
float l9_9=ssPow(abs(1.17-ssPow(l9_3/5.0,1.4)),8.0);
vec4 l9_10=vec4(clamp(vec3(l9_9)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_14=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_16=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_19;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_10.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_22;
...
#endif
vec3 l9_35=definedBlend(l9_33.xyz,l9_10.xyz);
