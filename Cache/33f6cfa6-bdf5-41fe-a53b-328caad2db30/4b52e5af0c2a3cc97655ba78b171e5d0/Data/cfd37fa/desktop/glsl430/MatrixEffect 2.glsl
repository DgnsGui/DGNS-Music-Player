...
l9_2=vec4(clamp(vec3(ssPow(abs(1.17-ssPow(l9_10/5.0,1.4)),8.0))+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
}
else
{
l9_2=Port_Input2_N000;
}
...
{
l9_18=clamp(l9_2.w*2.0,0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_2.xyz,vec3(l9_2.w)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_2.w;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_2.w;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_2.xyz,vec3(0.33333001))*l9_2.w;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_2.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
{
l9_37=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_35,sc_ScreenTextureLayout,l9_36),0.0);
}
#else
{
l9_37=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_35,sc_ScreenTextureLayout,l9_36).xy,0.0);
}
#endif
l9_31=l9_37;
}
...
#endif
vec3 l9_40=mix(l9_38.xyz,definedBlend(l9_38.xyz,l9_2.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_42=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_2.xyz*l9_44,l9_44);
}
#else
{
l9_43=l9_2;
