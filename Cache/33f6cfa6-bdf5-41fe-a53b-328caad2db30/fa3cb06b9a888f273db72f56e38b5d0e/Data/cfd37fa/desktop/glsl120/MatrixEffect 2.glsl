...
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),Tweak_N0Layout,l9_6);
vec4 l9_28=texture2D(Tweak_N0,l9_27.xy,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
...
{
if (l9_29.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_29.xyz).xyz,vec3(l9_29.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_29.w)),l9_29.w);
}
#else
{
vec4 l9_56;
