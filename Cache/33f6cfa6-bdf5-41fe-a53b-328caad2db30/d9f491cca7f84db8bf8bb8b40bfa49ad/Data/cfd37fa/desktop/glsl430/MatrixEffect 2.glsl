...
float l9_7=l9_0*0.5;
vec3 l9_8=N5_getResolution();
vec2 l9_9=mod(((varPackedTex.xy*l9_6.xy)/l9_8.xy)*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_10;
vec2 l9_11;
l9_11=l9_9;
l9_10=1.0;
...
{
int l9_13=l9_12+1;
float l9_14=(l9_7+23.0)*(1.0-(3.5/float(l9_13)));
...
vec4 l9_17=vec4(clamp(vec3(l9_16)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_21=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_23=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_24;
...
{
l9_24=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_26;
...
{
l9_28=dot(l9_17.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_29;
...
#endif
vec3 l9_42=definedBlend(l9_40.xyz,l9_17.xyz);
