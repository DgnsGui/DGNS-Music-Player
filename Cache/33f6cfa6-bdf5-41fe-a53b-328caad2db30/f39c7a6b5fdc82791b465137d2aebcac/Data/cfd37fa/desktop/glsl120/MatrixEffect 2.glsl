...
vec3 l9_3=normalize((sc_ModelMatrixInverse*vec4(l9_1,0.0)).xyz);
vec4 l9_4;
if ((float(l9_1.y>((Port_Value_N009+0.001)-0.001))*1.0)!=0.0)
{
vec3 l9_5=(l9_2+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_6=pow(abs(l9_3),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_7=l9_6.x;
float l9_8=l9_6.y;
float l9_9=l9_6.z;
float l9_10=l9_0*0.5;
vec2 l9_11=mod((((((((l9_5.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_7)+((((l9_5.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_8))+((((l9_5.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_9))/vec2((l9_7+l9_8)+l9_9))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_12;
vec2 l9_13;
l9_13=l9_11;
l9_12=1.0;
...
{
int l9_15=l9_14+1;
float l9_16=(l9_10+23.0)*(1.0-(3.5/float(l9_15)));
vec2 l9_17=l9_11+vec2(cos(l9_16-l9_13.x)+sin(l9_16+l9_13.y),sin(l9_16-l9_13.y)+cos(l9_16+l9_13.x));
l9_13=l9_17;
l9_12+=(1.0/length(vec2(l9_11.x/(sin(l9_17.x+l9_16)/0.0049999999),l9_11.y/(cos(l9_17.y+l9_16)/0.0049999999))));
l9_14=l9_15;
continue;
}
else
...
l9_4=vec4(clamp(vec3(ssPow(abs(1.17-ssPow(l9_12/5.0,1.4)),8.0))+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
}
else
{
vec3 l9_18=(l9_2+Port_Offset_N014)*Port_Scale_N014;
vec2 l9_19=vec2(Tweak_N1);
vec3 l9_20=pow(abs(l9_3),vec3(1.0/(1.0-(Port_Sharpness_N014*0.99000001))));
float l9_21=l9_20.x;
float l9_22=l9_20.y;
float l9_23=l9_20.z;
N15_resolution=Port_resolution_N015;
vec2 l9_24=(((((((l9_18.yz-Port_Center_N013)*l9_19)+Port_Center_N013)*l9_21)+((((l9_18.zx-Port_Center_N013)*l9_19)+Port_Center_N013)*l9_22))+((((l9_18.xy-Port_Center_N013)*l9_19)+Port_Center_N013)*l9_23))/vec2((l9_21+l9_22)+l9_23))-vec2(0.5);
vec2 l9_25=l9_24;
l9_25.x=l9_24.x*(N15_getResolution().x/N15_getResolution().y);
vec2 l9_26=N15_p6mmmap(l9_25*(N15_getResolution().x/2000.0),2.0);
vec3 l9_27=N15_getResolution();
vec3 l9_28=N15_getResolution();
vec3 l9_29=N15_getResolution();
float l9_30=((floor((Port_touchPosition_N015*vec4(l9_27.x,0.0,0.0,1.0)).x/10.0)*4.0)+(((4.0*l9_28.x)/10.0)*floor((Port_touchPosition_N015*vec4(0.0,l9_29.y,0.0,1.0)).y/10.0)))-100000.0;
float l9_31;
if (l9_30>(-100000.0))
{
l9_31=l9_30;
...
float l9_32=radians(l9_31*12.7);
float l9_33=cos(l9_32);
float l9_34=sin(l9_32);
vec2 l9_35=((mat2(vec2(l9_33,-l9_34),vec2(l9_34,l9_33))*((l9_26*0.64999998)-vec2(0.25)))+vec2(0.25))+vec2(l9_31*0.059999999);
float l9_36=l9_31*0.2;
float l9_37=N15_noise((N15_pyramids(l9_35+vec2(135.0))*31.0)+l9_36);
float l9_38=N15_noise((N15_pyramids(l9_35+vec2(25.0))*63.0)+l9_36);
float l9_39=clamp((((N15_noise((N15_pyramids(l9_35)*15.0)+l9_36)*l9_37)*l9_38)-0.090000004)*41.0,0.0,1.0);
float l9_40=clamp(clamp(l9_37,0.0,1.0)-0.2,0.0,1.0);
l9_4=vec4(mix(vec3(1.0),clamp(abs((fract(vec3(clamp(clamp(l9_38,0.0,1.0)-0.2,0.0,1.0),l9_40,l9_39).xxx+vec3(1.0,0.66666669,0.33333334))*6.0)-vec3(3.0))-vec3(1.0),vec3(0.0),vec3(1.0)),vec3(l9_40))*l9_39,1.0);
}
...
{
l9_43=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_44;
...
{
l9_44=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_49;
#if (sc_BlendMode_Add)
{
l9_49=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_52;
#if (sc_BlendMode_Min)
{
l9_52=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_Max)
{
l9_53=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_53=1.0;
...
#endif
l9_41=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_42);
}
#else
{
vec4 l9_54;
...
#endif
vec3 l9_64=mix(l9_62.xyz,definedBlend(l9_62.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=vec4(l9_4.xyz*l9_68,l9_68);
}
#else
{
l9_67=l9_4;
