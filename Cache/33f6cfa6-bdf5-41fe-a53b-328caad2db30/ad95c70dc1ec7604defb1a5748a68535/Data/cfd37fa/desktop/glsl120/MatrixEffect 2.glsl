...
#endif
l9_33=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,l9_38).xy,0.0);
}
#endif
vec4 l9_39;
...
#endif
vec3 l9_41=mix(l9_39.xyz,definedBlend(l9_39.xyz,l9_17.xyz).xyz,vec3(Port_Value4_N010));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_43=vec4(mix(vec3(1.0),l9_17.xyz,vec3(Port_Value4_N010)),Port_Value4_N010);
}
#else
{
vec4 l9_44;
...
{
l9_45=clamp(Port_Value4_N010,0.0,1.0);
}
#else
{
l9_45=Port_Value4_N010;
}
#endif
