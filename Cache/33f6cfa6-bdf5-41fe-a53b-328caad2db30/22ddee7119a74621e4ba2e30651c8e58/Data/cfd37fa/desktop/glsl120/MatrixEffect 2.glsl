...
#endif
vec3 l9_39=mix(l9_37.xyz,definedBlend(l9_37.xyz,l9_2.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_41=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_42;
...
#endif
l9_42=vec4(l9_2.xyz*l9_43,l9_43);
}
#else
{
l9_42=l9_2;
