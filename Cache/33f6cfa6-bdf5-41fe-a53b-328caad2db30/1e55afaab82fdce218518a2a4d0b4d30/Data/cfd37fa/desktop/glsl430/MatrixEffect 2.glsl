...
uniform vec4 Port_Input1_N009;
uniform vec4 Port_Input2_N009;
...
vec3 l9_2=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_3=pow(abs(normalize((sc_ModelMatrixInverse*vec4(l9_1,0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_4=l9_3.x;
float l9_5=l9_3.y;
float l9_6=l9_3.z;
float l9_7=l9_0*0.5;
vec2 l9_8=mod((((((((l9_2.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_4)+((((l9_2.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5))+((((l9_2.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_6))/vec2((l9_4+l9_5)+l9_6))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_9;
vec2 l9_10;
l9_10=l9_8;
l9_9=1.0;
...
{
int l9_12=l9_11+1;
float l9_13=(l9_7+23.0)*(1.0-(3.5/float(l9_12)));
vec2 l9_14=l9_8+vec2(cos(l9_13-l9_10.x)+sin(l9_13+l9_10.y),sin(l9_13-l9_10.y)+cos(l9_13+l9_10.x));
l9_10=l9_14;
l9_9+=(1.0/length(vec2(l9_8.x/(sin(l9_14.x+l9_13)/0.0049999999),l9_8.y/(cos(l9_14.y+l9_13)/0.0049999999))));
l9_11=l9_12;
continue;
}
else
...
float l9_15=ssPow(abs(1.17-ssPow(l9_9/5.0,1.4)),8.0);
vec4 l9_16;
if ((float(l9_1.y>=((Port_Value_N008+0.001)-0.001))*1.0)!=0.0)
{
l9_16=Port_Input1_N009;
}
else
{
l9_16=Port_Input2_N009;
}
vec4 l9_17=mix(vec4(clamp(vec3(l9_15)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0),l9_16,Port_Input2_N011);
float l9_18=l9_17.w;
...
{
l9_22=clamp(dot(l9_17.xyz,vec3(l9_18)),0.0,1.0);
}
#else
{
float l9_23;
...
{
l9_24=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*l9_18;
}
#else
{
float l9_25;
...
{
l9_25=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*l9_18;
}
#else
{
float l9_26;
...
{
l9_26=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*l9_18;
}
#else
{
float l9_27;
#if (sc_BlendMode_Add)
{
l9_27=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_28=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*l9_18;
}
#else
{
float l9_29;
...
{
l9_29=dot(l9_17.xyz,vec3(0.33333001))*l9_18;
}
#else
{
float l9_30;
#if (sc_BlendMode_Min)
{
l9_30=1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_Max)
{
l9_31=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_31=1.0;
...
#endif
l9_19=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_17.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_20);
}
#else
{
vec4 l9_32;
...
{
l9_40=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_38,sc_ScreenTextureLayout,l9_39),0.0);
}
#else
{
l9_40=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_38,sc_ScreenTextureLayout,l9_39).xy,0.0);
}
#endif
l9_34=l9_40;
}
...
{
vec4 l9_42=l9_34;
l9_42.x=l9_34.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_41=l9_42;
}
#else
{
...
#endif
vec3 l9_43=mix(l9_41.xyz,definedBlend(l9_41.xyz,l9_17.xyz).xyz,vec3(l9_18));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_45=vec4(mix(vec3(1.0),l9_17.xyz,vec3(l9_18)),l9_18);
}
#else
{
vec4 l9_46;
...
#endif
l9_46=vec4(l9_17.xyz*l9_47,l9_47);
}
#else
{
l9_46=l9_17;
