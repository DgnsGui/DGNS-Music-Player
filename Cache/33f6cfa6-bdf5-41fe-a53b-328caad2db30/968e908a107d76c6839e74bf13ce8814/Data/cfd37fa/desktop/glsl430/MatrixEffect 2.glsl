...
{
l9_23=clamp(dot(l9_18.xyz,vec3(l9_19)),0.0,1.0);
}
#else
{
float l9_24;
...
{
l9_25=(1.0-dot(l9_18.xyz,vec3(0.33333001)))*l9_19;
}
#else
{
float l9_26;
...
{
l9_26=(1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0))*l9_19;
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0)*l9_19;
}
#else
{
float l9_28;
#if (sc_BlendMode_Add)
{
l9_28=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_30=dot(l9_18.xyz,vec3(0.33333001))*l9_19;
}
#else
{
float l9_31;
#if (sc_BlendMode_Min)
{
l9_31=1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_32;
#if (sc_BlendMode_Max)
{
l9_32=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_32=1.0;
...
#endif
l9_20=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_18.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_21);
}
#else
{
vec4 l9_33;
...
#endif
vec3 l9_44=mix(l9_42.xyz,definedBlend(l9_42.xyz,l9_18.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_46=vec4(mix(vec3(1.0),l9_18.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_47;
...
#endif
l9_47=vec4(l9_18.xyz*l9_48,l9_48);
}
#else
{
l9_47=l9_18;
