...
#endif
vec3 l9_43=mix(l9_41.xyz,definedBlend(l9_41.xyz,l9_18.xyz).xyz,vec3(l9_19));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_45=vec4(mix(vec3(1.0),l9_18.xyz,vec3(l9_19)),l9_19);
}
#else
{
vec4 l9_46;
...
#endif
l9_46=vec4(l9_18.xyz*l9_47,l9_47);
}
#else
{
l9_46=l9_18;
