...
uniform vec4 Port_Input0_N006;
uniform vec4 Port_Input1_N006;
...
float l9_5=l9_2.z;
float l9_6=l9_0*0.5;
vec2 l9_7=mod((((((((l9_1.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_3)+((((l9_1.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_4))+((((l9_1.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5))/vec2((l9_3+l9_4)+l9_5))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_8;
vec2 l9_9;
l9_9=l9_7;
l9_8=1.0;
...
{
int l9_11=l9_10+1;
float l9_12=(l9_6+23.0)*(1.0-(3.5/float(l9_11)));
vec2 l9_13=l9_7+vec2(cos(l9_12-l9_9.x)+sin(l9_12+l9_9.y),sin(l9_12-l9_9.y)+cos(l9_12+l9_9.x));
l9_9=l9_13;
l9_8+=(1.0/length(vec2(l9_7.x/(sin(l9_13.x+l9_12)/0.0049999999),l9_7.y/(cos(l9_13.y+l9_12)/0.0049999999))));
l9_10=l9_11;
continue;
}
else
...
float l9_14=ssPow(abs(1.17-ssPow(l9_8/5.0,1.4)),8.0);
vec4 l9_15=vec4(clamp(vec3(l9_14)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
#endif
vec3 l9_40=definedBlend(l9_38.xyz,l9_15.xyz);
