...
l9_1=normalize((sc_ModelMatrixInverse*vec4(l9_3.normalWS,0.0)).xyz);
}
else
{
l9_2=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
l9_1=normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz);
}
vec3 l9_4=l9_2+Port_Offset_N003;
vec3 l9_5=l9_4*Port_Scale_N003;
vec3 l9_6=abs(l9_1);
vec3 l9_7=pow(l9_6,vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_8=l9_7.x;
float l9_9=l9_7.y;
float l9_10=l9_7.z;
float l9_11=l9_0*0.5;
vec2 l9_12=mod((((((((l9_5.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_8)+((((l9_5.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_9))+((((l9_5.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_10))/vec2((l9_8+l9_9)+l9_10))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_13;
vec2 l9_14;
l9_14=l9_12;
l9_13=1.0;
...
float l9_19=ssPow(abs(1.17-ssPow(l9_13/5.0,1.4)),8.0);
vec4 l9_20=vec4(clamp(vec3(l9_19)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
...
{
l9_26=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_28=(1.0-dot(l9_20.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_29;
...
{
l9_29=(1.0-clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_30;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_32=clamp(dot(l9_20.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_33;
...
{
l9_33=dot(l9_20.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_34;
...
#endif
vec3 l9_47=definedBlend(l9_45.xyz,l9_20.xyz);
