...
uniform float Port_Value3_N010;
uniform float Port_Value4_N010;
...
{
l9_2=Port_Input1_N009;
}
else
{
l9_2=Port_Input2_N009;
}
vec3 l9_3=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_4=pow(abs(normalize((sc_ModelMatrixInverse*vec4(l9_1,0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_5=l9_4.x;
float l9_6=l9_4.y;
float l9_7=l9_4.z;
float l9_8=l9_0*0.5;
vec2 l9_9=mod((((((((l9_3.yz-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_5)+((((l9_3.zx-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_6))+((((l9_3.xy-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002)*l9_7))/vec2((l9_5+l9_6)+l9_7))*6.2831855,vec2(6.2831855))-vec2(250.0);
float l9_10;
vec2 l9_11;
l9_11=l9_9;
l9_10=1.0;
...
vec4 l9_17=vec4(l9_2.x,clamp(vec3(l9_16)+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)).x,Port_Value3_N010,Port_Value4_N010);
#if (sc_BlendMode_AlphaTest)
{
if (Port_Value4_N010<alphaTestThreshold)
{
discard;
}
}
...
{
if (Port_Value4_N010<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_20=clamp(Port_Value4_N010*2.0,0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_21=clamp(dot(l9_17.xyz,vec3(Port_Value4_N010)),0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_23=(1.0-dot(l9_17.xyz,vec3(0.33333001)))*Port_Value4_N010;
}
#else
{
float l9_24;
...
{
l9_24=(1.0-clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0))*Port_Value4_N010;
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N010;
}
#else
{
float l9_26;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_27=clamp(dot(l9_17.xyz,vec3(1.0)),0.0,1.0)*Port_Value4_N010;
}
#else
{
float l9_28;
...
{
l9_28=dot(l9_17.xyz,vec3(0.33333001))*Port_Value4_N010;
}
#else
{
float l9_29;
...
{
l9_39=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,l9_38),0.0);
}
#else
{
l9_39=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,l9_38).xy,0.0);
}
#endif
l9_33=l9_39;
}
...
#endif
vec3 l9_42=mix(l9_40.xyz,definedBlend(l9_40.xyz,l9_17.xyz).xyz,vec3(Port_Value4_N010));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_44=vec4(mix(vec3(1.0),l9_17.xyz,vec3(Port_Value4_N010)),Port_Value4_N010);
}
#else
{
vec4 l9_45;
...
{
l9_46=clamp(Port_Value4_N010,0.0,1.0);
}
#else
{
l9_46=Port_Value4_N010;
}
#endif
l9_45=vec4(l9_17.xyz*l9_46,l9_46);
}
#else
{
l9_45=l9_17;
