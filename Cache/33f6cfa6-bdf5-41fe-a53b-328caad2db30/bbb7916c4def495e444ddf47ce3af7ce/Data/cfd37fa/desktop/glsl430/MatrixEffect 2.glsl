...
vec4 l9_1;
if ((float(Port_Value_N007.x<Port_Input1_N006)*1.0)!=0.0)
{
vec3 l9_2=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_3=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_4=l9_3.x;
float l9_5=l9_3.y;
float l9_6=l9_3.z;
float l9_7=l9_0*0.5;
...
l9_1=vec4(clamp(vec3(ssPow(abs(1.17-ssPow(l9_9/5.0,1.4)),8.0))+vec3(0.0,0.34999999,0.5),vec3(0.0),vec3(1.0)),1.0);
}
else
{
l9_1=Port_Input2_N000;
}
