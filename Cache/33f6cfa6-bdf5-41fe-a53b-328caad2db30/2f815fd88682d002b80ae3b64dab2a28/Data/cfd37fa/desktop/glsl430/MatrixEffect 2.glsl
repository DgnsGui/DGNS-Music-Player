...
#endif
vec4 l9_0;
if ((float(normalize(varNormal).y>=((Port_Value_N008+0.001)-0.001))*1.0)!=0.0)
{
l9_0=Port_Input1_N009;
}
else
{
l9_0=Port_Input2_N009;
}
vec4 l9_1=mix(Port_Input0_N011,l9_0,Port_Input2_N011);
float l9_2=l9_1.w;
...
#endif
vec3 l9_27=mix(l9_25.xyz,definedBlend(l9_25.xyz,l9_1.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_29=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_30;
