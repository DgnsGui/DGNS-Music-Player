...
float l9_2=l9_1.x;
vec4 l9_3;
if ((float(l9_2<((Port_Value_N008+vec2(0.001))-vec2(0.001)).x)*1.0)!=0.0)
{
vec3 l9_4=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N003)*Port_Scale_N003;
vec3 l9_5=pow(abs(normalize((sc_ModelMatrixInverse*vec4(l9_2,l9_1.yz,0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N003*0.99000001))));
float l9_6=l9_5.x;
float l9_7=l9_5.y;
float l9_8=l9_5.z;
float l9_9=l9_0*0.5;
...
{
l9_19=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_20=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_21;
...
{
l9_22=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_23;
...
{
l9_23=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_24;
...
{
l9_24=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_25;
#if (sc_BlendMode_Add)
{
l9_25=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_26;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_26=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_27;
...
{
l9_27=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_28;
#if (sc_BlendMode_Min)
{
l9_28=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_29;
#if (sc_BlendMode_Max)
{
l9_29=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_29=1.0;
...
#endif
l9_17=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_18);
}
#else
{
vec4 l9_30;
...
{
l9_38=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_36,sc_ScreenTextureLayout,l9_37),0.0);
}
#else
{
l9_38=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_36,sc_ScreenTextureLayout,l9_37).xy,0.0);
}
#endif
l9_32=l9_38;
}
...
{
vec4 l9_40=l9_32;
l9_40.x=l9_32.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_39=l9_40;
}
#else
{
...
#endif
vec3 l9_41=mix(l9_39.xyz,definedBlend(l9_39.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_43=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_44;
...
#endif
l9_44=vec4(l9_3.xyz*l9_45,l9_45);
}
#else
{
l9_44=l9_3;
