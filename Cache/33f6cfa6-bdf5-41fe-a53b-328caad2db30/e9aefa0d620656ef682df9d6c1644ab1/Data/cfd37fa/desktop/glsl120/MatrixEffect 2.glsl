...
#endif
vec3 l9_40=mix(l9_38.xyz,definedBlend(l9_38.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_42=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_43;
...
#endif
l9_43=vec4(l9_3.xyz*l9_44,l9_44);
}
#else
{
l9_43=l9_3;
