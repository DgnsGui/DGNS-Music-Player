...
{
float l9_63=l9_13.x;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_64=l9_63;
float l9_65=l9_13.y;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_66=l9_65;
vec2 l9_67;
float l9_68;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_69=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_69=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_70=l9_64;
float l9_71=1.0;
sc_ClampUV(l9_70,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_69,l9_71);
float l9_72=l9_70;
float l9_73=l9_71;
bool l9_74;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_75=l9_66;
float l9_76=l9_73;
sc_ClampUV(l9_75,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_74,l9_76);
l9_68=l9_76;
...
#endif
vec2 l9_77=sc_TransformUV(l9_67,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_81);
float l9_82=l9_81;
vec3 l9_83=sc_SamplingCoordsViewToGlobal(vec2(l9_78,l9_80),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_84=texture(normalTexArrSC,l9_83,0.0);
vec4 l9_85;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_85=mix(normalTexBorderColor,l9_84,vec4(l9_82));
}
#else
{
l9_85=l9_84;
...
{
float l9_86=l9_13.x;
sc_SoftwareWrapEarly(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_87=l9_86;
float l9_88=l9_13.y;
sc_SoftwareWrapEarly(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_89=l9_88;
vec2 l9_90;
float l9_91;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_93=l9_87;
float l9_94=1.0;
sc_ClampUV(l9_93,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_92,l9_94);
float l9_95=l9_93;
float l9_96=l9_94;
bool l9_97;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_97=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
...
float l9_98=l9_89;
float l9_99=l9_96;
sc_ClampUV(l9_98,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_97,l9_99);
l9_91=l9_99;
...
#endif
vec2 l9_100=sc_TransformUV(l9_90,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_101=l9_100.x;
float l9_102=l9_91;
sc_SoftwareWrapLate(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_102);
float l9_103=l9_100.y;
float l9_104=l9_102;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_104);
float l9_105=l9_104;
vec3 l9_106=sc_SamplingCoordsViewToGlobal(vec2(l9_101,l9_103),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_107=texture(normalTex,l9_106.xy,0.0);
vec4 l9_108;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_108=mix(normalTexBorderColor,l9_107,vec4(l9_105));
}
#else
{
l9_108=l9_107;
...
#if (materialParamsTexLayout==2)
{
float l9_110=l9_13.x;
sc_SoftwareWrapEarly(l9_110,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_111=l9_110;
float l9_112=l9_13.y;
sc_SoftwareWrapEarly(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_113=l9_112;
vec2 l9_114;
float l9_115;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_116=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_117=l9_111;
float l9_118=1.0;
sc_ClampUV(l9_117,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_116,l9_118);
float l9_119=l9_117;
float l9_120=l9_118;
bool l9_121;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_121=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_122=l9_113;
float l9_123=l9_120;
sc_ClampUV(l9_122,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_121,l9_123);
l9_115=l9_123;
...
#endif
vec2 l9_124=sc_TransformUV(l9_114,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_125=l9_124.x;
float l9_126=l9_115;
sc_SoftwareWrapLate(l9_125,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_126);
float l9_127=l9_124.y;
float l9_128=l9_126;
sc_SoftwareWrapLate(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_128);
float l9_129=l9_128;
vec3 l9_130=sc_SamplingCoordsViewToGlobal(vec2(l9_125,l9_127),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_131=texture(materialParamsTexArrSC,l9_130,0.0);
vec4 l9_132;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_132=mix(materialParamsTexBorderColor,l9_131,vec4(l9_129));
}
#else
{
l9_132=l9_131;
...
#else
{
float l9_133=l9_13.x;
sc_SoftwareWrapEarly(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_134=l9_133;
float l9_135=l9_13.y;
sc_SoftwareWrapEarly(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_136=l9_135;
vec2 l9_137;
float l9_138;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_139=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_139=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_140=l9_134;
float l9_141=1.0;
sc_ClampUV(l9_140,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_139,l9_141);
float l9_142=l9_140;
float l9_143=l9_141;
bool l9_144;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_144=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_145=l9_136;
float l9_146=l9_143;
sc_ClampUV(l9_145,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_144,l9_146);
l9_138=l9_146;
...
#endif
vec2 l9_147=sc_TransformUV(l9_137,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_148=l9_147.x;
float l9_149=l9_138;
sc_SoftwareWrapLate(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_149);
float l9_150=l9_147.y;
float l9_151=l9_149;
sc_SoftwareWrapLate(l9_150,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_151);
float l9_152=l9_151;
vec3 l9_153=sc_SamplingCoordsViewToGlobal(vec2(l9_148,l9_150),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_154=texture(materialParamsTex,l9_153.xy,0.0);
vec4 l9_155;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_155=mix(materialParamsTexBorderColor,l9_154,vec4(l9_152));
}
#else
{
l9_155=l9_154;
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_156=mat3(l9_3,l9_1,l9_2)*((l9_62.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_156=vec3(0.0);
...
#endif
float l9_157=clamp(l9_14.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_158=max(l9_61.xyz,vec3(0.0));
vec4 l9_159;
#if (sc_ProjectiveShadowsCaster)
{
l9_159=vec4(l9_158,l9_157);
}
#else
{
l9_159=ngsCalculateLighting(l9_158,l9_157,l9_156,l9_4,l9_5,Port_Emissive_N006,Port_Metallic_N006,clamp(l9_109.y,0.0,1.0),clamp(vec3(l9_109.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_160=max(l9_159,vec4(0.0));
if (isProxyMode)
{
vec4 l9_161;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_161,vec4(0.0)));
return;
}
vec4 l9_163;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_165=clamp(l9_160.w*2.0,0.0,1.0);
}
#else
{
float l9_166;
...
{
l9_166=clamp(dot(l9_160.xyz,vec3(l9_160.w)),0.0,1.0);
}
#else
{
float l9_167;
...
#if (sc_BlendMode_Multiply)
{
l9_168=(1.0-dot(l9_160.xyz,vec3(0.33333001)))*l9_160.w;
}
#else
{
float l9_169;
...
{
l9_169=(1.0-clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0))*l9_160.w;
}
#else
{
float l9_170;
#if (sc_BlendMode_ColoredGlass)
{
l9_170=clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0)*l9_160.w;
}
#else
{
float l9_171;
#if (sc_BlendMode_Add)
{
l9_171=clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_172;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_172=clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0)*l9_160.w;
}
#else
{
float l9_173;
...
{
l9_173=dot(l9_160.xyz,vec3(0.33333001))*l9_160.w;
}
#else
{
float l9_174;
#if (sc_BlendMode_Min)
{
l9_174=1.0-clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_175;
#if (sc_BlendMode_Max)
{
l9_175=clamp(dot(l9_160.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_175=1.0;
...
#endif
l9_163=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_160.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_164);
}
#else
{
vec4 l9_176;
...
{
vec3 l9_178=sc_GetFramebufferColor().xyz;
vec3 l9_179=mix(l9_178,definedBlend(l9_178,l9_160.xyz).xyz,vec3(l9_160.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_182=l9_160.w;
l9_181=vec4(mix(vec3(1.0),l9_160.xyz,vec3(l9_182)),l9_182);
}
#else
{
vec4 l9_183;
...
{
float l9_184=l9_160.w;
float l9_185;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_185=clamp(l9_184,0.0,1.0);
}
#else
{
l9_185=l9_184;
...
#endif
l9_183=vec4(l9_160.xyz*l9_185,l9_185);
}
#else
{
l9_183=l9_160;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_192-0.0039215689)),min(1.0,l9_192+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_194=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_193).xy);
float l9_195=packValue(l9_194);
int l9_202=int(l9_191.w*255.0);
float l9_203=packValue(l9_202);
sc_writeFragData0(vec4(packValue(l9_194),packValue(l9_194),packValue(l9_194),packValue(l9_194)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_206).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_211==0)
{
l9_214=texture(sc_OITAlpha0,l9_206);
l9_213=texture(sc_OITDepthLow0,l9_206);
l9_212=texture(sc_OITDepthHigh0,l9_206);
}
else
{
l9_214=vec4(0.0);
...
if (l9_211==1)
{
l9_217=texture(sc_OITAlpha1,l9_206);
l9_216=texture(sc_OITDepthLow1,l9_206);
l9_215=texture(sc_OITDepthHigh1,l9_206);
}
else
{
l9_217=l9_214;
...
vec4 l9_232=texture(sc_OITFilteredDepthBoundsTexture,l9_206);
