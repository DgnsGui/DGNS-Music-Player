...
#endif
float l9_32=l9_5;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_33=l9_32;
float l9_34=l9_8;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_35=l9_34;
vec2 l9_36;
float l9_37;
...
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_39=l9_33;
float l9_40=1.0;
sc_ClampUV(l9_39,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_38,l9_40);
float l9_41=l9_39;
float l9_42=l9_40;
bool l9_43;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_44=l9_35;
float l9_45=l9_42;
sc_ClampUV(l9_44,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_43,l9_45);
l9_37=l9_45;
...
#endif
vec2 l9_46=sc_TransformUV(l9_36,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_47=l9_46.x;
float l9_48=l9_37;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_48);
float l9_49=l9_46.y;
float l9_50=l9_48;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_50);
float l9_51=l9_50;
vec3 l9_52=sc_SamplingCoordsViewToGlobal(vec2(l9_47,l9_49),normalTexLayout,l9_31);
vec4 l9_53=texture2D(normalTex,l9_52.xy,0.0);
vec4 l9_54;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_54=mix(normalTexBorderColor,l9_53,vec4(l9_51));
}
#else
{
l9_54=l9_53;
...
#endif
float l9_56=l9_5;
sc_SoftwareWrapEarly(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_57=l9_56;
float l9_58=l9_8;
sc_SoftwareWrapEarly(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_59=l9_58;
vec2 l9_60;
float l9_61;
...
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_63=l9_57;
float l9_64=1.0;
sc_ClampUV(l9_63,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_62,l9_64);
float l9_65=l9_63;
float l9_66=l9_64;
bool l9_67;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_67=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_67=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_68=l9_59;
float l9_69=l9_66;
sc_ClampUV(l9_68,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_67,l9_69);
l9_61=l9_69;
...
#endif
vec2 l9_70=sc_TransformUV(l9_60,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_71=l9_70.x;
float l9_72=l9_61;
sc_SoftwareWrapLate(l9_71,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_72);
float l9_73=l9_70.y;
float l9_74=l9_72;
sc_SoftwareWrapLate(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0)),l9_74);
float l9_75=l9_74;
vec3 l9_76=sc_SamplingCoordsViewToGlobal(vec2(l9_71,l9_73),materialParamsTexLayout,l9_55);
vec4 l9_77=texture2D(materialParamsTex,l9_76.xy,0.0);
vec4 l9_78;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_78=mix(materialParamsTexBorderColor,l9_77,vec4(l9_75));
}
#else
{
l9_78=l9_77;
...
{
l9_79=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_54.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_79=vec3(0.0);
...
#endif
float l9_80=clamp(l9_29.w,0.0,1.0);
...
#endif
vec3 l9_81=max(l9_30.xyz,vec3(0.0));
vec4 l9_82;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
float l9_83=clamp(l9_78.y,0.0,1.0);
vec3 l9_84=ssSRGB_to_Linear(l9_81);
vec3 l9_85=normalize(l9_79);
...
#else
{
l9_87=clamp(vec3(l9_78.z),vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_88=vec3(Port_Metallic_N006);
vec3 l9_89=mix(vec3(0.039999999),l9_84*Port_Metallic_N006,l9_88);
vec3 l9_90=mix(l9_84*(1.0-Port_Metallic_N006),vec3(0.0),l9_88);
SurfaceProperties l9_91=SurfaceProperties(l9_90,l9_80,l9_85,varPos,l9_0,Port_Metallic_N006,l9_83,l9_86,l9_87,Port_SpecularAO_N006,vec3(1.0),l9_89);
vec4 l9_92=vec4(1.0);
vec3 l9_93;
vec3 l9_94;
vec3 l9_95;
...
l9_199=vec3(0.0);
l9_198=vec3(0.0);
l9_197=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_90,vec3(l9_80));
l9_196=1.0;
}
#else
{
...
l9_82=vec4(l9_216.x,l9_216.y,l9_216.z,l9_213.w);
}
#endif
vec4 l9_217=max(l9_82,vec4(0.0));
vec4 l9_218;
#if (sc_ProjectiveShadowsCaster)
{
float l9_219;
