...
//sampler sampler iridescenceMapSmpSC 0:17
...
//texture texture2D iridescenceMap 0:1:0:17
...
#endif
vec3 l9_35=max(mix(baseColor,l9_33*vec4(intensity),vec4(mixAmount)).xyz,vec3(0.0));
vec4 l9_36;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
float l9_37=clamp(metallic,0.0,1.0);
float l9_38=clamp(roughness,0.0,1.0);
vec3 l9_39=ssSRGB_to_Linear(l9_35);
vec3 l9_40=normalize(l9_34);
vec3 l9_41=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_42;
#if (sc_SSAOEnabled)
{
l9_42=evaluateSSAO(varPos);
}
#else
{
l9_42=Port_AO_N006;
...
#endif
vec3 l9_43=vec3(l9_37);
vec3 l9_44=mix(vec3(0.039999999),l9_39*l9_37,l9_43);
vec3 l9_45=mix(l9_39*(1.0-l9_37),vec3(0.0),l9_43);
SurfaceProperties l9_46=SurfaceProperties(l9_45,Port_Opacity_N006,l9_40,varPos,l9_1,l9_37,l9_38,l9_41,l9_42,Port_SpecularAO_N006,vec3(1.0),l9_44);
vec4 l9_47=vec4(1.0);
vec3 l9_48;
vec3 l9_49;
vec3 l9_50;
...
l9_56=vec3(0.0);
l9_55=vec3(0.0);
LightingComponents l9_62;
LightProperties l9_63;
SurfaceProperties l9_64;
vec3 l9_65;
int l9_66=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_66<sc_DirectionalLightsCount)
{
LightingComponents l9_67=accumulateLight(LightingComponents(l9_55,l9_56,l9_61,l9_60,l9_58,l9_57),LightProperties(sc_DirectionalLights[l9_66].direction,sc_DirectionalLights[l9_66].color.xyz,sc_DirectionalLights[l9_66].color.w*l9_47[(l9_59<3) ? l9_59 : 3]),l9_46,l9_1);
l9_61=l9_67.indirectDiffuse;
l9_60=l9_67.indirectSpecular;
l9_59++;
l9_58=l9_67.emitted;
l9_57=l9_67.transmitted;
l9_56=l9_67.directSpecular;
l9_55=l9_67.directDiffuse;
l9_66++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_84<sc_PointLightsCount)
{
vec3 l9_86=sc_PointLights[l9_84].position-varPos;
vec3 l9_87=normalize(l9_86);
float l9_88=l9_47[(l9_85<3) ? l9_85 : 3];
float l9_89=clamp((dot(l9_87,sc_PointLights[l9_84].direction)*sc_PointLights[l9_84].angleScale)+sc_PointLights[l9_84].angleOffset,0.0,1.0);
float l9_90=(sc_PointLights[l9_84].color.w*l9_88)*(l9_89*l9_89);
float l9_91;
if (sc_PointLights[l9_84].falloffEnabled)
{
l9_91=l9_90*computeDistanceAttenuation(length(l9_86),sc_PointLights[l9_84].falloffEndDistance);
}
else
{
l9_91=l9_90;
...
l9_77=l9_85+1;
LightingComponents l9_92=accumulateLight(LightingComponents(l9_71,l9_72,l9_76,l9_75,l9_74,l9_73),LightProperties(l9_87,sc_PointLights[l9_84].color.xyz,l9_91),l9_46,l9_1);
l9_78=l9_92.directDiffuse;
l9_79=l9_92.directSpecular;
l9_80=l9_92.indirectDiffuse;
l9_81=l9_92.indirectSpecular;
l9_82=l9_92.emitted;
l9_83=l9_92.transmitted;
l9_76=l9_80;
l9_75=l9_81;
l9_85=l9_77;
l9_74=l9_82;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_96=abs(varShadowTex-vec2(0.5));
vec4 l9_97=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_96.x,l9_96.y),0.5);
l9_95=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_97.xyz,vec3(sc_ShadowColor.w)),vec3(l9_97.w*sc_ShadowDensity));
}
#else
{
l9_95=vec3(1.0);
...
{
vec2 l9_99=calcPanoramicTexCoordsFromDir(l9_40,sc_EnvmapRotation.y);
vec4 l9_100;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_101=calcSeamlessPanoramicUvsForSampling(l9_99,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_101=l9_99;
...
#endif
l9_100=sc_EnvmapSpecularSampleViewIndexBias(l9_101,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_102;
...
{
vec2 l9_103=calcSeamlessPanoramicUvsForSampling(l9_99,sc_EnvmapDiffuseSize.xy,0.0);
int l9_104;
...
#endif
l9_102=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_103,sc_EnvmapDiffuseLayout,l9_104).xy,-13.0);
}
#else
{
l9_102=sc_EnvmapSpecularSampleViewIndexBias(l9_99,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_100=l9_102;
}
#endif
l9_98=(l9_100.xyz*(1.0/l9_100.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_105;
...
float l9_108=l9_106.y;
float l9_109=l9_106.z;
l9_105=(((((((sc_Sh[8]*0.42904299)*((l9_107*l9_107)-(l9_108*l9_108)))+((sc_Sh[6]*0.74312502)*(l9_109*l9_109)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_107*l9_108))+(sc_Sh[7]*(l9_107*l9_109)))+(sc_Sh[5]*(l9_108*l9_109)))*0.85808599))+((((sc_Sh[3]*l9_107)+(sc_Sh[1]*l9_108))+(sc_Sh[2]*l9_109))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_105=vec3(0.0);
...
{
l9_111=l9_98+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_112=l9_98;
l9_112.x=l9_98.x+(1e-06*sc_AmbientLights[0].color.x);
l9_111=l9_112;
}
#endif
l9_110=l9_111;
...
{
l9_114=l9_110+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_115=l9_110;
l9_115.x=l9_110.x+(1e-06*sc_AmbientLights[1].color.x);
l9_114=l9_115;
}
#endif
l9_113=l9_114;
...
{
l9_117=l9_113+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_118=l9_113;
l9_118.x=l9_113.x+(1e-06*sc_AmbientLights[2].color.x);
l9_117=l9_118;
}
#endif
l9_116=l9_117;
...
{
vec3 l9_120;
l9_120=sc_LightEstimationData.ambientLight;
vec3 l9_121;
int l9_122=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_122<sc_LightEstimationSGCount)
{
float l9_123=dot(sc_LightEstimationData.sg[l9_122].axis,l9_40);
float l9_124=exp(-sc_LightEstimationData.sg[l9_122].sharpness);
float l9_125=l9_124*l9_124;
float l9_126=1.0/sc_LightEstimationData.sg[l9_122].sharpness;
float l9_127=(1.0+(2.0*l9_125))-l9_126;
float l9_128=sqrt(1.0-l9_127);
float l9_129=0.36000001*l9_123;
float l9_130=(1.0/(4.0*0.36000001))*l9_128;
float l9_131=l9_129+l9_130;
float l9_132;
if (step(abs(l9_129),l9_130)>0.5)
{
l9_132=(l9_131*l9_131)/l9_128;
}
else
{
l9_132=clamp(l9_123,0.0,1.0);
}
l9_121=l9_120+((((sc_LightEstimationData.sg[l9_122].color/vec3(sc_LightEstimationData.sg[l9_122].sharpness))*6.2831855)*((l9_127*l9_132)+(((l9_124-l9_125)*l9_126)-l9_125)))/vec3(3.1415927));
l9_120=l9_121;
l9_122++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_134=clamp(pow(l9_38,0.66666669),0.0,1.0)*5.0;
vec2 l9_135=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_40,reflect(-l9_1,l9_40),l9_38),sc_EnvmapRotation.y);
vec4 l9_136;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_137=floor(l9_134);
float l9_138=ceil(l9_134);
l9_136=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_135,sc_EnvmapSpecularSize.xy,l9_137),sc_EnvmapSpecularGetStereoViewIndex(),l9_137),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_135,sc_EnvmapSpecularSize.xy,l9_138),sc_EnvmapSpecularGetStereoViewIndex(),l9_138),vec4(l9_134-l9_137));
}
#else
{
l9_136=sc_EnvmapSpecularSampleViewIndexLevel(l9_135,sc_EnvmapSpecularGetStereoViewIndex(),l9_134);
}
#endif
l9_133=vec3(0.0)+((((l9_136.xyz*(1.0/l9_136.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_46,abs(dot(l9_40,l9_1))));
}
#else
{
l9_133=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_140=clamp(l9_38*l9_38,0.0099999998,1.0);
vec3 l9_141;
l9_141=sc_LightEstimationData.ambientLight*l9_44;
int l9_142=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_142<sc_LightEstimationSGCount)
{
float l9_143=l9_140*l9_140;
vec3 l9_144=reflect(-l9_1,l9_40);
float l9_145=dot(l9_40,l9_1);
float l9_146=(2.0/l9_143)/(4.0*max(l9_145,9.9999997e-05));
float l9_147=length((l9_144*l9_146)+(sc_LightEstimationData.sg[l9_142].axis*sc_LightEstimationData.sg[l9_142].sharpness));
float l9_148=clamp(dot(l9_40,l9_144),0.0,1.0);
float l9_149=clamp(l9_145,0.0,1.0);
float l9_150=1.0-l9_143;
l9_141+=((((((((vec3(1.0/(3.1415927*l9_143))*exp((l9_147-l9_146)-sc_LightEstimationData.sg[l9_142].sharpness))*sc_LightEstimationData.sg[l9_142].color)*6.2831855)*(1.0-exp((-2.0)*l9_147)))/vec3(l9_147))*((1.0/(l9_148+sqrt(l9_143+((l9_150*l9_148)*l9_148))))*(1.0/(l9_149+sqrt(l9_143+((l9_150*l9_149)*l9_149))))))*(l9_44+((vec3(1.0)-l9_44)*pow(1.0-clamp(dot(l9_144,normalize(l9_144+l9_1)),0.0,1.0),5.0))))*l9_148);
l9_142++;
continue;
}
else
...
l9_154=vec3(0.0);
l9_153=vec3(0.0);
l9_152=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_45,vec3(Port_Opacity_N006));
l9_151=1.0;
}
#else
{
...
#endif
vec3 l9_156=l9_153*l9_42;
vec3 l9_157=l9_154+l9_156;
vec3 l9_158=l9_45*l9_157;
vec3 l9_159=l9_139*Port_SpecularAO_N006;
vec3 l9_160=l9_93+l9_159;
vec3 l9_161;
if (l9_155)
{
l9_161=l9_158*srgbToLinear(l9_151);
}
else
{
l9_161=l9_158;
}
vec3 l9_162=l9_161+l9_160;
vec3 l9_163=(l9_162+l9_41)+l9_152;
float l9_164=l9_163.x;
vec4 l9_165=vec4(l9_164,l9_163.yz,l9_151);
vec4 l9_166;
#if (sc_IsEditor)
{
vec4 l9_167=l9_165;
l9_167.x=l9_164+((l9_42.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_166=l9_167;
}
#else
{
...
{
vec3 l9_169=l9_166.xyz*1.8;
vec3 l9_170=(l9_166.xyz*(l9_169+vec3(1.4)))/((l9_166.xyz*(l9_169+vec3(0.5)))+vec3(1.5));
l9_168=vec4(l9_170.x,l9_170.y,l9_170.z,l9_166.w);
}
#else
{
l9_168=l9_166;
...
#endif
vec3 l9_171=vec3(linearToSrgb(l9_168.x),linearToSrgb(l9_168.y),linearToSrgb(l9_168.z));
l9_36=vec4(l9_171.x,l9_171.y,l9_171.z,l9_168.w);
}
#endif
vec4 l9_172=max(l9_36,vec4(0.0));
vec4 l9_173;
#if (sc_ProjectiveShadowsCaster)
{
float l9_174;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_175=clamp(l9_172.w*2.0,0.0,1.0);
}
#else
{
float l9_176;
...
{
l9_176=clamp(dot(l9_172.xyz,vec3(l9_172.w)),0.0,1.0);
}
#else
{
float l9_177;
...
#if (sc_BlendMode_Multiply)
{
l9_178=(1.0-dot(l9_172.xyz,vec3(0.33333001)))*l9_172.w;
}
#else
{
float l9_179;
...
{
l9_179=(1.0-clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0))*l9_172.w;
}
#else
{
float l9_180;
#if (sc_BlendMode_ColoredGlass)
{
l9_180=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0)*l9_172.w;
}
#else
{
float l9_181;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_182=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0)*l9_172.w;
}
#else
{
float l9_183;
...
{
l9_183=dot(l9_172.xyz,vec3(0.33333001))*l9_172.w;
}
#else
{
float l9_184;
...
vec3 l9_189=mix(l9_188,definedBlend(l9_188,l9_172.xyz).xyz,vec3(l9_172.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_192=l9_172.w;
l9_191=vec4(mix(vec3(1.0),l9_172.xyz,vec3(l9_192)),l9_192);
}
#else
{
vec4 l9_193;
...
{
float l9_194=l9_172.w;
float l9_195;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_195=clamp(l9_194,0.0,1.0);
}
#else
{
l9_195=l9_194;
...
#endif
l9_193=vec4(l9_172.xyz*l9_195,l9_195);
}
#else
{
l9_193=l9_172;
