...
export class PlayerSkinManager extends BaseScriptComponent {
    ...
    onAwake(): void {
        ...
        // Temporarily comment out to bypass compilation error for debugging
        /*
        ...
        */
        ...
        this.manualValidateButton(this.skinButtonY2K, "skinButtonY2K");
        this.manualValidateButton(this.skinButtonModern, "skinButtonModern");
        this.manualValidateButton(this.handButtonY2K, "handButtonY2K");
        this.manualValidateButton(this.handButtonModern, "handButtonModern");
        this.manualValidateButton(this.handButtonHand, "handButtonHand");
    ...
    // Temporary workaround method to bypass compilation issue
    private manualValidateButton(button: PinchButton | null, buttonName: string): void {
        if (!button) {
    ...
    // Original method (kept for reference, but commented out in onAwake to avoid compilation error)
