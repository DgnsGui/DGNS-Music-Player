...
vec2 l9_1=((varPackedTex.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003;
...
vec2 l9_8=(((((((l9_1*l9_3)+(l9_1*l9_4))+(l9_1*l9_5))/vec2((l9_3+l9_4)+l9_5))*2.0)-vec2(1.0))*l9_6.x)/vec2(l9_7.y);
float l9_9=sin(l9_0);
vec3 l9_10;
vec2 l9_11;
l9_11=l9_8;
