...
vec2 l9_6=l9_3*vec2(l9_4.x/l9_5.y,1.0);
float l9_7=l9_0*0.029999999;
vec2 l9_8=l9_6*1.1;
float l9_9=N0_fbm(l9_8*0.5);
vec2 l9_10=l9_8-vec2(l9_9-l9_7);
float l9_11;
vec2 l9_12;
l9_12=l9_10;
l9_11=0.0;
vec2 l9_13;
int l9_14=0;
float l9_15=0.80000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_14<8)
{
float l9_16=l9_15*N0_noise(l9_12);
l9_12=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_12)+vec2(l9_7);
l9_15*=0.69999999;
l9_11+=abs(l9_16);
l9_14++;
continue;
...
vec2 l9_19;
int l9_20=0;
float l9_21=0.69999999;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_20<8)
{
float l9_22=l9_21*N0_noise(l9_18);
l9_18=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_18)+vec2(l9_7);
l9_21*=0.60000002;
l9_17+=l9_22;
l9_20++;
continue;
...
float l9_23=l9_17+l9_11;
float l9_24=l9_17*l9_11;
float l9_25=l9_7*2.0;
float l9_26;
vec2 l9_27;
l9_27=(l9_8*2.0)-vec2(l9_9-l9_25);
l9_26=0.0;
vec2 l9_28;
int l9_29=0;
float l9_30=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_29<7)
{
float l9_31=l9_30*N0_noise(l9_27);
l9_27=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_27)+vec2(l9_25);
l9_30*=0.60000002;
l9_26+=l9_31;
l9_29++;
continue;
...
float l9_32=l9_7*3.0;
float l9_33;
vec2 l9_34;
l9_34=(l9_8*3.0)-vec2(l9_9-l9_32);
l9_33=0.0;
vec2 l9_35;
int l9_36=0;
float l9_37=0.40000001;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_36<7)
{
float l9_38=l9_37*N0_noise(l9_34);
l9_34=(mat2(vec2(1.6,1.2),vec2(-1.2,1.6))*l9_34)+vec2(l9_32);
l9_37*=0.60000002;
l9_33+=abs(l9_38);
l9_36++;
continue;
...
float l9_39=l9_26*0.69999999;
float l9_40=l9_33*0.30000001;
float l9_41=l9_39+l9_40;
float l9_42=N0_fbm(l9_8);
float l9_43=N0_fbm((l9_6+vec2(0.0099999998,0.0))*1.1);
float l9_44=N0_fbm((l9_6+vec2(0.0,0.0099999998))*1.1);
vec3 l9_45=mix(vec3(0.40000001,0.69999999,1.0),vec3(0.2,0.40000001,0.60000002),vec3(l9_3.y));
float l9_46=(8.0*((l9_23*0.5)+(l9_24*0.5)))*l9_11;
vec4 l9_47=vec4(mix(l9_45,clamp((l9_45*0.5)+(vec3(1.1,1.1,0.89999998)*clamp((0.5+(0.30000001*l9_41))+(max(0.0,dot(normalize(vec3((-(l9_43-l9_42))/0.0099999998,(-(l9_44-l9_42))/0.0099999998,0.050000001)),vec3(0.40824831,0.40824831,0.81649661)))*0.2),0.0,1.0)),vec3(0.0),vec3(1.0)),vec3(clamp((0.2+l9_46)+(l9_41*0.5),0.0,1.0))),1.0);
...
{
l9_51=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
...
{
l9_53=(1.0-dot(l9_47.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_54;
...
{
l9_54=(1.0-clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_55;
...
{
l9_55=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_56;
#if (sc_BlendMode_Add)
{
l9_56=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_57;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_57=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_58;
...
{
l9_58=dot(l9_47.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_59;
#if (sc_BlendMode_Min)
{
l9_59=1.0-clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
#if (sc_BlendMode_Max)
{
l9_60=clamp(dot(l9_47.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_60=1.0;
...
#endif
l9_48=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_47.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_49);
}
#else
{
vec4 l9_61;
...
{
l9_69=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_67,sc_ScreenTextureLayout,l9_68),0.0);
}
#else
{
l9_69=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_67,sc_ScreenTextureLayout,l9_68).xy,0.0);
}
#endif
l9_63=l9_69;
}
...
#endif
vec3 l9_72=definedBlend(l9_70.xyz,l9_47.xyz);
