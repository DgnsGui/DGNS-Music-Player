...
vec2 l9_9=((((((((((l9_1.yz-l9_2)*Tweak_N1)+l9_2)*l9_4)+((((l9_1.zx-l9_2)*Tweak_N1)+l9_2)*l9_5))+((((l9_1.xy-l9_2)*Tweak_N1)+l9_2)*l9_6))/vec2((l9_4+l9_5)+l9_6))*2.0)-vec2(1.0))*l9_7.x)/vec2(l9_8.y);
float l9_10=sin(l9_0);
vec3 l9_11;
vec2 l9_12;
l9_12=l9_9;
l9_11=vec3(0.0);
...
if (l9_15<2.0)
{
l9_13=fract(l9_12*2.5999999)-vec2(0.5);
float l9_16=length(l9_9);
float l9_17=l9_15*0.2;
float l9_18=l9_0*0.40000001;
float l9_19;
l9_19=length(l9_13)*exp(-l9_16);
float l9_20=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_20<0.80000001)
{
l9_19=abs(sin((l9_19*16.0)+l9_0)/16.0);
l9_20+=1.0;
continue;
}
else
...
l9_14=l9_11+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_16+l9_17)+l9_18))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+(vec4(0.0)-vec4(fract(sin(dot(l9_9,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_10+2.0)))).xyz)*l9_22);
l9_12=l9_13;
l9_11=l9_14;
l9_15+=1.0;
continue;
...
{
l9_27=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_29=(1.0-dot(l9_23.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_30;
...
{
l9_30=(1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_32;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_33=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_34;
...
{
l9_34=dot(l9_23.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_35;
...
#endif
vec3 l9_48=definedBlend(l9_46.xyz,l9_23.xyz);
