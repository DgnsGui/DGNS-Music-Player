...
l9_13=l9_10+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_15+l9_16)+l9_17))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+(vec4(0.0)-vec4(fract(sin(dot(l9_8,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_9+1.0)))).xyz)*l9_21);
l9_11=l9_12;
l9_10=l9_13;
l9_14+=1.0;
continue;
