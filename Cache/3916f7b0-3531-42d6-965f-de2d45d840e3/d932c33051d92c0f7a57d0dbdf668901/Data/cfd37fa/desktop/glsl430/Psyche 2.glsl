...
vec2 l9_3=((((((vec2(0.0)-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*2.0)-vec2(1.0))*l9_1.x)/vec2(l9_2.y);
float l9_4=sin(l9_0);
vec3 l9_5;
vec2 l9_6;
l9_6=l9_3;
...
if (l9_9<2.0)
{
l9_7=fract(l9_6*2.5999999)-vec2(0.5);
float l9_10=length(l9_3);
float l9_11=l9_9*0.2;
float l9_12=l9_0*0.40000001;
float l9_13;
l9_13=length(l9_7)*exp(-l9_10);
float l9_14=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_14<0.80000001)
{
l9_13=abs(sin((l9_13*16.0)+l9_0)/16.0);
l9_14+=1.0;
continue;
}
else
...
l9_8=l9_5+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_10+l9_11)+l9_12))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+(vec4(0.0)-vec4(fract(sin(dot(l9_3,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_4+2.0)))).xyz)*l9_16);
l9_6=l9_7;
l9_5=l9_8;
l9_9+=1.0;
continue;
