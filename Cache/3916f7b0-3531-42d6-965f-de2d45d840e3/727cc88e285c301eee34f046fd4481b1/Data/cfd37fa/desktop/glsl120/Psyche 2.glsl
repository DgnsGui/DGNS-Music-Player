...
vec2 l9_8=((((((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5))*2.0)-vec2(1.0))*l9_6.x)/vec2(l9_7.y);
float l9_9=sin(l9_0);
vec3 l9_10;
vec2 l9_11;
l9_11=l9_8;
...
if (l9_14<2.0)
{
l9_12=fract(l9_11*2.5999999)-vec2(0.5);
float l9_15=length(l9_8);
float l9_16=l9_14*0.2;
float l9_17=l9_0*0.40000001;
float l9_18;
l9_18=length(l9_12)*exp(-l9_15);
float l9_19=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_19<0.80000001)
{
l9_18=abs(sin((l9_18*16.0)+l9_0)/16.0);
l9_19+=1.0;
continue;
}
else
...
l9_13=l9_10+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_15+l9_16)+l9_17))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+(vec4(0.0)-vec4(fract(sin(dot(l9_8,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_9+2.0)))).xyz)*l9_21);
l9_11=l9_12;
l9_10=l9_13;
l9_14+=1.0;
continue;
...
{
l9_26=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_28=(1.0-dot(l9_22.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_29;
...
{
l9_29=(1.0-clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_31;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_32=clamp(dot(l9_22.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_33;
...
{
l9_33=dot(l9_22.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_34;
...
#endif
l9_38=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_42,sc_ScreenTextureLayout,l9_43).xy,0.0);
}
#endif
vec4 l9_44;
...
#endif
vec3 l9_46=definedBlend(l9_44.xyz,l9_22.xyz);
