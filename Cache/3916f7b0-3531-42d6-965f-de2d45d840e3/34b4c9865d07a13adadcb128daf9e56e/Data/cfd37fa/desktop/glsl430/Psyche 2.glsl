...
//sampler sampler Tweak_N6SmpSC 0:16
...
//texture texture2D Tweak_N6 0:0:0:16
...
//texture texture2DArray Tweak_N6ArrSC 0:25:0:16
...
vec3 l9_1=((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+Port_Offset_N005)*Port_Scale_N005;
vec3 l9_2=pow(abs(normalize((sc_ModelMatrixInverse*vec4(normalize(varNormal),0.0)).xyz)),vec3(1.0/(1.0-(Port_Sharpness_N005*0.99000001))));
float l9_3=l9_2.x;
float l9_4=l9_2.y;
float l9_5=l9_2.z;
vec2 l9_6=((((((l9_1.yz-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_3)+((((l9_1.zx-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_4))+((((l9_1.xy-Port_Center_N003)*Tweak_N1)+Port_Center_N003)*l9_5))/vec2((l9_3+l9_4)+l9_5);
N0_resolution=Port_resolution_N000;
vec3 l9_7=N0_getResolution();
vec3 l9_8=N0_getResolution();
vec2 l9_9=(((l9_6*2.0)-vec2(1.0))*l9_7.x)/vec2(l9_8.y);
vec4 l9_10;
#if (Tweak_N6Layout==2)
{
float l9_11=l9_6.x;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_12=l9_11;
float l9_13=l9_6.y;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_14=l9_13;
vec2 l9_15;
float l9_16;
...
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_18=l9_12;
float l9_19=1.0;
sc_ClampUV(l9_18,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_17,l9_19);
float l9_20=l9_18;
float l9_21=l9_19;
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
...
float l9_23=l9_14;
float l9_24=l9_21;
sc_ClampUV(l9_23,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_22,l9_24);
l9_16=l9_24;
...
#endif
vec2 l9_25=sc_TransformUV(l9_15,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_29);
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_32=texture(Tweak_N6ArrSC,l9_31,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_33=mix(Tweak_N6BorderColor,l9_32,vec4(l9_30));
}
#else
{
l9_33=l9_32;
...
{
float l9_34=l9_6.x;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_35=l9_34;
float l9_36=l9_6.y;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_37=l9_36;
vec2 l9_38;
float l9_39;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_41=l9_35;
float l9_42=1.0;
sc_ClampUV(l9_41,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_40,l9_42);
float l9_43=l9_41;
float l9_44=l9_42;
bool l9_45;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
...
float l9_46=l9_37;
float l9_47=l9_44;
sc_ClampUV(l9_46,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_45,l9_47);
l9_39=l9_47;
...
#endif
vec2 l9_48=sc_TransformUV(l9_38,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_55=texture(Tweak_N6,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_56=mix(Tweak_N6BorderColor,l9_55,vec4(l9_53));
}
#else
{
l9_56=l9_55;
...
#endif
float l9_57=sin(l9_0);
vec4 l9_58=l9_10-vec4(fract(sin(dot(l9_9,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_57+2.0)));
vec3 l9_59;
vec2 l9_60;
l9_60=l9_9;
l9_59=vec3(0.0);
...
if (l9_63<2.0)
{
l9_61=fract(l9_60*2.5999999)-vec2(0.5);
float l9_64=length(l9_9);
float l9_65=l9_63*0.2;
float l9_66=l9_0*0.40000001;
float l9_67;
l9_67=length(l9_61)*exp(-l9_64);
float l9_68=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_68<0.80000001)
{
l9_67=abs(sin((l9_67*16.0)+l9_0)/16.0);
l9_68+=1.0;
continue;
}
else
...
l9_62=l9_59+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_64+l9_65)+l9_66))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+l9_58.xyz)*l9_70);
l9_60=l9_61;
l9_59=l9_62;
l9_63+=1.0;
continue;
...
{
l9_75=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_76;
...
{
l9_77=(1.0-dot(l9_71.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_78;
...
{
l9_78=(1.0-clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_79;
...
{
l9_79=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_80;
#if (sc_BlendMode_Add)
{
l9_80=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_81;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_81=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_82;
...
{
l9_82=dot(l9_71.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_83;
#if (sc_BlendMode_Min)
{
l9_83=1.0-clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_84;
#if (sc_BlendMode_Max)
{
l9_84=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_84=1.0;
...
#endif
l9_72=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_71.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_73);
}
#else
{
vec4 l9_85;
...
#if (sc_FramebufferFetch)
{
vec4 l9_88=sc_readFragData0_Platform();
vec4 l9_89;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_90=l9_88;
l9_90.x=l9_88.x+_sc_framebufferFetchMarker;
l9_89=l9_90;
}
#else
{
...
{
l9_93=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_91,sc_ScreenTextureLayout,l9_92),0.0);
}
#else
{
l9_93=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_91,sc_ScreenTextureLayout,l9_92).xy,0.0);
}
#endif
l9_87=l9_93;
}
...
{
vec4 l9_95=l9_87;
l9_95.x=l9_87.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_94=l9_95;
}
#else
{
...
#endif
vec3 l9_96=definedBlend(l9_94.xyz,l9_71.xyz);
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_106-0.0039215689)),min(1.0,l9_106+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_108),packValue(l9_108),packValue(l9_108),packValue(l9_108)));
