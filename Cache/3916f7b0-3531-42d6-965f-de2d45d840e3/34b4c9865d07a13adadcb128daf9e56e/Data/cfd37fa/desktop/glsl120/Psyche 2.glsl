...
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),Tweak_N6Layout,l9_10);
vec4 l9_32=texture2D(Tweak_N6,l9_31.xy,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
...
#endif
float l9_34=sin(l9_0);
vec4 l9_35=l9_33-vec4(fract(sin(dot(l9_9,vec2(25.979601,156.466)))*43758.547)*(0.079999998*(l9_34+2.0)));
vec3 l9_36;
vec2 l9_37;
l9_37=l9_9;
l9_36=vec3(0.0);
...
if (l9_40<2.0)
{
l9_38=fract(l9_37*2.5999999)-vec2(0.5);
float l9_41=length(l9_9);
float l9_42=l9_40*0.2;
float l9_43=l9_0*0.40000001;
float l9_44;
l9_44=length(l9_38)*exp(-l9_41);
float l9_45=0.0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_45<0.80000001)
{
l9_44=abs(sin((l9_44*16.0)+l9_0)/16.0);
l9_45+=1.0;
continue;
}
else
...
l9_39=l9_36+(((vec3(0.5)+(vec3(0.5)*cos(((vec3(1.0)*((l9_41+l9_42)+l9_43))+vec3(0.2,0.40000001,0.55699998))*6.2831802)))+l9_35.xyz)*l9_47);
l9_37=l9_38;
l9_36=l9_39;
l9_40+=1.0;
continue;
...
{
l9_52=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
...
{
l9_54=(1.0-dot(l9_48.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_55;
...
{
l9_55=(1.0-clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_56;
...
{
l9_56=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_57;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_58=clamp(dot(l9_48.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_59;
...
{
l9_59=dot(l9_48.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_60;
...
#endif
vec3 l9_72=definedBlend(l9_70.xyz,l9_48.xyz);
