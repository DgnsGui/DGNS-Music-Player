...
#endif
l9_0=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*vec3(0.0),vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_1);
}
#else
{
vec4 l9_13;
...
#endif
vec4 l9_24=vec4(l9_22.x,l9_22.y,l9_22.z,vec4(0.0).w);
l9_24.w=1.0;
l9_14=l9_24;
}
#else
...
vec4 l9_30=outputMotionVectorsIfNeeded(varPos,max(l9_29,vec4(0.0)));
