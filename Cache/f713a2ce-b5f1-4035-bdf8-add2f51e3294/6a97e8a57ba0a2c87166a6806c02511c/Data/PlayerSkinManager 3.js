...
function switchToY2K() {
    ...
    // Ensure Y2K buttons are enabled
    if (script.y2kSkinButton && script.y2kSkinButton.getSceneObject()) {
        script.y2kSkinButton.getSceneObject().enabled = true;
    }
    if (script.y2kHandButton && script.y2kHandButton.getSceneObject()) {
...
function switchToModern() {
    ...
    // Ensure Modern buttons are enabled
    if (script.modernSkinButton && script.modernSkinButton.getSceneObject()) {
        script.modernSkinButton.getSceneObject().enabled = true;
        print("Modern skin button enabled.");
    }
    if (script.modernHandButton && script.modernHandButton.getSceneObject()) {
        script.modernHandButton.getSceneObject().enabled = true;
        print("Modern hand button enabled.");
    }
...
function switchToHand() {
    ...
    // Ensure Hand buttons are enabled
    if (script.handSkinButton && script.handSkinButton.getSceneObject()) {
        script.handSkinButton.getSceneObject().enabled = true;
    }
    if (script.handHandButton && script.handHandButton.getSceneObject()) {
