...
{
l9_0=Port_Default_N204;
}
float l9_1=Port_Import_N166.w*l9_0;
vec4 l9_2=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_2.w=l9_1;
...
{
l9_6=clamp(dot(l9_2.xyz,vec3(l9_1)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_1;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_1;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_11;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_1;
}
#else
{
float l9_13;
...
{
l9_13=dot(l9_2.xyz,vec3(0.33333001))*l9_1;
}
#else
{
float l9_14;
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_2.xyz).xyz,vec3(l9_1));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_1)),l9_1);
}
#else
{
vec4 l9_29;
