...
float l9_1;
if ((Port_Import_N206.x*1.0)!=0.0)
{
l9_1=0.0;
}
else
{
l9_1=Port_Default_N204;
}
float l9_2=Port_Import_N166.w*l9_1;
vec4 l9_3=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_3.w=l9_2;
...
{
l9_9=clamp(dot(l9_3.xyz,vec3(l9_2)),0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_11=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_2;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_2;
}
#else
{
float l9_13;
...
#if (sc_BlendMode_Add)
{
l9_14=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_2;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_3.xyz,vec3(0.33333001))*l9_2;
}
#else
{
float l9_17;
#if (sc_BlendMode_Min)
{
l9_17=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_18;
#if (sc_BlendMode_Max)
{
l9_18=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_18=1.0;
...
#endif
l9_6=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_7);
}
#else
{
vec4 l9_19;
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_3.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_33;
...
#endif
l9_33=vec4(l9_3.xyz*l9_34,l9_34);
}
#else
{
l9_33=l9_3;
