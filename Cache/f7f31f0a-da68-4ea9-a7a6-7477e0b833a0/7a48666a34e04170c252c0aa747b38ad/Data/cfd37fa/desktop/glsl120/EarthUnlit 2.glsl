...
#endif
vec4 l9_0=vec4(Port_Value1_N001.x,Port_Value1_N001.y,Port_Value1_N001.z,vec4(0.0).w);
l9_0.w=Port_Value2_N001;
...
{
l9_3=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_4;
...
{
l9_4=clamp(dot(l9_0.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_5;
...
{
l9_6=(1.0-dot(l9_0.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_7;
...
{
l9_7=(1.0-clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_8;
...
{
l9_8=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_9;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_10=clamp(dot(l9_0.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_11;
...
{
l9_11=dot(l9_0.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_12;
...
#endif
vec3 l9_24=mix(l9_22.xyz,definedBlend(l9_22.xyz,l9_0.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_26=vec4(mix(vec3(1.0),l9_0.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_27;
...
{
l9_28=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_28=Port_Value2_N001;
}
#endif
