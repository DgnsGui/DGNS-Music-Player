...
vec4 l9_117=l9_116*vec4(Tweak_N85);
vec4 l9_118=vec4(l9_2);
vec4 l9_119;
#if (Tweak_N99Layout==2)
{
float l9_120=l9_1.x;
sc_SoftwareWrapEarly(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x);
float l9_121=l9_120;
float l9_122=l9_1.y;
sc_SoftwareWrapEarly(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y);
float l9_123=l9_122;
vec2 l9_124;
float l9_125;
...
{
l9_126=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x==3;
}
#else
{
l9_126=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_127=l9_121;
float l9_128=1.0;
sc_ClampUV(l9_127,Tweak_N99UvMinMax.x,Tweak_N99UvMinMax.z,l9_126,l9_128);
float l9_129=l9_127;
float l9_130=l9_128;
bool l9_131;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_131=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y==3;
}
#else
{
l9_131=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_132=l9_123;
float l9_133=l9_130;
sc_ClampUV(l9_132,Tweak_N99UvMinMax.y,Tweak_N99UvMinMax.w,l9_131,l9_133);
l9_125=l9_133;
...
#endif
vec2 l9_134=sc_TransformUV(l9_124,(int(SC_USE_UV_TRANSFORM_Tweak_N99)!=0),Tweak_N99Transform);
float l9_135=l9_134.x;
float l9_136=l9_125;
sc_SoftwareWrapLate(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0)),l9_136);
float l9_137=l9_134.y;
float l9_138=l9_136;
sc_SoftwareWrapLate(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0)),l9_138);
float l9_139=l9_138;
vec3 l9_140=sc_SamplingCoordsViewToGlobal(vec2(l9_135,l9_137),Tweak_N99Layout,Tweak_N99GetStereoViewIndex());
vec4 l9_141=texture(Tweak_N99ArrSC,l9_140,0.0);
vec4 l9_142;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_142=mix(Tweak_N99BorderColor,l9_141,vec4(l9_139));
}
#else
{
l9_142=l9_141;
...
{
float l9_143=l9_1.x;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x);
float l9_144=l9_143;
float l9_145=l9_1.y;
sc_SoftwareWrapEarly(l9_145,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y);
float l9_146=l9_145;
vec2 l9_147;
float l9_148;
#if (SC_USE_UV_MIN_MAX_Tweak_N99)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_149=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x==3;
}
#else
{
l9_149=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_150=l9_144;
float l9_151=1.0;
sc_ClampUV(l9_150,Tweak_N99UvMinMax.x,Tweak_N99UvMinMax.z,l9_149,l9_151);
float l9_152=l9_150;
float l9_153=l9_151;
bool l9_154;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_154=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y==3;
}
#else
{
l9_154=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_155=l9_146;
float l9_156=l9_153;
sc_ClampUV(l9_155,Tweak_N99UvMinMax.y,Tweak_N99UvMinMax.w,l9_154,l9_156);
l9_148=l9_156;
...
#endif
vec2 l9_157=sc_TransformUV(l9_147,(int(SC_USE_UV_TRANSFORM_Tweak_N99)!=0),Tweak_N99Transform);
float l9_158=l9_157.x;
float l9_159=l9_148;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0)),l9_159);
float l9_160=l9_157.y;
float l9_161=l9_159;
sc_SoftwareWrapLate(l9_160,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0)),l9_161);
float l9_162=l9_161;
vec3 l9_163=sc_SamplingCoordsViewToGlobal(vec2(l9_158,l9_160),Tweak_N99Layout,Tweak_N99GetStereoViewIndex());
vec4 l9_164=texture(Tweak_N99,l9_163.xy,0.0);
vec4 l9_165;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_165=mix(Tweak_N99BorderColor,l9_164,vec4(l9_162));
}
#else
{
l9_165=l9_164;
...
#endif
vec4 l9_166=(l9_117*mix(l9_117,Port_Input1_N097,l9_118))+l9_119;
float l9_167=snoise(vec2(floor(Port_Seed_N083.x*10000.0)*9.9999997e-05,floor(Port_Seed_N083.y*10000.0)*9.9999997e-05)*((((l9_1-Port_Center_N092)*Port_Scale_N092)+Port_Center_N092)*0.5));
float l9_168=floor(((l9_167*0.5)+0.5)*10000.0)*9.9999997e-05;
vec3 l9_169=l9_166.xyz;
vec3 l9_170=mix(l9_169,(vec4(l9_168).xyz*l9_169).xyz,vec3(l9_168));
float l9_171=l9_170.x;
vec4 l9_172=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_172.w=l9_171;
#if (sc_BlendMode_AlphaTest)
{
if (l9_171<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_171<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_173,vec4(0.0)));
return;
}
vec4 l9_175;
...
{
l9_177=clamp(l9_171*2.0,0.0,1.0);
}
#else
{
float l9_178;
...
{
l9_178=clamp(dot(l9_172.xyz,vec3(l9_171)),0.0,1.0);
}
#else
{
float l9_179;
...
{
l9_180=(1.0-dot(l9_172.xyz,vec3(0.33333001)))*l9_171;
}
#else
{
float l9_181;
...
{
l9_181=(1.0-clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0))*l9_171;
}
#else
{
float l9_182;
...
#if (sc_BlendMode_Add)
{
l9_183=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_184;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_184=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0)*l9_171;
}
#else
{
float l9_185;
...
{
l9_185=dot(l9_172.xyz,vec3(0.33333001))*l9_171;
}
#else
{
float l9_186;
#if (sc_BlendMode_Min)
{
l9_186=1.0-clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_187;
#if (sc_BlendMode_Max)
{
l9_187=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_187=1.0;
...
#endif
l9_175=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_172.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_176);
}
#else
{
vec4 l9_188;
...
#if (sc_FramebufferFetch)
{
vec4 l9_191=sc_readFragData0_Platform();
vec4 l9_192;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_193=l9_191;
l9_193.x=l9_191.x+_sc_framebufferFetchMarker;
l9_192=l9_193;
}
#else
{
...
{
l9_195=1-sc_GetStereoViewIndex();
}
#else
{
l9_195=sc_GetStereoViewIndex();
}
#endif
vec4 l9_196;
#if (sc_ScreenTextureLayout==2)
{
l9_196=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_194,sc_ScreenTextureLayout,l9_195),0.0);
}
#else
{
l9_196=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_194,sc_ScreenTextureLayout,l9_195).xy,0.0);
}
#endif
l9_190=l9_196;
}
...
{
vec4 l9_198=l9_190;
l9_198.x=l9_190.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_197=l9_198;
}
#else
{
...
#endif
vec3 l9_199=mix(l9_197.xyz,definedBlend(l9_197.xyz,l9_172.xyz).xyz,vec3(l9_171));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_201=vec4(mix(vec3(1.0),l9_172.xyz,vec3(l9_171)),l9_171);
}
#else
{
vec4 l9_202;
...
#endif
l9_202=vec4(l9_172.xyz*l9_203,l9_203);
}
#else
{
l9_202=l9_172;
...
{
l9_206=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_206=vec4(0.0);
...
vec4 l9_208=outputMotionVectorsIfNeeded(varPos,max(l9_207,vec4(0.0)));
vec4 l9_209=clamp(l9_208,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_210=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_210-0.0039215689)),min(1.0,l9_210+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_212=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_211).xy);
float l9_213=packValue(l9_212);
int l9_220=int(l9_209.w*255.0);
float l9_221=packValue(l9_220);
sc_writeFragData0(vec4(packValue(l9_212),packValue(l9_212),packValue(l9_212),packValue(l9_212)));
sc_writeFragData1(vec4(l9_213,packValue(l9_212),packValue(l9_212),packValue(l9_212)));
sc_writeFragData2(vec4(l9_221,packValue(l9_220),packValue(l9_220),packValue(l9_220)));
...
if (l9_229==0)
{
l9_232=texture(sc_OITAlpha0,l9_224);
l9_231=texture(sc_OITDepthLow0,l9_224);
l9_230=texture(sc_OITDepthHigh0,l9_224);
}
else
{
l9_232=vec4(0.0);
...
if (l9_229==1)
{
l9_235=texture(sc_OITAlpha1,l9_224);
l9_234=texture(sc_OITDepthLow1,l9_224);
l9_233=texture(sc_OITDepthHigh1,l9_224);
}
else
{
l9_235=l9_232;
...
if (any(notEqual(l9_233,vec4(0.0)))||any(notEqual(l9_234,vec4(0.0))))
{
int l9_236[8]=l9_225;
unpackValues(l9_233.w,l9_229,l9_236);
unpackValues(l9_233.z,l9_229,l9_236);
unpackValues(l9_233.y,l9_229,l9_236);
unpackValues(l9_233.x,l9_229,l9_236);
unpackValues(l9_234.w,l9_229,l9_236);
unpackValues(l9_234.z,l9_229,l9_236);
unpackValues(l9_234.y,l9_229,l9_236);
unpackValues(l9_234.x,l9_229,l9_236);
int l9_245[8]=l9_226;
unpackValues(l9_235.w,l9_229,l9_245);
unpackValues(l9_235.z,l9_229,l9_245);
unpackValues(l9_235.y,l9_229,l9_245);
unpackValues(l9_235.x,l9_229,l9_245);
}
l9_229++;
continue;
}
...
vec4 l9_250=texture(sc_OITFilteredDepthBoundsTexture,l9_224);
vec2 l9_251=l9_250.xy;
int l9_252;
#if (sc_SkinBonesCount>0)
{
l9_252=encodeDepth(((1.0-l9_250.x)*1000.0)+getDepthOrderingEpsilon(),l9_251);
}
#else
{
l9_252=0;
...
#endif
int l9_253=encodeDepth(viewSpaceDepth(),l9_251);
vec4 l9_254;
l9_254=l9_209*l9_209.w;
vec4 l9_255;
int l9_256=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_256<8)
{
int l9_257=l9_225[l9_256];
int l9_258=l9_253-l9_252;
bool l9_259=l9_257<l9_258;
bool l9_260;
if (l9_259)
{
l9_260=l9_225[l9_256]>0;
}
else
{
l9_260=l9_259;
...
if (l9_260)
{
vec3 l9_261=l9_254.xyz*(1.0-(float(l9_226[l9_256])/255.0));
l9_255=vec4(l9_261.x,l9_261.y,l9_261.z,l9_254.w);
}
else
{
l9_255=l9_254;
