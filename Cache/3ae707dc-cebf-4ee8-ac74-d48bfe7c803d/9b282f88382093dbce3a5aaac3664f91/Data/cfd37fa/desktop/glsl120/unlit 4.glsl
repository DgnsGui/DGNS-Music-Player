...
vec2 l9_3=tempGlobals.Surface_UVCoord0;
vec3 l9_4=N0_getResolution();
vec3 l9_5=N0_getResolution();
vec3 l9_6=N0_getResolution();
vec2 l9_7=(((l9_3*l9_4.xy)*2.0)-l9_5.xy)/vec2(l9_6.y);
vec3 l9_8=normalize(vec3(0.0,0.0,1000.0)-vec3(0.0));
vec3 l9_9=normalize(cross(l9_8,vec3(0.0,1.0,0.0)));
vec3 l9_10=normalize(((l9_9*l9_7.x)+(normalize(cross(l9_9,l9_8))*l9_7.y))-(l9_8*3.0));
float l9_11;
l9_11=0.0;
float l9_12;
float l9_13;
...
if (l9_14<512)
{
vec3 l9_15=l9_10*l9_11;
vec3 l9_16=vec3(0.0)+l9_15;
float l9_17=N0_ocean(l9_16.xz*0.1);
float l9_18=(l9_16.y+0.5)+(l9_17*1.5);
if (l9_18<0.0099999998)
{
l9_13=1.0;
break;
}
...
float l9_19=tempGlobals.gTimeElapsed;
float l9_20=0.60000002*sin((l9_19*0.1)-1.0);
vec3 l9_21=normalize(vec3(-0.23862,0.178965,-0.95447999)+vec3(0.0,(-l9_20)*0.5,0.0));
float l9_22=1.0-l9_20;
vec3 l9_23=N0_sky(l9_10,l9_21,l9_22);
vec3 l9_24;
if (l9_13>0.0)
{
vec3 l9_25=l9_10*l9_11;
vec3 l9_26=vec3(0.0)+l9_25;
vec3 l9_27=l9_26+vec3(0.0099999998,0.0,0.0);
float l9_28=N0_ocean(l9_27.xz*0.1);
vec3 l9_29=l9_26-vec3(0.0099999998,0.0,0.0);
float l9_30=N0_ocean(l9_29.xz*0.1);
vec3 l9_31=l9_26+vec3(0.0,0.0099999998,0.0);
float l9_32=N0_ocean(l9_31.xz*0.1);
vec3 l9_33=l9_26-vec3(0.0,0.0099999998,0.0);
float l9_34=N0_ocean(l9_33.xz*0.1);
vec3 l9_35=l9_26+vec3(0.0,0.0,0.0099999998);
float l9_36=N0_ocean(l9_35.xz*0.1);
vec3 l9_37=l9_26-vec3(0.0,0.0,0.0099999998);
float l9_38=N0_ocean(l9_37.xz*0.1);
vec3 l9_39=normalize(vec3(((l9_27.y+0.5)+(l9_28*1.5))-((l9_29.y+0.5)+(l9_30*1.5)),((l9_31.y+0.5)+(l9_32*1.5))-((l9_33.y+0.5)+(l9_34*1.5)),((l9_35.y+0.5)+(l9_36*1.5))-((l9_37.y+0.5)+(l9_38*1.5))));
vec3 l9_40=N0_sky(reflect(l9_10,l9_39),l9_21,l9_22);
float l9_41=dot(l9_21,l9_39);
float l9_42=-l9_41;
float l9_43;
if (abs(l9_42)>1.0)
{
...
l9_24=mix(vec3(0.0099999998,0.029999999,0.079999998)+mix(l9_40*clamp(l9_41,0.0,1.0),l9_40*ssPow(clamp(l9_41+0.58999997,0.0,1.0),1000.0),vec3(0.40000001)),N0_sky(normalize(l9_10+(l9_39*((-cos(1.33*l9_43))-l9_41))),l9_21,l9_22),vec3(0.34999999));
}
else
{
l9_24=vec3(0.0);
}
float l9_44=min(l9_11,300.0);
vec3 l9_45=mix(l9_24,l9_23,vec3(l9_44/300.0));
float l9_46=l9_45.x;
float l9_47;
if (l9_46<=0.0)
{
...
vec4 l9_52=vec4(l9_47,l9_49,l9_51,1.0);
...
#endif
vec3 l9_76=definedBlend(l9_74.xyz,l9_52.xyz);
