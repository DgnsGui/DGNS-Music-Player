...
vec2 l9_1=fract(p);
float l9_2=l9_1.x;
float l9_3=((l9_2*l9_2)*l9_2)*((((6.0*l9_2)*l9_2)-(15.0*l9_2))+10.0);
float l9_4=l9_1.y;
return mix(mix(fract(43758.547*sin(dot(l9_0+vec2(0.0),vec2(100.0,1.0)))),fract(43758.547*sin(dot(l9_0+vec2(1.0,0.0),vec2(100.0,1.0)))),l9_3),mix(fract(43758.547*sin(dot(l9_0+vec2(0.0,1.0),vec2(100.0,1.0)))),fract(43758.547*sin(dot(l9_0+vec2(1.0),vec2(100.0,1.0)))),l9_3),((l9_4*l9_4)*l9_4)*((((6.0*l9_4)*l9_4)-(15.0*l9_4))+10.0));
}
...
p*=N0_rotate;
p*=N0_rotate;
return ((((0.0+(0.5*N0_noise((p*1.0)+((vec2(2.0,0.0)*tempGlobals.gTimeElapsed)*0.15000001))))+(0.25*N0_noise((p*2.01)+((vec2(5.0)*tempGlobals.gTimeElapsed)*0.15000001))))+(0.0625*N0_noise((p*8.0900002)+((vec2(6.0,3.0)*tempGlobals.gTimeElapsed)*0.15000001))))+(0.03215*N0_noise((p*15.98)+((vec2(8.0,5.0)*tempGlobals.gTimeElapsed)*0.15000001))))+(0.01608*N0_noise((p*32.93)+((vec2(16.0)*tempGlobals.gTimeElapsed)*0.15000001)));
}
...
vec3 N0_sky(vec3 rd,vec3 sunDir,float fac)
{
rd.y=max(0.0,rd.y);
return (mix(vec3(0.2,0.60000002,0.89999998)-vec3(rd.y*0.85000002),vec3(0.81,0.36000001,0.18000001),vec3(exp((-rd.y)*8.0)))*fac)+(vec3(0.89999998,0.40000001,0.2)*(5.0*ssPow(dot(sunDir,rd),120.0)));
}
...
N0_rotate=mat2(vec2(0.80000001,-0.60000002),vec2(0.60000002,0.80000001));
#if (sc_DepthOnly)
{
return;
}
...
tempGlobals=ssGlobals(l9_1,l9_2,0.0,l9_3);
N0_resolution=Port_resolution_N000;
vec2 l9_5=tempGlobals.Surface_UVCoord0;
vec3 l9_6=N0_getResolution();
vec3 l9_7=N0_getResolution();
vec3 l9_8=N0_getResolution();
vec2 l9_9=(((l9_5*l9_6.xy)*2.0)-l9_7.xy)/vec2(l9_8.y);
vec3 l9_10=normalize(vec3(0.0,0.0,1000.0)-vec3(0.0));
vec3 l9_11=normalize(cross(l9_10,vec3(0.0,1.0,0.0)));
vec3 l9_12=normalize(((l9_11*l9_9.x)+(normalize(cross(l9_11,l9_10))*l9_9.y))-(l9_10*3.0));
float l9_13;
l9_13=0.0;
float l9_14;
float l9_15;
...
if (l9_16<512)
{
vec3 l9_17=l9_12*l9_13;
vec3 l9_18=vec3(0.0)+l9_17;
float l9_19=N0_ocean(l9_18.xz*0.1);
float l9_20=(l9_18.y+0.5)+(l9_19*1.5);
if (l9_20<0.0099999998)
{
l9_15=1.0;
break;
}
...
float l9_21=tempGlobals.gTimeElapsed;
float l9_22=0.60000002*sin((l9_21*0.1)-1.0);
vec3 l9_23=normalize(vec3(-0.23862,0.178965,-0.95447999)+vec3(0.0,(-l9_22)*0.5,0.0));
float l9_24=1.0-l9_22;
vec3 l9_25=N0_sky(l9_12,l9_23,l9_24);
vec3 l9_26;
if (l9_15>0.0)
{
vec3 l9_27=l9_12*l9_13;
vec3 l9_28=vec3(0.0)+l9_27;
vec3 l9_29=l9_28+vec3(0.0099999998,0.0,0.0);
float l9_30=N0_ocean(l9_29.xz*0.1);
vec3 l9_31=l9_28-vec3(0.0099999998,0.0,0.0);
float l9_32=N0_ocean(l9_31.xz*0.1);
vec3 l9_33=l9_28+vec3(0.0,0.0099999998,0.0);
float l9_34=N0_ocean(l9_33.xz*0.1);
vec3 l9_35=l9_28-vec3(0.0,0.0099999998,0.0);
float l9_36=N0_ocean(l9_35.xz*0.1);
vec3 l9_37=l9_28+vec3(0.0,0.0,0.0099999998);
float l9_38=N0_ocean(l9_37.xz*0.1);
vec3 l9_39=l9_28-vec3(0.0,0.0,0.0099999998);
float l9_40=N0_ocean(l9_39.xz*0.1);
vec3 l9_41=normalize(vec3(((l9_29.y+0.5)+(l9_30*1.5))-((l9_31.y+0.5)+(l9_32*1.5)),((l9_33.y+0.5)+(l9_34*1.5))-((l9_35.y+0.5)+(l9_36*1.5)),((l9_37.y+0.5)+(l9_38*1.5))-((l9_39.y+0.5)+(l9_40*1.5))));
vec3 l9_42=N0_sky(reflect(l9_12,l9_41),l9_23,l9_24);
float l9_43=dot(l9_23,l9_41);
float l9_44=-l9_43;
float l9_45;
if (abs(l9_44)>1.0)
{
...
l9_26=mix(vec3(0.0099999998,0.029999999,0.079999998)+mix(l9_42*clamp(l9_43,0.0,1.0),l9_42*ssPow(clamp(l9_43+0.58999997,0.0,1.0),1000.0),vec3(0.40000001)),N0_sky(normalize(l9_12+(l9_41*((-cos(1.33*l9_45))-l9_43))),l9_23,l9_24),vec3(0.34999999));
}
else
{
l9_26=vec3(0.0);
}
float l9_46=min(l9_13,300.0);
vec3 l9_47=mix(l9_26,l9_25,vec3(l9_46/300.0));
float l9_48=l9_47.x;
float l9_49;
if (l9_48<=0.0)
{
...
{
l9_53=pow(l9_52,0.45449999);
}
vec4 l9_54=vec4(l9_49,l9_51,l9_53,1.0);
...
{
l9_60=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_62=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_63;
...
{
l9_63=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_64;
...
{
l9_64=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_65;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_66=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_67;
...
{
l9_67=dot(l9_54.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_68;
...
#endif
vec3 l9_81=definedBlend(l9_79.xyz,l9_54.xyz);
